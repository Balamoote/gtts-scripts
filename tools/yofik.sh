...
pack="tts.txt scriptdb/yodef0.txt.gz scriptaux/yodef0.pat.gz scriptdb/yodef1.txt.gz scriptaux/yodef1.pat.gz scriptdb/yomo-lc0.txt.gz scriptaux/yomo-lc0.pat.gz scriptdb/yomo-uc0.txt.gz scriptaux/yomo-uc0.pat.gz scriptaux/ttspat.yoy.gz scriptaux/tts0.yoy.gz scriptdb/yolc.txt scriptdb/yodef.awk scriptaux/yolc.pat"
read -a minpack <<< $pack
