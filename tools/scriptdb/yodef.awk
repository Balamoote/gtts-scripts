...
BEGIN {
 ...
 # Записать состояние словарных массивов
  ...
  system(cmd); close(cmd);
       ...
       cmpy["варено"]="варёно";cmpy["желто"]="жёлто";cmpy["зелено"]="зелёно";cmpy["пестро"]="пёстро";cmpy["солено"]="солёно";cmpy["твердо"]="твёрдо";cmpy["тепло"]="тёпло";
       cmpy["Варено"]="Варёно";cmpy["Желто"]="Жёлто";cmpy["Зелено"]="Зелёно";cmpy["Пестро"]="Пёстро";cmpy["Солено"]="Солёно";cmpy["Твердо"]="Твёрдо";cmpy["Тепло"]="Тёпло";
       cmpy["ВАРЕНО"]="ВАРЁНО";cmpy["ЖЕЛТО"]="ЖЁЛТО";cmpy["ЗЕЛЕНО"]="ЗЕЛЁНО";cmpy["ПЕСТРО"]="ПЁСТРО";cmpy["СОЛЕНО"]="СОЛЁНО";cmpy["ТВЕРДО"]="ТВЁРДО";cmpy["ТЕПЛО"]="ТЁПЛО";

       cmpy["темно"]="тёмно";cmpy["черно"]="чёрно";cmpy["блекло"]="блёкло";
       cmpy["Темно"]="Тёмно";cmpy["Черно"]="Чёрно";cmpy["Блекло"]="Блёкло";
       cmpy["ТЕМНО"]="ТЁМНО";cmpy["ЧЕРНО"]="ЧЁРНО";cmpy["БЛЕКЛО"]="БЛЁКЛО";
