...
### трех- !_#_!
    for(wrd in trex ){wln=split(trex[wrd],omlin," ");for(y=1;y<=wln;y++){b=strtonum(omlin[y]); nf=patsplit(book[b],l,patword,sep); # header1
    for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i);                                                        # header2
...
# Различные слова из omoz
    for(wrd in omos){wln=split(omos[wrd],omlin," ");for(y=1;y<=wln;y++){b=strtonum(omlin[y]); nf=patsplit(book[b],l,patword,sep); # wrd in omos

### всем !_#_!
    if(tolower(wrd)== "всем" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### моем !_#_!
    if(tolower(wrd)== "моем" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### нем !_#_!
    if(tolower(wrd)== "нем" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### сем !_#_!
    if(tolower(wrd)== "сем" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### чем !_#_!
    if(tolower(wrd)== "чем" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### таки !_#_!
    if(tolower(wrd)== "таки" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### е !_#_!
    if(tolower(wrd)== "е" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### желто !_#_!
    if(tolower(wrd)== "желто" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### зелено !_#_!
    if(tolower(wrd)== "зелено" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### пестро !_#_!
    if(tolower(wrd)== "пестро" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### припеку !_#_!
    if(tolower(wrd)== "припеку" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### твердо !_#_!
    if(tolower(wrd)== "твердо" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### темно !_#_!
    if(tolower(wrd)== "темно" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### тепло !_#_!
    if(tolower(wrd)== "тепло" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
...
### черно !_#_!
    if(tolower(wrd)== "черно" ){for(i=1;i<=nf;i++){if(l[i]==wrd)wpos[i];};for(i in wpos){i=strtonum(i); # header
