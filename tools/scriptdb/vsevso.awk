...
hyphback(book[b]);hyphbscy(bscy[b]);getwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=tolower(wrd))continue;is_vsyo=vsyo[l[i]];is_vsje=vsje[l[i]];          # header2
 ...
 if ( phs(-1,"и так") && Qw_(hsn,"mest_mn") &&
       q(1,"gl_nemn gl_pemn gl_pnmn") && !(qm(1,"gl_mn","GE","syg")) && s(hsn+1,0) )
 ...
 if ( w(1,"вместе") &&
       q(2,"mest_mnim suw_mnim") &&
        q(3,"gl_pemn gl_pnmn") &&
         q(4,"suw_edvi suw_mnvi prl_edvi prl_mnvi") && s(0,3) )
 { l[i]=is_vsje; V[113]++; if(dbg){print "V113"}; continue};
 if ( w(1,"вместе") &&
       q(2,"mest_vi suw_edvi suw_mnvi nar_spos nar_step") &&
 ...
 if ( wf(1,7,"мнения") &&
       w(wfn-2,"о") &&
        q(wfn-1,"mest_da suw_edda suw_mnda") && s(0,wfn-1) )
 ...
 if ( Qw_(-1,"mest_mn mest_ed gl_ed gl_in gl_vzmn gl_nemn gl_pemn gl_pnmn gl_poed gl_pomn") &&
       pre_da(1) &&
        q(2,"suw_edda suw_mnda") && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[118]++; if(dbg){print "V118"}; continue};
 if ( pre_da(1) && p(-1) &&
       q(2,"prl_edda prl_mnda mest_da") &&
        q(3,"suw_edda suw_mnda") && s(0,2) )
 { l[i]=is_vsyo; V[119]++; if(dbg){print "V119"}; continue};
 if ( pre_da(-1) && s(0) )
 ...
 if ( pre_ro(1) &&
       mest_ro(2) &&
        prq_edim(3) && s(0,2) )
 { l[i]=is_vsyo; V[129]++; if(dbg){print "V129"}; continue};
 if ( gl_in(-1) &&
       pre_ro(1) &&
 ...
 if ( pre_ro(1) &&
       suw_mnro(2) && s(0,1) )
 { l[i]=is_vsje; V[135]++; if(dbg){print "V135"}; continue};
 if ( pre_ro(1) && sc(0,",") &&
       q(2,"suw_mnro cap") && s(1) && p(2) )
 { l[i]=is_vsje; V[136]++; if(dbg){print "V136"}; continue};
 ...
 if ( w(-1,"со ко") && s(-1) )
 { l[i]=is_vsyo; V[139]++; if(dbg){print "V139"}; continue};
 if ( w(1,"до") &&
       w(2,"конца") && s(0,1) )
 ...
 if ( sc(0,",") &&
       pre_vi(1) &&
        w(2,"кого") && s(1) )
 { l[i]=is_vsje; V[147]++; if(dbg){print "V147"}; continue};
 if ( pre_vi(-1) &&
       gl_vzmn(1) &&
 ...
 if ( sc(0,",") &&
       pre_pr(1) &&
        w(2,"ком") && s(1) )
 { l[i]=is_vsje; V[152]++; if(dbg){print "V152"}; continue};
 if ( pre_pr(1) &&
 ...
 if ( mod_mn(1) &&
       qm(2,"gl_in","GE","py") &&
        pre_any(3) && s(0,3) )
 { l[i]=is_vsyo; V[170]++; if(dbg){print "V170"}; continue};
 if ( qm(-1,"gl_in","GE","qy") && s(-1) &&
      (w(1,"чтобы будто")||q(1,"mest_im nar_vopr")) && sc(0,",") )
 { l[i]=is_vsyo; V[171]++; if(dbg){print "V171"}; continue};
 if ( qm(-1,"gl_mn","GE","qy") && s(-1) &&
      (w(1,"чтобы будто")||q(1,"mest_im nar_vopr")) && sc(0,",") )
 { l[i]=is_vsyo; V[172]++; if(dbg){print "V172"}; continue};
 ...
 { l[i]=is_vsje; V[174]++; if(dbg){print "V174"}; continue};
 if ( mest_mnim(-4) &&
       w(-3,"же ведь") &&
        phs(-1,"и так") &&
 ...
 { l[i]=is_vsyo; V[177]++; if(dbg){print "V177"}; continue};
 if ( mest_mnim(-2) &&
       prl_kred_sr(-1) &&
 ...
 { l[i]=is_vsje; V[182]++; if(dbg){print "V182"}; continue};
 if ( w(1,"так") &&
       qm(2,"gl_mn","GE","nj") && s(0,1) && p(2) )
 { l[i]=is_vsje; V[183]++; if(dbg){print "V183"}; continue};
 if ( mest_mnim(-2) &&
       qm(-1,"gl_mn","GE","sgy") &&
        pre_pr(1) &&
 ...
 { l[i]=is_vsyo; V[186]++; if(dbg){print "V186"}; continue};
 if ( mest_mnim(-2) &&
       prl_kred_sr(-1) &&
 ...
 { l[i]=is_vsje; V[189]++; if(dbg){print "V189"}; continue};
 if ( qm(-2,"gl_po","GE","j") &&
       mest_mnim(-1) && s(-2,-1) )
 { l[i]=is_vsje; V[190]++; if(dbg){print "V190"}; continue};
 if ( mest_mnim(-2) &&
       qm(-1,"gl_mn","GE","syg") &&
 ...
 if ( q(-2,"suw_edvi suw_mnvi suw_mntv mest_vi") &&
       qm(-1,"gl_mn","GE","ogj") && s(-2,-1) && p(0) )
 { l[i]=is_vsje; V[195]++; if(dbg){print "V195"}; continue};
 ...
 if ( w(1,"уже ведь") &&
       qm(2,"gl_mn","GE","y") && s(0,1) )
 { l[i]=is_vsyo; V[204]++; if(dbg){print "V204"}; continue};
 if ( qm(1,"gl_mn","GE","y") && s(0) && p(1) )
 { l[i]=is_vsyo; V[205]++; if(dbg){print "V205"}; continue};
 if ( qm(-1,"gl_mn","GE","y") &&
       nar_step(1) && s(-1,0) )
 { l[i]=is_vsyo; V[206]++; if(dbg){print "V206"}; continue};
 ...
 if ( mod_mn(1) &&
       prl_kred_sr(2) &&
        gl_in(3) && s(0,2) )
 { l[i]=is_vsje; V[214]++; if(dbg){print "V214"}; continue};
 if ( mest_mn(-2) &&
       mod_mn(-1) &&
        gl_in(1) && s(-2,0) )
 ...
 if ( gl_in(-2) &&
       mod_mn(-1) && s(-2,-1) )
 { l[i]=is_vsje; V[216]++; if(dbg){print "V216"}; continue};
 if ( mod_ed(-2) &&
       pre_vi(-1) && s(-2,-1) && p(0) )
 ...
 if ( mod_bz(-2) &&
       gl_in(-1) && 
        q(1,"suw_edda suw_mnda") && Q(1,"suw_mnim") && s(-2,0))
 ...
 if ( mod_mn(1) &&
       nar_napr(2) && s(0,1) )
 { l[i]=is_vsje; V[224]++; if(dbg){print "V224"}; continue};
 if ( phf(1,"никак не") &&
 ...
 if ( q(-3,"suw_edim suw_mnim") &&
       mod_mn(-2) &&
        gl_in(-1) && s(-2,-1) && p(0) )
 { l[i]=is_vsje; V[226]++; if(dbg){print "V226"}; continue};
 if ( w(1,"не") &&
       mod_mn(2) &&
        gl_in(3) && s(0,2) )
 ...
 if ( gl_ed(-2) &&
       mest_it(-1) && s(-2,-1) )
 { l[i]=is_vsyo; V[233]++; if(dbg){print "V233"}; continue};
 if ( mest_it(-1) &&
       q(1,"nar_vrem nar_mest nar_spos nar_step nar_srav nar_kaq") &&
        q(2,"gl_ed gl_in") && s(-1,1) )
 { l[i]=is_vsyo; V[234]++; if(dbg){print "V234"}; continue};
 if ( prl_kred_sr(1) &&
       prl_kred_sr(2) &&
        q(3,"gl_ed gl_in") && s(0,2) )
 { l[i]=is_vsyo; V[235]++; if(dbg){print "V235"}; continue};
 if ( pre_tv(1) &&
 ...
 if ( mest_it(1) && s(0) && sc(1,",") &&
       vvod(2) && sc(2,",") &&
        q(3,"gl_nemn gl_pnmn") )
 { l[i]=is_vsje; V[244]++; if(dbg){print "V244"}; continue};
 if ( gl_ed(-1) &&
 ...
 if ( mest_it(-1) &&
       w(1,"кто") && s(-1) && sc(0,",") )
 { l[i]=is_vsje; V[260]++; if(dbg){print "V260"}; continue};
 if ( mest_it(-1) &&
       pre_ro(1) &&
        w(2,"того") &&
 ...
 if ( prq_krmn(-4) &&
       w(-3,"еще ещё") &&
        prl_kred_sr(-2) &&
         w(-1,"не") && s(-4,-1) )
 { l[i]=is_vsje; V[269]++; if(dbg){print "V269"}; continue};
 if ( prq_krmn(-3) &&
       prl_kred_sr(-2) &&
        w(-1,"не") && s(-3,-1) )
 { l[i]=is_vsje; V[270]++; if(dbg){print "V270"}; continue};
 if ( prq_kred_sr(-4) &&
       w(-3,"еще ещё") &&
        prl_kred_sr(-2) &&
         w(-1,"не") && s(-4,-1) )
 ...
 if ( w(1,"уже") &&
       q(2,"nar_mest nar_step") &&
        prq_kred_sr(3) && s(0,2) )
 { l[i]=is_vsyo; V[273]++; if(dbg){print "V273"}; continue};
 if ( mest_mnim(1) &&
       pre_ro(2) &&
 ...
 if ( q(1,"mest_tv prl_edtv prl_mntv") &&
       q(2,"suw_edtv suw_mntv") &&
        prq_krmn(3) && s(0,2) )
 { l[i]=is_vsje; V[275]++; if(dbg){print "V275"}; continue};
 if ( suw_edim(1) &&
 ...
 { l[i]=is_vsyo; V[278]++; if(dbg){print "V278"}; continue};
 if ( pre_ro(1) &&
 ...
 { l[i]=is_vsje; V[280]++; if(dbg){print "V280"}; continue};
 if ( prq_kred_sr(-2) &&
 ...
 if ( q(-1,"prq_edtv prq_mntv prl_edtv prl_mntv") && sc(-1,",") &&
       q(1,"prq_edtv prq_mntv") &&
 ...
 if ( prq_mnim(1) &&
       pre_ro(2) && s(0,1) )
 { l[i]=is_vsje; V[290]++; if(dbg){print "V290"}; continue};
 if ( w(1,"не") &&
       prq_mnim(2) &&
        pre_ro(3) && s(0,2) )
 { l[i]=is_vsje; V[291]++; if(dbg){print "V291"}; continue};
 if ( w(1,"даже") && sc(0,",") &&
       w(2,"не") &&
        prq_mnim(3) &&
         suw_edda(4) && s(1,3) )
 { l[i]=is_vsje; V[292]++; if(dbg){print "V292"}; continue};
 if ( w(1,"не") && sc(0,",") &&
       prq_mnim(2) &&
        suw_edda(3) && s(1,2) )
 ...
 { l[i]=is_vsyo; V[295]++; if(dbg){print "V295"}; continue};
 if ( q(1,"prq_edro prq_mnro") && s(0) )
 { l[i]=is_vsyo; V[296]++; if(dbg){print "V296"}; continue};
 if ( prq_edsrim(1) && sc(0,",") )
 { l[i]=is_vsyo; V[297]++; if(dbg){print "V297"}; continue};
 ...
 if ( q(1,"prl_mnim prq_mnim prl_mnro prq_mnro prl_krmn") &&
        souz_iili(2) &&
         q(3,"prl_mnim prq_mnim prl_mnro prq_mnro prl_krmn") &&
          suw_mnim(4) &&
           gl_nemn(5) && s(0,4)  )
 { l[i]=is_vsje; V[301]++; if(dbg){print "V301"}; continue};
 if ( q(1,"prl_mnim prq_mnim prl_mnro prq_mnro prl_krmn") &&
       souz_iili(2) &&
        q(3,"prl_mnim prq_mnim prl_mnro prq_mnro prl_krmn") &&
         suw_mnim(4) && s(0,3)  )
 { l[i]=is_vsje; V[302]++; if(dbg){print "V302"}; continue};
 ...
 { l[i]=is_vsje; V[303]++; if(dbg){print "V303"}; continue};
 if ( w(1,"и") &&
 ...
 { l[i]=is_vsyo; V[305]++; if(dbg){print "V305"}; continue};
 ...
 if ( q(1,"prl_edim prl_kred") &&
       suw_edim(2) && s(0,1) )
 { l[i]=is_vsyo; V[311]++; if(dbg){print "V311"}; continue};
 if ( q(1,"prl_pvedtv prl_pvmntv") &&
       q(2,"suw_edtv suw_mntv") && s(0,1) )
 { l[i]=is_vsyo; V[312]++; if(dbg){print "V312"}; continue};
 if ( q(1,"qast nar_kaq") &&
       q(2,"nar_kaq nar_step") &&
        prl_kred_sr(3) && s(0,2) )
 { l[i]=is_vsyo; V[313]++; if(dbg){print "V313"}; continue};
 if ( w(1,"ли") &&
       suw_mnim(2) &&
        prl_krmn(3) && s(0,2) )
 ...
 if ( suw_mnim(1) &&
       prl_krmn(2) && s(0,1) )
 { l[i]=is_vsje; V[315]++; if(dbg){print "V315"}; continue};
 if ( q(-1,"mest_da suw_edda suw_mnda") &&
       prl_kred_sr(1) && s(-1,0) )
 ...
 if ( q(1,"mest_ed mest_mn") &&
       q(2,"nar_kaq nar_step nar_spos") &&
        prl_krmn(3) && s(0,1) )
 { l[i]=is_vsje; V[320]++; if(dbg){print "V320"}; continue};
 ...
 { l[i]=is_vsyo; V[322]++; if(dbg){print "V322"}; continue};
 if ( w(1,"вроде как") &&
       w(2,"бы как") &&
        prl_kred_sr(3) && s(0,2) && p(3) )
 { l[i]=is_vsyo; V[323]++; if(dbg){print "V323"}; continue};
 if ( w(1,"так настолько") &&
       prl_kred_sr(2) &&
        w(3,"и") &&
         prl_kred_sr(4) && s(0,3) && p(4) )
 { l[i]=is_vsyo; V[324]++; if(dbg){print "V324"}; continue};
 ...
 { l[i]=is_vsje; V[338]++; if(dbg){print "V338"}; continue};
 if ( q(-1,"gl_nemn gl_pnmn gl_pemn") &&
       q(1,"prl_kred_sr prl_edsrim") && s(-1,0) && p(1) )
 { l[i]=is_vsje; V[339]++; if(dbg){print "V339"}; continue};
 ...
 { l[i]=is_vsje; V[344]++; if(dbg){print "V344"}; continue};
 if ( q(-1,"prl_kred_sr nar_kaq") &&
       pre_ro(1) &&
        q(2,"suw_edro suw_mnro") && s(-1,1) && p(2) )
 { l[i]=is_vsje; V[345]++; if(dbg){print "V345"}; continue};
 if ( q(-1,"prl_kred_sr nar_kaq") && s(-1) && p(0) )
 { l[i]=is_vsyo; V[346]++; if(dbg){print "V346"}; continue};
 if ( q(1,"mest_ed nar_kaq nar_vrem") &&
       q(2,"prl_kred_sr prl_edsrim") && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[347]++; if(dbg){print "V347"}; continue};
 if ( pre_pr(1) &&
       q(2,"mest_pr suw_edpr suw_mnpr") &&
        prl_kred_sr(3) && s(0,2) && p(3) )
 { l[i]=is_vsyo; V[348]++; if(dbg){print "V348"}; continue};
 ...
 { l[i]=is_vsje; V[350]++; if(dbg){print "V350"}; continue};
 ...
 { l[i]=is_vsje; V[356]++; if(dbg){print "V356"}; continue};
 if ( w(1,"ли же ведь") &&
       prl_mnim(2) && s(0,1) && (p(2)||(w(3,"и")||pre_any(3))) )
 { l[i]=is_vsje; V[357]++; if(dbg){print "V357"}; continue};
 if ( w(1,"больших") &&
       suw_mnro(2) && s(0,1) )
 ...
 if ( w(1,"нет") &&
       q(2,"suw_edro suw_mnro") && s(0,1) )
 { l[i]=is_vsyo; V[364]++; if(dbg){print "V364"}; continue};
 if ( q(1,"suw_edim suw_edne") &&
       q(2,"suw_edro suw_mnro suw_mnvi") &&
        gl_edsr(3) && s(0,2) )
 { l[i]=is_vsyo; V[365]++; if(dbg){print "V365"}; continue};
 if ( q(1,"mest_ed mest_mn") &&
       suw_mnim(2) && s(0,1) )
 ...
 if ( q(1,"prl_mnim prq_mnim") &&
       mest_da(2) &&
        suw_mnim(3) && s(0,2) )
 { l[i]=is_vsje; V[368]++; if(dbg){print "V368"}; continue};
 ...
 if ( pre_pr(-4) &&
       q(-3,"prl_edpr prl_mnpr") &&
        q(-2,"suw_edpr suw_mnpr") &&
         q(-1,"gl_pemn gl_pnmn") && s(-2,-1) && p(0) )
 { l[i]=is_vsyo; V[372]++; if(dbg){print "V372"}; continue};
 if ( pre_pr(-3) &&
       q(-2,"suw_edpr suw_mnpr") &&
        q(-1,"gl_pemn gl_pnmn") && s(-2,-1) && p(0) )
 { l[i]=is_vsyo; V[373]++; if(dbg){print "V373"}; continue};
 if ( suw_odmnim(-2) &&
       q(-1,"gl_pemn gl_pnmn") && s(-2,-1) && p(0) )
 { l[i]=is_vsyo; V[374]++; if(dbg){print "V374"}; continue};
 if ( suw_nomnvi(-2) &&
       q(-1,"gl_pemn gl_pnmn") && s(-2,-1) && p(0) )
 { l[i]=is_vsje; V[375]++; if(dbg){print "V375"}; continue};
 if ( suw_mnim(-1) &&
       prl_krmn(1) && s(-1,0) )
 { l[i]=is_vsje; V[376]++; if(dbg){print "V376"}; continue};
 if ( suw_mnim(1) && Q(1,"prl_mnim prl_mnvi") && s(0) )
 { l[i]=is_vsje; V[377]++; if(dbg){print "V377"}; continue};
 ...
 if ( q(1,"mest_edsr mest_mn") &&
       prl_edsrim(2) &&
        suw_edsrim(3) && s(0,2) )
 { l[i]=is_vsyo; V[379]++; if(dbg){print "V379"}; continue};
 if ( q(1,"mest_ed mest_mn") &&
       suw_edsrim(2) && s(0,1) )
 { l[i]=is_vsyo; V[380]++; if(dbg){print "V380"}; continue};
 if ( suw_edim(1) && Q(1,"nar_spos") && s(0) )
 { l[i]=is_vsyo; V[381]++; if(dbg){print "V381"}; continue};
 if ( q(1,"mest_ed mest_mn") &&
       suw_edim(2) &&
        qik_edim(3) && s(0,2) )
 { l[i]=is_vsje; V[382]++; if(dbg){print "V382"}; continue};
 if ( mest_ed(1) &&
       qast(2) &&
        suw_edim(3) && s(0,2) )
 ...
 if ( suw_edim(1) &&
       q(2,"suw_edro suw_mnro") && s(0,1) && p(2) )
 ...
 if ( suw_edim(1) &&
       q(2,"suw_edro suw_mnro") && s(0,1) )
 { l[i]=is_vsyo; V[393]++; if(dbg){print "V393"}; continue};
 if ( suw_mnim(-1) && sc(-1,",") &&
       pre_pr(1) &&
        q(2,"prl_edpr prl_mnpr") &&
         q(3,"suw_edpr suw_mnpr") && s(0,2) )
 ...
 { l[i]=is_vsje; V[399]++; if(dbg){print "V399"}; continue};
 ...
 { l[i]=is_vsje; V[410]++; if(dbg){print "V410"}; continue};
 if ( w(1,"как") &&
       w(2,"раз будто") &&
 ...
 { l[i]=is_vsje; V[418]++; if(dbg){print "V418"}; continue};
 ...
 if ( nar_mest(1) &&
       suw_mnim(2) && s(0,1) )
 { l[i]=is_vsje; V[420]++; if(dbg){print "V420"}; continue};
 ...
 if ( qis_im(1) && s(0) )
 { l[i]=is_vsje; V[425]++; if(dbg){print "V425"}; continue};
 if ( (q(1,"qik_edim qik_mnim")||wc(1,"^[0-9]+$")) && s(0) )
 { l[i]=is_vsje; V[426]++; if(dbg){print "V426"}; continue};

 # все + местоимения =============================================
 # все + мест.мн
 if ( w(-1,"чем даже") &&
       mest_mnim(1) && s(-1,0) )
 { l[i]=is_vsje; V[427]++; if(dbg){print "V427"}; continue};
 if ( mest_mn(-3) && sc(-3,",") &&
       w(-2,"а но") &&
        w(-1,"не") && s(-2,-1) )
 ...
 { l[i]=is_vsyo; V[431]++; if(dbg){print "V431"}; continue};
 if ( mest_im(-2) &&
       mest_mnim(-1) &&
        mest_mnim(1) && s(-2,0) )
 ...
 if ( mest_da(1) &&
       gl_ed(2) && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[437]++; if(dbg){print "V437"}; continue};
 if ( mest_mnim(1) &&
 ...
 if ( w(-2,"а") &&
       mest_mnim(-1) &&
        q(1,"gl_pnmn gl_nemn") &&
         prl_kred_sr(2) && s(-2,1) )
 { l[i]=is_vsyo; V[455]++; if(dbg){print "V455"}; continue};
 if ( mest_mn(1) &&
       ...
       (q(-3,"nar_mest nar_vrem")||w(-3,"же ведь")) &&
        pre_ro(-2) &&
         q(-1,"mest_ro suw_edro suw_mnro") &&
          pre_pr(1) &&
           q(2,"suw_edpr suw_mnpr") && s(-4,1) )
 { l[i]=is_vsje; V[461]++; if(dbg){print "V461"}; continue};
 if ( mest_mnim(-3) &&
       pre_ro(-2) &&
        q(-1,"mest_ro suw_edro suw_mnro") &&
         pre_pr(1) &&
          q(2,"suw_edpr suw_mnpr") && s(-3,1) )
 ...
 { l[i]=is_vsyo; V[470]++; if(dbg){print "V470"}; continue};
 if ( mest_ed(1) &&
       pre_tv(2) &&
        q(3,"mest_tv suw_edtv suw_mntv prl_edtv prl_mntv") && s(0,1) )
 { l[i]=is_vsyo; V[471]++; if(dbg){print "V471"}; continue};
 if ( mest_ed(1) &&
       nar_step(2) &&
        nar_kaq(3) && s(0,2) )
 { l[i]=is_vsyo; V[472]++; if(dbg){print "V472"}; continue};
 if ( mest_ed(1) &&
       q(2,"nar_kaq nar_step nar_spos") &&
        q(3,"gl_ed gl_in") && s(0,2) )
 ...
 if ( w(-1,"их") && p(0) )
 { l[i]=is_vsje; V[475]++; if(dbg){print "V475"}; continue};
 if ( mest_mn(1) && cap(0) && s(0) && p(1) )
 { l[i]=is_vsje; V[476]++; if(dbg){print "V476"}; continue};
 ...
 if ( gl_mn(1) && nmark(1,"TY","del") &&
       pre_ro(2) &&
        q(3,"suw_edro suw_mnro") && s(0,1) )
 { l[i]=is_vsyo; V[479]++; if(dbg){print "V479"}; continue};
 ...
 if ( qf(1,3,"gl_mn") && nmark(qfn,"TY","vosinf") &&
      ( p(qfn)||(q(qfn+1,"souz pre_any prl_kred_sr") && s(0,qfn-1)) ))
 ...
 if ( qf(1,5,"gl_pemn") && nmark(qfn,"TY","vosinf") &&
       q(qfn+1,"suw_edvi suw_mnvi") && s(0,qfn) )
 { l[i]=is_vsje; V[483]++; if(dbg){print "V483"}; continue};
 ...
 if ( gl_in(-1) &&
       pre_pr(1) &&
        q(2,"suw_edpr suw_mnpr") &&
         prl_edtv(3) && s(-1,2) )
 { l[i]=is_vsyo; V[491]++; if(dbg){print "V491"}; continue};
 if ( mest_mn(-1) &&
 ...
 if ( mest_ed(1) &&
       gl_ed(2) && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[500]++; if(dbg){print "V500"}; continue};
 ...
 { l[i]=is_vsyo; V[505]++; if(dbg){print "V505"}; continue};
 ...
 { l[i]=is_vsje; V[512]++; if(dbg){print "V512"}; continue};
 if ( deep(-2) &&
       q(-1,"suw_edtv suw_mntv") &&
        nar_mest(1) && s(-2,0) )
 ...
 { l[i]=is_vsyo; V[514]++; if(dbg){print "V514"}; continue};
 if ( deep(-2) &&
       mest_vi(-1) &&
        q(1,"prl_srav prl_edtv prl_mntv suw_edvi suw_mnvi") && s(-2,0) )
 ...
 if ( w(1,"включая") && sc(0,",") &&
       q(2,"suw_edvi suw_mnvi") && s(1) )
 { l[i]=is_vsje; V[521]++; if(dbg){print "V521"}; continue};
 if ( deep(-1) &&
       nar_mest(1) && s(-1,0) )
 ...
 if ( q(1,"nar_mest nar_kaq nar_vrem nar_spos") &&
       q(2,"gl_vzmn gl_nemn") && s(0,1) )
 { l[i]=is_vsje; V[526]++; if(dbg){print "V526"}; continue};
 if ( q(1,"nar_mest nar_kaq nar_vrem nar_spos") &&
       q(2,"gl_pnmn gl_pemn") && s(0,1) )
 { l[i]=is_vsje; V[527]++; if(dbg){print "V527"}; continue};
 if ( nar_vrem(1) &&
       nar_vrem(2) &&
        q(3,"gl_vzmn gl_nemn") && s(0,2) )
 ...
 if ( q(-1,"gl_vzed gl_vzmn gl_nemn") &&
       prl_srav(1) && s(-1,0) )
 { l[i]=is_vsyo; V[529]++; if(dbg){print "V529"}; continue};
 if ( nar_srav(1) &&
...
if ( gl_nemn(1) &&
 ...
 if ( gl_nemn(1) &&
       prl_krmn(2) && s(0,1) )
 { l[i]=is_vsje; V[537]++; if(dbg){print "V537"}; continue};
 if ( q(1,"gl_pemn gl_pnmn") &&
       q(2,"suw_edro suw_mnro") && s(0,1) )
 { l[i]=is_vsje; V[538]++; if(dbg){print "V538"}; continue};

 if ( q(1,"gl_pemn gl_pnmn") &&
       q(2,"suw_edtv suw_mntv suw_edda suw_mnda") && s(0,1) )
 ...
 if ( mest_mnim(-1) &&
       q(1,"gl_pemn gl_nemn gl_pnmn gl_vzmn") &&
        w(2,"и") &&
         q(3,"gl_pemn gl_nemn gl_pnmn gl_vzmn") && s(0,2) )
 { l[i]=is_vsyo; V[542]++; if(dbg){print "V542"}; continue};
 if ( w(1,"и") &&
 ...
 # Ну всё,
 if ( w(-1,"ну") && s(-1) )
 { l[i]=is_vsyo; V[555]++; if(dbg){print "V555"}; continue};
 ...
 { l[i]=is_vsje; V[570]++; if(dbg){print "V570"}; continue};
 ...
 if ( nar_mest(1) &&
       gl_pnmn(2) &&
        qast(3) &&
         gl_in(4) && s(0,3) )
 { l[i]=is_vsje; V[576]++; if(dbg){print "V576"}; continue};
 if ( q(1,"gl_pnmn gl_pemn") &&
       gl_in(2) && s(0,1) )
 { l[i]=is_vsje; V[577]++; if(dbg){print "V577"}; continue};
 if ( q(1,"gl_pnmn gl_pemn") &&
       qast(2) &&
        gl_in(3) && s(0,2) )
 { l[i]=is_vsje; V[578]++; if(dbg){print "V578"}; continue};
 if ( q(1,"gl_ed gl_in") && s(0) && cap(0) && p(1) )
 { l[i]=is_vsyo; V[579]++; if(dbg){print "V579"}; continue};
 if ( pre_ro(-2) &&
       mest_ro(-1) &&
        q(1,"gl_ed gl_in") && s(-2,0) )
 { l[i]=is_vsyo; V[580]++; if(dbg){print "V580"}; continue};
 if ( w(1,"и не ли так как же") &&
       q(2,"gl_ed gl_in") && s(0,1) )
 { l[i]=is_vsyo; V[581]++; if(dbg){print "V581"}; continue};
 if ( gl_ed(-3) &&
       w(-2,"бы") &&
        mest_mnvi(-1) &&
 ...
 if ( gl_ed(-3) &&
       pre_pr(-2) &&
       (q(-1,"suw_edpr suw_mnpr prl_edpr prl_mnpr")||wc(-1,"ах$")) && s(-3,-1) )
 { l[i]=is_vsyo; V[583]++; if(dbg){print "V583"}; continue};
 if ( gl_ed(-1) &&
       pre_pr(1) &&
       (q(2,"suw_edpr suw_mnpr prl_edpr prl_mnpr")||wc(2,"ах$")) && s(-1,1) )
 { l[i]=is_vsyo; V[584]++; if(dbg){print "V584"}; continue};
 if ( gl_ed(-2) &&
       mest_mnvi(-1) &&
        q(1,"gl_ed gl_in") && s(-2,0) )
 { l[i]=is_vsje; V[585]++; if(dbg){print "V585"}; continue};
 if ( mest_mnvi(-1) &&
 ...
 { l[i]=is_vsje; V[591]++; if(dbg){print "V591"}; continue};
 if ( mest_mn(-2) && s(-1) &&
       w(-1,"ведь уже") &&
 ...
 { l[i]=is_vsje; V[593]++; if(dbg){print "V593"}; continue};
 if ( mest_vi(1) &&
       q(2,"gl_pemn gl_pnmn") &&
 ...
 { l[i]=is_vsyo; V[606]++; if(dbg){print "V606"}; continue};
 if ( q(1,"gl_nemn gl_pnmn gl_pemn") &&
       pre_pr(2) &&
 ...
 if (pre_pr(1) &&
      q(2,"prl_edpr prl_mnpr") &&
       q(3,"suw_edpr suw_mnpr") &&
        gl_ed(4) && s(0,3) )
 { l[i]=is_vsyo; V[616]++; if(dbg){print "V616"}; continue};
 if (pre_pr(1) &&
      q(2,"prl_edpr prl_mnpr") &&
       q(3,"suw_edpr suw_mnpr") &&
 ...
 if ( mest_ro(-1) && p(-2) &&
       q(1,"gl_pemn gl_pnmn") &&
        (q(2,"suw_edtv suw_mntv isname")) && s(-1,1) )
 ...
 if ( vvb(-9,-2) &&
       w(vvn,"вот") &&
        w(-1,"и") && s(-1) && p(0) )
 { l[i]=is_vsyo; V[650]++; if(dbg){print "V650"}; continue};
 if ( vv(0,7) &&
 ...
 if ( nar_mest(1) && sc(1,",") && s(0) &&
       gl_mn(2) &&
        q(3,"mest_vi suw_edvi suw_mnvi") && s(2) )
 ...
 if ( mod_mn(2) &&
       gl_in(3) && s(0,2) )
 { l[i]=is_vsje; V[670]++; if(dbg){print "V670"}; continue};
 ...
 { l[i]=is_vsyo; V[672]++; if(dbg){print "V672"}; continue};

 # одиничное слово
 if ( p(-1) && p(0) &&
       w(1,"конец погиб амба пиздец капец финиш пришли приехали дожили") && p(1,"[—,]") )
 { l[i]=is_vsyo; V[673]++; if(dbg){print "V673"}; continue};
 if ( p(-1) && p(0) &&
       w(1,"конец") &&
 ...
 if ( q(-3,"gl_nemn") &&
       w(-2,"бы") && s(-3) && p(-2) &&
        w(-1,"как") && s(-1) && p(0) )
 { l[i]=is_vsje; V[675]++; if(dbg){print "V675"}; continue};
 if ( w(1,"и") && sc(0,",") &&
       qxs(2,"ещё","больше") )
 ...
 { l[i]=is_vsje; V[680]++; if(dbg){print "V680"}; continue};
 if ( prl_srav(1) && s(0) )
 { l[i]=is_vsyo; V[681]++; if(dbg){print "V681"}; continue};
 if ( gl_poed(-1) && s(-1) && p(0) )
 { l[i]=is_vsyo; V[682]++; if(dbg){print "V682"}; continue};
 if ( deep(1) && s(0) )
 { l[i]=is_vsyo; V[683]++; if(dbg){print "V683"}; continue};
 ...
 { l[i]=is_vsje; V[685]++; if(dbg){print "V685"}; continue};

 # Эскейпы для SpaCy
 if ( w(1,"новые новых") && s(0) )
 {             ; V[686]++; if(dbg){print "V686"}; continue};
 if ( p(-1) && p(0) )
 {             ; V[687]++; if(dbg){print "V687"}; continue};
 if ( p(-2) && p(0) )
 {             ; V[688]++; if(dbg){print "V688"}; continue};
 ...
 # SpaCy
 if ( vsyo_sy(0) )
 { l[i]=is_vsyo; V[692]++; if(dbg){print "V692"}; continue};
 if ( vsje_sy(0) )
 { l[i]=is_vsje; V[693]++; if(dbg){print "V693"}; continue};
