...
hyphback(book[b]);hyphbscy(bscy[b]);getwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=tolower(wrd))continue;is_vsyo=vsyo[l[i]];is_vsje=vsje[l[i]];          # header2
 ...
 { l[i]=is_vsje; V[51]++; if(dbg){print "V51"}; continue };
 ...
 { l[i]=is_vsje; V[137]++; if(dbg){print "V137"}; continue };
 ...
 if ( sc(0,",") &&
       pre_vi(1) &&
        w(2,"кого") && s(1) )
 { l[i]=is_vsje; V[148]++; if(dbg){print "V148"}; continue };
 if ( pre_vi(-1) &&
       gl_vzmn(1) &&
 ...
 { l[i]=is_vsje; V[163]++; if(dbg){print "V163"}; continue };
 if ( qm(1,"gl_mn","GE","y") &&
       w(2,"и") &&
 ...
 { l[i]=is_vsyo; V[165]++; if(dbg){print "V165"}; continue };
 if ( pre_pr(-4) &&
 ...
 { l[i]=is_vsje; V[175]++; if(dbg){print "V175"}; continue };
 if ( mest_mnim(-4) &&
       w(-3,"же ведь") &&
        phs(-1,"и так") &&
 ...
 { l[i]=is_vsje; V[184]++; if(dbg){print "V184"}; continue };
 if ( mest_mnim(-2) &&
       qm(-1,"gl_mn","GE","sgy") &&
        pre_pr(1) &&
 ...
 if ( qm(-2,"gl_po","GE","j") &&
       mest_mnim(-1) && s(-2,-1) )
 { l[i]=is_vsje; V[191]++; if(dbg){print "V191"}; continue };
 if ( mest_mnim(-2) &&
       qm(-1,"gl_mn","GE","syg") &&
 ...
 { l[i]=is_vsyo; V[193]++; if(dbg){print "V193"}; continue };
 if ( mest_it(-1) &&
 ...
 if ( qm(1,"gl_mn","GE","myg") && s(0) &&
       titul(2) && sc(1,",") )
 { l[i]=is_vsyo; V[197]++; if(dbg){print "V197"}; continue };
 if ( pre_pr(1) &&
 ...
 if ( mod_mn(1) &&
       prl_kred_sr(2) &&
        gl_in(3) && s(0,2) )
 { l[i]=is_vsje; V[215]++; if(dbg){print "V215"}; continue };
 if ( mest_mn(-2) &&
       mod_mn(-1) &&
        gl_in(1) && s(-2,0) )
 ...
 if ( mod_mn(1) &&
       nar_napr(2) && s(0,1) )
 { l[i]=is_vsje; V[225]++; if(dbg){print "V225"}; continue };
 if ( phf(1,"никак не") &&
 ...
 if ( mest_it(1) && s(0) && sc(1,",") &&
       vvod(2) && sc(2,",") &&
        q(3,"gl_nemn gl_pnmn") )
 { l[i]=is_vsje; V[245]++; if(dbg){print "V245"}; continue };
 if ( gl_ed(-1) &&
 ...
 if ( suw_mnim(-2) &&
       gl_ed(-1) &&
        pre_any(1) && s(-2,1) )
 { l[i]=is_vsje; V[249]++; if(dbg){print "V249"}; continue };
 if ( (cap(0)||p(-1,",")) &&
 ...
 if ( mest_it(-1) &&
       w(1,"кто") && s(-1) && sc(0,",") )
 { l[i]=is_vsje; V[261]++; if(dbg){print "V261"}; continue };
 if ( mest_it(-1) &&
       pre_ro(1) &&
        w(2,"того") &&
 ...
 if ( prq_krmn(-3) &&
       prl_kred_sr(-2) &&
        w(-1,"не") && s(-3,-1) )
 { l[i]=is_vsje; V[271]++; if(dbg){print "V271"}; continue };
 if ( prq_kred_sr(-4) &&
       w(-3,"еще ещё") &&
        prl_kred_sr(-2) &&
         w(-1,"не") && s(-4,-1) )
 ...
 if ( q(1,"mest_tv prl_edtv prl_mntv") &&
       q(2,"suw_edtv suw_mntv") &&
        prq_krmn(3) && s(0,2) )
 { l[i]=is_vsje; V[276]++; if(dbg){print "V276"}; continue };
 if ( suw_edim(1) &&
 ...
 { l[i]=is_vsje; V[281]++; if(dbg){print "V281"}; continue };
 if ( prq_kred_sr(-2) &&
 ...
 { l[i]=is_vsyo; V[306]++; if(dbg){print "V306"}; continue };
 ...
 if ( suw_mnim(1) &&
       prl_krmn(2) && s(0,1) )
 { l[i]=is_vsje; V[316]++; if(dbg){print "V316"}; continue };
 if ( q(-1,"mest_da suw_edda suw_mnda") &&
       prl_kred_sr(1) && s(-1,0) )
 { l[i]=is_vsyo; V[317]++; if(dbg){print "V317"}; continue };
 if ( prl_kred_sr(1) &&
       pre_pr(2) && s(0,1) )
 { l[i]=is_vsyo; V[318]++; if(dbg){print "V318"}; continue };
 if ( w(1,"так") &&
       prl_krmn(2) && s(0,1) )
 ...
 { l[i]=is_vsje; V[351]++; if(dbg){print "V351"}; continue };
 ...
 { l[i]=is_vsje; V[358]++; if(dbg){print "V358"}; continue };
 if ( w(1,"больших") &&
       suw_mnro(2) && s(0,1) )
 ...
 if ( q(1,"suw_edim suw_edne") &&
       q(2,"suw_edro suw_mnro suw_mnvi") &&
        gl_edsr(3) && s(0,2) )
 { l[i]=is_vsyo; V[366]++; if(dbg){print "V366"}; continue };
 if ( q(1,"mest_ed mest_mn") &&
       suw_mnim(2) && s(0,1) )
 ...
 if ( q(1,"mest_ed mest_mn") &&
       suw_edim(2) &&
        qik_edim(3) && s(0,2) )
 { l[i]=is_vsje; V[383]++; if(dbg){print "V383"}; continue };
 if ( mest_ed(1) &&
       qast(2) &&
        suw_edim(3) && s(0,2) )
 ...
 { l[i]=is_vsje; V[391]++; if(dbg){print "V391"}; continue };
 ...
 if ( suw_mnim(-1) && sc(-1,",") &&
       pre_pr(1) &&
        q(2,"prl_edpr prl_mnpr") &&
         q(3,"suw_edpr suw_mnpr") && s(0,2) )
 { l[i]=is_vsje; V[395]++; if(dbg){print "V395"}; continue };
 ...
 { l[i]=is_vsje; V[400]++; if(dbg){print "V400"}; continue };
 ...
 { l[i]=is_vsje; V[411]++; if(dbg){print "V411"}; continue };
 if ( w(1,"как") &&
       w(2,"раз будто") &&
 ...
 { l[i]=is_vsje; V[419]++; if(dbg){print "V419"}; continue };
 ...
 { l[i]=is_vsyo; V[432]++; if(dbg){print "V432"}; continue };
 if ( mest_im(-2) &&
       mest_mnim(-1) &&
        mest_mnim(1) && s(-2,0) )
 ...
 if ( mest_da(1) &&
       gl_ed(2) && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[438]++; if(dbg){print "V438"}; continue };
 if ( mest_mnim(1) &&
 ...
 if ( w(-2,"а") &&
       mest_mnim(-1) &&
        q(1,"gl_pnmn gl_nemn") &&
         prl_kred_sr(2) && s(-2,1) )
 { l[i]=is_vsyo; V[456]++; if(dbg){print "V456"}; continue };
 if ( mest_mn(1) &&
 ...
 { l[i]=is_vsje; V[477]++; if(dbg){print "V477"}; continue };
 ...
 { l[i]=is_vsje; V[481]++; if(dbg){print "V481"}; continue };
 ...
 if ( mest_ed(1) &&
       gl_ed(2) && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[501]++; if(dbg){print "V501"}; continue };
 ...
 if ( w(1,"кроме") && sc(0,",") &&
       cap(2) && s(1) )
 { l[i]=is_vsje; V[511]++; if(dbg){print "V511"}; continue };
 ...
 { l[i]=is_vsje; V[513]++; if(dbg){print "V513"}; continue };
 if ( deep(-2) &&
       q(-1,"suw_edtv suw_mntv") &&
        nar_mest(1) && s(-2,0) )
 ...
 { l[i]=is_vsje; V[522]++; if(dbg){print "V522"}; continue };
 if ( deep(-1) &&
       nar_mest(1) && s(-1,0) )
...
if ( gl_nemn(1) &&
 ...
 { l[i]=is_vsje; V[552]++; if(dbg){print "V552"}; continue };
 # все, кто
 if ( sc(0,",") &&
       q(1,"mest_edmu mest_edze") )
 ...
 if ( gl_ed(-1) && s(-1) &&
       sc(0,",") &&
        w(1,"кроме") )
 { l[i]=is_vsyo; V[554]++; if(dbg){print "V554"}; continue };
 ...
 { l[i]=is_vsje; V[572]++; if(dbg){print "V572"}; continue };
 ...
 { l[i]=is_vsyo; V[582]++; if(dbg){print "V582"}; continue };
 ...
 { l[i]=is_vsje; V[584]++; if(dbg){print "V584"}; continue };
 if ( gl_ed(-3) &&
       pre_pr(-2) &&
 ...
 { l[i]=is_vsyo; V[608]++; if(dbg){print "V608"}; continue };
 if ( q(1,"gl_nemn gl_pnmn gl_pemn") &&
       pre_pr(2) &&
 ...
 if (pre_pr(1) &&
      q(2,"prl_edpr prl_mnpr") &&
       q(3,"suw_edpr suw_mnpr") &&
        gl_ed(4) && s(0,3) )
 { l[i]=is_vsyo; V[618]++; if(dbg){print "V618"}; continue };
 if (pre_pr(1) &&
      q(2,"prl_edpr prl_mnpr") &&
       q(3,"suw_edpr suw_mnpr") &&
 ...
 if ( q(1,"gl_pemn gl_pnmn") && cap(0) &&
       q(2,"suw_edvi suw_mnvi mest_vi") &&
        gl_in(3) && s(0,2) )
 { l[i]=is_vsyo; V[622]++; if(dbg){print "V622"}; continue };
 if ( q(1,"gl_pemn gl_pnmn") &&
 ...
 { l[i]=is_vsyo; V[627]++; if(dbg){print "V627"}; continue };
 ...
 { l[i]=is_vsyo; V[649]++; if(dbg){print "V649"}; continue };
 if ( vvb(-8,-1) && suw_mnim(vvn) )
 ...
 { l[i]=is_vsyo; V[656]++; if(dbg){print "V656"}; continue };
 if ( qf(1,7,"gl_nemn") &&
 ...
 { l[i]=is_vsje; V[661]++; if(dbg){print "V661"}; continue };
 ...
 { l[i]=is_vsyo; V[668]++; if(dbg){print "V668"}; continue };
 ...
 if ( q(-3,"gl_nemn") &&
       w(-2,"бы") && s(-3) && p(-2) &&
        w(-1,"как") && s(-1) && p(0) )
 { l[i]=is_vsje; V[676]++; if(dbg){print "V676"}; continue };
 if ( w(1,"и") && sc(0,",") &&
       qxs(2,"ещё","больше") )
 ...
 { l[i]=is_vsje; V[686]++; if(dbg){print "V686"}; continue };
 ...
 # SpaCy
 if ( vsyo_sy(0) )
 { l[i]=is_vsyo; V[693]++; if(dbg){print "V693"}; continue };
 if ( vsje_sy(0) )
 { l[i]=is_vsje; V[694]++; if(dbg){print "V694"}; continue };
