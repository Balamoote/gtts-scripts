...
hyphback(book[b]);hyphbphy(bphy[b]);getwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=tolower(wrd))continue;is_vsyo=vsyo[l[i]];is_vsje=vsje[l[i]];          # header2
 ...
 { l[i]=is_vsje; V[3]++; if(dbg){print "V3"}; continue };
 if ( w(1,"же ж") &&
mest_it(2) &&
gl_pnmn(3) && s(0,2) )
 ...
 { l[i]=is_vsje; V[7]++; if(dbg){print "V7"}; continue };
 ...
 { l[i]=is_vsje; V[19]++; if(dbg){print "V19"}; continue };
 if ( wist(-1,"все́") &&
 ...
 { l[i]=is_vsje; V[45]++; if(dbg){print "V45"}; continue };
...
mest_mnim(-1) &&
 ...
 if ( pre_vi(1) &&
           q(2,"mest_it muk_ed muk_mn") &&
           w(3,"же ж") && s(0,2) )
 { l[i]=is_vsyo; V[114]++; if(dbg){print "V114"}; continue };
 if ( q(1,"mest_it muk_ed muk_mn") &&
      w(2,"же ж") && s(0,1) )
 { l[i]=is_vsyo; V[115]++; if(dbg){print "V115"}; continue };
...
mest_vi(2) &&
 ...
 pre_pr(1) &&
      w(2,"ком") && s(1) )
 { l[i]=is_vsje; V[158]++; if(dbg){print "V158"}; continue };
 if ( pre_pr(1) &&
           q(2,"mest_pr suw_pr") &&
     gl_edsr(3) && s(0,2) )
 ...
 { l[i]=is_vsyo; V[169]++; if(dbg){print "V169"}; continue };
 if ( prl_kred_sr(1) &&
...
#{ l[i]=is_vsje; V[180]++; if(dbg){print "V180"}; continue };
 ...
 { l[i]=is_vsje; V[188]++; if(dbg){print "V188"}; continue };
 if ( w(1,"так") &&
 ...
 { l[i]=is_vsyo; V[198]++; if(dbg){print "V198"}; continue };
 if ( mest_it(-1) &&
 ...
 if ( qm(1,"gl_mn","_ge_vsyo_gl_answer") && s(0) &&
   titul(2) && z(1) )
 { l[i]=is_vsyo; V[202]++; if(dbg){print "V202"}; continue };
 if ( pre_pr(1) &&
           q(2,"suw_pr suw_edme") &&
 ...
 if ( qm(1,"gl_mn","_ge_vsje") && s(0) &&
     !(w(2,"и") && qq(1,3)) )
 { l[i]=is_vsje; V[208]++; if(dbg){print "V208"}; continue };
 if ( qm(-1,"gl_mn","_ge_vsje") && s(-1) && p(0) )
 { l[i]=is_vsje; V[209]++; if(dbg){print "V209"}; continue };
 if ( w(1,"уже ведь") &&
     qm(2,"gl_mn","_ge_vsyo") && s(0,1) )
...
nar_step(1) && s(-1,0) )
 ...
 if ( gl_in(-2) &&
     mod_mn(-1) && s(-2,-1) )
 { l[i]=is_vsje; V[222]++; if(dbg){print "V222"}; continue };
 if ( mod_ed(-2) &&
      pre_vi(-1) && s(-2,-1) && p(0) )
 ...
 if ( qxs(1,"никак","не") &&
   mod_mn(xsn+1) && s(xsn) )
 { l[i]=is_vsyo; V[231]++; if(dbg){print "V231"}; continue };
 if ( q(-3,"suw_im") &&
 mod_mn(-2) &&
  gl_in(-1) && s(-2,-1) && p(0) )
 ...
 { l[i]=is_vsje; V[237]++; if(dbg){print "V237"}; continue };
 if ( mod_mn(1) && s(0) && p(1) )
 { l[i]=is_vsje; V[238]++; if(dbg){print "V238"}; continue };
 ...
 if ( mest_it(1) && s(0) && z(1) &&
         vvod(2) && z(2) &&
            q(3,"gl_nemn gl_pnmn") )
 { l[i]=is_vsje; V[250]++; if(dbg){print "V250"}; continue };
 if ( gl_ed(-1) &&
...
prl_kred_sr(2) && s(-1,1) )
 ...
 if ( z(0) &&
   vvod(1) && z(1) &&
      q(2,"gl_nemn gl_pnmn") )
 { l[i]=is_vsje; V[257]++; if(dbg){print "V257"}; continue };
 if ( mest_it(1) &&
         qast(2) &&
 ...
 if ( mest_it(-1) &&
            w(1,"кто") && s(-1) && z(0) )
 { l[i]=is_vsje; V[266]++; if(dbg){print "V266"}; continue };
 if ( mest_it(-1) &&
       pre_ro(1) &&
            w(2,"того") &&
 ...
 { l[i]=is_vsje; V[286]++; if(dbg){print "V286"}; continue };
 if ( prq_kred_sr(-2) &&
...
nar_kaq(2) &&
 ...
 if ( w(1,"не") && z(0) &&
         prq_mnim(2) &&
         suw_edda(3) && s(1,2) )
 { l[i]=is_vsje; V[299]++; if(dbg){print "V299"}; continue };
 if ( mest_vi(1) &&
            q(2,"prq_mnim prq_krmn") && s(0,1) )
 { l[i]=is_vsje; V[300]++; if(dbg){print "V300"}; continue };
 if ( prl_srav(1) &&
             q(2,"prq_ro") && s(0,1) )
...
suw_mnim(3) && s(0) && s(2))
 ...
 if ( q(1,"mest_ed mest_mn") &&
      q(2,"nar_kaq nar_step nar_spos") &&
         prl_krmn(3) && s(0,1) )
 { l[i]=is_vsje; V[326]++; if(dbg){print "V326"}; continue };
 if ( q(1,"nar_kaq nar_step nar_spos") &&
         prl_krmn(2) && s(0,1) )
 { l[i]=is_vsje; V[327]++; if(dbg){print "V327"}; continue };
 if ( pre_tv(-2) &&
           q(-1,"suw_tv") &&
...
sz_iili(2) &&
 ...
 { l[i]=is_vsyo; V[360]++; if(dbg){print "V360"}; continue };
 if ( prl_srav(1) &&
             q(2,"suw_im") && s(0,1) )
...
suw_mnvi(4) && s(1,3) )
 ...
 if ( w(1,"нет") &&
      q(2,"suw_ro") && s(0,1) )
 { l[i]=is_vsyo; V[370]++; if(dbg){print "V370"}; continue };
 if ( q(1,"suw_edim suw_edne") &&
      q(2,"suw_ro suw_mnvi") &&
gl_edsr(3) && s(0,2) )
 { l[i]=is_vsyo; V[371]++; if(dbg){print "V371"}; continue };
 if ( q(1,"mest_ed mest_mn") &&
         suw_mnim(2) && s(0,1) )
...
mest_da(2) &&
 ...
 if ( mest_mn(1) && s(0) &&
            q(2,"suw_im") && se(1," — ") )
 { l[i]=is_vsje; V[396]++; if(dbg){print "V396"}; continue };
...
nar_spos(1) && s(-1,0) && p(1) )
 { l[i]=is_vsje; V[405]++; if(dbg){print "V405"}; continue };
...
nar_srav(2) && s(0,1) && p(2) )
 ...
 { l[i]=is_vsje; V[416]++; if(dbg){print "V416"}; continue };
 if ( w(1,"как") &&
      w(2,"раз будто") &&
...
nar_kaq(2) && s(0,1) && p(2) )
 ...
 if ( nar_mest(1) &&
             w(2,"же") && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[429]++; if(dbg){print "V429"}; continue };

 # Все + ... + числительное =====================================
 # все + числ.
 if ( w(1,"один одна одно одни") && s(0) )
 { l[i]=is_vsyo; V[430]++; if(dbg){print "V430"}; continue };
 if ( qis_im(1) && s(0) )
 ...
 if ( w(-1,"не") && s(-1) &&
    qxw(1,"а но","только") && z(0) &&
      q(xwn+1,"mest_it prl_edsrim") && s(xwn) )
 { l[i]=is_vsyo; V[436]++; if(dbg){print "V436"}; continue };
 if ( mest_mnim(1) &&
    prl_kred_sr(2) &&
              w(3,"и") &&
 ...
 if ( mest_da(1) &&
        gl_ed(2) && s(0,1) && p(2) )
 { l[i]=is_vsyo; V[444]++; if(dbg){print "V444"}; continue };
 if ( mest_mnim(1) &&
 ...
 if ( w(-2,"а") &&
      ...
      q(1,"gl_pnmn gl_nemn") &&
            prl_kred_sr(2) && s(-2,1) )
 { l[i]=is_vsyo; V[462]++; if(dbg){print "V462"}; continue };
 if ( mest_mn(1) &&
 ...
 { l[i]=is_vsje; V[474]++; if(dbg){print "V474"}; continue };
 if ( q(1,"mest_ed mest_mn") &&
         qip_mnro(2) &&
         suw_mnro(3) && s(0,2) )
 ...
 if ( w(-1,"их") && p(0) )
 { l[i]=is_vsje; V[482]++; if(dbg){print "V482"}; continue };
...
# глаголы действия
 ...
 { l[i]=is_vsyo; V[493]++; if(dbg){print "V493"}; continue };
...
suw_edim(-1) &&
 ...
 if ( mest_mn(-1) &&
            q(1,"gl_pnmn gl_pemn") &&
     suw_mnvi(2) && s(-1,1) )
 { l[i]=is_vsje; V[508]++; if(dbg){print "V508"}; continue };
 if ( mest_mn(-1) &&
...
if ( gl_nemn(1) &&
 ...
 if ( gl_nemn(1) &&
     prl_krmn(2) && s(0,1) )
 { l[i]=is_vsje; V[549]++; if(dbg){print "V549"}; continue };
...
mest_da(-1) &&
 ...
 { l[i]=is_vsje; V[557]++; if(dbg){print "V557"}; continue };
 # все те, кто
 if ( w(1,"те") && z(1) &&
 ...
 { l[i]=is_vsje; V[562]++; if(dbg){print "V562"}; continue };
...
gl_vzed(-1) && s(-1) )
 ...
 if ( gl_ed(-2) &&
  mest_mnvi(-1) &&
          q(1,"gl_ed gl_in") && s(-2,0) )
 { l[i]=is_vsje; V[594]++; if(dbg){print "V594"}; continue };
 if ( mest_mnvi(-1) &&
 ...
 { l[i]=is_vsyo; V[601]++; if(dbg){print "V601"}; continue };
 if ( q(1,"gl_pemn gl_pnmn") &&
      w(2,"о об") &&
 ...
 { l[i]=is_vsyo; V[603]++; if(dbg){print "V603"}; continue };
 if ( mest_vi(1) &&
 ...
 { l[i]=is_vsyo; V[615]++; if(dbg){print "V615"}; continue };
 if ( q(1,"gl_nemn gl_pnmn gl_pemn") &&
 pre_pr(2) &&
...
mest_vi(2) &&
 ...
 if ( gl_nemn(-2) &&
       pre_vi(-1) &&
            q(1,"suw_tv") && s(-2,0) )
 { l[i]=is_vsyo; V[634]++; if(dbg){print "V634"}; continue };
...
gl_nemn(-1) &&
 ...
 { l[i]=is_vsyo; V[648]++; if(dbg){print "V648"}; continue };
 ...
 { l[i]=is_vsyo; V[663]++; if(dbg){print "V663"}; continue };
 if ( qf(1,7,"gl_nemn") &&
prq_krmn(qfn+1) && s(0,qfn) )
 ...
 if ( suw_mnne(1) &&
      nar_spos(2) &&
             q(3,"gl_pemn gl_pnmn") && s(0,2) && p(3) )
 { l[i]=is_vsje; V[677]++; if(dbg){print "V677"}; continue };
 if ( mod_mn(2) &&
       gl_in(3) && s(0,2) )
 ...
 { l[i]=is_vsje; V[687]++; if(dbg){print "V687"}; continue };
 if ( q(1,"gl_vzmn gl_nemn") && s(0) && p(1) )
 { l[i]=is_vsje; V[688]++; if(dbg){print "V688"}; continue };
 if ( prl_srav(1) && s(0) )
 { l[i]=is_vsyo; V[689]++; if(dbg){print "V689"}; continue };
 if ( gl_poed(-1) && s(-1) && p(0) )
 { l[i]=is_vsyo; V[690]++; if(dbg){print "V690"}; continue };
 if ( deep(1) && s(0) )
 { l[i]=is_vsyo; V[691]++; if(dbg){print "V691"}; continue };
 ...
 {              V[699]++; if(dbg){print "V699"}; continue };


 # SpaCy
 if ( vsyo_sy(0) )
 { l[i]=is_vsyo; V[700]++; if(dbg){print "V700"}; continue };
 if ( vsje_sy(0) )
