...
#       if($5~  /^osw_сущ_ед_общ_тв$/               ){  osw_edob_tv [$1]=$2; osw_edob_tv [$3]=$4; osw_edob_tv [$1,"info"]=$6; continue };
    ...
    cst = "свой мой твой ваш наш этот сей тот такой эдакий";
        stoar(cst,mstc_edmuim," ");
    cst = "своего моего твоего вашего нашего этого сего того такого эдакого";
        stoar(cst,mstc_edmuro," ");
    cst = "своему моему твоему вашему нашему этому сему тому такому эдакому";
        stoar(cst,mstc_edmuda," ");
    cst = "своим моим твоим вашим нашим этим сим тем таким эдаким";
        stoar(cst,mstc_edmutv," ");
    cst = "своём моём твоём вашем нашем этом сём том таком эдаком";
        stoar(cst,mstc_edmupr," ");

    cst = "своя моя твоя ваша наша эта сия та такая эдакая";
        stoar(cst,mstc_edzeim," ");
    cst = "свою мою твою вашу нашу эту сию ту такую эдакую";
        stoar(cst,mstc_edzevi," ");
    cst = "своей моей твоей вашей нашей этой сей той такой эдакой";
    ...
    cst = "свои мои твои ваши наши эти си те такие эдакие";
        stoar(cst,mstc_mnim," ");
    cst = "своих моих твоих ваших наших этих сих тех таких эдаких";
        stoar(cst,mstc_mnro," ");
    cst = "своим моим твоим вашим нашим этим сим тем таким эдаким";
        stoar(cst,mstc_mnda," ");
    cst = "своими моими твоими вашими нашими этими сими теми такими эдакими";
        stoar(cst,mstc_mntv," ");
    cst = "своих моих твоих ваших наших этих сих тех таких эдаких";
        stoar(cst,mstc_mnpr," ");
