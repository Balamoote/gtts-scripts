...
#getBFx(-3,3,"_an.txt"); Z[11]++; if(dbg){print "Z11"}; continue
 ...
 if ( iwrd=="замок" || iwrd=="замки" ) { Y["iwrd_case"]="iv"; if ( iwrd=="замок" ) {Y["iwrd_form"]="ediv"} else {Y["iwrd_form"]="mniv"}; if(dbg){print "замок: им+вин, ед+мн"};
    ...
    if ( wb(-5,-1,"в во")  ) { DEFINE_TN_OK_PREVI_ZAMOK(wbn,"в во");  Y["n_pre_v"]     = tn; Y["tn_is_v"]     = tn_ok };
    if ( wb(-5,-1,"за")    ) { DEFINE_TN_OK_PREVI_ZAMOK(wbn,"за");    Y["n_pre_za"]    = tn; Y["tn_is_za"]    = tn_ok };
    if ( wb(-5,-1,"на")    ) { DEFINE_TN_OK_PREVI_ZAMOK(wbn,"на");    Y["n_pre_na"]    = tn; Y["tn_is_na"]    = tn_ok };
    if ( wb(-5,-1,"под")   ) { DEFINE_TN_OK_PREVI_ZAMOK(wbn,"под");   Y["n_pre_pod"]   = tn; Y["tn_is_pod"]   = tn_ok };
    if ( wb(-5,-1,"о")     ) { DEFINE_TN_OK_PREVI_ZAMOK(wbn,"о");     Y["n_pre_o"]     = tn; Y["tn_is_o"]     = tn_ok };
    if ( wb(-5,-1,"через") ) { DEFINE_TN_OK_PREVI_ZAMOK(wbn,"через"); Y["n_pre_qerez"] = tn; Y["tn_is_qerez"] = tn_ok }; };
 #
 ...
 #
 if ( Y["tn_is_v"]||Y["tn_is_za"]||Y["tn_is_na"]||Y["tn_is_pod"]||Y["tn_is_o"]||Y["tn_is_qerez"] )
 { Y["tn_is_vi"]=1; Z[12]++; if(dbg){print "Z12"}; };
 if ( Y["tn_is_vi"] )
 { Y["tn_is_any"]=1; Z[13]++; if(dbg){print "Z13"}; };

#bba(-7,-1,"_lock_pe");    Y["n-_lock_pe"]    = bbn;
#bfa(1,5,  "_lock_pe");    Y["n+_lock_pe"]    = bfn;
#bba(-7,-1,"_castle_pe");  Y["n-_castle_pe"]  = bbn;
#bfa(1,5,  "_castle_pe");  Y["n+_castle_pe"]  = bfn;
...
#===============================================================================================================================================================
 ...
 if ( q(1,"gl_aux_be") &&
prq_any(2) && ba(2,"_prq_castle") && s(0,1) )
...
#{ l[i]=omo1; Z[36]++; if(dbg){print "Z36"}; continue };
 ...
 if ( bfa(2,5,"_castlelike_things") ) { bf_n=bfn;
    ...
    # ни … ни
    if ( vgle(bf_n,3,6) && qb(-4,-1,"qast_ne") && s(qbn,-1) && zs(0) && s(1,bf_n-1) &&
 ...
 cst="напоминать";
 if ( bf(-3,-1,cst) ) { wf_n=bfn;
   if ( bfa(wf_n-5,wf_n-1,"_castlelike_things") ) { bf_n=bfn;

    if ( vgle(wf_n,-3,-1) && vgle(bf_n,wf_n-5,wf_n-1) && z(bf_n) &&
          qir(bf_n-1,wf_n+1,"prl_kred_sr") &&
          qir(wf_n-1,-1,"prl_vi mest_vi mest_3e prq_vi") && s(bf_n+1,-1) )
 ...
 if ( bf(1,4,cst) ) { wf_n=bfn;
   if ( bfa(wf_n+1,wf_n+4,"_castlelike_things") ) { bf_n=bfn;
      ...
      if ( vgle(wf_n,1,4) && vgle(bf_n,wf_n+1,wf_n+4) && zs(0) &&
 ...
 if (bb(1,3,cst)) { bf_n=bbn; bbn=wfn="";
   cst0="дверью клеткой ключом";
   if ( bfa(bf_n+1,bf_n+5,"_castlelike_things")||wf(bf_n+1,bf_n+5,cst0) ) { if (bfn) bb_n=bfn; if (wfn) bb_n=wfn;

      if ( vgle(bf_n,1,3) && zs(0) && s(1,bf_n-1) &&
            bba(-4,-1,"_lock_pe") && s(bbn,-1) &&
            qir(bbn+1,-1,"prl_edmuim prl_mnim mest_vi mest_3e qast_any") )
      { bf_n=bb_n=""; Z[66]++; if(dbg){print "Z66"}; };
    ...
    if ( vgle(bf_n,1,3) && zs(0) && s(1,bf_n-1) &&
          ...
          qir(1,bf_n-1,"otsz_any mod_any gl_aux_be qast nar_any suw_ro isname") &&
            q(bf_n+1,"narph_any") &&
          qiz(xwn+1,bb_n-1,"prl_tv prq_tv mest_tv mest_3e nar_any prl_kred_sr qast_any suw_da mest_da isname suw_edne","qast") && s(bf_n,bb_n-1) )
 ...
 if (bb(1,3,cst)) { bf_n=bbn;
   cst0="вещью";
   if ( bfa(bf_n+1,bf_n+5,"_locklike_things")||wf(bf_n+1,bf_n+5,cst0) ) { if (bfn) bb_n=bfn; if (wfn) bb_n=wfn;
...
sz_iili(1) &&
 ...
 if ( wb(-6,-2,"в во") ) { wb_n=wbn; if ( wba(wb_n+1,-1,"_castle_v_suw-pr") ) { bb_n=wbn;
 ...
 if ( wba(-7,-1,"_castle_na_suw-pr") ) { bb_n=wbn; if ( wb(bb_n-5,bb_n-1,"на") ) { wb_n=wbn;
 cst0="двери";
    ...
    if ( vgle(wb_n,bb_n-5,bb_n-1) && vgle(bb_n,-7,-1) && s(wb_n,-1) &&
          ...
          qir(bb_n+1,-2,"prl_ro mest_ro mest_3e prq_ro nar_any qast_any") &&
            W(-1,cst0) && !bba(bb_n+1,-2,"_lock_prl") &&
            q(-1,"suw_ro isname") )
...
sz_iili(-3) &&
 ...
 # _castle_na_suw:start
 if ( wb(-6,-1,"на") ) { wb_n=wbn;
    if ( ba(wb_n-1,"_castle_na_suw") && z(wb_n-1) &&
          q(wb_n+1,"otsz_vi otsz_pr") && s(wfn,-1) &&
         ba(wb_n+2,"_gl_4_castle_na_suw-pr") &&
        qir(wf_n+3,-1,"prl_vi mest_vi mest_3e nar_any prq_vi"))
 ...
 if ( wfa(1,5,"_castle_suw-ro") ) { wf_n=wfn;
    if ( vgle(wf_n,1,5) && s(0,wf_n-1) &&
         (wfa(1,wf_n-1,"_lock_suw-ro") || wf(1,wf_n-1,cst8) || ww_(-1,"под")) )
    { wf_n=""; Z[211]++; if(dbg){print "Z211"}; }; #check_!под

    if ( vgle(wf_n,1,5) && s(0,wf_n-1) &&
          qir(1,wf_n-1,"prl_ro mest_ro prq_ro prl_kred_sr nar_step") )
    { l[i]=omo1; Z[212]++; if(dbg){print "Z212"}; continue }; #check_!под
 };

 if ( wf(1,3,"для") ) { wf_n=wfn;
   if ( wfa(wf_n+1,wf_n+4,"_castle_suw-ro2") ) { bf_n=wfn;

    if ( vgle(wf_n,1,3) && vgle(bf_n,wf_n+1,wf_n+4) && s(0,bf_n-1) &&
        !(bam(-1,"_lock_prl _lock_pe") && s(-1)) &&
          qir(wf_n+1,bf_n-1,"prl_ro mest_ro mest_3e prq_ro") )
    { l[i]=omo1; Z[213]++; if(dbg){print "Z213"}; continue };
    if ( vgle(wf_n,1,3) && vgle(bf_n,wf_n+1,wf_n+4) && s(0,bf_n-1) &&
          qir(wf_n+1,bf_n-1,"prl_ro mest_ro mest_3e prq_ro") &&
          qsb(-10,-1,",") && !(bb(sbm-3,sbn,"дверь люк") && s(sbm-3,sbm-1)) )
    { l[i]=omo1; Z[214]++; if(dbg){print "Z214"}; continue };

    cst1="закрыть закрыться открыть открыться";
    if ( vgle(wf_n,2,3) && vgle(bf_n,wf_n+1,wf_n+4) && s(0,bf_n-1) &&
           wf(1,wf_n-1,cst1) &&
          qir(wf_n+1,bf_n-1,"prl_ro mest_ro mest_3e prq_ro") )
    { l[i]=omo1; Z[215]++; if(dbg){print "Z215"}; continue };
 };};

 if ( wb(-5,-2,"для") ) { wb_n=wbn; if ( wba(wb_n+1,-1,"_castle_suw-ro1") ) { bb_n=wbn;
    if ( vgle(wb_n,-5,-1) && vgle(bb_n,wb_n+1,-1) && s(wb_n,-1) &&
 ...
 { l[i]=omo1; Z[243]++; if(dbg){print "Z243",qfn}; continue };
 if ( w(-2,"с со") &&
 ...
 { l[i]=omo1; Z[245]++; if(dbg){print "Z245",qfn}; continue };
 if ( w(-2,"с со") &&
 ...
 if ( z(0) &&
     ba(1,"_lock_s_suw-tv") &&
     bw(2,"который") && s(1) )
 { l[i]=omo1; Z[258]++; if(dbg){print "Z258"}; continue }; #check!
 # _lock_s_suw-tv:end
 ...
 if( veq(Y["iwrd_case"],"iv") ) {
    ...
    if ( !vis(Y["tn_is_any"]) && q(1,"prq_edmuim prq_mnim") && ba(1,"_prq_castle") && s(0) )
    ...
    if ( qb(-5,-1,"sz_iili") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_castle_environs") ) { bb_n=bbn;
         ...
         if ( bfa(1,5,"_lock_pe") && s(0,bfn-1) )
         { bb_n=qb_n=""; Z[274]++; if(dbg){print "Z274"}; };
    ...
    cst="встать красоваться стоять";
    if ( bb(-5,-1,cst) ) { wb_n=bbn;
      if ( bba(wb_n-5,wb_n-1,"_castle_platz") ) { bb_n=bbn;

       if ( vgle(wb_n,-5,-1) && vgle(bb_n,wb_n-5,wb_n-1) &&
    ...
    if ( bf(1,3,cst) ) { wf_n=bfn;
      if ( bba(-5,-1,"_castle_platz") ) { bb_n=bbn;
       ...
       if ( vgle(wf_n,1,3) && vgle(bb_n,-5,-1) &&
...
#      cst1="тяжелый";
#      cst2="блестыщий бронзовый железный золотой медный сверкающий";
#      if ( q(-2,"prl_edmuim prl_kred_mu") && bw(-2,cst1) && zs(-2) && s(-1) &&
#           q(-1,"prl_edmuim") && bw(-1,cst2) )
#      { l[i]=omo2; Z[307]++; if(dbg){print "Z307"}; continue };

       if ( q(1,"prl_edmuim prl_kred_mu") && ba(1,"_lock_prl") && s(0) &&
            W(1,"открыт сложен") && Q_w(2,"isname suw_im") )
       { l[i]=omo2; Z[308]++; if(dbg){print "Z308"}; continue };
       if ( q(1,"nar_mest gl_aux_be") &&
            q(2,"prl_edmuim prl_kred_mu") && ba(2,"_lock_prl") && s(0,1) &&
            W(1,"открыт сложен") && Q_w(3,"isname suw_im") )
       { l[i]=omo2; Z[309]++; if(dbg){print "Z309"}; continue };

    };
    if ( vis(Y["iwrd_form"],"mniv") ) {

       if ( q(-1,"prl_mnim prl_kred_mu") && ba(-1,"_lock_prl") && s(-1) )
       { l[i]=omo2; Z[310]++; if(dbg){print "Z310"}; continue };
       if ( q(-2,"prl_mnim prl_kred_mu") && ba(-2,"_lock_prl") &&
            q(-1,"prl_mnim prq_mnim mest_any qast_any gl_aux_be") && zs(-2) && s(-1) )
       { l[i]=omo2; Z[311]++; if(dbg){print "Z311"}; continue };
       if ( q(-3,"prl_mnim prl_kred_mu") && ba(-3,"_lock_prl") && zs(-3) &&
            q(-2,"prl_mnim prl_kred_sr prq_mnim mest_mnim mest_3e qast_any") && zs(-2) &&
            q(-1,"prl_mnim prq_mnim mest_mnim mest_3e qast_any") && s(-1)  )
       ...
       if ( q(1,"nar_mest") &&
            q(2,"prl_edmuim prl_mnim prl_kred_mu") && ba(2,"_lock_prl") && s(0,1) && Q(3,"isname suw_im") )
    ...
    cst1="быть ведь же казаться стать считаться являться";
    if ( bw(1,cst1) &&
          q(2,"prl_edmuim prl_mnim prl_tv prl_kred_mu") && ba(2,"_lock_prl") && s(0,1) )
  ...
  ######################################################################################################
  # в замок
  if ( vgle(Y["n_pre_v"],-5,-1) ) {

  if ( vis(Y["tn_is_v"]) ) { tn=Y["n_pre_v"];
    ...
    if ( bb(tn-3,tn-1,cst1) ) { bb_n=bbn;
       ...
       if ( vgle(bb_n,tn-4,tn-1) && s(bbn,tn-1) &&
    ...
    { l[i]=omo2; Z[357]++; if(dbg){print "Z357"}; continue }; #edit
    if ( bb(tn-9,tn-3,cst) &&
          w(bbn+1,cst1) &&
          q(bbn+2,"pre_tv") &&
        qir(tn+3,tn-1,"suw_tv prl_tv mest_tv prq_tv isname qast nar_any") && s(bbn,tn-2) && zs(tn-1) )
    { l[i]=omo2; Z[358]++; if(dbg){print "Z358"}; continue }; #edit
    ...
    if ( bba(tn-9,tn-1,"_gl_v_lock-iv") ) { bb_n = bbn;
       if ( veq(bb_n,tn-1) && s(tn-2,tn-1) &&
              q(tn-1,"prq_vi") && ba(tn-2,"_gl_v_castle-iv") )
       { bb_n=""; Z[402]++; if(dbg){print "Z402"}; };
       ...
       { l[i]=omo2; Z[405]++; if(dbg){print "Z405"}; continue };
       ...
       { l[i]=omo2; Z[409]++; if(dbg){print "Z409"}; continue }; #inspect
       if ( vgle(bb_n,tn-6,tn-2) &&
       ...
       { l[i]=omo2; Z[412]++; if(dbg){print "Z412"}; continue }; # _gl_v_lock-iv suw_vi suw_tv
       ...
       { l[i]=omo2; Z[413]++; if(dbg){print "Z413"}; continue }; # _gl_v_lock-iv suw_tv suw_vi
       ...
       { l[i]=omo2; Z[414]++; if(dbg){print "Z414"}; continue }; # _gl_v_lock-iv suw_tv suw_vi
       if ( veq(bb_n,tn-3) &&
              q(tn-2,"suw_vi suw_im mest_im mest_vi suw_tv mest_tv qast isname") &&
              q(tn-1,"suw_vi suw_tv qast nar_any") && s(tn-3,tn-1) )
       { l[i]=omo2; Z[415]++; if(dbg){print "Z415"}; continue }; #inspect
       if ( veq(bb_n,tn-2) &&
    ...
    if ( qb(tn-8,tn-2,"pre_vi") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_v_lock-iv") ) { bb_n=bbn;

       if ( vgle(qb_n,tn-8,tn-3) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,tn-1) &&
       ...
       { qb_n=bb_n=""; l[i]=omo2; Z[421]++; if(dbg){print "Z421"}; };
       if ( vgle(qb_n,tn-8,tn-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,tn-1) &&
             qir(bb_n+1,qb_n-1,"suw_vi mest_vi prq_vi mest_3e prq_vi") &&
    ...
    if ( qb(tn-8,tn-2,"pre_tv") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_v_lock-iv") ) { bb_n=bbn;

       if ( vgle(qb_n,tn-8,tn-2) && veq(bb_n,qb_n-1) &&
       ...
       if ( vgle(qb_n,tn-8,tn-3) && veq(bb_n,qb_n-1) &&
       ...
       if ( vgle(qb_n,tn-8,tn-4) && veq(bb_n,qb_n-1) &&
       ...
       if ( vgle(qb_n,tn-8,tn-2) && vgle(bb_n,qbn-5,qbn-1) &&
       ...
       { l[i]=omo2; Z[426]++; if(dbg){print "Z426"}; continue }; # _gl_v_lock-iv suw_vi PRE_TV suw_tv
       if ( vgle(qb_n,tn-8,tn-3) && vgle(bb_n,qb_n-5,qb_n-2) &&
    ...
    if ( qb(tn-8,tn-2,"pre_ro") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_v_lock-iv") ) { bb_n=bbn;
       ...
       if ( vgle(qb_n,tn-8,tn-2) && vgle(bb_n,qb_n-5,qb_n-1) &&
    ...
    if ( qb(tn-8,tn-2,"pre_pr") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_v_lock-iv") ) { bb_n=bbn;

        if ( vgle(qb_n,tn-8,tn-3) && veq(bb_n,qb_n-3) &&
        ...
        if ( vgle(qb_n,tn-8,tn-2) && vgle(bb_n,qb_n-5,qb_n-2) &&
        ...
        if ( vgle(qb_n,tn-8,tn-3) && veq(bb_n,qb_n-2) &&
                q(qb_n-1,"suw_vi prq_vi mest_vi mest_3e") &&
              qir(qb_n+1,tn-3,"prl_pr mcop_pr prq_pr qis_pr qik_pr") &&
                q(tn-2,"suw_pr") &&
                q(tn-1,"suw_vi prq_vi mest_vi mest_3e") && s(bb_n,tn-1) )
        { l[i]=omo2; Z[434]++; if(dbg){print "Z434"}; continue };
        if ( vgle(qb_n,tn-8,tn-3) && vgle(bb_n,qb_n-5,qb_n-1) &&
        ...
        if ( vgle(qb_n,tn-8,tn-2) && veq(bb_n,qb_n-3) &&
                q(qb_n-2,"pre_ro") &&
        ...
        if ( vgle(qb_n,tn-8,tn-4) && veq(bb_n,tn-6) &&
    ...
    { l[i]=omo2; Z[461]++; if(dbg){print "Z461"}; continue }; #check
    if ( bf(1,3,cst1) &&
        qir(1,bfn-1,"prl_vi mcop_vi prq_vi prl_im mcop_im prq_im") &&
         bw(bfn+1,cst) && s(tn,bfn-1) )
    { l[i]=omo2; Z[462]++; if(dbg){print "Z462"}; continue }; #check
    ...
    if ( bba(tn-8,tn-1,"_gl_v_castle-iv") ) { bb_n=bbn;
       ...
       { l[i]=omo1; Z[501]++; if(dbg){print "Z501"}; continue }; #check
       if ( vgle(bb_n,tn-5,tn-2) &&
               q(bb_n+1,"prq_vi suw_vi mest_vi mest_3e") &&
             qir(bb_n+2,tn-1,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") && s(bb_n,tn-2) && zs(tn-1) )
       { l[i]=omo1; Z[502]++; if(dbg){print "Z502"}; continue }; #check
       if ( vgle(bb_n,tn-6,tn-2) &&
    ...
    if ( qb(tn-9,tn-2,"pre_vi") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_v_castle-iv") ) { bb_n=bbn;
       ...
       if ( vgle(bb_n,qb_n-5,qb_n-1) && vgle(qb_n,tn-9,tn-2) && hwy(bb_n+1,"ка") &&
       ...
       if ( vgle(bb_n,qb_n-5,qb_n-1) && vgle(qb_n,tn-9,tn-2) &&
       ...
       if ( vgle(bb_n,qb_n-7,qb_n-1) && vgle(qb_n,tn-9,tn-2) && qb(qb_n+1,tn-1,"sz_iili") ) { qi_n=qbn; qsf(bb_n,qi_n,","); sc_n=sfn;
 ...
 narph_any(2) &&
    ...
    { l[i]=omo1; Z[591]++; if(dbg){print "Z591"}; continue }; # без tn!
    if ( ba(-5,"_gl_v_castle-iv") &&
          w(-4,"в") &&
          q(-3,"mest_edmuvi prl_edmuvi") &&
          q(-2,"prq_edmuvi prq_mnvi") &&
          q(-1,"suw_da mest_da prl_da suw_tv prl_tv mest_tv suw_edne isname") && s(-5,-1) )
    { l[i]=omo1; Z[592]++; if(dbg){print "Z592"}; continue }; # без tn!
    if ( ba(-3,"_gl_v_castle-iv") &&
          w(-2,"в") &&
          q(-1,"mest_vip3e mest_vi") && s(-3,-1) )
    { l[i]=omo1; Z[593]++; if(dbg){print "Z593"}; continue }; # без tn!

    tn_ok=""
  }; # в замок
  ######################################################################################################
  # на замок
  if ( vgle(Y["n_pre_na"],-5,-1) ) {

   if ( vis(Y["tn_is_na"]) ) { tn=Y["n_pre_na"];
    ...
    cst="навести направить";
    cst1="автомат бластер излучатель ладонь лазер мушкет оружие пистолет пушку ружье ствол стволы";
    if ( bb(tn-5,tn-2,cst) && s(bbn,tn-1) &&
    ...
    { l[i]=omo1; Z[612]++; if(dbg){print "Z612", bfn}; continue };
    # _gl_na_castle:end
    ...
    if ( bfa(1,5,"_gl_na_lock") ) { bf_n=bfn;
       ...
       if ( vgle(bf_n,1,5) && s(-1,bf_n-1) &&
          pre_vi(1) &&
             qiz(2,bf_n-1,"nar_any prl_kred_sr prl_vi mest_vi mest_3e","qast_any suw_vi") )
    ...
    if ( ba(-4,"_gl_na_lock") &&
          ...
          q(-2,"prl_vi prq_vi") &&
          q(-1,"suw_vi") && s(-4,-1) )
    { l[i]=omo2; Z[642]++; if(dbg){print "Z642"}; continue };
  ...
  ######################################################################################################
  # за замок
  if ( vgle(Y["n_pre_za"],-5,-1) ) {

  if ( vis(Y["tn_is_za"]) ) { tn=Y["n_pre_za"];
   ...
   if ( bw(-5,cst1) && z(-5) &&
    ...
    if ( qb(tn-7,tn-1,"pre_vi") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_za_lock") ) { bb_n=bbn;
    ...
    if ( qb(tn-7,tn-1,"pre_tv") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_za_lock") ) { bb_n=bbn;
    ...
    if ( qb(tn-7,tn-1,"pre_pr") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_za_lock") ) { bb_n=bbn;
  ...
  ######################################################################################################
  # под замок
  if ( vgle(Y["n_pre_pod"],-5,-1) ) {

  if ( vis(Y["tn_is_pod"]) ) { tn=Y["n_pre_pod"];
   ...
   if ( bw(-2,cst) &&
    ...
    #
    if ( qb(tn-5,tn-1,"pre_vi") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_pod_lock") ) { bb_n=bbn;
    ...
    #
    if ( qb(tn-5,tn-1,"pre_ro") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_pod_lock") ) { bb_n=bbn;
    ...
    if ( qb(tn-5,tn-1,"pre_tv") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_pod_lock") ) { bb_n=bbn;
    ...
    if ( qb(tn-5,tn-1,"pre_pr") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_pod_lock") ) { bb_n=bbn;
    ...
    if ( qb(tn-5,tn-1,"sz_iili") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_gl_pod_lock") ) { bb_n=bbn;
    ...
    if ( qf(1,3,"pre_ro") ) { qf_n=qfn; if ( bfa(qf_n+1,qf_n+5,"_gl_pod_lock") ) { bf_n=bfn;

       if ( vgle(qf_n,1,3) && vgle(bf_n,qf_n+1,qf_n+5) && s(0,bfn-1) &&
    ...
    if ( w(-4,"в во") &&
         ...
         w(-2,"не") &&
         w(-1,"под") && s(-4,-1) )
    { l[i]=omo2; Z[738]++; if(dbg){print "Z738"}; continue };
    if ( w(-1,"под") &&
         w(1,"в во") &&
         q(2,"suw_vi") && s(-1,1) )
    ...
    if ( q(-3,"mest_vi prl_vi mest_3e") && p(-4) &&
         q(-2,"suw_vi") &&
         w(-1,"под") && s(-3,-1) && p(0) )
    { l[i]=omo2; Z[741]++; if(dbg){print "Z741"}; continue };
    ...
    if ( pre_vi(-5) && p(-6) &&
        ...
        sz_iili(-2) &&
              w(-1,"под") && s(-5,-1) )
    { l[i]=omo2; Z[743]++; if(dbg){print "Z743"}; continue };
  ...
  ######################################################################################################
  # о замок
  if ( vgle(Y["n_pre_o"],-5,-1) ) {

  if ( vis(Y["tn_is_o"]) ) { tn=Y["n_pre_o"];
    ...
    if ( bba(tn-5,tn-1,"_gl_o_lock") ) { bb_n=bbn;
       ...
       if ( vgle(bb_n,tn-5,tn-1) && s(bb_n,-1) &&
  ...
  ######################################################################################################
  # через замок
  if ( vgle(Y["n_pre_qerez"],-5,-1) ) {

  if ( vis(Y["tn_is_qerez"]) ) { tn=Y["n_pre_qerez"];
...
#   };
#   if ( bba(tn-5,tn-1,"_gl_qerez_lock") ) { bb_n=bbn;
...
#   };
  ...
  # ниже "замок" без собственного предлога
   ...
   { l[i]=omo1; Z[767]++; if(dbg){print "Z767"}; continue };
    ...
    if ( bw(-2,cst1) &&
          w(-1,cst2) && s(-2,-1) )
    { l[i]=omo1; Z[768]++; if(dbg){print "Z768"}; continue };
    ...
    { l[i]=omo1; Z[769]++; if(dbg){print "Z769"}; continue };

    cst1="быть виднеться находиться располагаться расположиться стоять";
    cst2="глубине гуще конце начале середине центре";
    cst3="города долины композиции крепости круга леса подземелья склона";
    if ( wf(1,6,"в во на") ) { wf_n=wfn;
      if ( wf(wf_n+1,wf_n+4,cst3) ) { bf_n=wfn;
    ...
    if ( wb(-4,-1,cst3) ) { w3_n=wbn;
      if ( wb(w3_n-4,w3_n-1,cst2) ) { w2_n=wbn;
       ...
       { l[i]=omo1; Z[771]++; if(dbg){print "Z771"}; continue };
       if ( vgle(w3_n,-4,-1) && vgle(w2_n,w3_n-4,w3_n-1) && vgle(wb_n,w2_n-4,w2_n-1) && s(wb_n,-1) &&
             qir(wb_n+1,w2_n-1,"prl_pr prq_pr mest_pr mest_3e") &&
             qir(w2_n+1,w3_n-1,"prl_ro prq_ro mest_ro mest_3e") &&
             qir(w3_n+1,-1,"prl_vi mest_vi mest_3e prq_vi") )
       { l[i]=omo1; Z[772]++; if(dbg){print "Z772"}; continue };
    ...
    if ( bw(1,cst1) &&
          w(2,cst2) && s(0,1) )
    { l[i]=omo1; Z[773]++; if(dbg){print "Z773"}; continue };
    ...
    { l[i]=omo1; Z[775]++; if(dbg){print "Z775"}; continue };
    ...
    if ( w(1,"положен") && s(0) )
    { l[i]=omo1; Z[778]++; if(dbg){print "Z778"}; continue };
    if ( wy(1,"не") &&
          w(1+wyn,"положен положено") && s(0,0+wyn) )
    { l[i]=omo1; Z[779]++; if(dbg){print "Z779"}; continue };
    if ( bf(1,3,cst1) && Qf(1,bfn-1,"sz_iili pre_any") &&
          w(bfn+1,cst2) && zs(0) && s(1,bfn-1) )
    { l[i]=omo1; Z[780]++; if(dbg){print "Z780"}; continue };
    if ( bw(-1,cst1) &&
          w(bfn+1,"к ко") &&
          q(bfn+2,"mest_da mest_3e") &&
          w(bfn+3,"ногам") && s(0,bfn+2) )
    { l[i]=omo1; Z[781]++; if(dbg){print "Z781"}; continue };
    if ( bw(-1,cst1) &&
        qxs(1,"в","руины") && s(-1) )
    { l[i]=omo1; Z[782]++; if(dbg){print "Z782"}; continue };
  ...
  if ( bb(-7,-1,cst1) ) { bb_n=bbn;
    ...
    { l[i]=omo1; Z[785]++; if(dbg){print "Z785"}; continue };

    cst2="вырезать";
    cst3="гарнизон";
    if ( vgle(bb_n,-7,-1) && s(bb_n,-1) && zs(0) &&
          qir(bb_n+1,-1,"qast_any mest_vi prl_vi") &&
           bw(1,cst2) &&
    ...
    { l[i]=omo1; Z[787]++; if(dbg){print "Z787"}; continue };
    ...
    if ( vgle(bb_n,-7,-1) && s(bb_n,-1) && zs(0) &&
          qir(bb_n+1,-1,"qast_any mest_vi prl_vi") &&
          bfa(1,5,"_lock_pe") && s(1,bfn-1) &&
          qir(1,bfn-1,"prl_kred_sr mest_vi mest_3e") )
    ...
    if ( veq(bb_n,-1) &&
           q(1,"nar_napr") && s(-1,0) )
    { l[i]=omo2; Z[794]++; if(dbg){print "Z794"}; continue };
    ...
    cst0="шпиле";
       ...
       if ( vgle(bb_n,-7,-1) && vgle(bf_n,1,5) && s(bb_n,-1) && s(1,bf_n-1) && zs(0) &&
             qir(bb_n+1,-1,"prl_vi mest_vi mest_3e nar_any") &&
             qia(1,bf_n-1,"sz_i","prl_kred_sr nar_any") )
       { l[i]=omo2; Z[796]++; if(dbg){print "Z796"}; continue };
       if ( vgle(bb_n,-7,-1) && vgle(bf_n,1,5) && s(bb_n,-1) && s(1,bf_n-1) && zs(0) &&
             qiz(bb_n+1,-1,"prl_vi mest_vi mest_3e nar_any","sz_i") &&
             qir(1,bf_n-1,"prl_kred_sr nar_any") )
       { l[i]=omo2; Z[797]++; if(dbg){print "Z797"}; continue };
    };
    ...
    { l[i]=omo2; Z[798]++; if(dbg){print "Z798"}; continue };

    if ( veq(bb_n,-3) &&
          ba(-4,"_lock_parts") && s(-4,0) &&
        sz_i(-2) &&
           q(-1,"prl_vi mest_vi mest_3e prq_vi") &&
          bw(1,"поставить") )
    { l[i]=omo2; Z[799]++; if(dbg){print "Z799"}; continue };
    if ( veq(bb_n,-1) && s(-5,-1) &&
          ba(-5,"_lock_parts") &&
           w(-4,"в") &&
           q(-3,"suw_vi") &&
        sz_i(-2) )
    { l[i]=omo2; Z[800]++; if(dbg){print "Z800"}; continue };


    if ( veq(bb_n,-2) && ba(-4,"_gl_dvizh") && s(-4) &&
           q(-3,"nar_napr nar_spos nar_vrem") && z(-3) &&
           q(-1,"prl_vi mest_vi mest_3e") && s(-2,-1) )
    { l[i]=omo2; Z[801]++; if(dbg){print "Z801"}; continue };
    ...
    if ( veq(bb_n,-3) &&
           w(-2,"с со") &&
           w(-1,cst2) && s(-3,-1) )
    { l[i]=omo2; Z[807]++; if(dbg){print "Z807"}; continue };
    cst2="рук";
    if ( veq(bb_n,-1) &&
           w(1,"у") &&
           ...
           w(3,"из") &&
           w(4,cst2) && s(-1,3) )
    { l[i]=omo2; Z[808]++; if(dbg){print "Z808"}; continue };
    cst2="ногтем пальцами руками рукой";
    if ( veq(bb_n,-1) &&
           w(1,cst2) && s(-1,0) )
    { l[i]=omo2; Z[809]++; if(dbg){print "Z809"}; continue };
    if ( veq(bb_n,-1) &&
  ...
  if ( bf(1,3,cst1) ) { bf_n=bfn;
    ...
    if ( vgle(bf_n,1,3) && s(0,bf_n-1) &&
          qir(1,bf_n-1,"gl_aux_be mod_any") &&
            w(bf_n+1,cst2) )
    { l[i]=omo1; Z[813]++; if(dbg){print "Z813"}; continue };
    ...
    if ( veq(bf_n,1) &&
          ...
          bw(4,"кровь") && s(0,3) )
    { l[i]=omo2; Z[817]++; if(dbg){print "Z817"}; continue };

    if ( veq(bf_n,1) &&
          ba(2,"_lock_parts") && s(0,1) )
    { l[i]=omo2; Z[818]++; if(dbg){print "Z818"}; continue };
    if ( ba(-2,"_lock_parts") &&
          q(-1,"prl_vi mest_vi mest_3e") &&
          w(1,"не") &&
        veq(bf_n,2) && s(-2,1) )
    { l[i]=omo2; Z[819]++; if(dbg){print "Z819"}; continue };
  }; # брать взять --->>>:end
    ...
    { l[i]=omo2; Z[821]++; if(dbg){print "Z821"}; continue };
    ...
    if ( bw(-3,cst) &&
     pre_pr(-2) &&
         bw(-1,cst2) && s(-3,-1) )
    { l[i]=omo2; Z[822]++; if(dbg){print "Z822"}; continue };
    cst2="дверь ящик";
    if ( bw(-4,cst) &&
     pre_pr(-3) &&
         bw(-2,cst2) &&
    ...
    if ( bw(-4,cst1) && z(-4) &&
     pre_tv(-3) &&
          q(-2,"otsz_tv") &&
         bw(-1,cst2) && s(-3,-1) )
    { l[i]=omo2; Z[828]++; if(dbg){print "Z828"}; continue };
    ...
    if ( bw(-3,cst1) &&
          w(-2,"в") &&
          w(-1,cst3) && s(-3,-1) )
    { l[i]=omo2; Z[830]++; if(dbg){print "Z830"}; continue };
    ...
    if ( w(1,"не") &&
        bw(2,cst) && s(0,1) )
    { l[i]=omo1; Z[835]++; if(dbg){print "Z835"}; continue };
    cst1="башня время сила стена";
    if ( bw(1,cst) &&
         bw(2,cst1) && s(0,1) )
    { l[i]=omo1; Z[836]++; if(dbg){print "Z836"}; continue };
    if ( q(1,"suw_da mest_da") &&
         w(2,"не") &&
        bw(3,cst) && s(0,2) )
    { l[i]=omo1; Z[837]++; if(dbg){print "Z837"}; continue };
    if ( bw(1,cst) &&
          q(2,"suw_ro mest_ro mest_3e") &&
          w(3,"к ко") && s(0,2) )
    { l[i]=omo1; Z[838]++; if(dbg){print "Z838"}; continue };
    ...
    if ( bw(-1,cst) &&
          w(1,"от") &&
         bw(2,cst1) && s(-1,1) )
    { l[i]=omo1; Z[842]++; if(dbg){print "Z842"}; continue };
    if ( bw(-1,cst) &&
          w(1,"от") &&
          q(2,"prl_ro prq_ro") &&
         bw(3,cst1) && s(-1,2) )
    ...
    if ( bw(-2,cst) &&
      ...
      ( qxs(1,"из","его ее её их ваших цепких","лап рук")||
        qxs(1,"из","лап рук") ) )
    { l[i]=omo1; Z[845]++; if(dbg){print "Z845"}; continue };
    ...
    if ( bw(-3,cst) &&
          w(-2,"на") &&
          w(-1,cst1) && s(-3,-1) )
    { l[i]=omo1; Z[850]++; if(dbg){print "Z850"}; continue };
    ...
    if ( qy(1,"qast_any mest_3e") &&
         bw(1+qyn,cst) && s(0,1+qyn) &&
        qxw(2+qyn,"по",cst2) )
    { l[i]=omo1; Z[852]++; if(dbg){print "Z852"}; continue };
    if ( qy(1,"qast_any") &&
         bw(1+qyn,cst) && s(0,1+qyn) &&
        qxw(2+qyn,"до",cst4) )
    { l[i]=omo1; Z[853]++; if(dbg){print "Z853"}; continue };
    if ( qy(1,"qast_any") &&
         bw(1+qyn,cst) && s(0,1+qyn) &&
        qxw(2+qyn,"в",cst5) )
    ...
    if ( bw(-1,cst2) &&
         bw(1,cst1) && s(-1,0) )
    { l[i]=omo2; Z[856]++; if(dbg){print "Z856"}; continue };
    if ( w(1,"через после") &&
        bf(2,5,cst2) &&
        bw(bfn,cst1) && s(0,bfn) )
    { l[i]=omo2; Z[857]++; if(dbg){print "Z857"}; continue };
    if ( bw(1,cst1) &&
          w(2,"через после") &&
         bf(3,6,cst2) && s(0,bfn-1) )
    { l[i]=omo2; Z[858]++; if(dbg){print "Z858"}; continue };

    cst1="охватить охватывать";
    cst2="трубку трубу";
    cst3="ладонями пальцами руками";
    if ( bf(1,3,cst1) ) { bf_n=bfn;
       if ( vgle(bf_n,1,3) && s(0,bf_n) &&
               w(bf_n+1,cst2) &&
              Qf(1,bf_n-1,"sz_iili pre_any") )
       { l[i]=omo2; Z[859]++; if(dbg){print "Z859"}; continue };
       if ( vgle(bf_n,1,3) && wf(bf_n+1,bf_n+4,cst3) && zs(0) && s(1,wfn-1) &&
             qir(bf_n+1,wfn-1,"prl_tv mest_tv mest_3e") &&
              Qf(1,bf_n-1,"sz_iili pre_any") )
       { l[i]=omo2; Z[860]++; if(dbg){print "Z860"}; continue };
    };
    ...
    if ( bw(1,"загореться") &&
          w(2,"зеленым") && s(0,1) )
    { l[i]=omo2; Z[862]++; if(dbg){print "Z862"}; continue };

    # _castle_pe и _lock_pe
    if ( bba(-7,-1,"_lock_pe") ) { bb_n=bbn;
    ...
    if ( bba(-5,qbn-1,"_castle_pe") ) { bb_n=bbn;
    ...
    if ( qb(-7,-2,"pre_vi") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
       ...
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
             ...
             qir(qb_n+1,-2,"prl_vi mest_vi prq_vi mest_3e prl_kred_sr nar_any qast_any") &&
               q(-1,"suw_vi") )
       { l[i]=omo1; Z[867]++; if(dbg){print "Z867"}; continue };
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
               Q(bb_n,"suw_any") &&
             qir(bb_n+1,qb_n-1,"suw_vi suw_edne isname prl_vi mest_vi prq_vi mest_3e prl_kred_sr nar_any qast_any") &&
               q(qb_n+1,"suw_vi") &&
    ...
    if ( qb(-7,-2,"pre_da") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
        ...
        if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
              ...
              qir(qb_n+1,-2,"prl_da mest_da prq_da mest_3e prl_kred_sr nar_any qast_any") &&
                q(-1,"suw_da") )
        { l[i]=omo1; Z[870]++; if(dbg){print "Z870"}; continue };
        if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
                Q(bb_n,"suw_any") &&
              qir(bb_n+1,qb_n-1,"suw_vi suw_edne isname prl_vi mest_vi prq_vi mest_3e prl_kred_sr nar_any qast_any") &&
                q(qb_n+1,"suw_da") &&
    ...
    if ( qb(-7,-2,"pre_ro") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
       ...
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
             ...
             qir(qb_n+1,-2,"prl_ro mest_ro prq_ro mest_3e prl_kred_sr nar_any qast_any") &&
               q(-1,"suw_ro") )
       { l[i]=omo1; Z[872]++; if(dbg){print "Z872"}; continue };
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
               Q(bb_n,"suw_any") &&
             qir(bb_n+1,qb_n-1,"suw_vi suw_edne isname prl_vi mest_vi prq_vi mest_3e prl_kred_sr nar_any qast_any") &&
               q(qb_n+1,"suw_ro") &&
             qir(qb_n+2,-1,"prl_vi mest_vi prq_vi mest_3e prl_kred_sr nar_any qast_any") )
       { l[i]=omo1; Z[873]++; if(dbg){print "Z873"}; continue };

    };};

    # поиск по pre_tv + _castle_pe: qb_n и bb_n
    if ( qb(-7,-2,"pre_tv") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
        ...
        if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
              ...
              qir(qb_n+1,-2,"prl_tv mest_tv prq_tv mest_3e prl_kred_sr nar_any qast_any") &&
                q(-1,"suw_tv") )
        { l[i]=omo1; Z[874]++; if(dbg){print "Z874"}; continue };
        if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
                Q(bb_n,"suw_any") &&
              qir(bb_n+1,qb_n-1,"suw_vi suw_edne isname prl_vi mest_vi prq_vi mest_3e prl_kred_sr nar_any qast_any") &&
                q(qb_n-1,"suw_tv") &&
              qir(qb_n+2,-1,"prl_vi mest_vi prq_vi mest_3e prl_kred_sr nar_any qast_any") )
        { l[i]=omo1; Z[875]++; if(dbg){print "Z875"}; continue };
        ...
        { l[i]=omo1; Z[876]++; if(dbg){print "Z876"}; continue };

    };};

    # поиск по pre_pr + _castle_pe: qb_n и bb_n
    if ( qb(-7,-2,"pre_pr") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
       ...
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
             ...
             qir(qb_n+1,-2,"prl_pr prq_pr mest_pr mest_3e") &&
               q(-1,"suw_pr") )
       { l[i]=omo1; Z[877]++; if(dbg){print "Z877"}; continue };
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
               Q(bb_n,"suw_any") &&
             qir(bb_n+1,qb_n-1,"suw_da prl_da mest_da prq_da nar_mest prl_kred_sr") &&
               q(qb_n+1,"suw_pr isname") &&
             qir(qb_n+2,-1,"prl_vi prq_vi mest_vi mest_3e") )
       { l[i]=omo1; Z[878]++; if(dbg){print "Z878"}; continue };
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
               Q(bb_n,"suw_any") &&
             qir(bb_n+1,qb_n-1,"suw_da prl_da mest_da prq_da nar_mest prl_kred_sr") &&
             qir(qb_n+1,-3,"prl_pr prq_pr mest_pr mest_3e") &&
               q(-2,"suw_pr isname") &&
               q(-1,"prl_vi prq_vi mest_vi mest_3e") )
       { l[i]=omo1; Z[879]++; if(dbg){print "Z879"}; continue };
       ...
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
          ...
          pre_ro(bb_n+1) &&
             ...
             qir(qb_n+1,-3,"prl_pr prq_pr mest_pr mest_3e") &&
               q(-2,"suw_pr isname") &&
               q(-1,"prl_vi prq_vi mest_vi mest_3e") )
       { l[i]=omo1; Z[880]++; if(dbg){print "Z880"}; continue };
    ...
    #
    if ( qb(-7,-2,"pre_vi") ) { qb_n=qbn; if ( bba(qb_n-7,qb_n-1,"_lock_pe") ) { bb_n=bbn;

       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qbn-7,qbn-1) && s(bb_n,-1) &&
             vis(Y["tn_is_vi"]) )
       { bb_n=qb_n=""; Z[881]++; if(dbg){print "Z881"}; };
       ...
       if ( vgle(qb_n,-7,-2) && vgle(bb_n,qbn-7,qbn-1) && s(bb_n,-1) &&
             ...
             qir(qbn+1,-2,"prl_vi mest_vi prq_vi") &&
               q(-1,"suw_vi mest_vi") )
       { l[i]=omo2; Z[890]++; if(dbg){print "Z890"}; continue };

    };};

    #
    if ( qb(-7,-2,"pre_ro") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_lock_pe") ) { bb_n=bbn;

       if ( vgle(qb_n,-5,-1) && vgle(bb_n,qb_n-7,qb_n-1) && s(bb_n,-1) &&
             qir(bb_n+1,qb_n-1,"suw_vi prl_vi prq_vi mest_vi mest_3e nar_any") &&
             qir(qb_n+1,-2,"prl_ro mest_ro mest_3e") &&
               q(-1,"suw_ro mest_ro") )
       { l[i]=omo2; Z[891]++; if(dbg){print "Z891"}; continue };
       if ( vgle(qb_n,-5,-1) && vgle(bb_n,qb_n-7,qb_n-1) && s(bb_n,-1) &&
             qir(bb_n+1,qb_n-1,"suw_vi prl_vi prq_vi mest_vi mest_3e nar_any") &&
               q(qb_n+1,"suw_ro mest_ro") &&
             qir(qb_n+2,-1,"prl_vi mest_vi mest_3e prq_vi") )
       { l[i]=omo2; Z[892]++; if(dbg){print "Z892"}; continue };

    };};

    #
    if ( qb(-7,-2,"pre_tv") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_lock_pe") ) { bb_n=bbn;
    ...
    #
    if ( qb(-7,-2,"pre_pr") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_lock_pe") ) { bb_n=bbn;
    ...
    if ( bba(-7,-1,"_castle_pe") ) { bb_n=bbn;

       if ( vgle(bb_n,-7,-1) && xw(bb_n,"X_castle_pe") )
       { bb_n=""; Z[897]++; if(dbg){print "Z897"};};

         if ( veq(bb_n,-1) && s(-1) && q(-1,"prq_any gl_in") )
         { l[i]=omo1; Z[898]++; if(dbg){print "Z898"}; continue };

       if ( vgle(bb_n,-7,-1) && bfa(bb_n+1,-1,"_lock_pe") && s(bfn,-1) )
       { bb_n=""; Z[899]++; if(dbg){print "Z899"};};
       if ( vgle(bb_n,-7,-1) && q(bb_n,"prq_edmuim") && ba(bb_n-1,"_lock_pe") && s(bfn-1,-1) )
       { bb_n=""; Z[900]++; if(dbg){print "Z900"};};
       if ( veq(bb_n,-1) && q(bb_n,"predik vvod") && s(-1) && zs(-2) )
       { bb_n=""; Z[901]++; if(dbg){print "Z901"};};
         ...
         { l[i]=omo1; Z[904]++; if(dbg){print "Z904"}; continue };
         if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
         ...
         { l[i]=omo1; Z[907]++; if(dbg){print "Z907"}; continue };
         if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
         ...
         { l[i]=omo1; Z[910]++; if(dbg){print "Z910"}; continue };
         if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
      ...
      if ( qb(-5,-1,"sz_iili") ) { qb_n=qbn; if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
         ...
         { l[i]=omo1; Z[917]++; if(dbg){print "Z917"}; continue };
    ...
    if ( bba(-7,-1,"_lock_pe") ) { bb_n=bbn;
      ...
      { bb_n=""; Z[921]++; if(dbg){print "Z921"};};
       ...
       if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
             ...
             qir(bb_n+3,-1,"prl_vi prq_vi mest_vi mest_3e qast") )
       { l[i]=omo2; Z[925]++; if(dbg){print "Z925"}; continue };
       if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
               q(bb_n+1,"suw_da mest_da") &&
             qir(bb_n+2,-1,"prl_vi prq_vi mest_vi mest_3e qast") )
       { l[i]=omo2; Z[926]++; if(dbg){print "Z926"}; continue };
       if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
       ...
       { l[i]=omo2; Z[928]++; if(dbg){print "Z928"}; continue };
       if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
             qir(bb_n+1,-1,"suw_odim prl_im prq_im mest_im mest_3e qast_any isname") )
       { l[i]=omo2; Z[929]++; if(dbg){print "Z929"}; continue };
       if ( vgle(bb_n,-7,-1) &&
             qir(bb_n+1,-2,"prl_ro prq_ro mest_ro mest_3e qik_vi") &&
               q(-1,"suw_ro") && s(bb_n,-1) )
       { l[i]=omo2; Z[930]++; if(dbg){print "Z930"}; continue };
       if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
               q(bb_n+1,"prq_vi") &&
             qir(bb_n+2,-2,"prl_tv prq_tv mest_tv") &&
               q(-1,"suw_tv mest_tv") )
       { l[i]=omo2; Z[931]++; if(dbg){print "Z931"}; continue };

       cst1="ваш верхний второй его ее их мой наш сам свой такой тот этот";
       if ( vgle(bb_n,-7,-1) && s(bb_n,-1) &&
            (qaw(-1,"тот","или","иной этот") ||
             qaw(-1,"и также",cst1)||
             qaw(-1,"еще же ли уже","и",cst1)||
             qaw(-1,"один","и","тот","же")||
             qaw(-1,"еще","хоть","один")||
             qaw(-1,"хотя","бы")||
             qaw(-1,"хоть","один такой какой-то какой-нибудь") ) &&
             vlt(awn,0) &&
             qir(awn+1,-1,"prl_edmuim prq_edmuim mest_edmuvi") )
       { l[i]=omo2; Z[932]++; if(dbg){print "Z932"}; continue };
    ...
    if ( qb(-5,-1,"sz_iili") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_lock_pe") ) { bb_n=bbn;
          ...
          if ( vgle(qb_n,-5,-1) && vgle(bb_n,qbn-5,qbn-1) && s(bb_n,-1) &&
                  q(1,"mod_any") &&
                 ba(2,"_castle_pe") && s(0,1) )
          { qb_n=bb_n=""; Z[934]++; if(dbg){print "Z934"}; };
       if ( vgle(qb_n,-5,-1) && vgle(bb_n,qbn-5,qbn-1) && s(bb_n,-1) &&
    ...
    { l[i]=omo2; Z[937]++; if(dbg){print "Z937"}; continue };
    # _lock_pe <<<---:end

    # _castle_pe --->>>:start
    if ( bfa(1,6,"_castle_pe") ) { bf_n=bfn;

       if ( vgle(bf_n,1,6) && zs(0) && s(1,bf_n-1) &&
               q(bf_n,"mod_any") && q(bf_n+1,"gl_in") && !ba(bf_n+1,"_castle_pe") )
       { bf_n=""; Z[938]++; if(dbg){print "Z938"}; };
       if ( vgle(bf_n,1,6) && zs(0) && s(1,bf_n-1) &&
               q(bf_n,"mod_any") && q(bf_n+1,"gl_in") && ba(bf_n+1,"_castle_pe") )
       { bf_n=bf_n+1; Z[939]++; if(dbg){print "Z939"}; };
       ...
       { l[i]=omo1; Z[941]++; if(dbg){print "Z941"}; continue };
    ...
    { l[i]=omo1; Z[944]++; if(dbg){print "Z944"}; continue };
    ...
    { l[i]=omo2; Z[946]++; if(dbg){print "Z946"}; continue };
    if ( w(1,"на") &&
         q(2,"suw_vi mest_vi") &&
       bfa(3,5,"_lock_pe") &&
         s(0,bfn-1) && Qf(3,bfn-1,"sz_iili pre_any") )
    { l[i]=omo2; Z[947]++; if(dbg){print "Z947"}; continue };
    if ( qxs(-1,"еще","один") &&
           q(xsn-1,"gl_pein gl_peed gl_pemn gl_poed deep_pe") && s(xsn-1) &&
        sz_i(1) &&
          ba(2,"_lock_pe") && s(0,1) )
    { l[i]=omo2; Z[948]++; if(dbg){print "Z948"}; continue };
    if ( pre_pr(1) &&
              q(2,"suw_pr") &&
              q(3,"suw_ro") &&
         pre_tv(4) &&
              q(5,"suw_tv") &&
             ba(6,"_lock_pe") && s(0,5) )
    { l[i]=omo2; Z[949]++; if(dbg){print "Z949"}; continue };
    ...
    { l[i]=omo1; Z[952]++; if(dbg){print "Z952"}; continue };
    if ( prl_im(-2) && ba(-2,"_castle_prl_geo") &&
              Q(-1,"suw_any") && s(-2,-1)  )
    { l[i]=omo1; Z[953]++; if(dbg){print "Z953"}; continue };
 ...
 #
    ...
    { l[i]=omo1; Z[963]++; if(dbg){print "Z963"}; continue };
    ...
    { l[i]=omo2; Z[967]++; if(dbg){print "Z967"}; continue };
    if ( ba(-2,"_lock_prl") && prl_ro(-2) &&
          Q(-1,"suw_any sz_iili") && s(-2,-1) )
    { l[i]=omo2; Z[968]++; if(dbg){print "Z968"}; continue };
    if ( ba(-3,"_lock_prl") && prl_ro(-3) &&
          q(-2,"prl_any prq_any mest_any qast") && W(-2,"как") &&
          q(-1,"prl_any prq_any mest_any qast") && s(-3,-1)  )
    { l[i]=omo2; Z[969]++; if(dbg){print "Z969"}; continue };
    if ( ba(1,"_lock_prl") && s(0) && prl_ro(1) && !isname(1) )
    { l[i]=omo2; Z[970]++; if(dbg){print "Z970"}; continue };
    # _lock_prl:end
    ...
    if ( prl_ro(-2) &&
             ba(-2,"_castle_prl_geo") &&
              Q(-1,"suw_any") && s(-2,-1)  )
    { l[i]=omo1; Z[972]++; if(dbg){print "Z972"}; continue };
    if ( prl_ro(1) &&
             ba(1,"_castle_prl_geo") && s(0) && !prl_ro(1))
    { l[i]=omo1; Z[973]++; if(dbg){print "Z973"}; continue };
    # _castle_prl_geo:start

#   # _castle_prl_after:start
#   if ( q(-1,"prl_ro prl_kred_mu") && ba(-1,"_castle_prl_after") && s(-1) )
#   { l[i]=omo1; Z[974]++; if(dbg){print "Z974"}; continue };
#   # _castle_prl_after:start
...
#   # _castle_lock_after:start
 ...
 #
    ...
    { l[i]=omo2; Z[978]++; if(dbg){print "Z978"}; continue };
  ...
  #
    ...
    { l[i]=omo1; Z[980]++; if(dbg){print "Z980"}; continue };
    ...
    { l[i]=omo1; Z[983]++; if(dbg){print "Z983"}; continue };
    # _castle_prl:start

    # _lock_prl:start
    if ( ba(-1,"_lock_prl") && s(-1) && prl_da(-1) )
    { l[i]=omo2; Z[984]++; if(dbg){print "Z984"}; continue };
    if ( ba(-2,"_lock_prl") && prl_da(-2) &&
          Q(-1,"suw_any sz_iili") && s(-2,-1) )
    { l[i]=omo2; Z[985]++; if(dbg){print "Z985"}; continue };
...
#   { l[i]=omo2; Z[992]++; if(dbg){print "Z992"}; continue };
#   # _castle_lock_after:start
 ...
 #
    ...
    { l[i]=omo1; Z[993]++; if(dbg){print "Z993"}; continue };
    cst="окружить";
    if ( q(-2,"prq_edmutv prq_mntv") && bw(-2,cst) &&
         q(-1,"suw_tv mest_tv") && s(-2,-1) )
    { l[i]=omo1; Z[994]++; if(dbg){print "Z994"}; continue };
 ...
 #
    ...
    { l[i]=omo1; Z[997]++; if(dbg){print "Z997"}; continue };
    ...
    { l[i]=omo1; Z[1000]++; if(dbg){print "Z1000"}; continue };
    # _castle_prl:start
    ...
    if ( ba(-2,"_lock_prl") && prl_tv(-2) &&
          Q(-1,"suw_any sz_iili") && s(-2,-1) )
    { l[i]=omo2; Z[1002]++; if(dbg){print "Z1002"}; continue };
    ...
    if ( prl_tv(-2) &&
             ba(-2,"_castle_prl_geo") &&
              Q(-1,"suw_any") && s(-2,-1)  )
    { l[i]=omo1; Z[1006]++; if(dbg){print "Z1006"}; continue };
    if ( prl_tv(1) &&
...
#   { l[i]=omo2; Z[1009]++; if(dbg){print "Z1009"}; continue };
#   # _castle_lock_after:start
 ...
 #
    ...
    { l[i]=omo1; Z[1010]++; if(dbg){print "Z1010"}; continue };
    cst="окружить";
    ...
    { l[i]=omo2; Z[1012]++; if(dbg){print "Z1012"}; continue };
  ...
  if ( ba(tn-3,"_suw_v_lock") &&
        w(tn-2,"с") &&
        q(tn-1,"suw_tv") && s(tn-3,tn-1) )
  { l[i]=omo2; Z[1014]++; if(dbg){print "Z1014"}; continue };
  #
  if ( ba(tn-1,"_suw_v_castle-vp") && s(tn-1) )
  ...
  if ( bba(tn-7,tn-4,"_suw_v_castle-vp") &&
    pre_ro(bbn+1) &&
       qir(bbn+2,tn-1,"suw_ro prl_ro prq_ro mest_ro mest_3e isname") && s(bbn,tn-1) )
  { l[i]=omo1; Z[1018]++; if(dbg){print "Z1018"}; continue };
  # _suw_v_castle-vp:end
  } # в замке

    # _castle_prl:start
    if ( ba(-1,"_castle_prl") && prl_da(-1) && s(-1)  )
    { l[i]=omo1; Z[1019]++; if(dbg){print "Z1019"}; continue };
    if ( ba(-2,"_castle_prl") && prl_da(-2) &&
          q(-1,"prl_any prq_any mest_any qast") && s(-2,-1)  )
    { l[i]=omo1; Z[1020]++; if(dbg){print "Z1020"}; continue };
    if ( ba(-3,"_castle_prl") && prl_da(-3) &&
          q(-2,"prl_any prq_any mest_any qast") && W(-2,"как") &&
          q(-1,"prl_any prq_any mest_any qast") && s(-3,-1)  )
    { l[i]=omo1; Z[1021]++; if(dbg){print "Z1021"}; continue };
    if ( ba(1,"_castle_prl") && prl_da(1) && s(0) )
    { l[i]=omo1; Z[1022]++; if(dbg){print "Z1022"}; continue };
    # _castle_prl:start

    # _lock_prl:start
    if ( ba(-1,"_lock_prl") && s(-1) && prl_da(-1) )
    { l[i]=omo2; Z[1023]++; if(dbg){print "Z1023"}; continue };
    if ( ba(-2,"_lock_prl") && prl_da(-2) &&
          Q(-1,"suw_any sz_iili") && s(-2,-1) )
    { l[i]=omo2; Z[1024]++; if(dbg){print "Z1024"}; continue };
    if ( ba(-3,"_lock_prl") && prl_da(-3) &&
          q(-2,"prl_any prq_any mest_any qast") && W(-2,"как") &&
          q(-1,"prl_any prq_any mest_any qast") && s(-3,-1)  )
    { l[i]=omo2; Z[1025]++; if(dbg){print "Z1025"}; continue };
    if ( ba(1,"_lock_prl") && s(0) && prl_da(1) && !isname(1) )
    { l[i]=omo2; Z[1026]++; if(dbg){print "Z1026"}; continue };
    # _lock_prl:end

    # _castle_prl_geo:start
    if ( prl_da(-1) &&
             ba(-1,"_castle_prl_geo") && s(-1)  )
    { l[i]=omo1; Z[1027]++; if(dbg){print "Z1027"}; continue };
    if ( prl_da(-2) &&
             ba(-2,"_castle_prl_geo") &&
              Q(-1,"suw_any") && s(-2,-1)  )
    { l[i]=omo1; Z[1028]++; if(dbg){print "Z1028"}; continue };
    if ( prl_da(1) &&
             ba(1,"_castle_prl_geo") && s(0) && !prl_da(1))
    { l[i]=omo1; Z[1029]++; if(dbg){print "Z1029"}; continue };
    # _castle_prl_geo:start

#   # _castle_prl_after:start
#   if ( q(-1,"prl_pr prl_kred_mu") && ba(-1,"_castle_prl_after") && s(-1) )
#   { l[i]=omo1; Z[1030]++; if(dbg){print "Z1030"}; continue };
#   # _castle_prl_after:start

#   # _lock_prl_after:start
#   if ( q(-1,"prl_pr prl_kred_mu") && ba(-1,"_lock_prl_after") && s(-1) )
#   { l[i]=omo2; Z[1031]++; if(dbg){print "Z1031"}; continue };
#   # _castle_lock_after:start
 ...
 { l[i]=omo1; Z[1032]++; if(dbg){print "Z1032"}; continue };
 if ( z(0) && ba(1,"_castle_environs") && Q(1,"isname") )
 { l[i]=omo1; Z[1033]++; if(dbg){print "Z1033"}; continue };
 # перенос назад
 ...
 if ( bfa(1,5,"_lock_parts") ) { bf_n=bfn;
    ...
    { bf_n=""; Z[1034]++; if(dbg){print "Z1034"}; };
    if ( vgle(bf_n,1,5) && s(1,bf_n-1) && (s(0)||se(0," — ")) && bw(bf_n-1,"визитный") )
    { bf_n=""; Z[1035]++; if(dbg){print "Z1035"}; };

    if ( vgle(bf_n,1,5) && s(1,bf_n-1) && (s(0)||se(0," — ")) && qf(1,bfn,"isname") )
    { bf_n=""; Z[1036]++; if(dbg){print "Z1036"}; };
    if ( vgle(bf_n,1,5) && s(1,bf_n-1) && (s(0)||se(0," — ")) && q(-1,"isname") && p(-2) )
    { bf_n=""; Z[1037]++; if(dbg){print "Z1037"}; };

    if ( vgle(bf_n,1,5) && z(0) && s(1,bf_n) &&
          qir(1,bf_n-1,"prl_any mest_any qast_any") &&
            q(bf_n+1,"otsz_mu") )
    { l[i]=omo2; Z[1038]++; if(dbg){print "Z1038"}; continue };
    ...
    { l[i]=omo2; Z[1039]++; if(dbg){print "Z1039"}; continue };
 ...
 { l[i]=omo1; Z[1040]++; if(dbg){print "Z1040"}; continue };
 if ( z(0) &&
      q(1,"nar_spos prl_kred_sr") &&
      q(2,"prq_any") && ba(2,"_castle_pe") && s(1,2) && Q(-1,"suw_any") )
 { l[i]=omo1; Z[1041]++; if(dbg){print "Z1041"}; continue };
 if ( q(-3,"prq_any") && ba(-3,"_castle_pe") && Q(-3,"suw_any") &&
 pre_ro(-2) &&
      q(-1,"suw_ro") && s(-3,-1) )
 { l[i]=omo1; Z[1042]++; if(dbg){print "Z1042"}; continue };
 if ( q(-4,"prq_any") && ba(-4,"_castle_pe") && Q(-4,"suw_any") &&
 pre_ro(-3) &&
      q(-2,"prl_ro") &&
      q(-1,"suw_ro") && s(-4,-1) )
 { l[i]=omo1; Z[1043]++; if(dbg){print "Z1043"}; continue };
 if ( q(-1,"prq_any") && ba(-1,"_castle_pe") && s(-1) && Q(-1,"suw_any") )
 { l[i]=omo1; Z[1044]++; if(dbg){print "Z1044"}; continue };
 # _castle_pe:end
 ...
 { l[i]=omo2; Z[1045]++; if(dbg){print "Z1045"}; continue };
 if ( z(0) && q(1,"prq_any") && ba(1,"_lock_pe") && s(1) )
 { l[i]=omo2; Z[1046]++; if(dbg){print "Z1046"}; continue };
 if ( q(-1,"prq_any") && ba(-1,"_lock_pe") && s(-1) )
 { l[i]=omo2; Z[1047]++; if(dbg){print "Z1047"}; continue };
 # _lock_pe:end
 ...
 if ( wf(1,6,"в во") ) { wf_n=wfn; if ( wfa(wf_n+1,wf_n+4,"_castle_v_suw-pr") ) { bf_n=wfn;
    ...
    { l[i]=omo1; Z[1048]++; if(dbg){print "Z1048"}; continue };
 ...
 if ( wb(-6,-2,"в во") ) { wb_n=wbn; if ( wba(wb_n+1,-1,"_castle_v_suw-pr") ) { bb_n=wbn;
    ...
    { l[i]=omo2; Z[1049]++; if(dbg){print "Z1049"}; continue };
    # escape:end

    if ( vgle(wb_n,-6,-2) && vgle(bb_n,wb_n+1,-1) &&
          qir(wb_n+1,bb_n-1,"prl_pr mest_pr mest_3e prq_pr") && s(wb_n,bb_n-1) &&
          qia(bb_n+1,-1,"qast","prl_any mest_any nar_any suw_ro isname") && ds(bb_n) && s(bb_n+1,-1) )
    { l[i]=omo1; Z[1050]++; if(dbg){print "Z1050"}; continue };
 ...
 { l[i]=omo1; Z[1051]++; if(dbg){print "Z1051"}; continue };
 # похожий
 ...
 { l[i]=omo2; Z[1052]++; if(dbg){print "Z1052"}; continue };
 if ( w(-2,"на") &&
     ba(-1,"_lock_na_suw") && s(-2,-1) )
 { l[i]=omo2; Z[1053]++; if(dbg){print "Z1053"}; continue };
 if ( ba(-2,"_lock_na_suw") && se(-2," — ") &&
       w(-1,"на") && s(-1) )
 { l[i]=omo2; Z[1054]++; if(dbg){print "Z1054"}; continue };
 if ( w(1,"на") &&
    bfa(2,5,"_lock_na_suw") && s(0,bfn-1) &&
    qir(2,bfn-1,"prl_vi prl_pr mest_vi mest_pr prq_vi prq_pr") )
 { l[i]=omo2; Z[1055]++; if(dbg){print "Z1055"}; continue }; #check ислючения "в"
 if ( w(1,"у") && Ww_(-1,"в") &&
      q(2,"suw_vi mest_vi isname") &&
      w(3,"на") &&
    qir(4,5,"prl_vi prl_pr mest_vi mest_pr mest_3e prq_vi prq_pr") &&
    bfa(4,7,"_lock_na_suw") && s(0,bfn-1) )
 { l[i]=omo2; Z[1056]++; if(dbg){print "Z1056"}; continue };
 ...
 { l[i]=omo2; Z[1059]++; if(dbg){print "Z1059"}; continue };

 if ( z(0) && w(1,"где") )
 { l[i]=omo1; Z[1060]++; if(dbg){print "Z1060"}; continue };
 if ( z(-2) && w(-1,"где") && s(-1) &&
     ba(-2,"_castle_platz") )
 { l[i]=omo1; Z[1061]++; if(dbg){print "Z1061"}; continue };

 # цифры
 if ( wb(-7,-2,"в") ) { wb_n=wbn;

    if ( vgle(wb_n,-7,-3) && s(wb_n,-1) &&
       digits(wb_n+1) &&
           qy(wb_n+2,"digits") &&
            w(wb_n+2+qyn,"году годах") &&
          qir(wb_n+3+qyn,-1,"prl_vi mest_vi mest_3e") )
    { l[i]=omo1; Z[1062]++; if(dbg){print "Z1062"}; continue };
    if ( vgle(wb_n,-7,-3) && s(wb_n,-1) &&
       digits(wb_n+1) &&
            w(wb_n+2,"м х") &&
            w(wb_n+3,"году годах") &&
          qir(wb_n+4,-1,"prl_vi mest_vi mest_3e") )
    { l[i]=omo1; Z[1063]++; if(dbg){print "Z1063"}; continue };
    if ( vgle(wb_n,-7,-3) && s(wb_n,-1) &&
       digits(wb_n+1) &&
            w(wb_n+2,"м х") &&
            w(wb_n+3,"году годах") &&
    ...
    { l[i]=omo1; Z[1064]++; if(dbg){print "Z1064"}; continue };
    if ( vgle(wb_n,-6,-2) && s(wb_n+1,-1) &&
        roman(wb_n) &&
            w(wb_n+1,"веке веках") &&
          qir(wb_n+2,-1,"prl_vi mest_vi mest_3e") )
    { l[i]=omo1; Z[1065]++; if(dbg){print "Z1065"}; continue };
 ...
 { l[i]=omo1; Z[1066]++; if(dbg){print "Z1066"}; continue };

    # _castle_prl_after:start
    if ( q(-1,"prl_im prl_kred_mu") && ba(-1,"_castle_prl_after") && s(-1) )
    { l[i]=omo1; Z[1067]++; if(dbg){print "Z1067"}; continue };

    if ( q(1,"prl_edmuim prl_kred_mu") && ba(1,"_castle_prl_after") && s(0) )
    { l[i]=omo1; Z[1068]++; if(dbg){print "Z1068"}; continue };
    if ( q(1,"nar_mest") &&
         q(2,"prl_edmuim prl_kred_mu") && ba(2,"_castle_prl_after") && s(0,1) )
    { l[i]=omo1; Z[1069]++; if(dbg){print "Z1069"}; continue };
    # _castle_prl_after:end

    # _lock_prl_after:start
    if ( q(-1,"prl_im prl_kred_mu") && ba(-1,"_lock_prl_after") && s(-1) )
    { l[i]=omo2; Z[1070]++; if(dbg){print "Z1070"}; continue };

    if ( q(1,"prl_edmuim prl_kred_mu") && ba(1,"_lock_prl_after") && s(0) )
    { l[i]=omo2; Z[1071]++; if(dbg){print "Z1071"}; continue };
    if ( q(1,"nar_mest") &&
         q(2,"prl_edmuim prl_kred_mu") && ba(2,"_lock_prl_after") && s(0,1) )
    { l[i]=omo2; Z[1072]++; if(dbg){print "Z1072"}; continue };
    # _lock_after:end
 ...
 if ( gist(-4,2) &&
         ...
         w(-1,"а но и или") && s(0) )
 { l[i]=omo2; Z[1073]++; if(dbg){print "Z1073"}; continue };
 # от обработки предыдущего в строке:end

 if ( isname(1) && s(0) )
 { l[i]=omo1; Z[1074]++; if(dbg){print "Z1074"}; continue };
 if ( w(1,"де дю фон ди да дель ла ло ле лё ля") && isname(2) && s(0,1) )
 { l[i]=omo1; Z[1075]++; if(dbg){print "Z1075"}; continue };
 if ( (qxs(1,"де","ла")||
       qxs(1,"фон","дер")) &&
    isname(xsn+1) && s(xsn) )
 { l[i]=omo1; Z[1076]++; if(dbg){print "Z1076"}; continue };
 if ( w(1,"д л") && sc(1,"[\x27’]") && isname(2) && s(0) )
 { l[i]=omo1; Z[1077]++; if(dbg){print "Z1077"}; continue };
 if ( w(1,"ал") && se(1,"-") && isname(2) && s(0) )
 { l[i]=omo1; Z[1078]++; if(dbg){print "Z1078"}; continue };
 if ( q(1,"pre_vi pre_ro pre_pr") &&
 isname(2) && s(0,1) && !(bb(-4,-1,"ключ ключик")) )
 { l[i]=omo1; Z[1079]++; if(dbg){print "Z1079"}; continue };
 if ( isname(-1) && ( (s(-2,-1) && sv(-2,")"))||(z(-2) && s(-1)) ) )
 { l[i]=omo1; Z[1080]++; if(dbg){print "Z1080"}; continue };
 if ( isname(0) && s(-1) )
 { l[i]=omo1; Z[1081]++; if(dbg){print "Z1081"}; continue };
...
#   cst_muvi="prl_edmuvi prl_mnvi mcop_edmuvi mcop_mnvi qis_vi qik_vi prq_edmuvi prq_mnvi qast_any mest_3e nar_kaq nar_step";
    ...
    { tn_ok = 1; Z[1082]++; if(dbg){print "Z1082", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) && wy(-1,"же") &&
          qir(tn+2,-1-wyn,"mest_da suw_da prq_da nar_any prl_da") )
    { tn_ok = 1; Z[1083]++; if(dbg){print "Z1083", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
          qir(tn+2,-2,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
            q(-1,"suw_tv mest_tv") )
    { tn_ok = 1; Z[1084]++; if(dbg){print "Z1084", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
          qir(tn+2,-3,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
            q(-2,"suw_tv qik_tv") &&
            q(-1,cst3) )
    { tn_ok = 1; Z[1085]++; if(dbg){print "Z1085", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
            q(tn+2,"pre_vi") &&
          qir(tn+3,-2,"prl_vi mest_vi mest_3e") &&
            q(-1,"mest_vip3e suw_vi") )
    { tn_ok = 1; Z[1086]++; if(dbg){print "Z1086", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
            q(tn+2,"pre_tv") &&
          qir(tn+3,-2,"prl_tv mest_tv mest_3e") &&
            q(-1,"suw_tv") )
    { tn_ok = 1; Z[1087]++; if(dbg){print "Z1087", "-- tn_ok ON", el, "замок"};};
    cst="именно собственно";
    if ( !vis(tn_ok) && s(tn,-1) && qiw(tn+1,-1,cst1,cst) )
    { tn_ok = 1; Z[1088]++; if(dbg){print "Z1088", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(-4) && zs(-3) && s(-2,-1) && veq(tn,-4) &&
            q(-3,cst2) && q(-2,"nar_any prl_kred_sr") && q(-1,cst2) )
    { tn_ok = 1; Z[1089]++; if(dbg){print "Z1089", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(tn,-1) && veq(tn,-2) && wc(-1,"ский$|ный$") )
    { tn_ok = 1; Z[1090]++; if(dbg){print "Z1090", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && zs(-2) && s(-1) && veq(tn,-3) &&
            q(-2,cst2) && wc(-1,"ский$|ный$") )
    { tn_ok = 1; Z[1091]++; if(dbg){print "Z1091", "-- tn_ok ON", el, "замок"};};
    if ( !vis(tn_ok) && s(tn,-1) && veq(tn,-4) &&
            q(-3,cst2) && q(-2,"sz_iili") && wc(-1,"ский$|ный$") )
    { tn_ok = 1; Z[1092]++; if(dbg){print "Z1092", "-- tn_ok ON", el, "замок"};};
    # передвижка tn_ok
    if ( vis(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"ведь даже же") ) )
    { tn = xsn; Z[1093]++; if(dbg){print "Z1093", "-- tn_ok MOV", el, "замок"};};
    # выключение tn_ok
    if ( vis(tn_ok) && s(tn,-1) && qf(tn+1,-1,"prq_edmuvi prq_mnvi") &&
         bam(qfn,"_castle_pe _lock_pe") &&
           q(1,"suw_edmuvi suw_mnvi suw_edne") && s(0) )
    { tn_ok = ""; Z[1094]++; if(dbg){print "Z1094", "-- tn_ok OFF", el, "замок"};};
    if ( vis(tn_ok) && s(tn,-1) &&
         qxs(-1,"прошлый тот этот","раз") )
    { tn_ok = ""; Z[1095]++; if(dbg){print "Z1095", "-- tn_ok OFF", el, "замок"};};
}
