...
sz_iili(-3) &&
 ...
 { l[i]=omo1; Z[209]++; if(dbg){print "Z209",qfn}; continue };
 if ( w(-2,"с со") &&
...
#   { l[i]=omo2; Z[274]++; if(dbg){print "Z274"}; continue };
    ...
    if ( ba(-3,"_gl_v_castle_main") &&
          q(-2,"suw_vi suw_im suw_ro suw_tv suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname prq_tv qis_vi qik_vi") &&
...
#   if ( q(-2,"mdqast")  )
#   { l[i]=omo1; Z[408]++; if(dbg){print "Z408", l[i-2]}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"prl_vi prl_im mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          q(-2,"suw_vi suw_im mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||z(-2)) && s(-1) )
...
#   { l[i]=omo2; Z[620]++; if(dbg){print "Z620"}; continue };
 ...
 #
    ...
    { l[i]=omo1; Z[847]++; if(dbg){print "Z847"}; continue };
    # _castle_prl:start
 ...
 #
    ...
    if ( ba(1,"_castle_prl") && prl_da(1) && s(0) )
    { l[i]=omo1; Z[869]++; if(dbg){print "Z869"}; continue };
    # _castle_prl:start
