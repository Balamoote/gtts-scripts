...
#getBFx(-3,3,"_an.txt"); Z[11]++; if(dbg){print "Z11"}; continue
 ...
 if ( esca() )
 { Z[23]++; if(dbg){print "Z23", "-- is_a_phrase!"}; continue };
...
#{ print l[i+1] >> "_isname.txt"; Z[22]++; if(dbg){print "Z22"}; }; continue
 ...
 if ( iwrd=="замок" || iwrd=="замки" )  { Y["iwrd_case"]="iv"; if ( iwrd=="замок" ) {Y["iwrd_form"]="ediv"} else {Y["iwrd_form"]="mniv"}; if(dbg){print "замок: им+вин, ед+мн"};
    ...
    { Z[23]++; if(dbg){print "Z23", "-- is_escape!"}; continue };
    # pointesque
...
#{ l[i]=omo1; Z[53]++; if(dbg){print "Z53"}; continue };
 ...
 { l[i]=omo1; Z[55]++; if(dbg){print "Z55"}; stopp=ret=1; continue };
 ...
 if ( wf(2,6,"собой") && bw(wfn-1,"представлять") ) { wf_n=wfn;
      ...
      { Z[86]++; if(dbg){print "Z86", "-- TN_v_zamok_f"}; continue};
 ...
 if ( bf(1,4,cst) ) { bf_n=bfn;
   ...
   if ( bfa(bf_n+1,bf_n+5,"_castlelike_things")||
      ...
      ( bfa(bf_n+1,bf_n+5,"_prq_castle") && q(bfn,"prq_tv") ) ) {
       ...
       { bf_n=bb_n=""; Z[91]++; if(dbg){print "Z91"}; };
       if ( vgl(bf_n,1,4) && zs(0) && s(1,bb_n-1) &&
 ...
 if (bb(1,3,cst)) { bf_n=bbn;
   if ( bfa(bf_n+1,bf_n+5,"_locklike_things")||wf(bf_n+1,bf_n+5,cst2) ) { if (bfn) bb_n=bfn; if (wfn) bb_n=wfn;
       ...
       if ( vgl(bf_n,1,3) && zs(0) && s(1,bb_n-1) &&
            vex(Y["tn_ok_vi"]) )
       { bf_n=bb_n=""; Z[103]++; if(dbg){print "Z103"}; };
 ...
 if ( bfa(1,6,"_castle_environs") ) { bf_n=Y["n+_castle_environs"]=bfn; qb_n=Y["n-_lock_pe"]; bb_n=Y["n-_gl_v_lock-iv"];
   ...
   { var_do_tn=1; Z[119]++; if(dbg){print "Z119"}; };
   if ( wa(bf_n,"_castle_u_suw-ro") && s(1,bf_n-1) && wf(1,bf_n-1,"у") )
   { var_do_tn=1; Z[120]++; if(dbg){print "Z120"}; };
...
sz_iili(-2) &&
 ...
 if ( bfa(1,4,"_locklike_things") ) { bf_n=bfn;
    ...
    if ( q(1,"sz_iili") &&
       ...
       veq(bf_n,3) && s(0,2) ) {
            if ( vex(Y["tn_ok_v"]) && TN_v_zamok_f() )
            { Z[167]++; if(dbg){print "Z167"}; continue } else
    ...
    if ( z(0) && veq(bf_n,1) && !(isname(1) && bw(1,"люк")) ) {
       if ( vex(Y["tn_ok_v"]) && TN_v_zamok_f() )
       { Z[173]++; if(dbg){print "Z173"}; continue }
    else { l[i]=omo2; Z[174]++; if(dbg){print "Z174"}; continue };};
 };
...
sz_iili(1) &&
 ...
 if ( qb(-4,-1,"sz_iili") ) { qb_n=qbn;
   ...
   { qb_n=bb_n=""; Z[179]++; if(dbg){print "Z179"}; };
 ...
 if ( veq(Y["iwrd_case"],"tv") ) {
    ...
    { Z[191]++; if(dbg){print "Z191", "-- TN_pod_zamkom_f"}; continue};
 };
 # suw_ro escape:end

 if ( FN_zamok_suwro_f() )
 { Z[192]++; if(dbg){print "Z192", "-- FN_zamok_suwro_f"}; continue };
 ...
 if ( w(1,"из") ) { wf_n=1;
    ...
    { wf_n=""; Z[200]++; if(dbg){print "Z200"}; continue };
 ...
 if ( wf(1,6,"для") ) { wf_n=Y["n+_pre_dlya"]=wfn;
   if ( wfa(wf_n+1,wf_n+4,"_castle_suw-ro2") ) { bf_n=wfn;
    ...
    if ( vgl(wf_n,1,3) && vgl(bf_n,wf_n+1,wf_n+4) && s(0,bf_n-1) ) {
      ...
      { wf_n=bf_n=""; Z[205]++; if(dbg){print "Z205"}; };
      ...
      if ( vex(Y["tn_ok_v"]) && TN_v_zamok_f() )
      { Z[208]++; if(dbg){print "Z208", "-- TN_v_zamok_f"}; continue};
      if ( vex(Y["tn_ok_na"]) && TN_na_zamok_f() )
      { Z[209]++; if(dbg){print "Z209", "-- TN_na_zamok_f"}; continue};
      if ( vex(Y["tn_ok_pod"]) && TN_pod_zamok_f() )
      { Z[210]++; if(dbg){print "Z210", "-- TN_pod_zamok_f"}; continue};
 ...
 if ( wb(-5,-2,"для") ) { wb_n=Y["n-_pre_dlya"]=wbn;
   if ( wba(wb_n+1,-1,"_castle_suw-ro1") ) { bb_n=wbn;
    ...
    { l[i]=omo1; Z[213]++; if(dbg){print "Z213"}; continue }; #checkro2
...
#
 ...
 if ( vgl(Y["n_pre_na"],-8,-2) ) { wb_n=Y["n_pre_na"];
   if ( wfa(wb_n+1,-1,"_lock_na_suw-pr") ) { bf_n=wfn; qf_n=Y["n-_castle_pe"];
        ...
        { wb_n=bf_n=""; Z[273]++; if(dbg){print "Z273"}; };
 ...
 if ( w(1,"на") && wfa(2,5,"_lock_na_suw-pr") ) { wf_n=wfn; qb_n=Y["n-_castle_pe"]
        ...
        { Z[278]++; if(dbg){print "Z278"}; continue };
 ...
 if ( w(1,"на") ) {
   ...
   if ( bba(-5,-1,"_gl_4_lock_na_suw-vi") ) { bb_n=bbn;
     ...
     { l[i]=omo2; Z[297]++; if(dbg){print "Z297"}; continue };#uphere
   };};
 ...
 if ( wf(1,3,"с со") ) { wf_n=wfn;
     ...
     { Z[310]++; if(dbg){print "Z310", "-- TN_na_zamok_f"}; continue };
 ...
 { l[i]=omo1; Z[333]++; if(dbg){print "Z333"}; continue };
  ...
  ######################################################################################################
    ...
    { Z[334]++; if(dbg){print "Z334", "-- FN_castle_prl_f"}; continue };
    ...
    { Z[336]++; if(dbg){print "Z336", "-- FN_lock_prl_f(\"_lock_prl\")"}; continue };
 ...
 if( veq(Y["iwrd_case"],"iv") ) {
    ...
    { l[i]=omo1; Z[339]++; if(dbg){print "Z339"}; continue };b
    ...
    if ( qb(-5,-1,"sz_iili") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_castle_environs") ) { bb_n=bbn;
         ...
         { bb_n=qb_n=""; Z[356]++; if(dbg){print "Z356"}; };
    ...
    if ( bw(1,cst) &&
          w(2,"из") && s(0,1) )
    { l[i]=omo1; Z[368]++; if(dbg){print "Z368"}; stopp=ret=1; continue };
    if ( !vex(Y["tn_ok_v"]) && bw(1,cst) &&
            q(2,"nar_spos nar_kaq prl_kred_sr") && s(0,1) )
    { l[i]=omo1; Z[369]++; if(dbg){print "Z369"}; stopp=ret=1; continue };
    if ( bw(1,cst1) &&
         bf(2,5,cst) &&
    ...
    { l[i]=omo1; Z[372]++; if(dbg){print "Z372"}; stopp=ret=1; continue };
    # сложен
  ...
  if ( vgl(Y["n_pre_v"],-5,-1) ) {
    ...
    if ( TN_v_zamok_f() )
    { Z[388]++; if(dbg){print "Z388", "-- TN_v_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_na"],-5,-1) ) {
    ...
    if ( TN_na_zamok_f() )
    { Z[392]++; if(dbg){print "Z392", "-- TN_na_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_za"],-5,-1) ) {
    ...
    if ( TN_za_zamok_f() )
    { Z[403]++; if(dbg){print "Z403", "-- TN_za_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_pod"],-5,-1) ) {
    ...
    if ( TN_pod_zamok_f() )
    { Z[404]++; if(dbg){print "Z404", "-- TN_pod_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_o"],-5,-1) ) {
    ...
    if ( TN_o_zamok_f() )
    { Z[405]++; if(dbg){print "Z405", "-- TN_o_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_po"],-5,-1) ) {
    ...
    if ( TN_po_zamok_f() )
    { Z[406]++; if(dbg){print "Z406", "-- TN_po_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_qerez"],-5,-1) ) {
    ...
    if ( TN_qerez_zamok_f() )
    { Z[407]++; if(dbg){print "Z407", "-- TN_qerez_zamok_f"}; continue };
  ...
  if ( bf(1,3,cst1) ) { bf_n=bfn;
    ...
    if ( vgl(Y["n+_lock_pe"],1,6) ) { bf_n=Y["n+_lock_pe"];
       ...
       { l[i]=omo1; Z[561]++; if(dbg){print "Z561"}; continue }; # check4 mass errors
       if ( vgl(bf_n,1,6) &&
             bw(bf_n,cst) &&
              w(bf_n+1,"перед") &&
    ...
    if ( qb(-7,-2,"pre_da") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
        ...
        { l[i]=omo2; Z[573]++; if(dbg){print "Z573"}; continue }; #check
        if ( vgl(qb_n,-7,-2) && vgl(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
               w(1,"на") &&
             wfa(2,5,"_lock_na_suw-vi") && s(0,wfn-1) &&
             qir(2,wfn-1,"prl_vi mest_vi mest_3e prq_vi") )
        { l[i]=omo2; Z[574]++; if(dbg){print "Z574"}; continue }; #check
    ...
    if ( qb(-7,-2,"pre_vi") ) { qb_n=qbn;
      if ( bba(qb_n-7,qb_n-1,"_lock_pe") ) { bb_n=bbn;
       ...
       if ( vgl(qb_n,-7,-2) && vgl(bb_n,qb_n-7,qb_n-1) && s(bb_n,-1) &&
            vex(Y["tn_ok_vi"]) )
       { bb_n=qb_n=""; Z[585]++; if(dbg){print "Z585"}; };
       if ( vgl(qb_n,-7,-2) && vgl(bb_n,qb_n-7,qb_n-1) && s(bb_n,-1) &&
              w(qb_n,"в во") && qir(qb_n+1,-1,"isname") && ba(bb_n,"_gl_v_castle-iv") )
       { bb_n=qb_n=""; Z[586]++; if(dbg){print "Z586"}; };
    ...
    if ( vgl(Y["n-_castle_pe"],-7,-1) ) { bb_n=Y["n-_castle_pe"];
      ...
      if ( qb(-5,-1,"sz_iili") ) { qb_n=qbn;
        if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
         ...
         if ( vgl(Y["n+_lock_pe"],1,5) && s(0,Y["n+_lock_pe"]-1) )
         { bb_n=qb_n=""; Z[619]++; if(dbg){print "Z619"}; };
...
#      bfa(xwn-3,xwn-1,"_castle_pe") && s(bfn,-1) && Q(bfn,"suw_any") )
    ...
    if ( vgl(Y["n+_castle_pe"],1,6) ) { bf_n=Y["n+_castle_pe"]; bb_n=Y["n-_lock_pe"]; wf_n=Y["n-_gl_v_lock-iv"];
       ...
       { bf_n=bf_n+1; Z[648]++; if(dbg){print "Z648"}; };
       ...
       { l[i]=omo1; Z[665]++; if(dbg){print "Z665"}; continue };
         ...
         if ( vgl(bf_n,1,6) && s(0,bf_n-1) && veq(Y["iwrd_form"],"ediv") &&
          prq_any(bf_n) && !q(bf_n,"prq_edmuim prq_edmutv prq_kred_mu") &&
             !exb(-1,"тот ни другой ") )
         { bf_n=""; Z[666]++; if(dbg){print "Z666"}; };
         if ( vgl(bf_n,1,6) && s(0,bf_n-1) &&
               ba(-1,"_castle_prl_geo") && s(-1) )
         { bf_n=""; Z[667]++; if(dbg){print "Z667"}; };
...
#   cst1="быть ведь же стать считаться являться";
 ...
 #
    ...
    if ( TN_do_zamka_f() )
    { Z[695]++; if(dbg){print "Z695", "-- TN_do_zamka_f"}; continue };
 ...
 #
  #
    if ( TN_k_zamku_f() )
    { Z[703]++; if(dbg){print "Z703", "-- TN_k_zamku_f"}; continue };
 ...
 #
    ...
    if ( vex(Y["tn_ok_pod_tv"]) && TN_pod_zamkom_f() )
    { Z[709]++; if(dbg){print "Z709", "-- TN_pod_zamkom_f"}; continue};
 ...
 #
    ...
    { Z[715]++; if(dbg){print "Z715", "-- TN_v_zamke_f"}; continue};
 ...
 if ( bfa(1,5,"_lock_parts") ) { bf_n=bfn;
    ...
    { bf_n=""; Z[718]++; if(dbg){print "Z718"}; };
    if ( vgl(bf_n,1,5) && s(1,bf_n-1) && (s(0)||se(0," — ")) && bw(bf_n-1,"визитный") )
    { bf_n=""; Z[719]++; if(dbg){print "Z719"}; };
 ...
 { l[i]=omo2; Z[736]++; if(dbg){print "Z736"}; continue };
 ...
 { Z[745]++; if(dbg){print "Z745", "-- FN_castle_prl_after_f"}; continue };

 if ( FN_lock_prl_f("_lock_prl_after") )
 { Z[746]++; if(dbg){print "Z746", "-- FN_lock_prl_f(\"_lock_prl_after\")"}; continue };
 ...
 if ( isname(0) && s(-1) )
 { l[i]=omo1; Z[759]++; if(dbg){print "Z759", "-- is_CAP"}; continue };
...
function DEFINE_TN_OK_PREVI_ZAMOK(num,el,    fufu) { # определение компонентов между "pre_vi" и "замок"
    ...
    { tn = xsn; Z[771]++; if(dbg){print "Z771", "-- tn_ok MOV", el, "замок"};};
    # выключение tn_ok
    ...
    { tn_ok = ""; Z[772]++; if(dbg){print "Z772", "-- tn_ok OFF", el, "замок"};};
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) &&
         qxs(-1,"прошлый тот этот","раз") )
    { tn_ok = ""; Z[773]++; if(dbg){print "Z773", "-- tn_ok OFF", el, "замок"};};
}
...
function DEFINE_TN_OK_PREDA_ZAMKU(num,el,    fufu) { # определение компонентов между "pre_da" и "замку"
    ...
    if ( hwy(-1,"то") && qir(tn+1,-1-hyn,cst1) && s(tn,-1) )
    { tn_ok = 1; Z[774]++; if(dbg){print "Z774", "-- tn_ok ON", el, "замку"};};
    # передвижка tn_ok
    if ( vex(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"да","еще","и")||
         qxs(tn-1,"ведь даже же прямо сразу") ) )
    { tn = xsn; Z[775]++; if(dbg){print "Z775", "-- tn_ok MOV", el, "замку"};};
    # выключение tn_ok
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) && qf(tn+1,-1,"prq_edmuvi prq_mnvi") &&
         bam(qfn,"_castle_pe _lock_pe") &&
           q(1,"suw_edmuvi suw_mnvi suw_edne") && s(0) )
    { tn_ok = ""; Z[776]++; if(dbg){print "Z776", "-- tn_ok OFF", el, "замку"};};
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) &&
         qxs(-1,"прошлый тот этот","раз") )
    { tn_ok = ""; Z[777]++; if(dbg){print "Z777", "-- tn_ok OFF", el, "замку"};};
}
...
function DEFINE_TN_OK_PRETV_ZAMKOM(num,el,    fufu) { # определение компонентов между "pre_tv" и "замком"
    ...
    if ( hwy(-1,"то") && qir(tn+1,-1-hyn,cst1) && s(tn,-1) )
    { tn_ok = 1; Z[778]++; if(dbg){print "Z778", "-- tn_ok ON", el, "замком"};};
    # передвижка tn_ok
    if ( vex(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"да","еще","и")||
         qxs(tn-1,"ведь даже же прямо сразу") ) )
    { tn = xsn; Z[779]++; if(dbg){print "Z779", "-- tn_ok MOV", el, "замком"};};
    # выключение tn_ok
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) && qf(tn+1,-1,"prq_edmuvi prq_mnvi") &&
         bam(qfn,"_castle_pe _lock_pe") &&
           q(1,"suw_edmuvi suw_mnvi suw_edne") && s(0) )
    { tn_ok = ""; Z[780]++; if(dbg){print "Z780", "-- tn_ok OFF", el, "замком"};};
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) &&
         qxs(-1,"прошлый тот этот","раз") )
    { tn_ok = ""; Z[781]++; if(dbg){print "Z781", "-- tn_ok OFF", el, "замком"};};
}
...
function DEFINE_TN_OK_PREPR_ZAMKE(num,el) { # определение компонентов между "pre_pr" и "замке"
    ...
    if ( hwy(-1,"то") && qir(tn+1,-1-hyn,cst1) && s(tn,-1) )
    { tn_ok = 1; Z[782]++; if(dbg){print "Z782", "-- tn_ok ON", el, "замке"};};
    cst="именно собственно";
    if ( !vex(tn_ok) && s(tn,-1) && qiw(tn+1,-1,cst1,cst) )
    { tn_ok = 1; Z[783]++; if(dbg){print "Z783", "-- tn_ok ON", el, "замке"};};
    if ( !vex(tn_ok) && s(-4) && zs(-3) && s(-2,-1) && veq(tn,-4) &&
            q(-3,cst2) && q(-2,"nar_any prl_kred_sr") && q(-1,cst2) )
    ...
    if ( vex(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"да","еще","и")||
         qxs(tn-1,"ведь даже же прямо сразу") ) )
    { tn = xsn; Z[788]++; if(dbg){print "Z788", "-- tn_ok MOV", el, "замке"};};
}
...
#   if ( bba(tn-9,tn-1,"_gl_v_lock-iv")   ) { Y["n-_gl_v_lock-iv"]   = bbn };
    ...
    cst="угодить";
    cst1="шея голова рука нога голова локоть пуля";
    if ( bb(tn-4,tn-1,cst) &&
    ...
    { l[i]=omo2; Z[816]++; if(dbg){print "Z816"}; stopp=ret=1; continue }; #edit
    if ( bb(tn-9,tn-3,cst) &&
          w(bbn+1,cst1) &&
          q(bbn+2,"pre_tv") &&
        qir(tn+3,tn-1,"suw_tv prl_tv mest_tv prq_tv isname qast nar_any") && s(bbn,tn-2) && zs(tn-1) )
    { l[i]=omo2; Z[817]++; if(dbg){print "Z817"}; stopp=ret=1; continue }; #edit
    ...
    if ( vgl(Y["n-_gl_v_lock-iv"],tn-9,tn-1) ) { bb_n=Y["n-_gl_v_lock-iv"];
       ...
       if ( vgl(bb_n,tn-6,tn-3) && s(bb_n,tn-3) &&
            qir(bb_n+1,tn-3,"prl_vi prq_vi mcop_vi qik_vi qis_vi prl_kred_sr nar_any isname qast_any") &&
              ...
              q(tn-1,"sz") )
       { l[i]=omo2; Z[860]++; if(dbg){print "Z860"}; stopp=ret=1; continue }; #check
       ...
       { l[i]=omo2; Z[862]++; if(dbg){print "Z862"}; stopp=ret=1; continue }; #inspect
       if ( vgl(bb_n,tn-6,tn-2) &&
       ...
       { l[i]=omo2; Z[868]++; if(dbg){print "Z868"}; stopp=ret=1; continue }; #inspect
       if ( veq(bb_n,tn-2) &&
    ...
    if ( qb(tn-8,tn-2,"pre_vi") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_gl_v_lock-iv") ) { bb_n=bbn;
       ...
       { qb_n=bb_n=""; l[i]=omo2; Z[875]++; if(dbg){print "Z875"}; };
    ...
    { l[i]=omo2; Z[911]++; if(dbg){print "Z911"}; stopp=ret=1; continue }; #check
    if ( bf(1,3,cst) &&
        bf_(bfn+1,bfn+3,cst1) && s(1,bf2-1) &&
        qir(1,bfn-1,"nar_any") &&
        qir(bfn+1,bf2-1,"prl_vi mcop_vi prq_vi prl_im mcop_im prq_im") )
    { l[i]=omo2; Z[912]++; if(dbg){print "Z912"}; stopp=ret=1; continue }; #check
    if ( bf(1,3,cst1) &&
        qir(1,bfn-1,"prl_vi mcop_vi prq_vi prl_im mcop_im prq_im") &&
         bw(bfn+1,cst) && s(tn,bfn-1) )
    { l[i]=omo2; Z[913]++; if(dbg){print "Z913"}; stopp=ret=1; continue }; #check
    if ( wf(1,5,cst2) &&
    ...
    if ( vgl(Y["n-_gl_v_castle-iv"],tn-8,tn-1) ) { bb_n = Y["n-_gl_v_castle-iv"];
       ...
       { l[i]=omo1; Z[949]++; if(dbg){print "Z949"}; stopp=ret=1; continue }; #check
       if ( vgl(bb_n,tn-5,tn-2) &&
              q(bb_n+1,"prq_vi suw_vi mest_vi mest_3e") &&
            qir(bb_n+2,tn-1,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") && s(bb_n,tn-2) && zs(tn-1) )
       { l[i]=omo1; Z[950]++; if(dbg){print "Z950"}; stopp=ret=1; continue }; #check
       if ( vgl(bb_n,tn-6,tn-2) &&
    ...
    if ( bfa(1,6,"_gl_v_castle-iv") ) { bf_n=bfn;
       ...
       { bf_n=""; Z[1004]++; if(dbg){print "Z1004"}; };
   ...
   if ( vex(Y["tn_ok_na"]) ) { tn=Y["n_pre_na"];
    ...
    if ( bb(tn-6,tn-2,cst) && s(bbn,tn-1) &&
        qir(bbn+1,tn-2,"prl_vi mest_vi") &&
          w(tn-1,cst1) )
    { l[i]=omo1; Z[1026]++; if(dbg){print "Z1026"}; stopp=ret=1; continue };
    ...
    { l[i]=omo1; Z[1055]++; if(dbg){print "Z1055", bfn}; stopp=ret=1; continue };
    # _gl_na_castle:end
...
#   cst_muvi="prl_edmuvi prl_mnvi mcop_edmuvi mcop_mnvi qis_vi qik_vi prq_edmuvi prq_mnvi qast_any mest_3e nar_kaq nar_step";
    ...
    if ( hwy(-1,"то") && qir(tn+1,-1-hyn,cst1) && s(tn,-1) )
    { tn_ok = 1; Z[1169]++; if(dbg){print "Z1169", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) && wy(-1,"же") &&
#         qir(tn+2,-1-wyn,"mest_da suw_da prq_da nar_any prl_da") )
#   { tn_ok = 1; Z[1170]++; if(dbg){print "Z1170", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#         qir(tn+2,-2,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
#           q(-1,"suw_tv mest_tv") )
#   { tn_ok = 1; Z[1171]++; if(dbg){print "Z1171", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#         qir(tn+2,-3,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
#           q(-2,"suw_tv qik_tv") &&
...
#   { tn_ok = 1; Z[1174]++; if(dbg){print "Z1174", "-- tn_ok ON", el, "замка"};};
    ...
    if ( vex(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"да","еще","и")||
         qxs(tn-1,"ведь даже же прямо сразу") ) )
    { tn = xsn; Z[1180]++; if(dbg){print "Z1180", "-- tn_ok MOV", el, "замка"};};
    # выключение tn_ok
#   if ( vex(tn_ok) && s(tn,-1) && qf(tn+1,-1,"prq_edmuvi prq_mnvi") &&
#        bam(qfn,"_castle_pe _lock_pe") &&
#          q(1,"suw_edmuvi suw_mnvi suw_edne") && s(0) )
#   { tn_ok = ""; Z[1181]++; if(dbg){print "Z1181", "-- tn_ok OFF", el, "замка"};};
#   if ( vex(tn_ok) && s(tn,-1) &&
#        qxs(-1,"прошлый тот этот","раз") )
#   { tn_ok = ""; Z[1182]++; if(dbg){print "Z1182", "-- tn_ok OFF", el, "замка"};};
}
...
#   };
    if ( bba(tn-5,tn-1,"_gl_do_castle-ro") ) { bb_n=bbn;
       ...
       if ( vgl(bb_n,tn-5,tn-1) && s(bb_n,-1) &&
            qiz(bb_n+1,tn-1,"prl_ro mest_ro mest_3e","suw_ro suw_edne") )
       { l[i]=omo1; Z[1185]++; if(dbg){print "Z1185"}; stopp=ret=1; continue };
...
#   if ( vex(Y["tn_ok_na"]) && TN_na_zamok_f() )
#   { Z[1199]++; if(dbg){print "Z1199"}; stopp=ret=1; continue };
    if ( iwrd == "замок") {
          ...
          if ( bf(1,3,cst1) ) { wf_n=bfn;
             if ( bfa(wf_n+1,wf_n+5,str_castle) ) { bf_n=bfn;
                if ( vgl(Y["n+_lock_pe"],wf_n+1,bf_n-1) ||
                     ...
                     vex(Y["tn_ok_vi"]) )
                { wf_n=bf_n=""; Z[1206]++; if(dbg){print "Z1206"}; };
                if ( s(bf_n,bf_n+1) && sz_iili(bf_n+1) && ba(bf_n+2,"_lock_prl") )
                { wf_n=bf_n=""; Z[1207]++; if(dbg){print "Z1207"}; };
          ...
          if ( bf(1,3,cst1) ) { wf_n=bfn;
             if ( bfa(wf_n+1,wf_n+5,str_castle) ) { bf_n=bfn;
               if ( vgl(Y["n+_lock_pe"],wf_n+1,bf_n-1) ||
                    bfa(wf_n+1,bf_n-1,"_lock_prl") ||
                    vex(Y["tn_ok_vi"]) )
                { wf_n=bf_n=""; Z[1212]++; if(dbg){print "Z1212"}; };
...
function FN_lock_prl_f(str_lock,    ret, stopp, bb_n,bf_n,qb_n,qf_n,wb_n,wf_n) { stopp_str="FN" str_lock "_f"; stopp=v2s(Y[stopp_str]);
  while ( !stopp ) {
    ...
    { Z[1237]++; if(dbg){print "Z1237", "-- _castle_prl_geo -- break"}; stopp=1; ret=0; continue };

    cst="вернуться";
    if ( vex(Y["tn_ok_v"]) && vex(Y["n-_gl_v_castle-iv"]) && bw(Y["n-_gl_v_castle-iv"],cst) && TN_v_zamok_f() )
    { Z[1238]++; if(dbg){print "Z1238", "-- TN_v_zamok_f"}; stopp=ret=1; continue };
    if ( vex(Y["tn_ok_v"]) && vgl(Y["n-_suw_v_castle-vp"],Y["n_pre_v_ist"]-3,Y["n_pre_v_ist"]-1) && TN_v_zamok_f() )
    { Z[1239]++; if(dbg){print "Z1239", "-- TN_v_zamok_f"}; stopp=ret=1; continue };
    # _lock_prl:escape
    ...
    # _lock_prl:start
       ...
       if ( iwrd == "замок") {
          ...
          { l[i]=omo2; Z[1240]++; if(dbg){print "Z1240"}; stopp=ret=1; continue };
          ...
          { l[i]=omo2; Z[1241]++; if(dbg){print "Z1241"}; stopp=ret=1; continue }; #uphere
          if ( z(-3) && s(-2,-1) && qm(-3,"prl_edmuim",str_lock) && q(-2,"prl_edmuim prl_kred_sr nar_any sz_i") && q(-1,"prl_edmuim") )
          { l[i]=omo2; Z[1242]++; if(dbg){print "Z1242"}; stopp=ret=1; continue };
          ...
          { l[i]=omo2; Z[1244]++; if(dbg){print "Z1244"}; stopp=ret=1; continue };
...
function FN_zamok_suwro_f(    ret, stopp_str, stopp, bb_n,bf_n,qb_n,qf_n,wb_n,wf_n) { stopp=v2s(Y["FN_zamok_suwro_f"]);
 ...
 if ( wfa(1,5,"_castle_suw-ro") ) { wf_n=wfn;
    ...
    { wf_n=""; Z[1278]++; if(dbg){print "Z1278"}; };
    cst3="ломать щелкнуть";
    if ( vgl(wf_n,1,5) && s(-1,wf_n-1) && bw(-1,cst3) )
    { wf_n=""; Z[1279]++; if(dbg){print "Z1279"}; };

    if ( vgl(wf_n,1,5) && s(0,wf_n-1) &&
         qir(1,wf_n-1,"prl_ro mest_ro prq_ro prl_kred_sr nar_step qip_ro qik_im") )
    { l[i]=omo1; Z[1280]++; if(dbg){print "Z1280"}; stopp=ret=1; continue }; #check_!под
 };
 # _castle_suw-ro:end
...
function FN_zamok_vi_esc_f(    ret, stopp_str, stopp, bb_n,bf_n,qb_n,qf_n,wb_n,wf_n) { stopp=v2s(Y["FN_zamok_esc_f"]);
  while ( !stopp ) {
   ...
   { l[i]=omo1; Z[410]++; if(dbg){print "Z410"}; stopp=ret=1; continue };
   ...
   if ( bb(-4,-1,cst) ) { bb_n=bbn;
     ...
     { l[i]=omo1; Z[410]++; if(dbg){print "Z409"}; stopp=ret=1; continue };
