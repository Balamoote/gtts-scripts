...
sz_iili(-3) &&
 ...
 if ( ba(1,"_gl_4_castle_na_suw_pr") && (s(0)||sc(0,",")) &&
       w(2,"на") &&
...
#   { l[i]=omo2; Z[207]++; if(dbg){print "Z207"}; continue };
    ...
    # _v_lock_parts:sart - части замка́ escape1
    ...
    if ( base(-4,cst) &&
            ...
            w(-1,"в") && s(-4,-3) && (s(-2)||sc(-2,",")) && s(-1) && sc(0,",") &&
           ba(1,"_lock_pe") &&
           ba(2,"_v_lock_parts") && s(1) )
