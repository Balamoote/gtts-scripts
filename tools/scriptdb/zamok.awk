...
#{ print l[i+2] >> "_ss_tv.txt"; Z[4]++; if(dbg){print "Z4"}; }; continue
#if ( w(1,"между") &&
#     q(2,"prl_tv prq_tv mest_tv mest_3e") &&
#     q(3,"suw_tv") && s(0,2) && Q(3,"prl_tv")  )
#{ print l[i+3] >> "_ss_tv.txt"; Z[5]++; if(dbg){print "Z5"}; }; continue
#if ( w(1,"между") &&
#     q(2,"prl_tv prq_tv mest_tv mest_3e") &&
#     q(3,"prl_tv prq_tv mest_tv mest_3e") &&
#     q(4,"suw_tv") && s(0,3) && Q(4,"prl_tv")  )
#{ print l[i+4] >> "_ss_tv.txt"; Z[6]++; if(dbg){print "Z6"}; }; continue
#{ print l[i+1] >> "_sw.txt"; Z[7]++; if(dbg){print "Z7"}; }; continue

#getBFx(-3,3,"_an.txt"); Z[8]++; if(dbg){print "Z8"}; continue
...
#{ l[i]=omo1; Z[17]++; if(dbg){print "Z17"}; continue };
 ...
 if ( w(1,"у") && Ww_(-1,"в") &&
      ...
      w(3,"на") &&
    bfa(4,6,"_lock_na_item") && s(0,bfn-1) && Qf(4,bfn-1,"sz_iili pre_any") )
 { l[i]=omo2; Z[23]++; if(dbg){print "Z23"}; continue };
 cst="быть находиться стоять";
 if ( base(1,cst) &&
         w(2,"на") && Ww_(-1,"в") &&
       bfa(3,6,"_lock_na_item") && s(0,bfn-1) && Qf(3,bfn-1,"sz_iili pre_any") )
...
sz_iili(-3) &&
 ...
 { l[i]=omo1; Z[212]++; if(dbg){print "Z212",qfn}; continue };
 if ( w(-2,"с со") &&
 ...
 { l[i]=omo1; Z[214]++; if(dbg){print "Z214",qfn}; continue };
 if ( w(-2,"с со") &&
 ...
 if(iwrd=="замок" || iwrd=="замки") {
  ...
  if ( wb(-4,-1,"в во") && s(wbn,-1) ) {
    ...
    if ( qxs(-1,"по","возвращению приезду","в") )
...
#   { l[i]=omo2; Z[278]++; if(dbg){print "Z278"}; continue };
    ...
    if ( base(-6,cst) &&
           ...
           ba(-3,"_suw_v_lock") &&
            w(-2,"в") &&
            q(-1,"prl_vi mest_vi mest_3e prq_vi") && s(-6,-1) )
    ...
    #
    if ( bb(-6,-3,"попасть попадать") && qif(bbn+1,-3,"qast nar_any") &&
        (ba(-2,"_lock_parts")||w(-2,"им")) &&
          w(-1,"в") && s(bbn,-1) )
    { l[i]=omo2; Z[388]++; if(dbg){print "Z388"}; continue };
    if ( bb(-7,-4,"попасть попадать") && qif(bbn+1,-4,"qast nar_any") &&
         ba(-3,"_lock_parts") &&
          q(-2,"suw_ro") &&
          w(-1,"в") && s(bbn,-1) )
    ...
    if ( base(-4,cst) &&
            q(-3,"nar_any mest_vi mest_3e suw_vi") &&
            w(-2,cst1) &&
            w(-1,"в") && s(-4,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo2; Z[391]++; if(dbg){print "Z391"}; continue };
    if ( base(-5,cst) &&
            q(-4,"nar_any mest_vi mest_3e suw_vi") &&
            q(-3,"prl_tv mest_tv mest_3e prq_tv") &&
            w(-2,cst1) &&
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi") &&
          q(-3,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") &&
          q(-2,"nar_any") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[399]++; if(dbg){print "Z399"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi") &&
          q(-4,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi") &&
          q(-3,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") &&
          q(-2,"nar_any") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( (ba(-5,"_gl_v_castle_main") || (ba(-6,"_gl_v_castle_main") && se(-6,"-") && w(-5,"ка")) ) &&
           q(-4,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi nar_spos nar_step qast") &&
           q(-3,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi") &&
           q(-2,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") &&
           w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[402]++; if(dbg){print "Z402"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi nar_spos nar_step") &&
          q(-4,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi nar_spos nar_step") &&
          q(-3,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi") &&
          q(-2,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") &&
          w(-1,"в") && s(-6,-1) )
    { l[i]=omo1; Z[403]++; if(dbg){print "Z403"}; continue };
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi nar_spos nar_step") &&
          q(-5,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi nar_spos nar_step") &&
          q(-4,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi nar_spos nar_step") &&
          q(-3,"prl_vi mest_vi mest_3e prq_vi qik_vi qis_vi") &&
          q(-2,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") &&
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"prl_vi mest_vi mest_3e prq_vi qik_vi") &&
          q(-4,"suw_vi mest_vi mest_3e") &&
          q(-3,"prl_kred_sr nar_any qast") &&
          q(-2,"prl_kred_sr nar_any qast") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_vi suw_edne suw_tv prl_vi prq_vi mest_vi mest_3e isname") &&
          q(-2,"isname suw_odvi suw_da mest_da") &&
          w(-1,"в") && s(-4,-1) )
    { l[i]=omo1; Z[413]++; if(dbg){print "Z413"}; continue };
    if ( ba(-3,"_gl_v_castle_main") &&
          q(-2,"suw_vi suw_im suw_ro suw_tv suw_edne mest_vi prq_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname prq_tv qis_vi qik_vi") &&
          w(-1,"в") && s(-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[414]++; if(dbg){print "Z414"}; continue };
    if ( q(-2,"mwqast") &&
        ba(xwn-1,"_gl_v_castle_main") &&
         w(-1,"в") && s(xwn-1) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[415]++; if(dbg){print "Z415"}; continue };
#   if ( q(-2,"mdqast")  )
#   { l[i]=omo1; Z[416]++; if(dbg){print "Z416", l[i-2]}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"prl_vi prl_im mest_vi mest_im prq_vi suw_vi suw_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          q(-2,"suw_vi suw_im mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||z(-2)) && s(-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"prl_vi prl_im mest_vi mest_im prq_vi suw_vi suw_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          q(-3,"suw_vi suw_im mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          q(-2,"nar_any") &&
          w(-1,"в") && s(-5,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[419]++; if(dbg){print "Z419"}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_vi suw_edne") &&
          q(-2,"suw_ro prq_ro suw_edne isname") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[420]++; if(dbg){print "Z420"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"prl_im mest_im mest_im prq_im suw_im suw_edne isname") &&
          q(-3,"suw_im suw_edne isname") &&
          q(-2,"suw_im suw_edne isname") &&
          w(-1,"в") && s(-5,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[421]++; if(dbg){print "Z421"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"suw_vi suw_im prl_vi prl_im mest_vi mest_im mest_3e name_vi_sy isname") &&
          q(-3,"nar_any qast") &&
          q(-2,"nar_any suw_ro") &&
          w(-1,"в") && s(-5,-3) && (s(-2)||z(-2)) && s(-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"prl_ro mest_ro mest_3e gl_in prl_kred_sr nar_any qast name_ro_sy isname") &&
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"prl_tv mest_tv mest_3e gl_in prl_kred_sr nar_any qast name_tv_sy isname") &&
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"suw_vi mest_vi mest_3e name_vi_sy isname") &&
          q(-3,"prl_tv mest_tv mest_3e gl_in prl_kred_sr nar_any qast name_tv_sy isname") &&
          q(-2,"suw_tv mest_tv suw_edne mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          w(-1,"в") && s(-5,-3) && (s(-2)||z(-2)) && s(-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_vi suw_im mest_vi mest_im mest_3e isname") &&
          q(-2,"prl_tv prq_tv") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||z(-2)) && s(-1) )
    ...
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"gl_in") &&
          q(-5,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-4,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname qis_vi") &&
          q(-3,"sz_iili") &&
          q(-2,"suw_vi suw_im mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          w(-1,"в") && s(-7,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[439]++; if(dbg){print "Z439"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname prq_vi") &&
          q(-4,"sz_iili") &&
          q(-3,"prl_vi prq_vi mest_vi mest_3e qik_vi") &&
          q(-2,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname qis_vi") &&
          w(-1,"в") && s(-6,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[440]++; if(dbg){print "Z440"}; continue };
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname") &&
          q(-5,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname") &&
          q(-4,"sz_iili") &&
          q(-3,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname") &&
          q(-2,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname") &&
          w(-1,"в") && s(-7,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[441]++; if(dbg){print "Z441"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname prq_vi") &&
          q(-4,"sz_iili") &&
          q(-3,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname") &&
          q(-2,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname suw_ro") &&
          w(-1,"в") && s(-6,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[442]++; if(dbg){print "Z442"}; continue };
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname prq_vi") &&
          q(-5,"sz_iili") &&
          q(-4,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname") &&
          q(-3,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e isname suw_ro") &&
          q(-2,"nar_any") &&
          w(-1,"в") && s(-7,-3) && (s(-2)||z(-2)) && s(-1) )
    { l[i]=omo1; Z[443]++; if(dbg){print "Z443"}; continue };
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-5,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          q(-4,"sz_iili") &&
          q(-3,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-2,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname qis_vi") &&
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          ...
          q(-2,"suw_ro suw_mnsq prl_kred_sr isname") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[452]++; if(dbg){print "Z452"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"suw_vi suw_edne mest_vi mest_3e") &&
          q(-3,"prl_da prq_da mest_da mest_3e") &&
          q(-2,"suw_da isname") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[453]++; if(dbg){print "Z453"}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_vi suw_edne mest_vi mest_3e") &&
          q(-2,"suw_da isname") &&
          w(-1,"в") && s(-4,-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"nar_vrem prl_kred_sr qast mest_vi suw_vi mest_3e suw_im mest_im isname") &&
     pre_da(-3) &&
          q(-2,"suw_da mest_da isname") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[459]++; if(dbg){print "Z459"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"suw_im mest_im isname") &&
          q(-4,"nar_vrem prl_kred_sr qast mest_vi suw_vi mest_3e isname") &&
     pre_da(-3) &&
          q(-2,"suw_da mest_da") &&
          w(-1,"в") && s(-6,-1) )
    { l[i]=omo1; Z[460]++; if(dbg){print "Z460"}; continue };
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"nar_vrem prl_kred_sr qast mest_vi suw_vi mest_3e isname") &&
     pre_vi(-5) &&
          q(-4,"mest_vi suw_vi suw_edne") &&
     pre_da(-3) &&
          q(-2,"suw_da mest_da") &&
          w(-1,"в") && s(-7,-1) )
    { l[i]=omo1; Z[461]++; if(dbg){print "Z461"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"nar_vrem prl_kred_sr qast mest_vi mest_3e isname") &&
    ...
    if ( ba(-7,"_gl_v_castle_main") &&
     pre_da(-6) &&
          q(-5,"prl_da mest_da mest_3e prq_da prl_kred_sr nar_any") &&
          q(-4,"prl_da mest_da mest_3e prq_da") &&
          q(-3,"suw_da suw_edne isname") &&
          q(-2,"nar_napr") &&
          w(-1,"в") && s(-7,-1) )
    { l[i]=omo1; Z[466]++; if(dbg){print "Z466"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
     pre_da(-4) &&
          q(-3,"prl_da mest_da mest_3e prq_da") &&
          q(-2,"suw_da suw_edne isname") &&
          w(-1,"в") && s(-5,-1) )
    ...
    if ( (ba(-4,"_gl_v_castle_main") || (ba(-5,"_gl_v_castle_main") && se(-5,"-") && w(-4,"ка")) ) &&
      pre_tv(-3) &&
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
     pre_tv(-5) &&
          q(-4,"prl_tv mest_tv qik_tv mest_3e") &&
          q(-3,"prl_tv mest_tv qik_tv mest_3e") &&
          q(-2,"mest_tv suw_tv suw_edne isname") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-7,"_gl_v_castle_main") &&
     pre_tv(-6) &&
          q(-5,"prl_tv mest_tv mest_3e prq_tv qik_tv") &&
          q(-4,"mest_tv suw_tv suw_edne isname") &&
    sz_iili(-3) &&
          q(-2,"mest_tv suw_tv suw_edne isname") &&
          w(-1,"в") && s(-7,-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"mest_vi suw_vi mest_da suw_da mest_3e qis_vi nar_any prl_kred_sr isname") &&
     pre_tv(-3) &&
          q(-2,"mest_tv suw_tv suw_edne isname prq_tv") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[493]++; if(dbg){print "Z493"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"mest_vi suw_vi mest_da suw_da mest_3e qis_vi nar_any prl_kred_sr isname") &&
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-4,"mest_vi suw_vi mest_3e qis_vi isname") &&
     pre_tv(-3) &&
          q(-2,"mest_tv suw_tv suw_edne isname") &&
          w(-1,"в") && s(-6,-1) )
    { l[i]=omo1; Z[495]++; if(dbg){print "Z495"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"mest_vi suw_vi mest_da suw_da mest_3e nar_any prl_kred_sr isname") &&
     pre_tv(-4) &&
          q(-3,"prl_tv mest_tv mest_3e prq_tv qik_tv") &&
          q(-2,"suw_tv suw_edne isname") &&
          w(-1,"в") && s(-6,-1) )
    { l[i]=omo1; Z[496]++; if(dbg){print "Z496"}; continue };
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"mest_vi suw_vi mest_da suw_da mest_3e nar_any prl_kred_sr isname") &&
     pre_tv(-5) &&
          q(-4,"prl_tv mest_tv mest_3e prq_tv qik_tv") &&
          q(-3,"suw_tv suw_edne isname") &&
          q(-2,"nar_any prl_kred_sr") &&
          w(-1,"в") && s(-7,-1) )
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"mest_vi suw_vi nar_any prl_kred_sr isname") &&
     pre_tv(-4) &&
          q(-3,"mest_tv suw_tv mest_3e suw_edne isname") &&
          q(-2,"mest_tv suw_tv suw_edne isname") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"mest_vi suw_vi nar_any prl_kred_sr isname") &&
     pre_tv(-5) &&
          q(-4,"mest_tv suw_tv suw_edne isname") &&
     pre_da(-3) &&
          q(-2,"suw_da mest_da isname") &&
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
     pre_ro(-5) &&
          q(-4,"mest_ro suw_ro suw_edne isname") &&
     pre_da(-3) &&
          q(-2,"suw_da mest_da isname") &&
          w(-1,"в") && s(-6,-1) )
    { l[i]=omo1; Z[502]++; if(dbg){print "Z502"}; continue };
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"mest_vi suw_vi isname mest_3e") &&
     pre_ro(-5) &&
          q(-4,"mest_ro suw_ro suw_edne isname") &&
     pre_da(-3) &&
          q(-2,"suw_da mest_da isname") &&
    ...
    if ( ba(-7,"_gl_v_castle_main") &&
     pre_ro(-6) &&
          q(-5,"prl_ro mest_ro mest_3e prq_ro") &&
          q(-4,"mest_ro suw_ro suw_edne isname") &&
     pre_da(-3) &&
          q(-2,"suw_da mest_da isname") &&
          w(-1,"в") && s(-7,-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
     pre_vi(-3) &&
          q(-2,"mest_vi suw_vi suw_edne isname suw_odim") &&
          w(-1,"в") && s(-4,-1) )
    { l[i]=omo1; Z[511]++; if(dbg){print "Z511"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"nar_any suw_im isname") &&
     pre_vi(-3) &&
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
     pre_vi(-4) &&
          q(-3,"mest_vi suw_vi suw_edne qik_vi") &&
          q(-2,"suw_ro suw_edne") &&
          w(-1,"в") && s(-5,-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
     pre_vi(-4) &&
          q(-3,"prl_vi mest_vi mest_3e prq_vi nar_step") &&
          q(-2,"mest_vi suw_vi suw_edne") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[521]++; if(dbg){print "Z521"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"mest_vi suw_vi mest_3e suw_edne") &&
     pre_vi(-4) &&
          q(-3,"prl_vi mest_vi mest_3e prq_vi") &&
          q(-2,"mest_vi suw_vi suw_edne") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-7,"_gl_v_castle_main") &&
          q(-6,"mest_vi suw_vi suw_edne suw_da mest_da mest_3e") &&
     pre_vi(-5) &&
          q(-4,"mest_vi suw_vi suw_edne") &&
    sz_iili(-3) &&
          q(-2,"mest_vi suw_vi suw_edne") &&
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"suw_vi suw_edne") &&
          q(-4,"mest_ro suw_ro suw_edne") &&
     pre_vi(-3) &&
          q(-2,"mest_vi suw_vi suw_edne") &&
          w(-1,"в") && s(-6,-1) )
    { l[i]=omo1; Z[525]++; if(dbg){print "Z525"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"prl_vi mest_vi mest_3e prq_vi") &&
          q(-4,"prl_vi prq_vi suw_vi suw_edne") &&
     pre_vi(-3) &&
          q(-2,"mest_vi suw_vi suw_edne") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
     pre_pr(-4) &&
          q(-3,"prl_pr mest_pr mest_3e prq_pr") &&
          q(-2,"suw_pr suw_edne") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[530]++; if(dbg){print "Z530"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
     pre_pr(-5) &&
          q(-4,"prl_pr mest_pr mest_3e prq_pr") &&
          q(-3,"suw_pr suw_edne") &&
          q(-2,"nar_any") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
     pre_ro(-3) &&
          q(-2,"mest_ro suw_ro suw_edne isname") &&
          w(-1,"в") && s(-4,-1) )
    { l[i]=omo1; Z[532]++; if(dbg){print "Z532"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
     pre_ro(-4) &&
          q(-3,"mest_ro suw_ro suw_edne") &&
          q(-2,"nar_any") &&
          w(-1,"в") && s(-5,-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
     pre_ro(-4) &&
          q(-3,"prl_ro mest_ro suw_ro suw_edne prq_ro") &&
          q(-2,"mest_ro suw_ro suw_edne") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[535]++; if(dbg){print "Z535"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
     pre_ro(-5) &&
          q(-4,"prl_ro mest_ro suw_ro suw_edne prq_ro") &&
          q(-3,"mest_ro suw_ro suw_edne isname") &&
          q(-2,"mest_ro suw_ro suw_edne isname") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-7,"_gl_v_castle_main") &&
     pre_ro(-6) &&
          q(-5,"prl_ro mest_ro suw_ro suw_edne prq_ro") &&
          q(-4,"suw_ro suw_edne") &&
          q(-3,"prl_ro mest_ro suw_ro suw_edne prq_ro") &&
          q(-2,"suw_ro suw_edne") &&
          w(-1,"в") && s(-7,-1) )
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"mest_vi suw_vi isname") &&
     pre_ro(-4) &&
          q(-3,"mest_ro suw_ro suw_edne") &&
          q(-2,"nar_any suw_im isname") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"mest_da suw_da suw_edne") &&
          q(-2,"suw_vi suw_edne mest_vi mest_3e nar_napr") &&
          w(-1,"в") && s(-4,-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"prl_im prq_im mest_im") &&
    sz_iili(-3) &&
          q(-2,"prl_im prq_im mest_im") &&
          w(-1,"в") && s(-5,-1) )
    { l[i]=omo1; Z[551]++; if(dbg){print "Z551"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"prl_im prq_im mest_im") &&
    sz_iili(-4) &&
          q(-3,"nar_any prl_srav") &&
          q(-2,"prl_im prq_im mest_im") &&
          w(-1,"в") && s(-6,-1) )
    ...
    if ( narph_any(-3) &&
                ba(xwn-1,"_gl_v_castle_main") &&
                 q(-2,"suw_vi suw_im mest_vi mest_im mest_3e isname nar_any") &&
                 w(-1,"в") && s(xnw-1,-1) )
    { l[i]=omo1; Z[564]++; if(dbg){print "Z564"}; continue };
    if ( narph_any(-2) &&
                ba(xwn-2,"_gl_v_castle_main") &&
    ...
    if ( w(-4,"из") &&
        (w(-3,cst)||q(-3,"isname")) &&
         q(-2,"nar_any") &&
         w(-1,"в") && s(-4,-1) && !(bb(-8,-5,"выстрелить выпалить прицелиться") && s(bbn,-5)) )
...
#   { l[i]=omo2; Z[665]++; if(dbg){print "Z665"}; continue };
   ...
   sz_iili(2) &&
    ...
    if ( base(-2,cst) &&
        ...
        ( qxs(1,"из","его ее её их ваших цепких","лап рук")||
          qxs(1,"из","лап рук") ) )
    { l[i]=omo1; Z[805]++; if(dbg){print "Z805"}; continue };
    ...
    if ( z(0) &&
         q(1,"otnsz_mu") &&
       bfa(2,4,"_castle_pe") && s(1,bfn-1) && !(ba(bfn,"_castle_pe_notrh")) && Qf(2,bfn-1,"sz_iili pre_any") )
 ...
 #
    ...
    if ( prl_da(-1) &&
             ba(-1,"_castle_prl_geo") && s(-1)  )
    { l[i]=omo1; Z[897]++; if(dbg){print "Z897"}; continue };
    if ( prl_da(-2) &&
             ba(-2,"_castle_prl_geo") &&
              Q(-1,"suw_any") && s(-2,-1)  )
 ...
 #
    ...
    if ( ba(-3,"_lock_prl") && prl_tv(-3) &&
          q(-2,"prl_any prq_any mest_any qast") && W(-2,"как") &&
          q(-1,"prl_any prq_any mest_any qast") && s(-3,-1)  )
    { l[i]=omo2; Z[906]++; if(dbg){print "Z906"}; continue };
 ...
 #
    ...
    # _lock_prl:start
    if ( ba(-1,"_lock_prl") && s(-1) && prl_da(-1) )
    { l[i]=omo2; Z[915]++; if(dbg){print "Z915"}; continue };
    if ( ba(-2,"_lock_prl") && prl_da(-2) &&
          Q(-1,"suw_any sz_iili") && s(-2,-1) )
    ...
    if ( prl_da(-1) &&
             ba(-1,"_castle_prl_geo") && s(-1)  )
    { l[i]=omo1; Z[919]++; if(dbg){print "Z919"}; continue };
    if ( prl_da(-2) &&
             ba(-2,"_castle_prl_geo") &&
              Q(-1,"suw_any") && s(-2,-1)  )
 ...
 { l[i]=omo1; Z[936]++; if(dbg){print "Z936"}; continue };
 if ( isname(0) && s(-1) )
