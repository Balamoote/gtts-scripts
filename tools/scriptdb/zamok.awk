...
#if ( w(-2,"не") &&
#     w(-1,"в") && s(-2,-1)  )
#{ getBFx(-5,-1,"_nev.txt"); Z[1]++; if(dbg){print "Z1"}; }; continue
#{ print l[i+1] >> "_sw.txt"; Z[2]++; if(dbg){print "Z2"}; }; continue

#getBFx(-3,3,"_an.txt"); Z[3]++; if(dbg){print "Z3"}; continue
...
sz_iili(1) &&
 ...
 if ( sc(-1,",") && ba(-1,"_castle_environs") )
 { l[i]=omo1; Z[38]++; if(dbg){print "Z38"}; continue };
 if ( sc(0,",") && ba(1,"_castle_environs") )
...
sz_iili(-3) &&
 ...
 if ( q(-1,"sz_iili") &&
     ba(-2,"_locklike_list") && s(-2,-1) )
 { l[i]=omo2; Z[159]++; if(dbg){print "Z159"}; continue };
 if ( sc(-1,",") && ba(-1,"_locklike_list") && !(isname(1) && base(1,"люк")) )
 { l[i]=omo2; Z[160]++; if(dbg){print "Z160"}; continue };
 if ( sc(0,",") && ba(1,"_locklike_list") && !(isname(1) && base(1,"люк")) )
 ...
 if(iwrd=="замок" || iwrd=="замки") {
    ...
    if ( q(1,"prl_im prl_kred_mu") && ba(1,"_lock_prl") && s(0) && !(isname(1)) )
    ...
    if ( q(1,"prq_im prq_kred_mu") && ba(1,"_lock_prq_kak_gl") && s(0) && !(isname(1)) )
...
#   { l[i]=omo2; Z[197]++; if(dbg){print "Z197"}; continue };
    ...
    if ( ba(-3,"_v_lock_parts") && sc(-3,",") &&
         ba(-2,"_gl_v_castle_main") &&
          w(-1,"в") )
    { l[i]=omo2; Z[290]++; if(dbg){print "Z290"}; continue };
    if ( ba(-4,"_v_lock_parts") && sc(-4,",") &&
    ...
    if ( ba(-3,"_gl_v_castle_main") &&
          q(-2,"suw_vi suw_im suw_ro suw_tv suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          w(-1,"в") && s(-3) && (s(-2)||sc(-2,",")) && s(-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          ...
          q(-2,"suw_vi suw_im mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          ...
          q(-3,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          q(-2,"qast") &&
          w(-1,"в") && s(-5,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          ...
          q(-2,"suw_ro mest_ro suw_edne mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          ...
          q(-2,"suw_tv mest_tv suw_edne mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    { l[i]=omo1; Z[310]++; if(dbg){print "Z310"}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          w(-2,"в во") &&
          q(-1,"prl_vi prq_vi mest_vi mest_3e") && s(-4) && (s(-3)||sc(-3,",")) && s(-2,-1) )
    { l[i]=omo1; Z[311]++; if(dbg){print "Z311"}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_tv mest_tv suw_edne mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          w(-2,"в во") &&
          q(-1,"prl_vi prq_vi mest_vi mest_3e") && s(-4) && (s(-3)||sc(-3,",")) && s(-2,-1) )
    { l[i]=omo1; Z[312]++; if(dbg){print "Z312"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"suw_vi suw_im suw_tv suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr nar_spos qast name_vi_sy isname") &&
          w(-3,"в во") &&
          q(-2,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-1,"prl_vi prq_vi mest_vi mest_3e") && s(-5) && (s(-4)||sc(-4,",")) && s(-3,-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast name_vi_sy isname") &&
          q(-3,"sz_iili") &&
          q(-2,"suw_vi suw_im mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast name_vi_sy isname") &&
          w(-1,"в") && s(-5,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    { l[i]=omo1; Z[315]++; if(dbg){print "Z315"}; continue };
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast name_vi_sy isname") &&
          q(-4,"sz_iili") &&
          q(-3,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-2,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast name_vi_sy isname") &&
          w(-1,"в") && s(-6,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    { l[i]=omo1; Z[316]++; if(dbg){print "Z316"}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_vi suw_im suw_edne mest_vi suw_tv mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast name_vi_sy isname") &&
          q(-2,"nar_napr nar_vrem nar_spos prl_kred_sr") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    { l[i]=omo1; Z[317]++; if(dbg){print "Z317"}; continue };
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"qast") &&
          q(-3,"suw_vi suw_im suw_edne mest_vi mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast name_vi_sy isname") &&
          q(-2,"nar_napr nar_vrem nar_spos prl_kred_sr") &&
          w(-1,"в") && s(-5,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    { l[i]=omo1; Z[318]++; if(dbg){print "Z318"}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"qast") &&
          q(-2,"suw_vi mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    { l[i]=omo1; Z[319]++; if(dbg){print "Z319"}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"qast") &&
          q(-2,"suw_tv mest_tv suw_edne mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||sc(-2,",")) && s(-1) )
    ...
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"suw_vi suw_tv mest_vi suw_edne mest_3e gl_in prl_kred_sr nar_vrem nar_mest nar_napr qast") &&
          w(-2,"в во") &&
          q(-1,"prl_vi mest_vi mest_3e") && s(-4,-1) )
  ...
  if ( wb(-3,-1,"под") && s(wbn,-1) ) {
    ...
    if ( ba(-2,"_lock_pe") &&
          q(-1,"prl_vi prq_vi mest_vi mest_3e qast nar_mest nar_cel nar_napr nar_vrem prl_kred_sr") && s(-2,-1) )
 ...
 if ( sc(0,",") && q(1,"prq_any") && ba(1,"_castle_pe") && s(1) && Q(1,"suw_any") )
 ...
 if ( sc(0,",") && q(1,"prq_any") && ba(1,"_lock_pe") && s(1) )
