...
#{ l[i]=omo1; Z[48]++; if(dbg){print "Z48"}; continue };
 ...
 if ( vgl(Y["n+_castlelike_things"],2,5) ) { bf_n=Y["n+_castlelike_things"];
    ...
    { Z[61]++; if(dbg){print "Z61"}; continue };
 ...
 if ( wf(2,6,"собой") && bw(wfn-1,"представлять") ) { wf_n=wfn;
      ...
      { Z[77]++; if(dbg){print "Z77", "-- TN_v_zamok_f"}; continue};
 ...
 if ( bf(1,4,cst) ) { bf_n=bfn;
   ...
   if ( bfa(bf_n+1,bf_n+5,"_castlelike_things")||
      ...
      ( bfa(bf_n+1,bf_n+5,"_prq_castle") && q(bfn,"prq_tv") ) ) {
       ...
       { bf_n=bb_n=""; Z[82]++; if(dbg){print "Z82"}; };
       if ( vgl(bf_n,1,4) && zs(0) && s(1,bb_n-1) &&
              w(bb_n,"ключом") && !w(bb_n+1,"к") )
       { bf_n=bb_n=""; Z[83]++; if(dbg){print "Z83"}; };
 ...
 if ( bfa(1,6,"_castle_environs") ) { bf_n=Y["n+_castle_environs"]=bfn;
    ...
    { bf_n=""; Z[116]++; if(dbg){print "Z116"}; };
    if ( vgl(bf_n,1,6) &&
         bam(-1,"_lock_pe _lock_prl") && s(-1) )
    { bf_n=""; Z[117]++; if(dbg){print "Z117"}; };
...
sz_iili(-2) &&
 ...
 if ( bfa(1,4,"_locklike_things") ) { bf_n=bfn;
    ...
    if ( qq(-1,1) && z(0) && s(-1) &&
         veq(bf_n,2) && s(1) ) {
            if ( vex(Y["tn_ok_v"]) && TN_v_zamok_f() )
            { Z[142]++; if(dbg){print "Z142"}; continue } else
    ...
    if ( q(1,"sz_iili") &&
       ...
       veq(bf_n,3) && s(0,2) ) {
            if ( vex(Y["tn_ok_v"]) && TN_v_zamok_f() )
            { Z[149]++; if(dbg){print "Z149"}; continue } else
    ...
    if ( z(0) && veq(bf_n,1) && !(isname(1) && bw(1,"люк")) ) {
       if ( vex(Y["tn_ok_v"]) && TN_v_zamok_f() )
       { Z[155]++; if(dbg){print "Z155"}; continue }
    else { l[i]=omo2; Z[156]++; if(dbg){print "Z156"}; continue };};
 };
...
sz_iili(1) &&
 ...
 if ( qb(-4,-1,"sz_iili") ) { qb_n=qbn;
   ...
   { qb_n=bb_n=""; Z[161]++; if(dbg){print "Z161"}; };
   if ( vgl(Y["n-_castle_pe"],bb_n+1,qb_n-1) && s(Y["n-_castle_pe"],-1) )
   { qb_n=bb_n=""; Z[162]++; if(dbg){print "Z162"}; };
 ...
 if ( veq(Y["iwrd_case"],"tv") ) {
    ...
    { Z[173]++; if(dbg){print "Z173", "-- TN_pod_zamkom_f"}; continue};
 };
 # suw_ro escape:end

 if ( FN_zamok_suwro_f() )
 { Z[174]++; if(dbg){print "Z174", "-- FN_zamok_suwro_f"}; continue };
 ...
 if ( w(1,"из") ) { wf_n=1;
    ...
    { wf_n=""; Z[182]++; if(dbg){print "Z182"}; continue };
 ...
 if ( wf(1,6,"для") ) { wf_n=Y["n+_pre_dlya"]=wfn;
   if ( wfa(wf_n+1,wf_n+4,"_castle_suw-ro2") ) { bf_n=wfn;
    ...
    if ( vgl(wf_n,1,3) && vgl(bf_n,wf_n+1,wf_n+4) && s(0,bf_n-1) ) {
      ...
      { wf_n=bf_n=""; Z[187]++; if(dbg){print "Z187"}; };
      if ( wa(1,"_lock_suw-ro") && s(0) )
      { wf_n=bf_n=""; Z[188]++; if(dbg){print "Z188"}; };
      if ( qsb(-10,-1,",") && bb(sbn-3,sbn,"дверь люк") && s(sbn-3,sbn-1) )
      { wf_n=bf_n=""; Z[189]++; if(dbg){print "Z189"}; };
      if ( vex(Y["tn_ok_v"]) && TN_v_zamok_f() )
      { Z[190]++; if(dbg){print "Z190", "-- TN_v_zamok_f"}; continue};
      if ( vex(Y["tn_ok_na"]) && TN_na_zamok_f() )
      { Z[191]++; if(dbg){print "Z191", "-- TN_na_zamok_f"}; continue};
      if ( vex(Y["tn_ok_pod"]) && TN_pod_zamok_f() )
      { Z[192]++; if(dbg){print "Z192", "-- TN_pod_zamok_f"}; continue};
 ...
 if ( wb(-5,-2,"для") ) { wb_n=Y["n-_pre_dlya"]=wbn;
   if ( wba(wb_n+1,-1,"_castle_suw-ro1") ) { bb_n=wbn;
    ...
    { l[i]=omo1; Z[195]++; if(dbg){print "Z195"}; continue }; #checkro2
   ...
   if ( wba(wb_n+1,-1,"_castle_suw-ro2") ) { bb_n=wbn;
    ...
    if ( vgl(wb_n,-5,-1) && vgl(bb_n,wb_n+1,-1) && s(wb_n-1,-1) &&
         ...
         qir(wb_n+1,bb_n-1,"prl_ro mest_ro mest_3e prq_ro") &&
         qir(bb_n+1,-1,"prl_any mest_any") )
    { l[i]=omo1; Z[196]++; if(dbg){print "Z196"}; continue }; #checkro2
 ...
 if ( wf(1,4,"в во") ) { wf_n=wfn;
    ...
    if ( vgl(wf_n,1,4) && s(0,wf_n-1) &&
        (veq(Y["n_pre_pod"],-1)||veq(Y["n_pre_na"],-1)||veq(Y["n-_lock_pe"],-1)) )
    { wf_n=""; Z[202]++; if(dbg){print "Z202"}; };
...
#
 ...
 if ( vgl(Y["n_pre_na"],-8,-2) ) { wb_n=Y["n_pre_na"];
   if ( wfa(wb_n+1,-1,"_lock_na_suw-pr") ) { bf_n=wfn;
        ...
        if ( vgl(Y["n-_castle_pe"],bf_n+1,-1) )
        { bf_n=""; Z[248]++; if(dbg){print "Z248"}; };
        if ( vgl(Y["n-_castle_pe"],bf_n-5,bf_n-2) )
        { bf_n=""; Z[249]++; if(dbg){print "Z249"}; };
        if ( s(-1) && bw(-1,"весь целый") )
        { wb_n=bf_n=""; Z[250]++; if(dbg){print "Z250"}; };
 ...
 if ( w(1,"на") && wfa(2,5,"_lock_na_suw-pr") ) { wf_n=wfn;
        ...
        { Z[260]++; if(dbg){print "Z260"}; continue };
...
#       { wb_n=bf_n=""; Z[268]++; if(dbg){print "Z268"}; };
 ...
 if ( w(1,"на") ) {
   if ( wfa(2,5,"_lock_na_suw-vi") ) { wf_n=wfn;
     ...
     { Z[272]++; if(dbg){print "Z272"}; continue };
   ...
   if ( bba(-5,-1,"_gl_4_lock_na_suw-vi") ) { bb_n=bbn;
     ...
     { l[i]=omo2; Z[274]++; if(dbg){print "Z274"}; continue };#uphere
   };};
 ...
 if ( w(1,"с со") ) {
     ...
     { Z[287]++; if(dbg){print "Z287", "-- TN_na_zamok_f"}; continue } else {
     # _castle_s_suw-ro:start
     if ( zs(0) &&
 ...
 if ( wf(1,3,"с со") ) { wf_n=wfn;
   if ( wfa(wf_n+1,wf_n+4,"_lock_s_suw-tv") ) { bf_n=wfn;
    ...
    if ( veq(wf_n,2) && vgl(bf_n,wf_n+1,wf_n+4) && s(0) && z(1) && s(2,bf_n-1) &&
           q(1,"prl_edmuim") )
 ...
 { l[i]=omo1; Z[309]++; if(dbg){print "Z309"}; continue };
  ...
  ######################################################################################################
    ...
    { Z[310]++; if(dbg){print "Z310", "-- FN_castle_prl_f"}; continue };

    # основные прилагательные -- lock
    if ( FN_lock_prl_f("_lock_prl") )
    { Z[311]++; if(dbg){print "Z311", "-- FN_lock_prl_f(\"_lock_prl\")"}; continue };
 ...
 if( veq(Y["iwrd_case"],"iv") ) {
    ...
    if ( qb(-5,-1,"sz_iili") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_castle_environs") ) { bb_n=bbn;
         ...
         { bb_n=qb_n=""; Z[327]++; if(dbg){print "Z327"}; };
    ...
    if ( bw(1,cst) &&
          w(2,"из") && s(0,1) )
    { l[i]=omo1; Z[339]++; if(dbg){print "Z339"}; stopp=ret=1; continue };
    if ( !vex(Y["tn_ok_v"]) && bw(1,cst) &&
            q(2,"nar_spos nar_kaq prl_kred_sr") && s(0,1) )
    { l[i]=omo1; Z[340]++; if(dbg){print "Z340"}; stopp=ret=1; continue };
    if ( bw(1,cst1) &&
         bf(2,5,cst) &&
    ...
    if ( bw(1,cst) && s(0) &&
       (qxs(2,"вовсе совсем никак отнюдь","не")||
        qxs(2,"не") ) &&
          w(xsn+1,"из") && s(xsn+1) )
    { l[i]=omo1; Z[342]++; if(dbg){print "Z342"}; stopp=ret=1; continue };
    if ( wb(-7,-4,"из") && s(wbn,-1) &&
          q(wbn+1,"otsz_ro") &&
         bw(wbn+2,cst1) &&
         bw(wbn+3,cst) &&
        qir(wbn+4,-1,"prl_vi mest_vi mest_3e") )
    { l[i]=omo1; Z[343]++; if(dbg){print "Z343"}; stopp=ret=1; continue };
    # сложен
  ...
  if ( vgl(Y["n_pre_v"],-5,-1) ) {
    ...
    if ( TN_v_zamok_f() )
    { Z[358]++; if(dbg){print "Z358", "-- TN_v_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_na"],-5,-1) ) {
    ...
    if ( TN_na_zamok_f() )
    { Z[362]++; if(dbg){print "Z362", "-- TN_na_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_za"],-5,-1) ) {
    ...
    if ( TN_za_zamok_f() )
    { Z[373]++; if(dbg){print "Z373", "-- TN_za_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_pod"],-5,-1) ) {
    ...
    if ( TN_pod_zamok_f() )
    { Z[374]++; if(dbg){print "Z374", "-- TN_pod_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_o"],-5,-1) ) {
    ...
    if ( TN_o_zamok_f() )
    { Z[375]++; if(dbg){print "Z375", "-- TN_o_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_po"],-5,-1) ) {
    ...
    if ( TN_po_zamok_f() )
    { Z[376]++; if(dbg){print "Z376", "-- TN_po_zamok_f"}; continue };
  ...
  if ( vgl(Y["n_pre_qerez"],-5,-1) ) {
    ...
    if ( TN_qerez_zamok_f() )
    { Z[377]++; if(dbg){print "Z377", "-- TN_qerez_zamok_f"}; continue };
  ...
  if ( bf(1,3,cst1) ) { bf_n=bfn;
    ...
    if ( vgl(Y["n+_lock_pe"],1,6) ) { bf_n=Y["n+_lock_pe"];
       ...
       { l[i]=omo1; Z[526]++; if(dbg){print "Z526"}; continue }; # check4 mass errors
       if ( vgl(bf_n,1,6) &&
             bw(bf_n,cst) &&
              w(bf_n+1,"перед") &&
    ...
    if ( qb(-7,-2,"pre_da") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
        ...
        { l[i]=omo2; Z[538]++; if(dbg){print "Z538"}; continue }; #check
        if ( vgl(qb_n,-7,-2) && vgl(bb_n,qb_n-5,qb_n-1) && s(bb_n,-1) &&
               w(1,"на") &&
             wfa(2,5,"_lock_na_suw-vi") && s(0,wfn-1) &&
             qir(2,wfn-1,"prl_vi mest_vi mest_3e prq_vi") )
        { l[i]=omo2; Z[539]++; if(dbg){print "Z539"}; continue }; #check
    ...
    if ( qb(-7,-2,"pre_vi") ) { qb_n=qbn;
      if ( bba(qb_n-7,qb_n-1,"_lock_pe") ) { bb_n=bbn;
       ...
       if ( vgl(qb_n,-7,-2) && vgl(bb_n,qbn-7,qbn-1) && s(bb_n,-1) &&
            vex(Y["tn_ok_vi"]) )
       { bb_n=qb_n=""; Z[550]++; if(dbg){print "Z550"}; };
       if ( vgl(qb_n,-7,-2) && vgl(bb_n,qbn-7,qbn-1) && s(bb_n,-1) &&
              w(qb_n,"в во") && qir(qb_n+1,-1,"isname") && ba(bb_n,"_gl_v_castle-iv") )
       { bb_n=qb_n=""; Z[551]++; if(dbg){print "Z551"}; };
    ...
    if ( vgl(Y["n-_castle_pe"],-7,-1) ) { bb_n=Y["n-_castle_pe"];
      ...
      if ( qb(-5,-1,"sz_iili") ) { qb_n=qbn;
        if ( bba(qb_n-5,qb_n-1,"_castle_pe") ) { bb_n=bbn;
         ...
         if ( vgl(Y["n+_lock_pe"],1,5) && s(0,Y["n+_lock_pe"]-1) )
         { bb_n=qb_n=""; Z[584]++; if(dbg){print "Z584"}; };
...
#      bfa(xwn-3,xwn-1,"_castle_pe") && s(bfn,-1) && Q(bfn,"suw_any") )
    ...
    if ( vgl(Y["n+_castle_pe"],1,6) ) { bf_n=Y["n+_castle_pe"]; bb_n=Y["n-_lock_pe"];
       ...
       { bf_n=bf_n+1; Z[609]++; if(dbg){print "Z609"}; };
       ...
       { l[i]=omo1; Z[620]++; if(dbg){print "Z620"}; continue };
         ...
         if ( vgl(bf_n,1,6) && s(0,bf_n-1) && veq(Y["iwrd_form"],"ediv") &&
          prq_any(bf_n) && !q(bf_n,"prq_edmuim prq_edmutv prq_kred_mu") &&
             !exb(-1,"тот ни другой ") )
         { bf_n=""; Z[621]++; if(dbg){print "Z621"}; };
         if ( vgl(bf_n,1,6) && s(0,bf_n-1) &&
               ba(-1,"_castle_prl_geo") && s(-1) )
         { bf_n=""; Z[622]++; if(dbg){print "Z622"}; };
...
#   cst1="быть ведь же стать считаться являться";
 ...
 #
    ...
    if ( TN_do_zamka_f() )
    { Z[648]++; if(dbg){print "Z648", "-- TN_do_zamka_f"}; continue };
 ...
 #
    ...
    if ( vex(Y["tn_ok_pod_tv"]) && TN_pod_zamkom_f() )
    { Z[661]++; if(dbg){print "Z661", "-- TN_pod_zamkom_f"}; continue};
 ...
 { Z[696]++; if(dbg){print "Z696", "-- FN_castle_prl_after_f"}; continue };

 if ( FN_lock_prl_f("_lock_prl_after") )
 { Z[697]++; if(dbg){print "Z697", "-- FN_lock_prl_f(\"_lock_prl_after\")"}; continue };
 ...
 if ( q(1,"isname") && s(0) ) {
      ...
      { l[i]=omo1; Z[701]++; if(dbg){print "Z701"}; continue } else
 ...
 if ( isname(0) && s(-1) )
 { l[i]=omo1; Z[709]++; if(dbg){print "Z709", "-- is_CAP"}; continue };
...
function DEFINE_TN_OK_PREVI_ZAMOK(num,el,    fufu) { # определение компонентов между "pre_vi" и "замок"
    ...
    { tn_ok = 1; Z[710]++; if(dbg){print "Z710", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) && wy(-1,"же") &&
          qir(tn+2,-1-wyn,"mest_da suw_da prq_da nar_any prl_da") )
    { tn_ok = 1; Z[711]++; if(dbg){print "Z711", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
          qir(tn+2,-2,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
            q(-1,"suw_tv mest_tv") )
    { tn_ok = 1; Z[712]++; if(dbg){print "Z712", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
          qir(tn+2,-3,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
            q(-2,"suw_tv qik_tv") &&
            q(-1,cst3) )
    { tn_ok = 1; Z[713]++; if(dbg){print "Z713", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
            q(tn+2,"pre_vi") &&
          qir(tn+3,-2,"prl_vi mest_vi mest_3e") &&
            q(-1,"mest_vip3e suw_vi") )
    { tn_ok = 1; Z[714]++; if(dbg){print "Z714", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(tn,-1) &&
            q(tn+1,cst2) &&
            q(tn+2,"pre_tv") &&
          qir(tn+3,-2,"prl_tv mest_tv mest_3e") &&
            q(-1,"suw_tv") )
    { tn_ok = 1; Z[715]++; if(dbg){print "Z715", "-- tn_ok ON", el, "замок"};};
    cst="именно собственно";
    if ( !vex(tn_ok) && s(tn,-1) && qiw(tn+1,-1,cst1,cst) )
    { tn_ok = 1; Z[716]++; if(dbg){print "Z716", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(-4) && zs(-3) && s(-2,-1) && veq(tn,-4) &&
            q(-3,cst2) && q(-2,"nar_any prl_kred_sr") && q(-1,cst2) )
    { tn_ok = 1; Z[717]++; if(dbg){print "Z717", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(tn,-1) && veq(tn,-2) && wc(-1,"ский$|ный$") )
    { tn_ok = 1; Z[718]++; if(dbg){print "Z718", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && zs(-2) && s(-1) && veq(tn,-3) &&
            q(-2,cst2) && wc(-1,"ский$|ный$") )
    { tn_ok = 1; Z[719]++; if(dbg){print "Z719", "-- tn_ok ON", el, "замок"};};
    if ( !vex(tn_ok) && s(tn,-1) && veq(tn,-4) &&
            q(-3,cst2) && q(-2,"sz_iili") && wc(-1,"ский$|ный$") )
    { tn_ok = 1; Z[720]++; if(dbg){print "Z720", "-- tn_ok ON", el, "замок"};};
    # передвижка tn_ok
    if ( vex(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"да","еще","и")||
         qxs(tn-1,"ведь даже же прямо сразу") ) )
    { tn = xsn; Z[721]++; if(dbg){print "Z721", "-- tn_ok MOV", el, "замок"};};
    # выключение tn_ok
    ...
    { tn_ok = ""; Z[722]++; if(dbg){print "Z722", "-- tn_ok OFF", el, "замок"};};
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) &&
         qxs(-1,"прошлый тот этот","раз") )
    { tn_ok = ""; Z[723]++; if(dbg){print "Z723", "-- tn_ok OFF", el, "замок"};};
}
...
function DEFINE_TN_OK_PRETV_ZAMKOM(num,el,    fufu) { # определение компонентов между "pre_tv" и "замком"
    ...
    if ( hwy(-1,"то") && qir(tn+1,-1-hyn,cst1) && s(tn,-1) )
    { tn_ok = 1; Z[724]++; if(dbg){print "Z724", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) && wy(-1,"же") &&
#         qir(tn+2,-1-wyn,"mest_da suw_da prq_da nar_any prl_da") )
#   { tn_ok = 1; Z[725]++; if(dbg){print "Z725", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#         qir(tn+2,-2,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
#           q(-1,"suw_tv mest_tv") )
#   { tn_ok = 1; Z[726]++; if(dbg){print "Z726", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#         qir(tn+2,-3,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
#           q(-2,"suw_tv qik_tv") &&
#           q(-1,cst3) )
#   { tn_ok = 1; Z[727]++; if(dbg){print "Z727", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#           q(tn+2,"pre_vi") &&
#         qir(tn+3,-2,"prl_vi mest_vi mest_3e") &&
#           q(-1,"mest_vip3e suw_vi") )
#   { tn_ok = 1; Z[728]++; if(dbg){print "Z728", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#           q(tn+2,"pre_tv") &&
#         qir(tn+3,-2,"prl_tv mest_tv mest_3e") &&
#           q(-1,"suw_tv") )
#   { tn_ok = 1; Z[729]++; if(dbg){print "Z729", "-- tn_ok ON", el, "замком"};};
#   cst="именно собственно";
#   if ( !vex(tn_ok) && s(tn,-1) && qiw(tn+1,-1,cst1,cst) )
#   { tn_ok = 1; Z[730]++; if(dbg){print "Z730", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(-4) && zs(-3) && s(-2,-1) && veq(tn,-4) &&
#           q(-3,cst2) && q(-2,"nar_any prl_kred_sr") && q(-1,cst2) )
#   { tn_ok = 1; Z[731]++; if(dbg){print "Z731", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(tn,-1) && veq(tn,-2) && wc(-1,"ским$|ным$") )
#   { tn_ok = 1; Z[732]++; if(dbg){print "Z732", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && zs(-2) && s(-1) && veq(tn,-3) &&
#           q(-2,cst2) && wc(-1,"ский$|ный$") )
#   { tn_ok = 1; Z[733]++; if(dbg){print "Z733", "-- tn_ok ON", el, "замком"};};
#   if ( !vex(tn_ok) && s(tn,-1) && veq(tn,-4) &&
#           q(-3,cst2) && q(-2,"sz_iili") && wc(-1,"ский$|ный$") )
#   { tn_ok = 1; Z[734]++; if(dbg){print "Z734", "-- tn_ok ON", el, "замком"};};
    # передвижка tn_ok
    if ( vex(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"да","еще","и")||
         qxs(tn-1,"ведь даже же прямо сразу") ) )
    { tn = xsn; Z[735]++; if(dbg){print "Z735", "-- tn_ok MOV", el, "замком"};};
    # выключение tn_ok
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) && qf(tn+1,-1,"prq_edmuvi prq_mnvi") &&
         bam(qfn,"_castle_pe _lock_pe") &&
           q(1,"suw_edmuvi suw_mnvi suw_edne") && s(0) )
    { tn_ok = ""; Z[736]++; if(dbg){print "Z736", "-- tn_ok OFF", el, "замком"};};
    if ( vex(tn_ok) && !vex(fufu) && s(tn,-1) &&
         qxs(-1,"прошлый тот этот","раз") )
    { tn_ok = ""; Z[737]++; if(dbg){print "Z737", "-- tn_ok OFF", el, "замком"};};
}
...
#   if ( bba(tn-9,tn-1,"_gl_v_lock-iv")   ) { Y["n-_gl_v_lock-iv"]   = bbn };
    ...
    { l[i]=omo2; Z[765]++; if(dbg){print "Z765"}; stopp=ret=1; continue }; #edit
    if ( bb(tn-9,tn-3,cst) &&
          w(bbn+1,cst1) &&
          q(bbn+2,"pre_tv") &&
        qir(tn+3,tn-1,"suw_tv prl_tv mest_tv prq_tv isname qast nar_any") && s(bbn,tn-2) && zs(tn-1) )
    { l[i]=omo2; Z[766]++; if(dbg){print "Z766"}; stopp=ret=1; continue }; #edit
    ...
    if ( vgl(Y["n-_gl_v_lock-iv"],tn-9,tn-1) ) { bb_n=Y["n-_gl_v_lock-iv"];
       ...
       if ( vgl(bb_n,tn-6,tn-3) && s(bb_n,tn-3) &&
            qir(bb_n+1,tn-3,"prl_vi prq_vi mcop_vi qik_vi qis_vi prl_kred_sr nar_any isname qast_any") &&
              ...
              q(tn-1,"sz") )
       { l[i]=omo2; Z[807]++; if(dbg){print "Z807"}; stopp=ret=1; continue }; #check
       ...
       { l[i]=omo2; Z[809]++; if(dbg){print "Z809"}; stopp=ret=1; continue }; #inspect
       if ( vgl(bb_n,tn-6,tn-2) &&
       ...
       { l[i]=omo2; Z[815]++; if(dbg){print "Z815"}; stopp=ret=1; continue }; #inspect
       if ( veq(bb_n,tn-2) &&
    ...
    if ( qb(tn-8,tn-2,"pre_vi") ) { qb_n=qbn;
      if ( bba(qb_n-5,qb_n-1,"_gl_v_lock-iv") ) { bb_n=bbn;
       ...
       { qb_n=bb_n=""; l[i]=omo2; Z[822]++; if(dbg){print "Z822"}; };
    ...
    { l[i]=omo2; Z[858]++; if(dbg){print "Z858"}; stopp=ret=1; continue }; #check
    if ( bf(1,3,cst) &&
        bf_(bfn+1,bfn+3,cst1) && s(1,bf2-1) &&
        qir(1,bfn-1,"nar_any") &&
        qir(bfn+1,bf2-1,"prl_vi mcop_vi prq_vi prl_im mcop_im prq_im") )
    { l[i]=omo2; Z[859]++; if(dbg){print "Z859"}; stopp=ret=1; continue }; #check
    if ( bf(1,3,cst1) &&
    ...
    if ( vgl(Y["n-_gl_v_castle-iv"],tn-8,tn-1) ) { bb_n = Y["n-_gl_v_castle-iv"];
       ...
       { l[i]=omo1; Z[896]++; if(dbg){print "Z896"}; stopp=ret=1; continue }; #check
       if ( vgl(bb_n,tn-5,tn-2) &&
              q(bb_n+1,"prq_vi suw_vi mest_vi mest_3e") &&
            qir(bb_n+2,tn-1,"suw_vi mest_vi mest_3e suw_mnsq qis_vi isname") && s(bb_n,tn-2) && zs(tn-1) )
       { l[i]=omo1; Z[897]++; if(dbg){print "Z897"}; stopp=ret=1; continue }; #check
       if ( vgl(bb_n,tn-6,tn-2) &&
   ...
   if ( vex(Y["tn_ok_na"]) ) { tn=Y["n_pre_na"];
    ...
    if ( bfa(1,4,"_suw_na_castle") ) { bf_n=bfn;
       if ( vgl(bf_n,1,4) && s(0,bf_n-1) &&
              q(bf_n,"prl_vi") )
       { bf_n=""; Z[989]++; if(dbg){print "Z989"}; stopp=ret=1; };
    ...
    { l[i]=omo1; Z[1000]++; if(dbg){print "Z1000", bfn}; stopp=ret=1; continue };
    # _gl_na_castle:end
  ...
  if ( vex(Y["tn_ok_pod"]) ) { tn=Y["n_pre_pod"];
   ...
   if ( bw(-2,cst) &&
    ...
    if ( pre_vi(-4) &&
        ...
        sz_iili(-2) &&
              w(-1,"под") && s(-4,-1) )
    { l[i]=omo2; Z[1097]++; if(dbg){print "Z1097"}; stopp=ret=1; continue };
   Y["tn_ok_vi"]="";
   } # tn_ok <<== end
...
function TN_pod_zamkom_f(    ret, tn, stopp, bb_n,bf_n,qb_n,qf_n,wb_n,wf_n) { stopp=v2s(Y["TN_pod_zamkom_f"]);
  ...
  if ( vex(Y["tn_ok_pod_tv"]) ) { tn=vex(Y["n_pre_pod_tv"]);
      if ( bba(tn-5,tn-1,"_gl_pod_lock-tv") ) { bb_n=bbn;

       if ( vgl(bb_n,tn-5,tn-1) && s(bb_n,-1) &&
            qir(qb_n+1,-1,"suw_vi mest_vi mest_3e") )
       { l[i]=omo2; Z[1098]++; if(dbg){print "Z1098"}; stopp=ret=1; continue };
...
#   cst_muvi="prl_edmuvi prl_mnvi mcop_edmuvi mcop_mnvi qis_vi qik_vi prq_edmuvi prq_mnvi qast_any mest_3e nar_kaq nar_step";
    ...
    if ( hwy(-1,"то") && qir(tn+1,-1-hyn,cst1) && s(tn,-1) )
    { tn_ok = 1; Z[1131]++; if(dbg){print "Z1131", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) && wy(-1,"же") &&
#         qir(tn+2,-1-wyn,"mest_da suw_da prq_da nar_any prl_da") )
#   { tn_ok = 1; Z[1132]++; if(dbg){print "Z1132", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#         qir(tn+2,-2,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
#           q(-1,"suw_tv mest_tv") )
#   { tn_ok = 1; Z[1133]++; if(dbg){print "Z1133", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#         qir(tn+2,-3,"mest_tv prq_tv qik_tv nar_any prl_tv") &&
#           q(-2,"suw_tv qik_tv") &&
#           q(-1,cst3) )
#   { tn_ok = 1; Z[1134]++; if(dbg){print "Z1134", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#           q(tn+2,"pre_vi") &&
#         qir(tn+3,-2,"prl_vi mest_vi mest_3e") &&
#           q(-1,"mest_vip3e suw_vi") )
#   { tn_ok = 1; Z[1135]++; if(dbg){print "Z1135", "-- tn_ok ON", el, "замка"};};
#   if ( !vex(tn_ok) && s(tn,-1) &&
#           q(tn+1,cst2) &&
#           q(tn+2,"pre_tv") &&
#         qir(tn+3,-2,"prl_tv mest_tv mest_3e") &&
#           q(-1,"suw_tv") )
#   { tn_ok = 1; Z[1136]++; if(dbg){print "Z1136", "-- tn_ok ON", el, "замка"};};
    cst="именно собственно";
    if ( !vex(tn_ok) && s(tn,-1) && qiw(tn+1,-1,cst1,cst) )
    { tn_ok = 1; Z[1137]++; if(dbg){print "Z1137", "-- tn_ok ON", el, "замка"};};
    if ( !vex(tn_ok) && s(-4) && zs(-3) && s(-2,-1) && veq(tn,-4) &&
            q(-3,cst2) && q(-2,"nar_any prl_kred_sr") && q(-1,cst2) )
    { tn_ok = 1; Z[1138]++; if(dbg){print "Z1138", "-- tn_ok ON", el, "замка"};};
    if ( !vex(tn_ok) && s(tn,-1) && veq(tn,-2) && wc(-1,"ского$|ного$") )
    { tn_ok = 1; Z[1139]++; if(dbg){print "Z1139", "-- tn_ok ON", el, "замка"};};
    if ( !vex(tn_ok) && zs(-2) && s(-1) && veq(tn,-3) &&
            q(-2,cst2) && wc(-1,"ского$|ного$") )
    { tn_ok = 1; Z[1140]++; if(dbg){print "Z1140", "-- tn_ok ON", el, "замка"};};
    if ( !vex(tn_ok) && s(tn,-1) && veq(tn,-4) &&
            q(-3,cst2) && q(-2,"sz_iili") && wc(-1,"ского$|ного$") )
    { tn_ok = 1; Z[1141]++; if(dbg){print "Z1141", "-- tn_ok ON", el, "замка"};};
    # передвижка tn_ok
    if ( vex(tn_ok) && s(tn,-1) &&
       ( qxs(tn-1,"как","и")||
         qxs(tn-1,"да","еще","и")||
         qxs(tn-1,"ведь даже же прямо сразу") ) )
    { tn = xsn; Z[1142]++; if(dbg){print "Z1142", "-- tn_ok MOV", el, "замка"};};
    # выключение tn_ok
#   if ( vex(tn_ok) && s(tn,-1) && qf(tn+1,-1,"prq_edmuvi prq_mnvi") &&
#        bam(qfn,"_castle_pe _lock_pe") &&
#          q(1,"suw_edmuvi suw_mnvi suw_edne") && s(0) )
#   { tn_ok = ""; Z[1143]++; if(dbg){print "Z1143", "-- tn_ok OFF", el, "замка"};};
#   if ( vex(tn_ok) && s(tn,-1) &&
#        qxs(-1,"прошлый тот этот","раз") )
#   { tn_ok = ""; Z[1144]++; if(dbg){print "Z1144", "-- tn_ok OFF", el, "замка"};};
}
...
#   if ( vex(Y["tn_ok_na"]) && TN_na_zamok_f() )
#   { Z[1149]++; if(dbg){print "Z1149"}; stopp=ret=1; continue };
    if ( iwrd == "замок") {
       ...
       { l[i]=omo1; Z[1152]++; if(dbg){print "Z1152"}; stopp=ret=1; continue };
          ...
          if ( bf(1,3,cst1) ) { wf_n=bfn;
             if ( bfa(wf_n+1,wf_n+5,str_castle) ) { bf_n=bfn;
                if ( vgl(Y["n+_lock_pe"],wf_n+1,bf_n-1) ||
                     ...
                     vex(Y["tn_ok_vi"]) )
                { wf_n=bf_n=""; Z[1156]++; if(dbg){print "Z1156"}; };
                if ( s(bf_n,bf_n+1) && sz_iili(bf_n+1) && ba(bf_n+2,"_lock_prl") )
                { wf_n=bf_n=""; Z[1157]++; if(dbg){print "Z1157"}; };
          ...
          if ( bf(1,3,cst1) ) { wf_n=bfn;
             if ( bfa(wf_n+1,wf_n+5,str_castle) ) { bf_n=bfn;
               if ( vgl(Y["n+_lock_pe"],wf_n+1,bf_n-1) ||
                    bfa(wf_n+1,bf_n-1,"_lock_prl") ||
                    vex(Y["tn_ok_vi"]) )
                { wf_n=bf_n=""; Z[1162]++; if(dbg){print "Z1162"}; };
...
function FN_lock_prl_f(str_lock,    ret, stopp, bb_n,bf_n,qb_n,qf_n,wb_n,wf_n) { stopp_str="FN" str_lock "_f"; stopp=v2s(Y[stopp_str]);
  while ( !stopp ) {
    ...
    { Z[1187]++; if(dbg){print "Z1187", "-- _castle_prl_geo -- break"}; stopp=1; ret=0; continue };

    cst="вернуться";
    if ( vex(Y["tn_ok_v"]) && vex(Y["n-_gl_v_castle-iv"]) && bw(Y["n-_gl_v_castle-iv"],cst) && TN_v_zamok_f() )
    { Z[1188]++; if(dbg){print "Z1188", "-- TN_v_zamok_f"}; stopp=ret=1; continue };
    if ( vex(Y["tn_ok_v"]) && vgl(Y["n-_suw_v_castle-vp"],Y["n_pre_v_ist"]-3,Y["n_pre_v_ist"]-1) && TN_v_zamok_f() )
    { Z[1189]++; if(dbg){print "Z1189", "-- TN_v_zamok_f"}; stopp=ret=1; continue };
    # _lock_prl:escape
    ...
    # _lock_prl:start
       ...
       if ( iwrd == "замок") {
          ...
          { l[i]=omo2; Z[1191]++; if(dbg){print "Z1191"}; stopp=ret=1; continue }; #uphere
       ...
       if ( iwrd == "замками") {
          ...
          { l[i]=omo2; Z[1225]++; if(dbg){print "Z1225"}; stopp=ret=1; continue };
       };
       if ( iwrd == "замках") {
          if ( s(-1) && q(-1,"prl_mnpr") && ba(-1,str_lock) )
          { l[i]=omo2; Z[1226]++; if(dbg){print "Z1226"}; stopp=ret=1; continue };
...
function FN_zamok_suwro_f(    ret, stopp_str, stopp, bb_n,bf_n,qb_n,qf_n,wb_n,wf_n) { stopp=v2s(Y["FN_zamok_suwro_f"]);
 ...
 if ( wfa(1,5,"_castle_suw-ro") ) { wf_n=wfn;
    ...
    { wf_n=""; Z[1228]++; if(dbg){print "Z1228"}; };
    cst3="ломать щелкнуть";
    if ( vgl(wf_n,1,5) && s(-1,wf_n-1) && bw(-1,cst3) )
    { wf_n=""; Z[1229]++; if(dbg){print "Z1229"}; };

    if ( vgl(wf_n,1,5) && s(0,wf_n-1) &&
         qir(1,wf_n-1,"prl_ro mest_ro prq_ro prl_kred_sr nar_step") )
    { l[i]=omo1; Z[1230]++; if(dbg){print "Z1230"}; stopp=ret=1; continue }; #check_!под
 };
 # _castle_suw-ro:end
 ...
 if ( wfa(1,5,"_lock_suw-ro") ) { wf_n=wfn;
       ...
       if ( vgl(wf_n,1,5) && s(0,wf_n-1) && !( isname(wf_n)||isname(1) ) &&
            qir(1,wf_n-1,"prl_ro mest_ro prq_ro qik_im qip_ro") )
       { l[i]=omo2; Z[1232]++; if(dbg){print "Z1232"}; stopp=ret=1; continue };
