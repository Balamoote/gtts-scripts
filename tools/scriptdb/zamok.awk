...
#if ( w(-1,"в") && w(0,"замок") &&
#     bba(-7,-2,"_gl_v_castle_main") && s(bbn,-1) )
...
sz_iili(-3) &&
 ...
 { l[i]=omo1; Z[211]++; if(dbg){print "Z211",qfn}; continue };
 if ( w(-2,"с со") &&
...
#   if ( q(-2,"mdqast")  )
#   { l[i]=omo1; Z[410]++; if(dbg){print "Z410", l[i-2]}; continue };
    if ( ba(-4,"_gl_v_castle_main") &&
          q(-3,"prl_vi prl_im mest_vi mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          q(-2,"suw_vi suw_im mest_vi suw_edne mest_im mest_3e gl_in prl_kred_sr nar_any qast name_vi_sy isname") &&
          w(-1,"в") && s(-4,-3) && (s(-2)||z(-2)) && s(-1) )
    ...
    if ( ba(-5,"_gl_v_castle_main") &&
          q(-4,"mest_vi suw_vi mest_da suw_da mest_3e nar_any prl_kred_sr isname") &&
     pre_tv(-3) &&
          q(-2,"mest_tv suw_tv suw_edne isname") &&
          w(-1,"в") && s(-5,-1) )
    ...
    if ( ba(-6,"_gl_v_castle_main") &&
          q(-5,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-4,"mest_vi suw_vi mest_3e isname") &&
     pre_tv(-3) &&
          q(-2,"mest_tv suw_tv suw_edne isname") &&
          w(-1,"в") && s(-6,-1) )
...
#   { l[i]=omo2; Z[630]++; if(dbg){print "Z630"}; continue };
  ...
  if ( wb(-4,-1,"о") && s(wbn,-1) ) {
   ...
   sz_iili(2) &&
    ...
    if ( qxs(1,"на","кирпичи кирпичики") &&
        base(-1,cst) && s(-1) )
    { l[i]=omo1; Z[774]++; if(dbg){print "Z774"}; continue };
    ...
    if ( ba(-3,"_lock_pe") &&
          ...
          q(-1,"suw_tv") && s(-3,-1) )
    { l[i]=omo2; Z[820]++; if(dbg){print "Z820"}; continue };
    if ( ba(-3,"_lock_pe") &&
          q(-2,"prq_vi") &&
          q(-1,"suw_tv") && s(-3,-1) )
    ...
    if ( ba(-5,"_lock_pe") &&
     pre_vi(-4) &&
          ...
          q(-2,"prl_vi prq_vi mest_vi mest_3e") &&
          q(-1,"prl_vi prq_vi mest_vi mest_3e") && s(-5,-1) )
    { l[i]=omo2; Z[829]++; if(dbg){print "Z829"}; continue };
    if ( ba(-6,"_lock_pe") &&
     pre_vi(-5) &&
          q(-4,"suw_vi mest_vi") &&
          q(-3,"nar_napr") &&
 ...
 #
    ...
    if ( prl_da(-1) &&
             ba(-1,"_castle_prl_geo") && s(-1)  )
    { l[i]=omo1; Z[884]++; if(dbg){print "Z884"}; continue };
    if ( prl_da(-2) &&
             ba(-2,"_castle_prl_geo") &&
              Q(-1,"suw_any") && s(-2,-1)  )
    { l[i]=omo1; Z[885]++; if(dbg){print "Z885"}; continue };
    if ( prl_da(1) &&
             ba(1,"_castle_prl_geo") && s(0) && !(prl_da(1)))
