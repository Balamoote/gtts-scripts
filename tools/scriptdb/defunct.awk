...
function sw_da_f(rett, stopp) { while (stopp == 0) {
 #
 if ( (gl_pnin(-1)||gl_pned(-1)||gl_pnmn(-1)||deep_pn(-1)) && nmark(-1,"GG","Ud") && s(-1,-1) )
 { rett=stopp=1; d[93]++; if(dbg){print "D93"}; continue };
 if ( (gl_pnin(1)||gl_pned(1)||gl_pnmn(1)||deep_pn(1)) && nmark(1,"GG","Ud") && s(0,0) &&
       W(0,"смогу") )
 { rett=stopp=1; d[93]++; if(dbg){print "D93"}; continue };
...
function sw_tv_f(rett, stopp) { while (stopp == 0) {
 #
 if ( (gl_pnin(-1)||gl_pned(-1)||gl_pnmn(-1)||deep_pn(-1)) && nmark(-1,"GG","Ut") && s(-1,-1) )
 { rett=stopp=1; d[93]++; if(dbg){print "D93"}; continue };
 if ( (gl_pnin(1)||gl_pned(1)||gl_pnmn(1)||deep_pn(1)) && nmark(1,"GG","Ut") && s(0,0) )
 { rett=stopp=1; d[93]++; if(dbg){print "D93"}; continue };
...
function sw_ro_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (gl_nein(-1)||gl_need(-1)||gl_nemn(-1)||gl_vzed(-1)||deep_ne(-1)) && nmark(-1,"GG","Nnero") && s(-1,-1) )
 { rett=0; stopp=1; d[5]++; if(dbg){print "D5"}; continue };


 if ( (mest_ro(-2)||suw_edro(-2)||suw_mnro(-2)) &&
       (gl_pnin(-1)||gl_pned(-1)||gl_pnmn(-1)||deep_pn(-1)) && nmark(-1,"GG","Ur") && s(-2,-1) )
 { rett=0; stopp=1; d[80]++; if(dbg){print "D80"}; continue };
 ...
 if ( (suw_edim(-1)||suw_mnim(-1)) && !(prl_edim(-1)||prl_mnim(-1)||mest_im(-1)) &&
       (gl_pein(1)||gl_peed(1)||gl_pemn(1)||gl_pnin(1)||gl_pned(1)||gl_pnmn(1)) &&
        (prl_edvi(2)||prl_mnvi(2)||mest_vi(2)) &&
         (suw_edvi(3)||suw_mnvi(3)) && s(-1,2) )
 { rett=stopp=1; d[82]++; if(dbg){print "D82"}; continue };
 if ( (suw_edim(-1)||suw_mnim(-1)) && !(prl_edim(-1)||prl_mnim(-1)||mest_im(-1)) &&
       (gl_pein(1)||gl_peed(1)||gl_pemn(1)||gl_pnin(1)||gl_pned(1)||gl_pnmn(1)) &&
        (suw_edvi(2)||suw_mnvi(2)||gl_in(2)||prl_kred_sr(2)||mest_vi(2)||nar_step(2)) && s(-1,1) )
 { rett=stopp=1; d[82]++; if(dbg){print "D82"}; continue };

 if ( (suw_edtv(-1)||suw_mntv(-1)) &&
	 (gl_pein(1)||gl_peed(1)||gl_pemn(1)) && s(-1,0) )
 { rett=stopp=1; d[82]++; if(dbg){print "D82"}; continue };
 if ( (suw_edda(-1)||suw_mnda(-1)) &&
	 (gl_pein(1)||gl_peed(1)||gl_pemn(1)) && s(-1,0) )
 { rett=stopp=1; d[82]++; if(dbg){print "D82"}; continue };

 if ( (mest_im(-5)||suw_edim(-5)||suw_mnim(-5)) &&
       pre_ro(-4) &&
       (prl_edro(-3)||prl_mnro(-3)||mest_ro(-3)) &&
        (prl_edro(-2)||prl_mnro(-2)) &&
         (suw_edro(-1)||suw_mnro(-1)) && s(-5,-1) )
 { rett=stopp=1; d[82]++; if(dbg){print "D82"}; continue };
 if ( (mest_im(-4)||suw_edim(-4)||suw_mnim(-4)) &&
        pre_ro(-3) &&
        (prl_edro(-2)||prl_mnro(-2)||mest_ro(-2)) &&
         (suw_edro(-1)||suw_mnro(-1)) && s(-4,-1) )
 { rett=stopp=1; d[82]++; if(dbg){print "D82"}; continue };
 if ( (mest_im(-3)||suw_edim(-3)||suw_mnim(-3)) && prex!=1 &&
        pre_ro(-2) &&
         (suw_edro(-1)||suw_mnro(-1)) && s(-3,-1) )
 { rett=stopp=1; d[82]++; if(dbg){print "D82"}; continue };
...
function sw_edro_f(rett,   stopp) { while (stopp == 0) {
 ...
 if ( (gl_pnin(-3)||gl_pned(-3)||gl_pnmn(-3)||deep_pn(-3)) && nmark(-3,"GG","Pt-v") &&
       pre_tv(-2) &&
       (suw_edtv(-1)||suw_mntv(-1)||mest_tv(-1)) && s(-2,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[1]++; if(dbg){print "D1"}; continue };
 if ( !(w(-4,"не") && s(-4,-4)) && nmark(-3,"GG","Pd-v") &&
        (gl_pnin(-3)||gl_pned(-3)||gl_pnmn(-3)||deep_pn(-3)) &&
          pre_da(-2) &&
          (suw_edda(-1)||suw_mnda(-1)||mest_da(-1)) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[2]++; if(dbg){print "D2"}; continue };


 if ( narph_any(-1) &&
      gl_nemn(xsn-1) && s(xsn-1,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[6]++; if(dbg){print "D6"}; continue };

 if ( se(-1,"-") && suw_mnim(0) && suw_mnim(-1) && prl_mnim(-2) )
 { rett=0; edro2mnim=1; stopp=1; d[7]++; if(dbg){print "D7"}; continue };
 if ( se(-1,"-") && suw_mnim(0) && suw_mnim(-1) && Q(-1,"suw_edro") )
 { rett=0; edro2mnim=1; stopp=1; d[8]++; if(dbg){print "D8"}; continue };
 

 if ( !(w(-2,"не") && s(-2,-2)) &&
      deep_na(-1) && s(-1,-1) )
 { rett=0; stopp=1; d[9]++; if(dbg){print "D9"}; continue };
 if ( suw_edzeim(-1) && (mark("Ycla","paedze")||mark("Ycla","plkrez")) && s(-1,-1) )
 { rett=0; stopp=1; d[10]++; if(dbg){print "D10"}; continue };
 if ( suw_mnim(-1) && mark("Ycla","pamn") && s(-1,-1) )
 { rett=0; stopp=1; d[11]++; if(dbg){print "D11"}; continue };
 if ( preph_vi(-1)||preph_da(-1)||preph_tv(-1) )
 { rett=0; stopp=1; d[12]++; if(dbg){print "D12"}; continue };
 ...
 { rett=0; edro2mnvi=1; stopp=1; d[19]++; if(dbg){print "D19"}; continue };
 if ( (prl_mnim(-3)||prq_mnim(-3)) &&
        pre_ro(-2) &&
         (suw_edro(-1)||suw_mnro(-1)) && suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[20]++; if(dbg){print "D20"}; continue };
 if ( (prl_mnim(-3)||prq_mnim(-3)) &&
       (suw_edtv(-2)||suw_mntv(-2)) &&
        (suw_edro(-1)||suw_mnro(-1)) && suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[21]++; if(dbg){print "D21"}; continue };
 if ( gl_nemn(-3) &&
      (prl_mnim(-2)||prq_mnim(-2)) &&
       (suw_edtv(-1)||suw_mntv(-1)) &&
         suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[22]++; if(dbg){print "D22"}; continue };
 if ( (prl_mn(-4)||prq_mn(-4)) && sc(-4,",") &&
        pre_pr(-3) &&
         suw_mnpr(-2) &&
         (suw_edro(-1)||suw_mnro(-1)) && suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[23]++; if(dbg){print "D23"}; continue };
 if ( pre_ro(-2) &&
      (suw_edro(-1)||suw_mnro(-1)) &&
       (prl_krmn(1)||gl_mn(1)) && suw_mnvi(0) && s(-2,0) && sv(-2,0,"-") && p(1) )
 { rett=0; edro2mnvi=1; stopp=1; d[24]++; if(dbg){print "D24"}; continue };
 if ( (prl_mnim(-4)||prq_mnim(-4)) &&
        pre_pr(-3) &&
         mest_pr(-2) &&
         (suw_edpr(-1)||suw_mnpr(-1)) && s(-4,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[25]++; if(dbg){print "D25"}; continue };
 if ( (gl_pned(-4)||gl_pnmn(-4)) &&
        nar_kaq(-3) &&
         pre_da(-2) &&
         (suw_edda(-1)||suw_mnda(-1)||mest_da(-1)) && s(-4,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[26]++; if(dbg){print "D26"}; continue };
 if ( (prl_srav(-4)||nar_srav(-4)||w(-4,"более мало менее много столько сколько")) &&
       pre_da(-3) && s(-4,-3) &&
        (suw_edda(-2)||suw_mnda(-2)) && sc(-2,",") &&
        w(-1,"чем нежели") && s(-1,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[27]++; if(dbg){print "D27"}; continue };
 if ( (prl_srav(-2)||nar_srav(-2)||w(-2,"более мало менее много столько сколько")) && sc(-2,",") &&
        w(-1,"чем нежели") && s(-1,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[28]++; if(dbg){print "D28"}; continue };

 if ( (suw_edro(1)||suw_mnro(1)||isname(-3)) &&
       (nar_spos(2)||prl_kred_sr(2)) &&
        (gl_nemn(3)||gl_vzmn(3)) && s(0,2) )
 { rett=0; edro2mnvi=1; stopp=1; d[29]++; if(dbg){print "D29"}; continue };
 ...
 if ( (gl_need(-3)||gl_nemn(-3)) &&
        pre_pr(-2) &&
        (suw_edpr(-1)||suw_mnpr(-1)||mest_pr(-1)) && s(-3,-1) )
 ...
 if ( (prl_srav(-2)||nar_srav(-2)||w(-2,"более мало менее много столько сколько")) &&
       (prl_edro(-1)||prq_edro(-1)||w(-1,"же")) && s(-2,-1) && !(gl_in(1) && s(0,0)) )
 ...
 if ( (pre_tv(-3)||preph_tv(-3)) &&
       (suw_edtv(-2)||suw_mntv(-2)||mest_tv(-2)) &&
 ...
 if ( pre_pr(-4) &&
       prq_edpr(-3) &&
        (suw_edtv(-2)||suw_mntv(-2)) &&
         (suw_edda(-1)||suw_mnda(-1)||suw_edme(-1)) && s(-4,-1) )
...
function sw_em_v_f(rett, stopp) { while (stopp == 0) {
 ...
 #_#_#
 if (prex == 1) {
 if ( (prex_vi(-3)||preph_vi(-3)) &&
       (prl_edmuvi(-2)||prq_edmuvi(-2)||mest_edmuvi(-2)||wc(-2,"^[0-9]+$")) &&
        (prl_edmuvi(-1)||prq_edmuvi(-1)||mest_edmuvi(-1)||wc(-1,"^[0-9]+$")) && s(-3,-1) )
...
function sw_em_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; d[210]++; if(dbg){print "D210"}; continue };
#if ( (gl_nein(-2)||gl_need(-2)||gl_nemn(-2)||deep_ne(-2)) && nmark(-2,"GG","Pd-t") &&
#        pre_da(-1) && s(-2,-1) )
#{ rett=stopp=1; d[70]++; if(dbg){print "D70"}; continue };
 if ( (gl_pnin(-1)||gl_pned(-1)||gl_pnmn(-1)||deep_pn(-1)) && nmark(-1,"GG","Ud") && s(-1,-1) )
 { rett=stopp=1; d[71]++; if(dbg){print "D71"}; continue };
 if ( (gl_pein(-1)||gl_peed(-1)||gl_pemn(-1)||deep_pe(-1)) && nmark(-1,"GG","Ud") && s(-1,-1) )
 ...
 #_#_#
 if (prex == 1) {
 if ( (prex_da(-3)||preph_da(-3)) &&
       (prl_edmuda(-2)||prq_edmuda(-2)||mest_edmuda(-2)||wc(-2,"^[0-9]+$")) &&
        (prl_edmuda(-1)||prq_edmuda(-1)||mest_edmuda(-1)||wc(-1,"^[0-9]+$")) && s(-3,-1) )
...
function sw_em_t_f(rett, stopp) { while (stopp == 0) {
 ...
 #_#_#
 if (prex == 1) {
 if ( (prex_tv(-3)||preph_tv(-3)) &&
       (prl_edmutv(-2)||prq_edmutv(-2)||mest_edmutv(-2)||wc(-2,"^[0-9]+$")) &&
        (prl_edmutv(-1)||prq_edmutv(-1)||mest_edmutv(-1)||wc(-1,"^[0-9]+$")) && s(-3,-1) )
...
function sw_em_p_f(rett, stopp) { while (stopp == 0) {
 #
 if ( ismark(-1,"Npre") )
 { rett=0; stopp=1; d[101]++; if(dbg){print "D101"}; continue };
 #_#_#
 if (prex == 1) {
 if ( prex_pr(-3) &&
      (prl_edmupr(-2)||prq_edmupr(-2)||mest_edmupr(-2)||wc(-2,"^[0-9]+$")) &&
       (prl_edmupr(-1)||prq_edmupr(-1)||mest_edmupr(-1)||wc(-1,"^[0-9]+$")) && s(-3,-1) )
...
function sw_es_v_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( (prex_vi(-3)||preph_vi(-3)) &&
       (prl_edsrvi(-2)||prq_edsrvi(-2)||mest_edmuvi(-2)) &&
        (prl_edsrvi(-1)||prq_edsrvi(-1)||mest_edmuvi(-1)) && s(-3,-1) )
...
function sw_es_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (preph_ro(-1)||prl_edsrro(-1)||prq_edsrro(-1)||mest_edsrro(-1)) && W(-1,"его него чем") && s(-1,-1) )
...
function sw_es_d_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( (prex_da(-3)||preph_da(-3)) &&
       (prl_edsrda(-2)||prq_edsrda(-2)||mest_edmuda(-2)) &&
        (prl_edsrda(-1)||prq_edsrda(-1)||mest_edmuda(-1)) && s(-3,-1) )
...
function sw_es_t_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( (prex_tv(-3)||preph_tv(-3)) &&
       (prl_edsrtv(-2)||prq_edsrtv(-2)||mest_edmutv(-2)) &&
        (prl_edsrtv(-1)||prq_edsrtv(-1)||mest_edmutv(-1)) && s(-3,-1) )
...
function sw_ez_i_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; d[164]++; if(dbg){print "D164"}; continue };
 if ( (mest_ro(-2)||suw_edro(-2)||suw_mnro(-2)) &&
       (gl_pnin(-1)||gl_pned(-1)||gl_pnmn(-1)||deep_pn(-1)) && nmark(-1,"GG","Ur") && s(-2,-1) )
 { rett=stopp=1; d[165]++; if(dbg){print "D165"}; continue };
 if ( (mest_ro(-1)||suw_edro(-1)||suw_mnro(-1)) &&
       (gl_pnin(1)||gl_pned(1)||gl_pnmn(1)||deep_pn(1)) && nmark(1,"GG","Ur") && s(-1,0) )
...
function sw_ez_v_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( (prex_vi(-3)||preph_vi(-3)) &&
       (prl_edzevi(-2)||prq_edzevi(-2)||mest_edzevi(-2)) &&
        (prl_edzevi(-1)||prq_edzevi(-1)||mest_edzevi(-1)) && s(-3,-1) )
...
function sw_ez_d_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( (prex_da(-3)||preph_da(-3)) &&
       (prl_edzeda(-2)||prq_edzeda(-2)||mest_edzeda(-2)) &&
        (prl_edzeda(-1)||prq_edzeda(-1)||mest_edzeda(-1)) && s(-3,-1) )
...
function sw_em_l_f(rett, stopp) { while (stopp == 0) {
 ...
 #
 if ( w(-3,"в на") &&
      (prl_edmupr(-2)||prq_edmupr(-2)||mest_pr(-2)||mest_vi(-2)||wc(-2,"^[0-9]+$")) &&
       (prl_edmupr(-1)||prq_edmupr(-1)||mest_pr(-1)||mest_vi(-1)||wc(-1,"^[0-9]+$")) && s(-3,-1) )
...
function sw_ez_l_f(rett, stopp) { while (stopp == 0) {
 ...
 #
 if ( w(-3,"в на") &&
      (prl_edzepr(-2)||prq_edzepr(-2)||mest_pr(-2)||mest_vi(-2)) &&
       (prl_edzepr(-1)||prq_edzepr(-1)||mest_pr(-1)||mest_vi(-1)) && s(-2,-1) )
...
function sw_ez_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( (prex_ro(-3)||preph_ro(-3)) &&
       (prl_edzero(-2)||prq_edzero(-2)||mest_edzero(-2)) &&
        (prl_edzero(-1)||prq_edzero(-1)||mest_edzero(-1)) && s(-3,-1) )
...
function sw_ez_t_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( (prex_tv(-3)||preph_tv(-3)) &&
       (prl_edzetv(-2)||prq_edzetv(-2)||mest_edzetv(-2)) &&
        (prl_edzetv(-1)||prq_edzetv(-1)||mest_edzetv(-1)) && s(-3,-1) )
...
function sw_ez_p_f(rett, stopp) { while (stopp == 0) {
 ...
 if (prex == 1) {
 if ( prex_pr(-3) &&
      (prl_edzepr(-2)||prq_edzepr(-2)||mest_edzepr(-2)) &&
       (prl_edzepr(-1)||prq_edzepr(-1)||mest_edzepr(-1)) && s(-3,-1) )
...
function sw_mn_i_f(rett, stopp) { while (stopp == 0) {
 if ( edro2mnim==1 )
 { edro2mnim==""; rett=stopp=1; d[225]++; if(dbg){print "D225"}; continue };
 if ( sw_im_f() )
 { rett=stopp=1; d[210]++; if(dbg){print "D210"}; continue };
 ...
 if ( pre_pr(-3) &&
      (prl_edpr(-2)||prq_edpr(-2)||mest_pr(-2)) &&
       (suw_edpr(-1)||suw_mnpr(-1)||suw_edme(-1)) &&
...
function sw_mn_p_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( pre_pr(-1) && s(-1,-1) )
 { rett=stopp=1; d[272]++; if(dbg){print "D272"}; continue };
 };#_#_#
break}; return rett }
...
function pl_kr_em_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (w(-1,cst)||suw_edmuim(-1)) && s(-1,-1) && (p(0)||gl_in(1)||pre_any(1)) )
...
function gl_inf_f(rett, stopp) { while (stopp == 0) {
 if ( (mod_ed(-1)||mod_mn(-1)||mod_bz(-1)) && s(-1,-1) )
