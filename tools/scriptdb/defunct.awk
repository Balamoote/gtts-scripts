...
function sw_im_f(rett, stopp) { while (stopp == 0) {
 ...
 #
 if ( (qxs(-1,"а и но","вот как где сколько","и же его ее её их")||
       qxs(-1,"а и","вот")||
       qxs(-1,"вот","и же его ее её их")||
       qxs(-1,"вот","мне тебе ей вам нам им","и")||
         w(-1,"вот") ) && s(-1) )
 { rett=stopp=1; D[6]++; if(dbg){print "D6"}; continue };
 if ( (qxs(-3,"а и но","вот как где сколько","и же его ее её их")||
       qxs(-3,"а и","вот")||
       qxs(-3,"вот","и же его ее её их")||
 ...
 if ( q(-3,"mest_it") &&
    qxs(-1,"всего ведь же","лишь только просто его ее её их не") && s(-3) )
 { rett=stopp=1; D[24]++; if(dbg){print "D24"}; continue };
 if ( q(-2,"mest_it") &&
      w(-1,"же ж лишь только просто его ее её их не") && s(-2,-1) )
 { rett=stopp=1; D[25]++; if(dbg){print "D25"}; continue };
#if ( q(-2,"mest_it") &&
#      w(-1,"не его ее её их") && s(-2,-1) )
...
#{ rett=stopp=1; D[110]++; if(dbg){print "D110"}; continue };
 ...
 { rett=0; stopp=1; edro2mnvi=1; D[119]++; if(dbg){print "D119"}; continue };
 ...
 { rett=0; stopp=1; edro2mnvi=1; D[121]++; if(dbg){print "D121"}; continue };

 if ( q(-2,"gl_pein gl_peed gl_pemn deep_pe") &&
      q(-1,"nar_any") && s(-2,-1) )
 { rett=0; stopp=1; edro2mnvi=1; D[122]++; if(dbg){print "D122"}; continue };
 if ( q(-2,"gl_pnin gl_pned gl_pnmn gl_popned gl_popnmn deep_pn") &&
      q(-1,"nar_napr") && s(-2,-1) && W(0,"сорок"))
 { rett=0; stopp=1; edro2mnvi=1; D[123]++; if(dbg){print "D123"}; continue };
#if ( q(-2,"gl_pnin gl_pned gl_pnmn deep_pn") &&
#     q(-1,"nar_any") && s(-2,-1) )
#{ rett=0; stopp=1; edro2mnvi=1; D[124]++; if(dbg){print "D124"}; continue };
 if ( q(-4,"gl_pein gl_peed gl_pemn deep_pe") && !(qxs(-2,"то","есть")||w(-1,"как много немного")) &&
      q(-3,"nar_any") &&
      q(-2,"suw_vi") &&
sz_iili(-1) && s(-4,-1) )
 { rett=0; stopp=1; edro2mnvi=1; D[125]++; if(dbg){print "D125"}; continue };

 if ( pre_tv(-3) && p(-4) &&
           q(-2,"mest_tv suw_tv") &&
           q(-1,"gl_in gl_ed gl_mn deep") && s(-3,-1) && p(0) )
 { rett=0; stopp=1; edro2mnim=1; D[126]++; if(dbg){print "D126"}; continue };
 if ( q(-2,"mest_ro suw_ro") &&
      q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && regn(-1,"Ur") && s(-2,-1) )
 { rett=0; stopp=1; edro2mnvi=1; D[127]++; if(dbg){print "D127"}; continue };
...
sz_iili(-3) &&
 ...
 if ( sz_iili(1) &&
            q(2,"prq_ro") &&
       pre_pr(3) &&
           (q(4,"mest_pr suw_pr")||w(4,"него нее неё них")) &&
            q(5,"suw_ro") && s(0,4) )
 { rett=stopp=1; D[139]++; if(dbg){print "D139"}; continue };
 if ( q(-3,"prq_edro") &&
 pre_pr(-2) &&
     (q(-1,"mest_pr suw_pr")||w(-1,"него нее неё них")) && s(-3,-1) )
...
sz_iili(-1) &&
 ...
 if ( q(1,"mest_im suw_im") && s(0,1) &&
          narph_any(2) &&
      w(xwn+1,"не") &&
      q(xwn+2,"gl_peed gl_pemn gl_pein gl_pned gl_pnmn gl_pnin prq_any") && regn(xwn+2,"Ynero") && s(xwn,xwn+1) )
...
sz_iili(-2) &&
 ...
 if ( Q(0,"suw_edne") && sz_iili(1) &&
      q(2,"suw_im") && Q(2,"suw_edro") && s(0,1) && type(2,"unit") )
...
function sw_edro_f(rett,   stopp) { while (stopp == 0) {
 ...
 { rett=stopp=1; stopp=1; D[227]++; if(dbg){print "D227"}; continue };
...
sz_iili(-2) &&
 ...
 { rett=0; stopp=1; edro2mnim=1; D[251]++; if(dbg){print "D251"}; continue };
 ...
 if ( prq_mnim(-3) &&
        pre_ro(-2) &&
             q(-1,"suw_ro") &&
      suw_mnim(1) && s(-3,0) )
 { rett=stopp=1; stopp=1; D[256]++; if(dbg){print "D256"}; continue };
 if ( q(-2,"prl_mnim prq_mnim") &&
         suw_mnim(-1) && Q(-1,"prl_mnim") &&
      q(1,"gl_mn gl_vzmn") && s(-2,0) )
 { rett=stopp=1; stopp=1; D[257]++; if(dbg){print "D257"}; continue };
 #
 if ( q(-3,"pre_vi") &&
      q(-2,"suw_vi") &&
      q(-1,"suw_edro") &&
 ...
 pre_tv(-2) &&
      q(-1,"suw_tv mest_tv") && s(-2,-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[260]++; if(dbg){print "D260"}; continue };
 if ( Ww_(-4,"не") && regn(-3,"Pd-v") &&
        q(-3,"gl_pnin gl_pned gl_pnmn deep_pn") &&
   pre_da(-2) &&
        q(-1,"suw_da mest_da") && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[261]++; if(dbg){print "D261"}; continue };

 if ( q(-2,"mest_mnim") &&
      q(-1,"mest_im mest_3e") && s(-2,-1) )
 { rett=0; edro2mnim=1; stopp=1; D[262]++; if(dbg){print "D262"}; continue };
 if ( q(-1,"mest_mnim") && s(-1) )
 { rett=0; edro2mnim=1; stopp=1; D[263]++; if(dbg){print "D263"}; continue };
 if ( q(-3,"mest_mnim") &&
         suw_mnim(-2) &&
sz_iili(-1) && s(-3,-1) )
 { rett=0; edro2mnim=1; stopp=1; D[264]++; if(dbg){print "D264"}; continue };

 if ( narph_any(-1) && s(-1) &&
        gl_nemn(xwn-1) && s(xwn-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[265]++; if(dbg){print "D265"}; continue };

 if ( se(-1,"-") && suw_mnim(0) && suw_mnim(-1) && prl_mnim(-2) )
 { rett=0; edro2mnim=1; stopp=1; D[266]++; if(dbg){print "D266"}; continue };
 if ( se(-1,"-") && suw_mnim(0) && suw_mnim(-1) && Q(-1,"suw_edro") )
 { rett=0; edro2mnim=1; stopp=1; D[267]++; if(dbg){print "D267"}; continue };
 #
 if ( p(-1) &&
      q(1,"prl_ro prq_ro") &&
      q(2,"suw_ro") &&
     (q(3,"suw_ro")||name_ro_sy(3)) && sc(3,",") &&
         prq_mnim(4) && s(-1,1) )
 { rett=0; edro2mnim=1; stopp=1; D[268]++; if(dbg){print "D268"}; continue };
 if ( p(-1) &&
      q(1,"suw_ro") &&
     (q(2,"suw_ro")||name_ro_sy(2)||isname(2)) && sc(2,",") &&
         prq_mnim(3) && s(0,1) )
 { rett=0; edro2mnim=1; stopp=1; D[269]++; if(dbg){print "D269"}; continue };


 if ( Ww_(-2,"не") &&
  deep_na(-1) && s(-1) )
 { rett=0; stopp=1; D[270]++; if(dbg){print "D270"}; continue };
 if ( suw_edzeim(-1) && q(0,"gl_paedze prl_kred_ze") && s(-1) )
 { rett=0; stopp=1; D[271]++; if(dbg){print "D271"}; continue };
 if ( suw_mnim(-1) && q(0,"gl_pamn") && s(-1) )
 { rett=0; stopp=1; D[272]++; if(dbg){print "D272"}; continue };
 if ( q(-1,"preph_vi preph_da preph_tv") && s(-1))
 { rett=0; stopp=1; D[273]++; if(dbg){print "D273"}; continue };
 ...
 if ( Ww_(-3,"не") && !(wmark("TY","part")) &&
        ...
        q(-1,"suw_da mest_da") && suw_mnvi(0) && Q(0,"gl_in") && s(-2,-1) )
 ...
 pre_ro(-2) &&
      q(-1,"suw_ro") && suw_mnvi(0) && s(-3,-1) &&
           !(suw_mnim(1) && s(1)) )
 { rett=0; edro2mnvi=1; stopp=1; D[281]++; if(dbg){print "D281"}; continue };
 if ( q(-3,"prl_mnim prq_mnim") &&
      q(-2,"suw_tv") &&
      q(-1,"suw_ro") && suw_mnvi(0) && s(-3,-1) )
 ...
 { rett=0; edro2mnvi=1; stopp=1; D[285]++; if(dbg){print "D285"}; continue };
 if ( q(-4,"prl_mnim prq_mnim") &&
 pre_pr(-3) &&
mest_pr(-2) &&
      q(-1,"suw_pr") && s(-4,-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[286]++; if(dbg){print "D286"}; continue };
 if ( q(-4,"gl_pned gl_pnmn") &&
nar_kaq(-3) &&
 pre_da(-2) &&
      q(-1,"suw_da mest_da") && s(-4,-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[287]++; if(dbg){print "D287"}; continue };
 ...
 { rett=0; stopp=1; edro2mnim=1; D[288]++; if(dbg){print "D288"}; continue };
 ...
 if ( (q(-4,"prl_srav nar_srav")||w(-4,cst)) &&
  pre_da(-3) && s(-4,-3) &&
       q(-2,"suw_da") && sc(-2,",") &&
       w(-1,"чем нежели") && s(-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[289]++; if(dbg){print "D289"}; continue };
 if ( (q(-2,"prl_srav nar_srav")||w(-2,cst)) && sc(-2,",") &&
       w(-1,"чем нежели") && s(-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[290]++; if(dbg){print "D290"}; continue };

 if ( q(1,"suw_ro isname") &&
      q(2,"nar_spos prl_kred_sr") &&
      q(3,"gl_nemn gl_vzmn") && s(0,2) )
 { rett=0; edro2mnvi=1; stopp=1; D[291]++; if(dbg){print "D291"}; continue };

 ##

 if ( se(0,"-") && q(1,"suw_ro") && Q(1,"suw_mnim") )
 { rett=stopp=1; stopp=1; D[292]++; if(dbg){print "D292"}; continue };
 if ( se(-1,"-") && q(-1,"suw_ro") && Q(-1,"suw_mnim") )
 { rett=stopp=1; stopp=1; D[293]++; if(dbg){print "D293"}; continue };
...
sz_iili(-1) && s(-3,-1) )
 ...
 if ( q(-4,"prl_edzero prq_edzero mest_edzero muk_edro") && W(-4,"его нее неё ее её") &&
           suw_edzero(-3) &&
sz_iili(-2) &&
      q(-1,"mest_ro") && s(-4,-1) &&
   !( q(1,"prq_mnim") && sc(0,",") ) )
 { rett=stopp=1; D[316]++; if(dbg){print "D316"}; continue };
 if ( q(-3,"prl_edzero prq_edzero mest_edzero muk_edro") && W(-3,"его нее неё ее её") &&
           suw_edzero(-2) &&
sz_iili(-1) && s(-3,-1) &&
   !( q(1,"prq_mnim") && sc(0,",") ) )
...
function sw_em_i_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=stopp=1; D[411]++; if(dbg){print "D411"}; continue };
 if ( q(-2,"mest_it") &&
      w(-1,"не") && s(-2,-1) )
 { rett=stopp=1; D[412]++; if(dbg){print "D412"}; continue };
 if ( q(-1,"mest_it") && s(-1) )
...
#{ rett=stopp=1; D[417]++; if(dbg){print "D417"}; continue };
 ...
 if ( sw_im_f() )
 { rett=stopp=1; D[420]++; if(dbg){print "D420", "sw_im_f"}; continue };

break}; return rett }

function sw_em_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; D[421]++; if(dbg){print "D421", "sw_vi_f"}; continue };

 if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && s(-1) &&
   !(q_(0,swo_edmu_ro) && q_(0,sw_edmu_ro)) )
 { rett=stopp=1; D[422]++; if(dbg){print "D422"}; continue };
...
function sw_em_d_f(rett, stopp) { while (stopp == 0) {
 if ( loc2emd==1 )
 { rett=stopp=1; D[430]++; if(dbg){print "D430", "sw_da_f"}; continue };

 if ( sw_da_f() )
 { rett=stopp=1; D[431]++; if(dbg){print "D431", "sw_da_f"}; continue };
...
function sw_em_r_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=stopp=1; D[445]++; if(dbg){print "D445"}; continue };
 if ( q(-2,"prl_edmuro prl_mnro") &&
      q(-1,"mest_da suw_da") && s(-2,-1) )
 { rett=stopp=1; D[446]++; if(dbg){print "D446"}; continue };

 #_#_#
 if ( q(-3,"pre_ro preph_ro") &&
     (q(-2,"prl_edmuro prq_edmuro mest_ro")||wc(-2,"^[0-9]+$")||wc(-2,".[ео]го$ [ео]ва$")) &&
     (q(-1,"prl_edmuro prq_edmuro")||wc(-1,"^[0-9]+$")||wc(-1,"[ео]го$ [ео]ва$")) && s(-3,-1) )
 { rett=stopp=1; D[447]++; if(dbg){print "D447"}; continue };
 if ( q(-2,"pre_ro preph_ro") &&
     (q(-1,"prl_edmuro prq_edmuro mest_ro")||wc(-1,"^[0-9]+$")||wc(-1,".[ео]го$ [ео]ва$")) && W(-1,"него нее неё них") && s(-2,-1) )
...
mest_3e(-1) && s(-2,-1) )
 ...
 { rett=stopp=1; D[453]++; if(dbg){print "D453"}; continue };

 if ( sw_edro_f() )
 { rett=stopp=1; D[454]++; if(dbg){print "D454", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; D[455]++; if(dbg){print "D455", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[456]++; if(dbg){print "D456"}; continue };

break}; return rett }

function sw_em_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; D[457]++; if(dbg){print "D457", "sw_tv_f"}; continue };
...
function sw_em_p_f(rett, stopp) { while (stopp == 0) {
 #
 if ( ismark(-1,"Npre") )
 { rett=0; stopp=1; D[462]++; if(dbg){print "D462"}; continue };
 ...
 if ( q(-2,"pre_pr") &&
      q(-1,"prl_edmupr prq_edmupr mest_edmupr") && s(-2,-1) && W(-1,"мне нём нем") )
 ...
 { rett=stopp=1; D[466]++; if(dbg){print "D466"}; continue };
...
function sw_msz_z_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=stopp=1; D[474]++; if(dbg){print "D474"}; continue };

 if ( suw_any(-2) && type(-2,"unit") &&
            q(-1,"prl_edro prq_edro mest_ro") && s(-2,-1) )
 { rett=stopp=1; stopp=1; D[475]++; if(dbg){print "D475"}; continue };
 ...
 { rett=stopp=1; D[478]++; if(dbg){print "D478"}; continue };
 ...
 { rett=stopp=1; D[482]++; if(dbg){print "D482"}; continue };

break}; return rett }

function sw_em_z_f(rett, stopp) { if (wmark("TY","part")) { while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; D[483]++; if(dbg){print "D483", "sw_msz_z_f"}; continue };
 ...
 { rett=stopp=1; D[486]++; if(dbg){print "D486"}; continue };

break};}; return rett }

function sw_es_z_f(rett, stopp) { if (wmark("TY","part")) { while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; D[487]++; if(dbg){print "D487", "sw_msz_z_f"}; continue };
...
function sw_ez_z_f(rett, stopp) { if (wmark("TY","part")) { while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; D[491]++; if(dbg){print "D491", "sw_msz_z_f"}; continue };
 ...
 if ( (w(-1,cst)||q(-1,"suw_edtv prl_edzero mest_edzero")) && s(-1) && W(-1,"ее её") )
...
function sw_es_i_f(rett, stopp) { while (stopp == 0) {
 if ( sw_im_f() )
 { rett=stopp=1; D[495]++; if(dbg){print "D495", "sw_im_f"}; continue };
 ...
 if ( q(-2,"gl_edsr") &&
      q(-1,"qast") && s(-2,-1) )
 { rett=stopp=1; D[502]++; if(dbg){print "D502"}; continue };
 if ( q(-1,"gl_edsr") && s(-1) )
...
function sw_es_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; D[511]++; if(dbg){print "D511", "sw_vi_f"}; continue };
...
function sw_es_r_f(rett, stopp) { while (stopp == 0) {
 ...
 pre_vi(-2) &&
      q(-1,"suw_vi") && s(-4,-1) )
 { rett=stopp=1; D[516]++; if(dbg){print "D516"}; continue };
 if ( (w(-2,"нет")||q(-2,"pre_ro qi_duom")||wc(-2,"[234][^0-9]*$")) &&
       q(-1,"prl_mnro prq_mnro mest_mnro") && s(-2,-1) && W(-1,"него нее неё них") )
 { rett=stopp=1; D[517]++; if(dbg){print "D517"}; continue };
 if ( (w(-1,"нет")||qi_duom(-1)||wc(-1,"[234][^0-9]*$")) && s(-1) )
 { rett=stopp=1; D[518]++; if(dbg){print "D518"}; continue };
 if ( w(-3,"не") &&
 ...
 if ( sw_edro_f() )
 { rett=stopp=1; D[525]++; if(dbg){print "D525", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; D[526]++; if(dbg){print "D526", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[527]++; if(dbg){print "D527"}; continue };
 ...
 if ( q(-2,"pre_ro preph_ro") &&
     (q(-1,"prl_edsrro prq_edsrro mest_edsrro")||wc(-1,"[ео]го$ [ео]ва$")) && W(-1,"него нее неё них") && s(-2,-1) )
 ...
 if ( q(-3,"pre_ro preph_ro") &&
     (q(-2,"prl_edsrro prq_edsrro mest_edsrro")||wc(-2,"[ео]го$ [ео]ва$")) && W(-2,"него нее неё них") && s(-3,-2) && sc(-1,"-") )
 ...
 if ( q(-2,"preph_ro prl_edsrro prq_edsrro mest_edsrro muk_edsrro") &&
      w(-1,"его ее её их же") && s(-2,-1) )
 { rett=stopp=1; D[534]++; if(dbg){print "D534"}; continue };
...
function sw_es_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; D[536]++; if(dbg){print "D536", "sw_da_f"}; continue };
 #
 ...
 { rett=stopp=1; D[542]++; if(dbg){print "D542"}; continue };
break}; return rett }

function sw_es_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; D[543]++; if(dbg){print "D543", "sw_tv_f"}; continue };
 #_#_#
 if ( q(-3,"pre_tv preph_tv") &&
 ...
 { rett=stopp=1; D[545]++; if(dbg){print "D545"}; continue };
...
function sw_ez_i_f(rett, stopp) { while (stopp == 0) {
 if ( sw_im_f() )
 { rett=stopp=1; D[551]++; if(dbg){print "D551", "sw_im_f"}; continue };
 ...
 { rett=0; stopp=1; D[554]++; if(dbg){print "D554"}; continue };
 if ( q(-2,"mest_ro suw_ro") &&
      q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && regn(-1,"Ur") && s(-2,-1) )
 ...
 if ( q(-2,"mest_it") &&
      w(-1,"не") && s(-2,-1) )
 { rett=stopp=1; D[559]++; if(dbg){print "D559"}; continue };
 if ( q(-1,"mest_it") && s(-1) )
 ...
 { rett=stopp=1; D[567]++; if(dbg){print "D567"}; continue };

break}; return rett }

function sw_ez_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; D[568]++; if(dbg){print "D568", "sw_vi_f"}; continue };
 ...
 { rett=stopp=1; D[575]++; if(dbg){print "D575"}; continue };
break}; return rett }

function sw_ez_d_f(rett, stopp) { while (stopp == 0) {
 if ( loc2ezd==1 )
 { rett=stopp=1; D[576]++; if(dbg){print "D576", "sw_da_f"}; continue };

 if ( sw_da_f() )
 { rett=stopp=1; D[577]++; if(dbg){print "D577", "sw_da_f"}; continue };
 if ( muk_edzeda(-2) &&
...
function sw_em_l_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; loc2emd=1; D[584]++; if(dbg){print "D584"}; continue };
 if ( id(-1,"hw4loc") && s(-1) )
 { rett=stopp=1; D[585]++; if(dbg){print "D585"}; continue };

 #
 if ( pre_pr(-3) &&
    prq_edpr(-2) &&
           q(-1,"suw_tv") && s(-3,-1) )
 { rett=stopp=1; D[586]++; if(dbg){print "D586"}; continue };
 #
 if ( w(-4,"в") && s(-3) && s(-4,-3) &&
      q(-3,"prl_edmupr prq_edmupr mest_edmupr mest_3e") &&
      q(-2,"prl_edmupr prq_edmupr mest_edmupr mest_3e") && (sc(-2,",")||s(-2)) &&
     wc(-1,"^[0-9]+$") && s(-1) )
 { rett=stopp=1; D[587]++; if(dbg){print "D587"}; continue };
 if ( w(-3,"в") && s(-3) &&
      q(-2,"prl_edmupr prq_edmupr mest_edmupr mest_3e") && (sc(-2,",")||s(-2)) &&
     wc(-1,"^[0-9]+$") && s(-1) )
...
function sw_ez_l_f(rett, stopp) { while (stopp == 0) {
 ...
 !( (wb(-5,-1,"в во на") && !(sq(wbn,-1,"[….:;!?]"))) || (wf(1,3,"в во на") && !(sq(0,wfn-1,"[….:;!?]")))) )
 { rett=0; stopp=1; loc2emd=1; D[594]++; if(dbg){print "D594"}; continue };
 if ( (regn(-2,"Nme")||type(-2,"dvi del")) &&
          w(-1,"в во на") && s(-2,-1) )
 { rett=0; stopp=1; D[595]++; if(dbg){print "D595"}; continue };
 if ( type(-2,"vos") &&
         w(-1,"на") && s(-2,-1) )
 { rett=0; stopp=1; D[596]++; if(dbg){print "D596"}; continue };
 #
 if ( !(regn(-4,"Nme") && s(-4) ) &&
      pre_pr(-3) &&
    prq_edpr(-2) &&
...
function sw_ez_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (w(-2,"нет")||qi_duoz(-2)||wc(-2,"[234][^0-9]*$")) &&
       q(-1,"prl_edzero prl_edzero prq_edzero prq_edzero mest_ro muk_edzero") && W(-1,"него нее неё них") && s(-2,-1) )
 ...
 { rett=stopp=1; D[604]++; if(dbg){print "D604"}; continue };
 if ( (w(-1,"нет")||qi_duoz(-1)||wc(-1,"[234][^0-9]*$")) && s(-1) )
 { rett=stopp=1; D[605]++; if(dbg){print "D605"}; continue };
 if ( muk_edzero(-2) &&
               w(-1,"же лишь только") && s(-2,-1) )
 { rett=stopp=1; D[606]++; if(dbg){print "D606"}; continue };
 if ( muk_edzero(-1) && s(-1) )
 ...
 if ( sw_edro_f() )
 { rett=stopp=1; D[613]++; if(dbg){print "D613", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; D[614]++; if(dbg){print "D614", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[615]++; if(dbg){print "D615"}; continue };
 ...
 if ( q(-2,pre_string) &&
     (q(-1,"prl_edzero prq_edzero mest_edzero muk_edzero mest_3e")||wc(-1,"[ео]й$ [ео]йся$")) && W(-1,"нее неё") && s(-2,-1) )
 { rett=stopp=1; D[617]++; if(dbg){print "D617"}; continue };
 if ( q(-1,pre_string) && s(-1) )
 { rett=stopp=1; D[618]++; if(dbg){print "D618"}; continue };
 if ( q(-3,pre_string) &&
      q(-2,"suw_ro") &&
sz_iili(-1) && s(-3,-1) )
 ...
 if ( (q(-1,"preph_ro prl_edzero mest_edzero muk_edzero")||wc(-1,"ской$ [ео]вой$")) && W(-1,"нее неё ее её") && s(-1) )
...
function sw_ez_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; D[627]++; if(dbg){print "D627", "sw_tv_f"}; continue };
 ...
 { rett=stopp=1; D[629]++; if(dbg){print "D629"}; continue };
...
function sw_mn_i_f(rett, stopp) { while (stopp == 0) {
 if ( edro2mnim==1 )
 { edro2mnim==""; rett=stopp=1; D[638]++; if(dbg){print "D638"}; continue };
...
sz_iili(-1) &&
 ...
 if ( q(-3,"mest_mnim") &&
    qxs(-1,"всего ведь же","лишь только просто его ее её их") && s(-3) )
 { rett=stopp=1; D[679]++; if(dbg){print "D679"}; continue };
 if ( q(-2,"mest_mnim") &&
      w(-1,"же ж лишь только просто его ее её их") && s(-2,-1) )
...
sz_iili(3) &&
      q(4,"prl_ro prq_ro") &&
      q(5,"suw_ro") && p(5) )
 { rett=stopp=1; D[764]++; if(dbg){print "D764"}; continue };
 if ( p(-1,",") &&
 pre_ro(1) &&
      q(2,"suw_ro") &&
sz_iili(3) &&
 ...
 if ( sw_im_f() )
 { rett=stopp=1; D[775]++; if(dbg){print "D775", "sw_im_f"}; continue };
break}; return rett }
...
sz_iili(-2) &&
 ...
 if (prex == 1) { pre_string = "prex_vi preph_vi" } else { pre_string = "pre_vi preph_vi" };
 if ( q(-2,pre_string) &&
      q(-1,"prl_mnvi prq_mnvi mest_vi") && W(-1,"него нее неё них") && s(-2,-1) )
...
sz_iili(-1) && s(-2,-1) && Q(0,"gl_paedze") )
 ...
 { rett=stopp=1; D[849]++; if(dbg){print "D849"}; continue };
 if ( q(-4,"gl_pein gl_peed gl_pemn deep_pe") && Q(-4,"gl_nein gl_pnin gl_need gl_nemn gl_vzmn gl_pned gl_pnmn deep_pn deep_ne") &&
 pre_vi(-3) &&
      q(-2,"suw_vi") &&
      q(-1,"mest_vi") && s(-3,-1) )
 { rett=stopp=1; D[850]++; if(dbg){print "D850"}; continue };
 if ( q(-3,"gl_pein gl_peed gl_pemn deep_pe") && Q(-3,"gl_nein gl_pnin gl_need gl_nemn gl_vzmn gl_pned gl_pnmn deep_pn deep_ne") &&
 pre_tv(-2) && !(regn(-3,"Ynero")) &&
      q(-1,"suw_tv mest_tv") && s(-3,-1) )
 { rett=stopp=1; D[851]++; if(dbg){print "D851"}; continue };
...
function sw_mn_r_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; D[862]++; if(dbg){print "D862"}; continue };
 if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && regn(-1,"Nnero") && s(-1) )
 { rett=0; stopp=1; D[863]++; if(dbg){print "D863"}; continue };
 if ( q(-1,"gl_nein gl_need gl_nemn gl_vzmn gl_vzed deep_ne") && regn(-1,"Nnero") && s(-1) )
 { rett=0; stopp=1; D[864]++; if(dbg){print "D864"}; continue };
 ...
 { rett=stopp=1; D[877]++; if(dbg){print "D877"}; continue };
 ...
 { rett=stopp=1; D[878]++; if(dbg){print "D878"}; continue };
 if ( Q(0,"gl_paedmu") && q(-1,pre_string) && s(-1) )
 { rett=stopp=1; D[879]++; if(dbg){print "D879"}; continue };
...
suw_edtv(-1) && s(-3,-1) )
 ...
 #
 if ( sw_ro_f() )
 { rett=stopp=1; D[890]++; if(dbg){print "D890", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[891]++; if(dbg){print "D891"}; continue };
...
function sw_mn_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; D[892]++; if(dbg){print "D892", "sw_da_f"}; continue };
 #_#_#
 if (prex == 1) { pre_string = "prex_da preph_da" } else { pre_string ="pre_da preph_da" };
 if ( q(-2,pre_string) &&
...
function pl_kr_ez_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (w(-2,cst)||suw_edzeim(-1)) &&
       w(-1,"же не ведь всё-таки все-таки таки и") && s(-2,-1) )
...
function gl_ed1e_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( w(-2,"я") &&
   qast(-1) && s(-2,-1) )
 { rett=stopp=1; D[1003]++; if(dbg){print "D1003"}; continue };
 if ( w(-1,"я") && s(-1) )
 { rett=stopp=1; D[1004]++; if(dbg){print "D1004"}; continue };
break}; return rett }
...
function gl_ed3e_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (w(-2,"он она оно")||q(-2,"suw_edim mest_it")) &&
       q(-1,"prl_kred_sr nar_mest nar_spos") &&
       q(1,"suw_vi pre_any") && s(-2,0) )
 { rett=stopp=1; D[1005]++; if(dbg){print "D1005"}; continue };
 if ( (w(-2,"он она оно")||q(-2,"suw_edim mest_it")) &&
       q(1,"prl_kred_sr nar_mest nar_spos") &&
       q(2,"suw_vi pre_any") && s(-1,1) )
 { rett=stopp=1; D[1006]++; if(dbg){print "D1006"}; continue };
 if ( (w(-2,"он она оно")||q(-2,"suw_edim mest_it")) &&
       q(1,"suw_vi nar_napr nar_spos gl_in pre_any") && s(-1,0) )
...
function gl_mn2e_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; mn2e2pomn=1; D[1016]++; if(dbg){print "D1016"}; continue };
 if ( w(-2,"а да") &&
      w(-1,"вы") && s(-2,-1) && Q_w(1,"mest_da suw_da") &&
      W(0,"шутите гоните"))
 { rett=0; stopp=1; mn2e2pomn=1; D[1017]++; if(dbg){print "D1017"}; continue };
 if ( w(-2,"вы") &&
      w(-1,"только лучше") && s(-2,-1) )
 { rett=0; stopp=1; mn2e2pomn=1; D[1018]++; if(dbg){print "D1018"}; continue };
 if ( w(-3,"вы") &&
      q(-2,"mest_vi suw_vi") &&
      w(-1,"не") && s(-3,-1) && p(0,"?") )
 { rett=0; stopp=1; mn2e2pomn=1; D[1019]++; if(dbg){print "D1019"}; continue };
 ...
 { rett=stopp=1; D[1020]++; if(dbg){print "D1020"}; continue };
 #
 if ( wb(-5,-2,"как") &&
       w(wbn-1,"бы долго же") && s(wbn,-1) )
 { rett=stopp=1; D[1021]++; if(dbg){print "D1021"}; continue };
 #
 if ( wb(-5,-1,"вы") && s(wbn,-1) )
 { rett=stopp=1; D[1022]++; if(dbg){print "D1022"}; continue };
 if ( vvb(-5,-1) &&
        w(vvn,"вы") && Ww_(vvn-1,"а") )
 { rett=stopp=1; D[1023]++; if(dbg){print "D1023"}; continue };
 if ( vvb(-5,-1) &&
       wb(vvn-5,vvn,"вы") && s(wbn,vvn-1) )
 { rett=stopp=1; D[1024]++; if(dbg){print "D1024"}; continue };
 #
 if ( sc(0,"?") )
 { rett=stopp=1; D[1025]++; if(dbg){print "D1025"}; continue };
 #
 if ( sc(0,",") &&
       q(1,"mod_mn") &&
       w(2,"не") &&
       q(3,"gl_in") && s(1,2) )
 { rett=stopp=1; D[1026]++; if(dbg){print "D1026"}; continue };
#if ( sc(0,",") &&
#      w(1,"не") &&
#       q(2,"gl_povzmn") && s(1) )
#{ rett=stopp=1; D[1027]++; if(dbg){print "D1027"}; continue };
break}; return rett }
...
function nar_spos_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=stopp=1; D[1028]++; if(dbg){print "D1028"}; continue };
 #
 if ( p(-2) &&
      q(-1,"gl_mn gl_vzmn") &&
      q(1,"mest_mnim suw_mnim") && s(-1,0) )
 { rett=stopp=1; D[1029]++; if(dbg){print "D1029"}; continue };
 #
 if ( p(-3) &&
      q(-2,"gl_mn gl_vzmn") &&
      q(-1,"mest_mnim suw_mnim") && s(-2,-1) )
 { rett=stopp=1; D[1030]++; if(dbg){print "D1030"}; continue };
