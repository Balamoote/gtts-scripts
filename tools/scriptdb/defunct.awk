...
#{ rett=stopp=1; d[100]++; if(dbg){print "D100"}; continue };
 ...
 { rett=0; stopp=1; edro2mnvi=1; d[102]++; if(dbg){print "D102"}; continue };
 if ( !(q(-3,"suw_mnim") && sc(-3,",")) &&
      q(-2,"prq_mnvi") &&
       nar_mest(-1) && pre_ro(-1) && s(-2,-1) &&
      !(q(1,"prl_mnim suw_mnim") && s(1)) )
 { rett=0; stopp=1; edro2mnvi=1; d[103]++; if(dbg){print "D103"}; continue };

 if ( w(-2,"не") && q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && regn(-1,"Nnero") && s(-2,-1) )
 { rett=0; stopp=1; edro2mnvi=1; d[104]++; if(dbg){print "D104"}; continue };
 if ( w(-2,"не") && q(-1,"gl_pein gl_peed gl_pemn deep_pe") && regn(-1,"Nnero") && s(-2,-1) )
 { rett=0; stopp=1; edro2mnvi=1; d[105]++; if(dbg){print "D105"}; continue };
 if ( w(-2,"не") && q(-1,"gl_nein gl_need gl_nemn gl_vzmn gl_vzed deep_ne") && regn(-1,"Nnero") && s(-2,-1) )
 { rett=0; stopp=1; edro2mnvi=1; d[106]++; if(dbg){print "D106"}; continue };
 if ( Qw_(-2,"pre_ro preph_ro") && !(w(-2,"не") && regn(-1,"Ynero") && s(-2) ) &&
         q(-1,"mest_mnim mest_mnvi prl_mnim prl_mnvi prq_mnim prq_mnvi") && Q(-1,"mest_edim mest_edvi") && s(-1) )
 { rett=0; stopp=1; edro2mnvi=1; d[107]++; if(dbg){print "D107"}; continue };
 ...
 { rett=0; stopp=1; edro2mnvi=1; d[108]++; if(dbg){print "D108"}; continue };

 if ( pre_tv(-3) && p(-4) &&
      q(-2,"mest_tv suw_edtv suw_mntv") &&
       q(-1,"gl_in gl_ed gl_mn deep") && s(-3,-1) && p(0) )
 { rett=0; stopp=1; edro2mnim=1; d[109]++; if(dbg){print "D109"}; continue };
 if ( q(-2,"mest_ro suw_edro suw_mnro") &&
       q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && regn(-1,"Ur") && s(-2,-1) )
 { rett=0; stopp=1; edro2mnvi=1; d[110]++; if(dbg){print "D110"}; continue };
...
function sw_edro_f(rett,   stopp) { while (stopp == 0) {
 ...
 if ( suw_any(-2) && type(-2,"unit") &&
       q(-1,"prl_edro prq_edro mest_ro") && s(-2,-1) )
 { rett=stopp=1; stopp=1; d[210]++; if(dbg){print "D210"}; continue };
 if ( suw_any(-1) && type(-1,"unit") && s(-1) )
 ...
 { rett=0; stopp=1; edro2mnim=1; d[234]++; if(dbg){print "D234"}; continue };
 ...
 if ( prq_mnim(-3) &&
       pre_ro(-2) &&
        q(-1,"suw_edro suw_mnro") &&
	 suw_mnim(1) && s(-3,0) )
 { rett=stopp=1; stopp=1; d[239]++; if(dbg){print "D239"}; continue };
 if ( q(-2,"prl_mnim prq_mnim") &&
       suw_mnim(-1) && Q(-1,"prl_mnim") &&
	q(1,"gl_mn gl_vzmn") && s(-2,0) )
 { rett=stopp=1; stopp=1; d[240]++; if(dbg){print "D240"}; continue };
 #
 if ( q(-3,"pre_vi") &&
       q(-2,"suw_edvi suw_mnvi") &&
        q(-1,"suw_edro") &&
 ...
 if ( q(-3,"gl_pnin gl_pned gl_pnmn deep_pn") && regn(-3,"Pt-v") &&
       pre_tv(-2) &&
        q(-1,"suw_edtv suw_mntv mest_tv") && s(-2,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[243]++; if(dbg){print "D243"}; continue };
 if ( Ww_(-4,"не") && regn(-3,"Pd-v") &&
         q(-3,"gl_pnin gl_pned gl_pnmn deep_pn") &&
          pre_da(-2) &&
           q(-1,"suw_edda suw_mnda mest_da") && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[244]++; if(dbg){print "D244"}; continue };

 if ( q(-2,"mest_mnim") &&
       q(-1,"mest_im mest_3e") && s(-2,-1) )
 { rett=0; edro2mnim=1; stopp=1; d[245]++; if(dbg){print "D245"}; continue };
 if ( q(-1,"mest_mnim") && s(-1) )
 { rett=0; edro2mnim=1; stopp=1; d[246]++; if(dbg){print "D246"}; continue };
 if ( q(-3,"mest_mnim") &&
       suw_mnim(-2) &&
        souz_iili(-1) && s(-3,-1) )
 { rett=0; edro2mnim=1; stopp=1; d[247]++; if(dbg){print "D247"}; continue };

 if ( narph_any(-1) &&
       gl_nemn(xsn-1) && s(xsn-1,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[248]++; if(dbg){print "D248"}; continue };

 if ( se(-1,"-") && suw_mnim(0) && suw_mnim(-1) && prl_mnim(-2) )
 { rett=0; edro2mnim=1; stopp=1; d[249]++; if(dbg){print "D249"}; continue };
 if ( se(-1,"-") && suw_mnim(0) && suw_mnim(-1) && Q(-1,"suw_edro") )
 { rett=0; edro2mnim=1; stopp=1; d[250]++; if(dbg){print "D250"}; continue };
 # 
 if ( p(-1) &&
       q(1,"prl_edro prl_mnro prq_edro prq_mnro") &&
        ...
        (q(3,"suw_edro suw_mnro")||name_ro_sy(3)) && sc(3,",") &&
          prq_mnim(4) && s(-1,1) )
 { rett=0; edro2mnim=1; stopp=1; d[251]++; if(dbg){print "D251"}; continue };
 if ( p(-1) &&
       q(1,"suw_edro suw_mnro") &&
       (q(2,"suw_edro suw_mnro")||name_ro_sy(2)||isname(2)) && sc(2,",") &&
         prq_mnim(3) && s(0,1) )
 { rett=0; edro2mnim=1; stopp=1; d[252]++; if(dbg){print "D252"}; continue };


 if ( Ww_(-2,"не") &&
         deep_na(-1) && s(-1) )
 { rett=0; stopp=1; d[253]++; if(dbg){print "D253"}; continue };
 if ( suw_edzeim(-1) && q(0,"gl_paedze prl_kred_ze") && s(-1) )
 { rett=0; stopp=1; d[254]++; if(dbg){print "D254"}; continue };
 if ( suw_mnim(-1) && q(0,"gl_pamn") && s(-1) )
 { rett=0; stopp=1; d[255]++; if(dbg){print "D255"}; continue };
 if ( q(-1,"preph_vi preph_da preph_tv") && s(-1))
 { rett=0; stopp=1; d[256]++; if(dbg){print "D256"}; continue };
 if ( Ww_(-3,"не") && !(wmark("TY","part")) &&
         q(-2,"gl_pein gl_peed gl_pemn deep_pe") && Q(-2,"suw_edim") &&
          q(-1,"suw_edtv suw_mntv mest_tv") && suw_mnvi(0) && s(-2,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[257]++; if(dbg){print "D257"}; continue };
 if ( Ww_(-3,"не") &&
         prq_pe(-6) &&
          pre_pr(-5) &&
 ...
 if ( Ww_(-3,"не") && !(wmark("TY","part")) &&
         q(-2,"gl_pnin gl_pned gl_pnmn deep_pn") && Q(-2,"suw_edim") &&
          q(-1,"suw_edtv suw_mntv mest_tv") && suw_mnvi(0) && s(-2,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[259]++; if(dbg){print "D259"}; continue };
 if ( Ww_(-3,"не") && !(wmark("TY","part")) &&
 ...
 { rett=0; edro2mnvi=1; stopp=1; d[262]++; if(dbg){print "D262"}; continue };
 ...
 if ( gl_nemn(-3) &&
       q(-2,"prl_mnim prq_mnim") &&
        q(-1,"suw_edtv suw_mntv") &&
         suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[266]++; if(dbg){print "D266"}; continue };
 ...
 { rett=0; stopp=1; edro2mnim=1; d[271]++; if(dbg){print "D271"}; continue };

 cst="более мало менее много полно столько сколько"
 ...
 { rett=stopp=1; stopp=1; d[275]++; if(dbg){print "D275"}; continue };
 if ( se(-1,"-") && q(-1,"suw_edro suw_mnro") && Q(-1,"suw_mnim") )
 { rett=stopp=1; stopp=1; d[276]++; if(dbg){print "D276"}; continue };
...
#{ rett=stopp=1; d[290]++; if(dbg){print "D290"}; continue };
 ...
 cst="нет хватает хватит достаточно мало много"
...
if ( p(-2) &&
 ...
 if ( Qw_(-4,"pre_any") &&
   ...
   Q(-3,"souz qast pre_any prl_ed prl_mn mest_ed mest_mn gl_ed gl_pemn gl_pnmn gl_nemn nar_vrem narph_any gl_poed") )
...
#{ rett=stopp=1; d[397]++; if(dbg){print "D397"}; continue };
 ...
 if ( sw_im_f() )
 { rett=stopp=1; d[400]++; if(dbg){print "D400", "sw_im_f"}; continue };

break}; return rett }

function sw_em_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; d[401]++; if(dbg){print "D401", "sw_vi_f"}; continue };
...
function sw_em_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; d[410]++; if(dbg){print "D410", "sw_da_f"}; continue };
...
function sw_em_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( sw_edro_f() )
 { rett=stopp=1; d[432]++; if(dbg){print "D432", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; d[433]++; if(dbg){print "D433", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; d[434]++; if(dbg){print "D434"}; continue };

break}; return rett }

function sw_em_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; d[435]++; if(dbg){print "D435", "sw_tv_f"}; continue };
...
function sw_em_p_f(rett, stopp) { while (stopp == 0) {
 #
 if ( ismark(-1,"Npre") )
 { rett=0; stopp=1; d[440]++; if(dbg){print "D440"}; continue };
...
function sw_msz_z_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( suw_any(-2) && type(-2,"unit") &&
       q(-1,"prl_edro prq_edro mest_ro") && s(-2,-1) )
 { rett=stopp=1; stopp=1; d[451]++; if(dbg){print "D451"}; continue };
 if ( suw_any(-1) && type(-1,"unit") && s(-1) )
...
function sw_em_z_f(rett, stopp) { if (wmark("TY","part")) { while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; d[459]++; if(dbg){print "D459", "sw_msz_z_f"}; continue };
...
function sw_es_z_f(rett, stopp) { if (wmark("TY","part")) { while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; d[463]++; if(dbg){print "D463", "sw_msz_z_f"}; continue };
...
function sw_ez_z_f(rett, stopp) { if (wmark("TY","part")) { while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; d[467]++; if(dbg){print "D467", "sw_msz_z_f"}; continue };
...
function sw_es_i_f(rett, stopp) { while (stopp == 0) {
 if ( sw_im_f() )
 { rett=stopp=1; d[471]++; if(dbg){print "D471", "sw_im_f"}; continue };
...
function sw_es_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; d[484]++; if(dbg){print "D484", "sw_vi_f"}; continue };
...
function sw_es_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( sw_edro_f() )
 { rett=stopp=1; d[498]++; if(dbg){print "D498", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; d[499]++; if(dbg){print "D499", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; d[500]++; if(dbg){print "D500"}; continue };
...
function sw_es_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; d[509]++; if(dbg){print "D509", "sw_da_f"}; continue };
 #
...
function sw_es_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; d[516]++; if(dbg){print "D516", "sw_tv_f"}; continue };
 #_#_#
 if ( q(-3,"pre_tv preph_tv") &&
...
function sw_ez_i_f(rett, stopp) { while (stopp == 0) {
 if ( sw_im_f() )
 { rett=stopp=1; d[524]++; if(dbg){print "D524", "sw_im_f"}; continue };

 if ( qf(1,5,"gl_paedze") && s(0,qfn-1) )
 { rett=stopp=1; d[525]++; if(dbg){print "D525"}; continue };
 if ( w(-1,"она") && gl_paedze(0) && s(0) )
 { rett=0; stopp=1; d[526]++; if(dbg){print "D526"}; continue };
 if ( q(-2,"mest_ro suw_edro suw_mnro") &&
       q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && regn(-1,"Ur") && s(-2,-1) )
...
function sw_ez_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; d[540]++; if(dbg){print "D540", "sw_vi_f"}; continue };
 ...
 if ( q(-1,"preph_vi prl_edzevi prq_edzevi mest_edzevi") && s(-1) )
 { rett=stopp=1; d[544]++; if(dbg){print "D544"}; continue };
break}; return rett }

function sw_ez_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; d[545]++; if(dbg){print "D545", "sw_da_f"}; continue };
 if ( muk_edzeda(-2) &&
...
function sw_ez_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( sw_edro_f() )
 { rett=stopp=1; d[577]++; if(dbg){print "D577", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; d[578]++; if(dbg){print "D578", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; d[579]++; if(dbg){print "D579"}; continue };
...
function sw_ez_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; d[591]++; if(dbg){print "D591", "sw_tv_f"}; continue };
...
function sw_mn_i_f(rett, stopp) { while (stopp == 0) {
 if ( edro2mnim==1 )
 { edro2mnim==""; rett=stopp=1; d[601]++; if(dbg){print "D601"}; continue };
...
#{ rett=stopp=1; d[716]++; if(dbg){print "D716"}; continue };
 ...
 if ( sw_im_f() )
 { rett=stopp=1; d[736]++; if(dbg){print "D736", "sw_im_f"}; continue };
break}; return rett }
...
function sw_mn_r_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; d[820]++; if(dbg){print "D820"}; continue };
 if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && regn(-1,"Nnero") && s(-1) )
 { rett=0; stopp=1; d[821]++; if(dbg){print "D821"}; continue };
 if ( q(-1,"gl_nein gl_need gl_nemn gl_vzmn gl_vzed deep_ne") && regn(-1,"Nnero") && s(-1) )
 { rett=0; stopp=1; d[822]++; if(dbg){print "D822"}; continue };
 ...
 #
 if ( sw_ro_f() )
 { rett=stopp=1; d[847]++; if(dbg){print "D847", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; d[848]++; if(dbg){print "D848"}; continue };
...
function sw_mn_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; d[849]++; if(dbg){print "D849", "sw_da_f"}; continue };
 #_#_#
 if (prex == 1) { pre_string = "prex_da preph_da" } else { pre_string ="pre_da preph_da" };
 if ( q(-2,pre_string) &&
...
function pl_kr_em_f(rett, stopp) { while (stopp == 0) {
 cst="я ты он был буду будет стал станет будь стань слишком чересчур весьма очень сильно столь настолько так"
...
function pl_kr_es_f(rett, stopp) { while (stopp == 0) {
 cst="я ты оно было буду будет стало станет будь стань слишком чересчур весьма очень сильно столь настолько так"
 if ( (w(-2,cst)||(suw_mnim(-2) && Q(-2,"suw_edro"))) &&
        prl_kred_sr(-1) && s(-2,-1) )
...
function pl_kr_ez_f(rett, stopp) { while (stopp == 0) {
 cst="я ты она была буду будет стала станет будь стань слишком чересчур весьма очень сильно столь настолько так"
 if ( (w(-2,cst)||(suw_mnim(-2) && Q(-2,"suw_edro"))) &&
        prl_kred_sr(-1) && s(-2,-1) )
...
function pl_krmn_f(rett, stopp) { while (stopp == 0) {
 cst="мы вы они были будем будут стали станем станут будьте станьте слишком чересчур весьма очень сильно столь настолько"
 if ( (w(-2,cst)||(suw_mnim(-2) && Q(-2,"suw_edro"))) &&
        prl_kred_sr(-1) && s(-2,-1) )
...
function gl_mn2e_f(rett, stopp) { while (stopp == 0) {
 #
 if ( qxs(-1,"так","что") )
 { rett=0; stopp=1; mn2e2pomn=1; d[948]++; if(dbg){print "D948"}; continue };
 if ( w(-2,"а да") &&
      w(-1,"вы") && s(-2,-1) && Q_w(1,"mest_da suw_edda suw_mnda") &&
      W(0,"шутите гоните"))
 { rett=0; stopp=1; mn2e2pomn=1; d[949]++; if(dbg){print "D949"}; continue };
 if ( w(-2,"вы") &&
      w(-1,"только лучше") && s(-2,-1) )
 { rett=0; stopp=1; mn2e2pomn=1; d[950]++; if(dbg){print "D950"}; continue };
 if ( w(-3,"вы") &&
       q(-2,"mest_vi suw_edvi suw_mnvi") &&
        w(-1,"не") && s(-3,-1) && p(0,"?") )
 { rett=0; stopp=1; mn2e2pomn=1; d[951]++; if(dbg){print "D951"}; continue };
