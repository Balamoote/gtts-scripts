...
#{ rett=0; stopp=1; edro2mnvi=1; D[125]++; if(dbg){print "D125"}; continue };
 if ( q(-4,"gl_pein gl_peed gl_pemn deep_pe") && !(qxs(-2,"то","есть")||w(-1,"как много немного")) &&
      ...
      q(-2,"suw_vi") &&
sz_iili(-1) && s(-4,-1) )
 { rett=0; stopp=1; edro2mnvi=1; D[126]++; if(dbg){print "D126"}; continue };

 if ( pre_tv(-3) && p(-4) &&
           q(-2,"mest_tv suw_tv") &&
           q(-1,"gl_in gl_ed gl_mn deep") && s(-3,-1) && p(0) )
 { rett=0; stopp=1; edro2mnim=1; D[127]++; if(dbg){print "D127"}; continue };
 if ( q(-2,"mest_ro suw_ro") &&
      q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && ba(-1,"_gg_obj_ro") && s(-2,-1) )
 { rett=0; stopp=1; edro2mnvi=1; D[128]++; if(dbg){print "D128"}; continue };
...
function sw_edro_f(rett,   stopp) { while (stopp == 0) {
 ...
 { rett=stopp=1; stopp=1; D[229]++; if(dbg){print "D229"}; continue };
...
sz_iili(-2) &&
 ...
 { rett=0; stopp=1; edro2mnim=1; D[254]++; if(dbg){print "D254"}; continue };
 ...
 if ( prq_mnim(-3) &&
        pre_ro(-2) &&
             q(-1,"suw_ro") &&
      suw_mnim(1) && s(-3,0) )
 { rett=stopp=1; stopp=1; D[259]++; if(dbg){print "D259"}; continue };
 if ( q(-2,"prl_mnim prq_mnim") &&
         suw_mnim(-1) && Q(-1,"prl_mnim") &&
      q(1,"gl_mn gl_vzmn") && s(-2,0) )
 { rett=stopp=1; stopp=1; D[260]++; if(dbg){print "D260"}; continue };
 #
 if ( q(-3,"pre_vi") &&
      q(-2,"suw_vi") &&
      q(-1,"suw_edro") &&
 ...
 pre_tv(-2) &&
      q(-1,"suw_tv mest_tv") && s(-2,-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[263]++; if(dbg){print "D263"}; continue };
 if ( Ww_(-4,"не") && ba(-3,"_gl_preob_da_obj_vi") &&
        q(-3,"gl_pnin gl_pned gl_pnmn deep_pn") &&
   pre_da(-2) &&
        q(-1,"suw_da mest_da") && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[264]++; if(dbg){print "D264"}; continue };

 if ( q(-2,"mest_mnim") &&
      q(-1,"mest_im mest_3e") && s(-2,-1) )
 { rett=0; edro2mnim=1; stopp=1; D[265]++; if(dbg){print "D265"}; continue };
...
sz_iili(-1) && s(-3,-1) )
 ...
 { rett=0; edro2mnim=1; stopp=1; D[270]++; if(dbg){print "D270"}; continue };
 #
 if ( p(-1) &&
      q(1,"prl_ro prq_ro") &&
      q(2,"suw_ro") &&
     (q(3,"suw_ro")||name_ro_sy(3)) && sc(3,",") &&
         prq_mnim(4) && s(-1,1) )
 { rett=0; edro2mnim=1; stopp=1; D[271]++; if(dbg){print "D271"}; continue };
 if ( p(-1) &&
      q(1,"suw_ro") &&
     (q(2,"suw_ro")||name_ro_sy(2)||isname(2)) && sc(2,",") &&
         prq_mnim(3) && s(0,1) )
 { rett=0; edro2mnim=1; stopp=1; D[272]++; if(dbg){print "D272"}; continue };
 ...
 { rett=0; stopp=1; D[274]++; if(dbg){print "D274"}; continue };
 if ( suw_mnim(-1) && q(0,"gl_pamn") && s(-1) )
 { rett=0; stopp=1; D[275]++; if(dbg){print "D275"}; continue };
 if ( q(-1,"preph_vi preph_da preph_tv") && s(-1))
 { rett=0; stopp=1; D[276]++; if(dbg){print "D276"}; continue };
 if ( Ww_(-3,"не") && !(wa(0,"_is_partitive")) &&
 ...
 { rett=0; edro2mnvi=1; stopp=1; D[288]++; if(dbg){print "D288"}; continue };
 if ( q(-4,"prl_mnim prq_mnim") &&
 pre_pr(-3) &&
mest_pr(-2) &&
      q(-1,"suw_pr") && s(-4,-1) )
...
nar_kaq(-3) &&
 ...
 { rett=0; stopp=1; edro2mnim=1; D[291]++; if(dbg){print "D291"}; continue };
 ...
 if ( (q(-4,"prl_srav nar_srav")||w(-4,cst)) &&
  pre_da(-3) && s(-4,-3) &&
       q(-2,"suw_da") && sc(-2,",") &&
       w(-1,"чем нежели") && s(-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[292]++; if(dbg){print "D292"}; continue };
 if ( (q(-2,"prl_srav nar_srav")||w(-2,cst)) && sc(-2,",") &&
       w(-1,"чем нежели") && s(-1) )
 { rett=0; edro2mnvi=1; stopp=1; D[293]++; if(dbg){print "D293"}; continue };

 if ( q(1,"suw_ro isname") &&
      q(2,"nar_spos prl_kred_sr") &&
      q(3,"gl_nemn gl_vzmn") && s(0,2) )
 { rett=0; edro2mnvi=1; stopp=1; D[294]++; if(dbg){print "D294"}; continue };

 ##

 if ( se(0,"-") && q(1,"suw_ro") && Q(1,"suw_mnim") )
 { rett=stopp=1; stopp=1; D[295]++; if(dbg){print "D295"}; continue };
 if ( se(-1,"-") && q(-1,"suw_ro") && Q(-1,"suw_mnim") )
 { rett=stopp=1; stopp=1; D[296]++; if(dbg){print "D296"}; continue };
...
#{ rett=stopp=1; D[420]++; if(dbg){print "D420"}; continue };
 ...
 if ( sw_im_f() )
 { rett=stopp=1; D[423]++; if(dbg){print "D423", "sw_im_f"}; continue };

break}; return rett }

function sw_em_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; D[424]++; if(dbg){print "D424", "sw_vi_f"}; continue };
...
function sw_em_d_f(rett, stopp) { while (stopp == 0) {
 if ( loc2emd==1 )
 { rett=stopp=1; D[433]++; if(dbg){print "D433", "sw_da_f"}; continue };

 if ( sw_da_f() )
 { rett=stopp=1; D[434]++; if(dbg){print "D434", "sw_da_f"}; continue };
...
mest_3e(-1) && s(-2,-1) )
 ...
 if ( sw_edro_f() )
 { rett=stopp=1; D[457]++; if(dbg){print "D457", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; D[458]++; if(dbg){print "D458", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[459]++; if(dbg){print "D459"}; continue };

break}; return rett }

function sw_em_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; D[460]++; if(dbg){print "D460", "sw_tv_f"}; continue };
...
function sw_em_p_f(rett, stopp) { while (stopp == 0) {
 #
 if ( ismark(-1,"Npre") )
 { rett=0; stopp=1; D[465]++; if(dbg){print "D465"}; continue };
...
function sw_msz_z_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( suw_any(-2) && ba(-2,"_unit") &&
            q(-1,"prl_edro prq_edro mest_ro") && s(-2,-1) )
 { rett=stopp=1; stopp=1; D[478]++; if(dbg){print "D478"}; continue };
...
function sw_em_z_f(rett, stopp) {# if (wa(0,"_is_partitive")) {
    while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; D[486]++; if(dbg){print "D486", "sw_msz_z_f"}; continue };
...
function sw_es_z_f(rett, stopp) {# if (wa(0,"_is_partitive")) {
    while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; D[490]++; if(dbg){print "D490", "sw_msz_z_f"}; continue };
...
function sw_ez_z_f(rett, stopp) {# if (wa(0,"_is_partitive")) {
    while (stopp == 0) {
 if ( sw_msz_z_f() )
 { rett=stopp=1; D[494]++; if(dbg){print "D494", "sw_msz_z_f"}; continue };
...
function sw_es_i_f(rett, stopp) { while (stopp == 0) {
 if ( sw_im_f() )
 { rett=stopp=1; D[498]++; if(dbg){print "D498", "sw_im_f"}; continue };
...
function sw_es_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; D[514]++; if(dbg){print "D514", "sw_vi_f"}; continue };
...
function sw_es_r_f(rett, stopp) { while (stopp == 0) {
 ...
 pre_vi(-2) &&
      q(-1,"suw_vi") && s(-3,-1) )
 { rett=stopp=1; D[527]++; if(dbg){print "D527"}; continue };

 if ( sw_edro_f() )
 { rett=stopp=1; D[528]++; if(dbg){print "D528", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; D[529]++; if(dbg){print "D529", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[530]++; if(dbg){print "D530"}; continue };
...
function sw_es_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; D[539]++; if(dbg){print "D539", "sw_da_f"}; continue };
 #
...
function sw_es_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; D[546]++; if(dbg){print "D546", "sw_tv_f"}; continue };
 #_#_#
 if ( q(-3,"pre_tv preph_tv") &&
...
function sw_ez_i_f(rett, stopp) { while (stopp == 0) {
 if ( sw_im_f() )
 { rett=stopp=1; D[554]++; if(dbg){print "D554", "sw_im_f"}; continue };
 ...
 { rett=0; stopp=1; D[557]++; if(dbg){print "D557"}; continue };
 if ( q(-2,"mest_ro suw_ro") &&
      q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && ba(-1,"_gg_obj_ro") && s(-2,-1) )
 ...
 if (prex == 1) { pre_string = "prex_im" } else { pre_string ="pre_im" };
 if ( q(-1,pre_string) && s(-1) )
 { rett=stopp=1; D[568]++; if(dbg){print "D568"}; continue };
 #_#_#
...
function sw_ez_v_f(rett, stopp) { while (stopp == 0) {
 if ( sw_vi_f() )
 { rett=stopp=1; D[571]++; if(dbg){print "D571", "sw_vi_f"}; continue };
...
function sw_ez_d_f(rett, stopp) { while (stopp == 0) {
 if ( loc2ezd==1 )
 { rett=stopp=1; D[579]++; if(dbg){print "D579", "sw_da_f"}; continue };

 if ( sw_da_f() )
 { rett=stopp=1; D[580]++; if(dbg){print "D580", "sw_da_f"}; continue };
 if ( muk_edzeda(-2) &&
...
function sw_ez_l_f(rett, stopp) { while (stopp == 0) {
 ...
 !( (wb(-5,-1,"в во на") && !(sq(wbn,-1,"[….:;!?]"))) || (wf(1,3,"в во на") && !(sq(0,wfn-1,"[….:;!?]")))) )
 { rett=0; stopp=1; loc2emd=1; D[597]++; if(dbg){print "D597"}; continue };
 if ( bam(-2,"_gg_no_locative _gl_dvizh _gl_make") &&
        w(-1,"в во на") && s(-2,-1) )
 { rett=0; stopp=1; D[598]++; if(dbg){print "D598"}; continue };
 if ( ba(-2,"_gl_learn") &&
       w(-1,"на") && s(-2,-1) )
 { rett=0; stopp=1; D[599]++; if(dbg){print "D599"}; continue };
 #
...
function sw_ez_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( sw_edro_f() )
 { rett=stopp=1; D[620]++; if(dbg){print "D620", "sw_edro_f"}; continue };
 if ( sw_ro_f() )
 { rett=stopp=1; D[621]++; if(dbg){print "D621", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[622]++; if(dbg){print "D622"}; continue };
...
function sw_ez_t_f(rett, stopp) { while (stopp == 0) {
 if ( sw_tv_f() )
 { rett=stopp=1; D[634]++; if(dbg){print "D634", "sw_tv_f"}; continue };
...
function sw_mn_i_f(rett, stopp) { while (stopp == 0) {
 if ( edro2mnim==1 )
 { edro2mnim==""; rett=stopp=1; D[645]++; if(dbg){print "D645"}; continue };
...
sz_iili(3) &&
 ...
 if ( sw_im_f() )
 { rett=stopp=1; D[782]++; if(dbg){print "D782", "sw_im_f"}; continue };
break}; return rett }
...
sz_iili(-1) && s(-2,-1) && Q(0,"gl_paedze") )
 ...
 if ( qb(-8,-4,"gl_pnin gl_pned gl_pnmn deep_pn") &&
     Ww_(qbn-1,"не") && !(wa(0,"_is_partitive")) && Q(qbn,"suw_edim") && suw_mnvi(0) && Q(0,"gl_in") &&
...
function sw_mn_r_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; D[869]++; if(dbg){print "D869"}; continue };
 if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && ba(-1,"_gg_no_nero") && s(-1) )
 { rett=0; stopp=1; D[870]++; if(dbg){print "D870"}; continue };
...
suw_edtv(-1) && s(-3,-1) )
 ...
 #
 if ( sw_ro_f() )
 { rett=stopp=1; D[897]++; if(dbg){print "D897", "sw_ro_f"}; continue };
 if ( edro2mnvi )
 { rett=0; stopp=1; D[898]++; if(dbg){print "D898"}; continue };
...
function sw_mn_d_f(rett, stopp) { while (stopp == 0) {
 if ( sw_da_f() )
 { rett=stopp=1; D[899]++; if(dbg){print "D899", "sw_da_f"}; continue };
 #_#_#
 if (prex == 1) { pre_string = "prex_da preph_da" } else { pre_string ="pre_da preph_da" };
 if ( q(-2,pre_string) &&
...
function gl_paedze_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( suw_edzeim(-3) && s(-3) &&
           gl_ed(-2) && sc(-2,",") &&
               w(-1,"что как") && s(-1) )
 { rett=stopp=1; D[1018]++; if(dbg){print "D1018"}; continue };
break}; return rett }

function gl_mn1e_f(rett, stopp) { while (stopp == 0) {
 #
 if ( wb(-5,-1,"мы если когда коли куда") && s(wbn,-1) )
 { rett=stopp=1; D[1019]++; if(dbg){print "D1019"}; continue };
 #
 if ( p(-1) && p(0) )
...
function gl_mn2e_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; mn2e2pomn=1; D[1023]++; if(dbg){print "D1023"}; continue };
 if ( w(-2,"а да") &&
      w(-1,"вы") && s(-2,-1) && Q_w(1,"mest_da suw_da") &&
      W(0,"шутите гоните"))
 { rett=0; stopp=1; mn2e2pomn=1; D[1024]++; if(dbg){print "D1024"}; continue };
 if ( w(-2,"вы") &&
      w(-1,"только лучше") && s(-2,-1) )
 { rett=0; stopp=1; mn2e2pomn=1; D[1025]++; if(dbg){print "D1025"}; continue };
 if ( w(-3,"вы") &&
      q(-2,"mest_vi suw_vi") &&
      w(-1,"не") && s(-3,-1) && p(0,"?") )
 { rett=0; stopp=1; mn2e2pomn=1; D[1026]++; if(dbg){print "D1026"}; continue };
 ...
 { rett=stopp=1; D[1031]++; if(dbg){print "D1031"}; continue };
 #
 if ( sc(0,"?") )
 { rett=stopp=1; D[1032]++; if(dbg){print "D1032"}; continue };
 #
 if ( sc(0,",") &&
       q(1,"mod_mn") &&
       w(2,"не") &&
       q(3,"gl_in") && s(1,2) )
 { rett=stopp=1; D[1033]++; if(dbg){print "D1033"}; continue };
#if ( sc(0,",") &&
#      w(1,"не") &&
#       q(2,"gl_povzmn") && s(1) )
#{ rett=stopp=1; D[1034]++; if(dbg){print "D1034"}; continue };
break}; return rett }
...
function nar_spos_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=stopp=1; D[1035]++; if(dbg){print "D1035"}; continue };
 #
 if ( p(-2) &&
      q(-1,"gl_mn gl_vzmn") &&
      q(1,"mest_mnim suw_mnim") && s(-1,0) )
 { rett=stopp=1; D[1036]++; if(dbg){print "D1036"}; continue };
 #
 if ( p(-3) &&
      q(-2,"gl_mn gl_vzmn") &&
      q(-1,"mest_mnim suw_mnim") && s(-2,-1) )
 { rett=stopp=1; D[1037]++; if(dbg){print "D1037"}; continue };
