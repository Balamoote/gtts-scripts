...
function sw_da_f(rett, stopp) { while (stopp == 0) {
 #
 if ( q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Ud") && s(-1) )
 { rett=stopp=1; d[31]++; if(dbg){print "D31"}; continue };
 if ( q(1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(1,"GG","Ud") && s(0) &&
       W(0,"смогу") )
...
function sw_tv_f(rett, stopp) { while (stopp == 0) {
 #
 if ( q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Ut") && s(-1) )
 { rett=stopp=1; d[33]++; if(dbg){print "D33"}; continue };
 if ( q(1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(1,"GG","Ut") && s(0) )
...
#{ rett=stopp=1; d[38]++; if(dbg){print "D38"}; continue };
 ...
 if ( q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Nnero") && s(-1) )
 { rett=0; stopp=1; d[39]++; if(dbg){print "D39"}; continue };
 if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && nmark(-1,"GG","Nnero") && s(-1) )
 { rett=0; stopp=1; d[40]++; if(dbg){print "D40"}; continue };
 if ( q(-1,"gl_nein gl_need gl_nemn gl_vzed deep_ne") && nmark(-1,"GG","Nnero") && s(-1) )
 { rett=0; stopp=1; d[41]++; if(dbg){print "D41"}; continue };


 if ( q(-2,"mest_ro suw_edro suw_mnro") &&
       q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Ur") && s(-2,-1) )
 { rett=0; stopp=1; d[42]++; if(dbg){print "D42"}; continue };

 if ( w(1,"не") &&
       q(2,"gl_peed gl_pemn gl_pein gl_pned gl_pnmn gl_pnin") && nmark(2,"GG","NEr") && s(0,1) )
 ...
 if ( q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Ur") && s(-1) )
 { rett=stopp=1; d[43]++; if(dbg){print "D43"}; continue };
 if ( q(-1,"gl_nein gl_need gl_nemn deep_ne") && nmark(-1,"GG","Ur") && s(-1) )
 { rett=stopp=1; d[44]++; if(dbg){print "D44"}; continue };
 if ( q(1,"gl_pein gl_peed gl_pemn") && nmark(1,"GG","Ur") && s(0) && p(-1) )
 ...
 if ( pre_vi(-3) &&
       q(-2,"prl_edvi prl_mnvi mest_vi") &&
        q(-1,"suw_edvi suw_mnvi") && Q(-1,"prl_mnvi") && Qf(5,"gl_mn") && s(-3,-1) )
 ...
 if ( p(-1) &&
       w(1,"не") &&
        q(2,"gl_in gl_ed gl_mn deep") && s(0,1) && p(2) )
...
function sw_edro_f(rett,   stopp) { while (stopp == 0) {
 ...
 { rett=0; edro2mnim=1; stopp=1; d[65]++; if(dbg){print "D65"}; continue };
 if ( se(-1,"-") && suw_mnim(0) && suw_mnim(-1) && Q(-1,"suw_edro") )
 { rett=0; edro2mnim=1; stopp=1; d[66]++; if(dbg){print "D66"}; continue };
 

 if ( !(w(-2,"не") && s(-2)) &&
         deep_na(-1) && s(-1) )
 { rett=0; stopp=1; d[67]++; if(dbg){print "D67"}; continue };
 if ( suw_edzeim(-1) && (wmark("Ycla","paedze")||wmark("Ycla","plkrez")) && s(-1) )
 { rett=0; stopp=1; d[68]++; if(dbg){print "D68"}; continue };
 if ( suw_mnim(-1) && wmark("Ycla","pamn") && s(-1) )
 { rett=0; stopp=1; d[69]++; if(dbg){print "D69"}; continue };
 if ( q(-1,"preph_vi preph_da preph_tv") && s(-1))
 { rett=0; stopp=1; d[70]++; if(dbg){print "D70"}; continue };
 if ( !(w(-3,"не") && s(-3)) && !(wmark("Yro","part")) &&
 ...
 { rett=0; edro2mnvi=1; stopp=1; d[77]++; if(dbg){print "D77"}; continue };
 if ( q(-3,"prl_mnim prq_mnim") &&
       pre_ro(-2) &&
        q(-1,"suw_edro suw_mnro") && suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[78]++; if(dbg){print "D78"}; continue };
 if ( q(-3,"prl_mnim prq_mnim") &&
       q(-2,"suw_edtv suw_mntv") &&
        q(-1,"suw_edro suw_mnro") && suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[79]++; if(dbg){print "D79"}; continue };
 if ( gl_nemn(-3) &&
       q(-2,"prl_mnim prq_mnim") &&
        q(-1,"suw_edtv suw_mntv") &&
         suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[80]++; if(dbg){print "D80"}; continue };
 if ( q(-4,"prl_mn prq_mn") && sc(-4,",") &&
       pre_pr(-3) &&
        suw_mnpr(-2) &&
         q(-1,"suw_edro suw_mnro") && suw_mnvi(0) && s(-3,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[81]++; if(dbg){print "D81"}; continue };
 if ( pre_ro(-2) &&
       q(-1,"suw_edro suw_mnro") &&
        q(1,"prl_krmn gl_mn") && suw_mnvi(0) && s(-2,0) && sv(-2,0,"-") && p(1) )
 { rett=0; edro2mnvi=1; stopp=1; d[82]++; if(dbg){print "D82"}; continue };
 if ( q(-4,"prl_mnim prq_mnim") &&
       pre_pr(-3) &&
        mest_pr(-2) &&
         q(-1,"suw_edpr suw_mnpr") && s(-4,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[83]++; if(dbg){print "D83"}; continue };
 if ( q(-4,"gl_pned gl_pnmn") &&
       nar_kaq(-3) &&
        pre_da(-2) &&
         q(-1,"suw_edda suw_mnda mest_da") && s(-4,-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[84]++; if(dbg){print "D84"}; continue };
 if ( (q(-4,"prl_srav nar_srav")||w(-4,"более мало менее много столько сколько")) &&
        pre_da(-3) && s(-4,-3) &&
         q(-2,"suw_edda suw_mnda") && sc(-2,",") &&
          w(-1,"чем нежели") && s(-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[85]++; if(dbg){print "D85"}; continue };
 if ( (q(-2,"prl_srav nar_srav")||w(-2,"более мало менее много столько сколько")) && sc(-2,",") &&
        w(-1,"чем нежели") && s(-1) )
 { rett=0; edro2mnvi=1; stopp=1; d[86]++; if(dbg){print "D86"}; continue };

 if ( q(1,"suw_edro suw_mnro isname") &&
       q(2,"nar_spos prl_kred_sr") &&
        q(3,"gl_nemn gl_vzmn") && s(0,2) )
 { rett=0; edro2mnvi=1; stopp=1; d[87]++; if(dbg){print "D87"}; continue };
 ...
 if ( !(pre_any(-2) && s(-2)) &&
      suw_any(-1) && s(-1) && (p(0)||w(1,"и или")||pre_any(1)) &&
 ...
 if ( (q(-1,"prl_srav nar_srav")||w(-1,"более мало менее много столько сколько")) && s(-1) && !(gl_in(1) && s(0)) )
...
function sw_em_i_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( q(-1,"prl_edmuim prq_edmuim muk_edim") && s(-1) )
 { rett=stopp=1; d[118]++; if(dbg){print "D118"}; continue };
break}; return rett }

function sw_em_v_f(rett, stopp) { while (stopp == 0) {
 if ( q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Uv") && s(-1) )
 ...
 if ( q(-1,"preph_vi prl_edmuvi prq_edmuvi muk_edvi") && s(-1) )
...
#{ rett=stopp=1; d[129]++; if(dbg){print "D129"}; continue };
 ...
 if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && nmark(-1,"GG","Ud") && s(-1) )
...
function sw_em_t_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( q(-1,"preph_tv prl_edmutv prq_edmutv") && s(-1) )
...
function sw_em_p_f(rett, stopp) { while (stopp == 0) {
 #
 if ( ismark(-1,"Npre") )
 { rett=0; stopp=1; d[159]++; if(dbg){print "D159"}; continue };
 #_#_#
 if (prex == 1) {
 if ( prex_pr(-3) &&
...
function sw_em_z_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (w(-1,"с немного чуть-чуть")||q(-1,"suw_edtv prl_edmuro prq_edmuro mest_edmuro")) && s(-1) )
...
function sw_es_i_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( q(-1,"prl_edsrim prq_edsrim") && s(-1) )
...
function sw_es_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( q(-1,"preph_ro prl_edsrro prq_edsrro mest_edsrro") && W(-1,"его него чем") && s(-1) )
...
function sw_ez_i_f(rett, stopp) { while (stopp == 0) {
 ...
 { rett=0; stopp=1; d[224]++; if(dbg){print "D224"}; continue };
 if ( q(-2,"mest_ro suw_edro suw_mnro") &&
       q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Ur") && s(-2,-1) )
...
function sw_ez_d_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( q(-1,"preph_da prl_edzeda prq_edzeda mest_da") && s(-1) )
...
function sw_mn_i_f(rett, stopp) { while (stopp == 0) {
 if ( edro2mnim==1 )
 { edro2mnim==""; rett=stopp=1; d[283]++; if(dbg){print "D283"}; continue };
 if ( sw_im_f() )
...
function sw_mn_v_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( q(-1,"gl_in gl_ed gl_mn deep gl_poed") && nmark(-1,"GG","Uv") && s(-1) )
 { rett=stopp=1; d[301]++; if(dbg){print "D301"}; continue };
#if ( q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Uv") && s(-1) )
#{ rett=stopp=1; d[302]++; if(dbg){print "D302"}; continue };
#if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && nmark(-1,"GG","Uv") && s(-1) )
#{ rett=stopp=1; d[303]++; if(dbg){print "D303"}; continue };
#if ( q(-1,"gl_nein gl_need gl_nemn deep_ne") && nmark(-1,"GG","Uv") && s(-1) )
#{ rett=stopp=1; d[304]++; if(dbg){print "D304"}; continue };
 ...
 if ( W(-2,"не") &&
       q(-1,"deep_pe gl_peed gl_pein gl_pemn") && qv(-1,"suw_edda suw_edvi") && s(-1) )
...
function sw_mn_r_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( suw_any(-1) && nmark(-1,"GS","qis") && s(-1) )
 { rett=stopp=1; d[314]++; if(dbg){print "D314"}; continue };
 #
 if ( q(-1,"gl_pnin gl_pned gl_pnmn deep_pn") && nmark(-1,"GG","Nnero") && s(-1) )
 { rett=0; stopp=1; d[315]++; if(dbg){print "D315"}; continue };
 if ( q(-1,"gl_pein gl_peed gl_pemn deep_pe") && nmark(-1,"GG","Nnero") && s(-1) )
 { rett=0; stopp=1; d[316]++; if(dbg){print "D316"}; continue };
 if ( q(-1,"gl_nein gl_need gl_nemn gl_vzed deep_ne") && nmark(-1,"GG","Nnero") && s(-1) )
 { rett=0; stopp=1; d[317]++; if(dbg){print "D317"}; continue };
 ...
 if ( (q(-1,"preph_ro prl_mnro prq_mnro qi_ed qi_mn")||wc(-1,"^[0-9]+$")) && s(-1) )
 { rett=stopp=1; d[325]++; if(dbg){print "D325"}; continue };

 #
#if ( q(-1,"qik_im qik_mnim qik_mnro") && s(-1) )
 if ( pre_vi(1) &&
 ...
 if ( !(gl_paedmu_f() && gl_paedmu(0) && s(0) ) &&
...
function pl_krmn_f(rett, stopp) { while (stopp == 0) {
 ...
 if ( (w(-1,"мы вы они были стали")||(suw_mnim(-1) && Q(-1,"suw_edro"))) && s(-1) )
