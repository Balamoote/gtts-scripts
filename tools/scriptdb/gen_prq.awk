...
BEGIN { PROCINFO["sorted_in"]="@ind_num_asc"
  ...
  cst="вылокать выменить карёжить котить меньжеваться прошать псить разгнать разымать распочать руссифицировать руссифицироваться скарёжить скарёжиться убегти \
       успокоивать щеплять обигорить обигоривать сустреть сустретить";
  ...
  cst="держущий держущийся мяучущий подъемлемый подъемлющий претерпенный стелящий стелящийся впечатлевший";
