...
BEGIN { PROCINFO["sorted_in"]="@ind_num_asc"
  ...
  cst="котить прошать псить убегти щеплять вылокать выменить меньжеваться разгнать разымать распочать руссифицировать руссифицироваться успокоивать карёжить скарёжить скарёжиться";
  ...
  cst="держущий держущийся стелящий стелящийся мяучущий подъемлемый подъемлющий претерпенный";
