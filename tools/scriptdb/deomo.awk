...
### все !_#_!
 ...
 { sub(/[Ее]/, "ё", l[i]); r[339]++; if(dbg){print "R339"}; continue;};
 if ( suw_edim(1) && s(0,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[340]++; if(dbg){print "R340"}; continue;};
 if ( mest_mn(-1) && s(-1,-1) &&
       prl_edim(1) &&
        suw_edim(2) && se(0," — ") && s(1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[341]++; if(dbg){print "R341"}; continue;};
 if ( mest_mn(1) && s(0,0) &&
 ...
 if ( gl_in(-1) &&
       ...
       (suw_edpr(2)||suw_mnpr(2)) &&
         prl_edtv(3) && s(-1,2) )
 { sub(/[Ее]/, "ё", l[i]); r[415]++; if(dbg){print "R415"}; continue;};
 if ( mest_mn(-1) &&
...
if ( gl_nemn(1) &&
 ...
 if ( (gl_pemn(1)||gl_nemn(1)||gl_pnmn(1)||gl_vzmn(1)) &&
        w(2,"и") &&
        (gl_pemn(3)||gl_nemn(3)||gl_pnmn(3)||gl_vzmn(3)) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[463]++; if(dbg){print "R463"}; continue;};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[539]++; if(dbg){print "R539"}; continue;};
 if ( (gl_pemn(1)) && sc(1,",") &&
        w(2,"что") && s(0,0) )
 ...
 if ( vv(1) &&
       gl_edsr(vvn+1) )
 { sub(/[Ее]/, "ё", l[i]); r[551]++; if(dbg){print "R551"}; continue;};
