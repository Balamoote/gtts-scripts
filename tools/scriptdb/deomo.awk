...
nf=splitline(book[b]); hyphback(book[b]); getwpos(wrd); for(i in wpos){i=strtonum(i);     # header2
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); sub(/[Ее]/, "ё", l[i+1]); r[15]++; if(dbg){print "R15"}; continue};
 ...
 if ( w(1,"и") &&
       w(2,"всяческие") && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[18]++; if(dbg){print "R18"}; continue};
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); r[21]++; if(dbg){print "R21"}; continue};
 if ( phf(1,"и так") &&
 ...
 if ((phf(1,"на одно лицо")||
      ...
      phf(1,"за и против") ) &&
      s(0,hfn-2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[28]++; if(dbg){print "R28"}; continue};
 ...
 if ( mest_mnim(1) &&
     ...
     (phf(3,"на одно лицо")||
      ...
      s(0,hfn-2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[29]++; if(dbg){print "R29"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[41]++; if(dbg){print "R41"}; continue};
 if ( phf(1,"больше по") &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[77]++; if(dbg){print "R77"}; continue};
 if ( mest_it(1) &&
       mest_mnim(2) &&
       (gl_pnmn(3)||gl_nemn(3)) &&
         pre_any(4) && s(0,4) )
 ...
 if ( phs(-1,"как и") && s(-2,0) &&
       mest_mn(1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[86]++; if(dbg){print "R86"}; continue};
 if ( phs(-2,"как и") && s(-3,-1) &&
       mest_mn(-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[87]++; if(dbg){print "R87"}; continue};
 if ( phs(-1,"как и") &&
       (mest_im(1)||prl_mnim(1)) && s(-2,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[88]++; if(dbg){print "R88"}; continue};
 if ( phs(-1,"как и") &&
       pre_ro(1) &&
        mest_ro(2) && s(-2,1) )
 ...
 if ( w(1,"как") &&
       mod_bz(2) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[94]++; if(dbg){print "R94"}; continue};

 # все как
 if ( w(1,"как") &&
       w(2,"надо нужно есть было") && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[95]++; if(dbg){print "R95"}; continue};
 if ( w(1,"как") &&
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); r[104]++; if(dbg){print "R104"}; continue};
 ...
 if ( mest_mnim(1) && sc(0,",") &&
      (pre_ro(2)||pre_vi(2)) &&
        w(3,"кого") && s(1,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[111]++; if(dbg){print "R111"}; continue};
 if ( (pre_ro(1)||pre_vi(1)) && sc(0,",") &&
       w(2,"кого" ) && s(1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[112]++; if(dbg){print "R112"}; continue};
 if ( pre_vi(1) &&
 ...
 if ( pre_ro(1) &&
       (suw_mnro(2)) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[120]++; if(dbg){print "R120"}; continue};
 if ( pre_ro(1) && sc(0,",") &&
 ...
 if ( w(1,"за") &&
       mest_vi(2) &&
        w(3,"горой") && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[123]++; if(dbg){print "R123"}; continue};
 if ( w(-1,"со ко") && s(-1,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[124]++; if(dbg){print "R124"}; continue};
 if ( w(1,"до") &&
       w(2,"конца") && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[125]++; if(dbg){print "R125"}; continue};
 if ( w(1,"до") &&
       w(2,"единого") && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[126]++; if(dbg){print "R126"}; continue};
 if ( pre_pr(-3) &&
 ...
 if ( mest_mn(-2) &&
       w(-1,"же ведь") &&
        mest_it(1) &&
         glc_mn(2,"syg") && s(-2,1) )
 { sub(/([Ее])/, "ё", l[i]); r[165]++; if(dbg){print "R165"}; continue};
 if ( w(-1,"так") &&
       glc_mn(1,"nj") && s(-1,0) && p(1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[166]++; if(dbg){print "R166"}; continue};
 if ( w(1,"так") &&
       glc_mn(2,"nj") && s(0,1) && p(2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[167]++; if(dbg){print "R167"}; continue};
 if ( mest_mnim(-2) &&
        glc_mn(-1,"sgy") &&
          pre_pr(1) &&
 ...
 { sub(/([Ее])/, "ё", l[i]); r[171]++; if(dbg){print "R171"}; continue};
 if ( mest_mnim(-2) &&
        glc_mn(-1,"sgy") && s(-2,-1) && p(0) )
 { sub(/([Ее])/, "ё", l[i]); r[172]++; if(dbg){print "R172"}; continue};
 if ( (suw_noedim(-2)||suw_nomnim(-2)) &&
        glc_mn(-1,"ogj") && s(-2,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[173]++; if(dbg){print "R173"}; continue};
 if ( glc_po(-2,"j") &&
       mest_mnim(-1) && s(-2,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[174]++; if(dbg){print "R174"}; continue};
 if ( mest_mnim(-2) &&
       glc_mn(-1,"syg") &&
 ...
 if ( mod_mn(1) &&
       prl_kred_sr(2) &&
        gl_in(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[197]++; if(dbg){print "R197"}; continue};
 if ( mest_mn(-2) &&
       mod_mn(-1) &&
        gl_in(1) && s(-2,0) )
 ...
 if ( gl_in(-2) &&
       mod_mn(-1) && s(-2,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[199]++; if(dbg){print "R199"}; continue};
 if ( mod_ed(-2) &&
       pre_vi(-1) && s(-2,-1) && p(0) )
 ...
 if ( mod_bz(1) &&
       mod_ed(2) &&
        gl_in(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[203]++; if(dbg){print "R203"}; continue};
 if ( mod_bz(1) &&
       gl_in(2) && s(0,1))
 { sub(/[Ее]/, "ё", l[i]); r[204]++; if(dbg){print "R204"}; continue};
 if ( mod_bz(-1) && s(-1,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[205]++; if(dbg){print "R205"}; continue};
 if ( mod_bz(1) && s(0,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[206]++; if(dbg){print "R206"}; continue};
 if ( mod_mn(1) &&
       nar_napr(2) && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[207]++; if(dbg){print "R207"}; continue};
 if ( phf(1,"никак не") &&
 ...
 if ( (suw_edim(-3)||suw_mnim(-3)) &&
        mod_mn(-2) &&
         gl_in(-1) && s(-2,-1) && p(0) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[209]++; if(dbg){print "R209"}; continue};
 if ( w(1,"не") &&
       mod_mn(2) &&
        gl_in(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[210]++; if(dbg){print "R210"}; continue};
 if ( mod_mn(1) &&
       mest_edim(2) &&
       gl_in(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[211]++; if(dbg){print "R211"}; continue};
 if ( mod_mn(1) &&
       gl_in(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[212]++; if(dbg){print "R212"}; continue};
 if ( mod_mn(1) &&
       glc_in(2,"j") && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[213]++; if(dbg){print "R213"}; continue};
 if ( mod_mn(1) &&
      (mest_ed(2)||mest_mn(2)) && s(0,1) && p(2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[214]++; if(dbg){print "R214"}; continue};
 ...
 if ( gl_ed(-2) &&
       mest_it(-1) && s(-2,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[216]++; if(dbg){print "R216"}; continue};
 if ( mest_it(-1) &&
 ...
 if ( pre_tv(1) &&
      (mest_tv(2)||suw_edtv(2)||suw_mntv(2)) &&
       (gl_ed(3)||gl_in(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[219]++; if(dbg){print "R219"}; continue};
 if ( pre_vi(1) &&
 ...
 if ( mest_it(1) && s(0,0) && sc(1,",") &&
       vvod(2) && sc(2,",") &&
       (gl_nemn(3)||gl_pnmn(3)) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[227]++; if(dbg){print "R227"}; continue};
 if ( gl_ed(-1) &&
 ...
 if ( sc(0,",") &&
       vvod(1) && sc(1,",") &&
       (gl_nemn(2)||gl_pnmn(2)) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[234]++; if(dbg){print "R234"}; continue};
 if ( mest_it(1) &&
       qast(2) &&
 ...
 if ( mest_it(-1) &&
       mest_im(1) &&
        suw_edim(2) && s(-1,1) )
 { sub(/[Ее]/, "ё", l[i]); r[240]++; if(dbg){print "R240"}; continue};
 if ( mest_it(-1) &&
       pre_ro(1) &&
 ...
 if ( mest_it(-1) &&
       w(1,"кто") && s(-1,-1) && sc(0,",") )
 { sub(/([Ее])/, "<_&_>", l[i]); r[243]++; if(dbg){print "R243"}; continue};
 if ( mest_it(-1) &&
       pre_ro(1) &&
        w(2,"того") &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[249]++; if(dbg){print "R249"}; continue};
 ...
 if ( prq_krmn(-4) &&
       w(-3,"еще ещё") &&
        prl_kred_sr(-2) &&
         w(-1,"не") && s(-4,-1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[252]++; if(dbg){print "R252"}; continue};
 if ( prq_krmn(-3) &&
       prl_kred_sr(-2) &&
        w(-1,"не") && s(-3,-1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[253]++; if(dbg){print "R253"}; continue};
 if ( prq_kred_sr(-4) &&
       w(-3,"еще ещё") &&
        prl_kred_sr(-2) &&
         w(-1,"не") && s(-4,-1) )
 ...
 if ( mest_mnim(1) &&
       ...
       (suw_edro(3)||suw_mnro(3)) &&
         prq_krmn(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[257]++; if(dbg){print "R257"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[269]++; if(dbg){print "R269"}; continue};
 ...
 if ( w(1,"не") &&
       prq_mnim(2) &&
        pre_ro(3) && s(0,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[273]++; if(dbg){print "R273"}; continue};
 if ( w(1,"даже") && sc(0,",") &&
       w(2,"не") &&
        prq_mnim(3) &&
         suw_edda(4) && s(1,3) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[282]++; if(dbg){print "R282"}; continue};
 if ( (prl_mnim(1)||prq_mnim(1)||prl_mnro(1)||prq_mnro(1)||prl_krmn(1)) &&
        w(2,"и или") &&
 ...
 if ( (prl_mnim(1)||prq_mnim(1)||prl_mnro(1)||prq_mnro(1)||prl_krmn(1)) &&
        ...
        (prl_mnim(3)||prq_mnim(3)||prl_mnro(3)||prq_mnro(3)||prl_krmn(3)) &&
          suw_mnim(4) && s(0,3)  )
 { sub(/([Ее])/, "<_&_>", l[i]); r[284]++; if(dbg){print "R284"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[288]++; if(dbg){print "R288"}; continue};
 if ( mest_tv(1) &&
       prl_krmn(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[289]++; if(dbg){print "R289"}; continue};
 if ( prl_krmn(1) && s(0,0) )
 ...
 if ( (mest_ed(1)||mest_mn(1)) &&
       (nar_kaq(2)||nar_step(2)||nar_spos(2)) &&
         prl_krmn(3) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[301]++; if(dbg){print "R301"}; continue};
 ...
 if ( w(1,"вроде как") &&
       w(2,"бы как") &&
        prl_kred_sr(3) && s(0,2) && p(3) )
 { sub(/[Ее]/, "ё", l[i]); r[303]++; if(dbg){print "R303"}; continue};
 if ( w(1,"так настолько") &&
       prl_kred_sr(2) &&
        w(3,"и") &&
         prl_kred_sr(4) && s(0,3) && p(4) )
 { sub(/[Ее]/, "ё", l[i]); r[304]++; if(dbg){print "R304"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[322]++; if(dbg){print "R322"}; continue};
 if ( (prl_kred_sr(-1)||nar_kaq(-1)) &&
        w(1,"кто кого кому кем") && sc(0,",") && s(-1,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[323]++; if(dbg){print "R323"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[327]++; if(dbg){print "R327"}; continue};
 if ( pre_pr(1) &&
      (mest_pr(2)||suw_edpr(2)||suw_mnpr(2)) &&
        prl_kred_sr(3) && s(0,2) && p(3) )
 { sub(/[Ее]/, "ё", l[i]); r[328]++; if(dbg){print "R328"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[331]++; if(dbg){print "R331"}; continue};
 if ( prl_srav(1) && se(1,", ") &&
       prl_srav(2) && s(0,0) )
 ...
 if ( souz(1) && sc(0,",") &&
       w(2,"не") &&
        prq_mnim(3) &&
         suw_edda(4) &&
          suw_mnvi(5) && s(1,4) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[337]++; if(dbg){print "R337"}; continue};
 if ( souz(1) && sc(0,",") &&
       prq_mnim(2) &&
        suw_edda(3) &&
         suw_mnvi(4) && s(1,3) )
 ...
 if ( w(1,"не") &&
       prq_mnim(2) &&
        suw_edda(3) &&
         suw_mnvi(4) && s(1,3) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[340]++; if(dbg){print "R340"}; continue};
 if ( w(1,"нет") &&
      (suw_edro(2)||suw_mnro(2)) && s(0,1) )
 ...
 if ( suw_edim(1) && se(1,"-") &&
       suw_mnim(2) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[344]++; if(dbg){print "R344"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[362]++; if(dbg){print "R362"}; continue};
 if ( mest_mn(1) && s(0,0) &&
      (suw_edim(2)||suw_mnim(2)) && se(1," — ") )
 { sub(/([Ее])/, "<_&_>", l[i]); r[363]++; if(dbg){print "R363"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[373]++; if(dbg){print "R373"}; continue};
 if ( (w(1,"куда")||prl_kred_sr(1)) &&
        nar_srav(2) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[374]++; if(dbg){print "R374"}; continue};
 if ( nar_srav(1) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[378]++; if(dbg){print "R378"}; continue};
 if ( nar_step(1) &&
 ...
 if ( (nar_kaq(1)||nar_spos(1)||nar_step(1)||prl_kred_sr(1)) &&
        prl_kred_sr(2) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[383]++; if(dbg){print "R383"}; continue};
 if ( nar_step(1) &&
 ...
 { sub(/([Ее])/, "ё", l[i]); r[394]++; if(dbg){print "R394"}; continue};
 if ( qis_im(1) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[395]++; if(dbg){print "R395"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[437]++; if(dbg){print "R437"}; continue};
 if ( mest_ed(1) &&
       pre_tv(2) &&
 ...
 if ( mest_ed(1) &&
       nar_step(2) &&
        nar_kaq(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[439]++; if(dbg){print "R439"}; continue};
 if ( mest_ed(1) &&
      (nar_kaq(2)||nar_step(2)||nar_spos(2)) &&
       (gl_ed(3)||gl_in(3)) && s(0,2) )
 ...
 if ( (gl_in(-1)||gl_ed(-1)) &&
       (prl_edtv(1)||prl_mntv(1)) &&
        (suw_edtv(2)||suw_mntv(2)) && s(-1,1) )
 { sub(/[Ее]/, "ё", l[i]); r[449]++; if(dbg){print "R449"}; continue};
 if ( gl_in(-1) &&
       pre_pr(1) &&
       (suw_edpr(2)||suw_mnpr(2)) &&
         prl_edtv(3) && s(-1,2) )
 { sub(/[Ее]/, "ё", l[i]); r[450]++; if(dbg){print "R450"}; continue};
 if ( mest_mn(-1) &&
 ...
 if ( mest_mn(-1) &&
       mest_da(1) &&
        gl_nemn(2) && s(-1,1) && p(2))
 { sub(/[Ее]/, "<_&_>", l[i]); r[452]++; if(dbg){print "R452"}; continue};
 if ( (gl_pnmn(1)||gl_pemn(1)||gl_nemn(1)) && sc(1,",") &&
        w(2,"кто никто") && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[453]++; if(dbg){print "R453"}; continue};
 if ( (suw_edvi(-3)||suw_mnvi(-3)||mest_vi(-3)) &&
       (gl_pnmn(-2)||gl_pemn(-2)||gl_nemn(-2)) &&
         mest_mnim(-1) && s(-3,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[454]++; if(dbg){print "R454"}; continue};
 if ( mest_mn(-1) &&
      (gl_pnmn(1)||gl_pemn(1)) &&
        suw_mnvi(2) && s(-1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[455]++; if(dbg){print "R455"}; continue};
 if ( mest_mn(-1) &&
 ...
 if ( mest_ed(1) &&
       gl_ed(2) && s(0,1) && p(2) )
 { sub(/([Ее])/, "ё", l[i]); r[459]++; if(dbg){print "R459"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[461]++; if(dbg){print "R461"}; continue};
 ...
 if ( gl_ed(-1) &&
       pre_ro(1) &&
       (mest_ro(2)||suw_edro(2)||suw_mnro(2)||prl_edro(2)||prl_mnro(2)||prq_edro(2)||prq_mnro(2)) && s(-1,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[466]++; if(dbg){print "R466"}; continue};
 if ( pre_ro(1) &&
      (mest_ro(2)||suw_edro(2)||suw_mnro(2)||prl_edro(2)||prl_mnro(2)||prq_edro(2)||prq_mnro(2)) &&
        w(3,"так слишком") &&
         prl_kred_sr(4) && s(0,3) )
 { sub(/[Ее]/, "ё", l[i]); r[467]++; if(dbg){print "R467"}; continue};
 ...
 if ( (prl_srav(1)||nar_step(1)) &&
        deep(2) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[470]++; if(dbg){print "R470"}; continue};
 if ( deep(1) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[474]++; if(dbg){print "R474"}; continue};
 if ( deep(-1) &&
       pre_pr(1) &&
 ...
 # Всё + ... + глагол.мн + дополнение ============================
  if ( gl_pemn(-2) &&
        w(-1,"себя") && s(-2,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[492]++; if(dbg){print "R492"}; continue};
if ( gl_nemn(1) &&
      nar_kaq(2) &&
       prq_krmn(3) && s(0,2) )
 ...
 if ( (gl_pemn(1)||gl_pnmn(1)) &&
       (suw_edro(2)||suw_mnro(2)) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[495]++; if(dbg){print "R495"}; continue};
 ...
 if ( mest_mnim(-2) && w(-1,"то") && se(-2,"-") &&
      (gl_pemn(1)||gl_nemn(1)||gl_pnmn(1)||gl_vzmn(1)) &&
        w(2,"и") &&
        (gl_pemn(3)||gl_nemn(3)||gl_pnmn(3)||gl_vzmn(3)) && s(0,2) )
 { sub(/([Ее])/, "ё", l[i]); r[498]++; if(dbg){print "R498"}; continue};
 if ( mest_mnim(-1) &&
      (gl_pemn(1)||gl_nemn(1)||gl_pnmn(1)||gl_vzmn(1)) &&
        w(2,"и") &&
        (gl_pemn(3)||gl_nemn(3)||gl_pnmn(3)||gl_vzmn(3)) && s(0,2) )
 { sub(/([Ее])/, "ё", l[i]); r[499]++; if(dbg){print "R499"}; continue};
 if ( w(1,"и") &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[504]++; if(dbg){print "R504"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[516]++; if(dbg){print "R516"}; continue};
 if ( prl_kred_sr(1) &&
       gl_in(2) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[517]++; if(dbg){print "R517"}; continue};
 if ( gl_vzed(-1) &&
 ...
 { sub(/([Ее])/, "ё", l[i]); r[520]++; if(dbg){print "R520"}; continue};
 if ( sc(0,",") &&
       gl_vzed(-1) && s(-1,-1) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[523]++; if(dbg){print "R523"}; continue};
 if ( qast(1) &&
      (nar_vrem(2)||nar_mest(2)||nar_spos(2)||nar_srav(2)||nar_kaq(2)||suw_edvi(2)||mest_ed(2)) &&
       (gl_ed(3)||gl_in(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[524]++; if(dbg){print "R524"}; continue};
 if ( qast(1) &&
      (nar_vrem(2)||nar_mest(2)||nar_spos(2)||nar_srav(2)||nar_kaq(2)||suw_edvi(2)||mest_ed(2)) &&
        qast(3) &&
        (gl_ed(4)||gl_in(4)) && s(0,3) )
 ...
 if ( (nar_vrem(1)||nar_mest(1)||nar_spos(1)||nar_srav(1)||nar_kaq(1)||suw_edvi(1)||mest_ed(1)) &&
        qast(2) &&
        (gl_ed(3)||gl_in(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[527]++; if(dbg){print "R527"}; continue};
 if ( gl_nemn(-1) &&
       gl_in(1) && s(-1,0) && p(1) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[543]++; if(dbg){print "R543"}; continue};
 if ( mest_da(1) &&
      (gl_ed(2)||gl_in(2)) && s(0,1) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[546]++; if(dbg){print "R546"}; continue};
 if ( (gl_pemn(1)||gl_pnmn(1)) &&
        w(2,"о об") &&
 ...
 if ( (gl_nemn(1)||gl_pnmn(1)||gl_pemn(1)) &&
        nar_srav(2) && s(0,1) && p(2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[559]++; if(dbg){print "R559"}; continue};
 if ( suw_mnvi(-1) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[561]++; if(dbg){print "R561"}; continue};
 if (qast(1) &&
      gl_pnmn(2) &&
       pre_vi(3) &&
        suw_edvi(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[562]++; if(dbg){print "R562"}; continue};
 if (gl_pnmn(1) &&
      pre_vi(2) &&
       mest_vi(3) &&
        suw_edvi(4) && s(0,3) )
 ...
 if (gl_pnmn(1) &&
      pre_vi(2) &&
       mest_vi(3) && s(0,2) && p(3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[565]++; if(dbg){print "R565"}; continue};
 if (prl_kred_sr(1) &&
      gl_pnmn(2) &&
       pre_vi(3) &&
        mest_vi(4) && s(0,3) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[577]++; if(dbg){print "R577"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[587]++; if(dbg){print "R587"}; continue};
 if ( mest_mnim(1) && vv(1) &&
 ...
 if ( vv(1) &&
       gl_edsr(vvn+1) )
 { sub(/[Ее]/, "ё", l[i]); r[590]++; if(dbg){print "R590"}; continue};
 if ( vv(0) && (gl_vzmn(vvn+1)||gl_nemn(vvn+1)) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[591]++; if(dbg){print "R591"}; continue};
 if ( vvb(-1) && suw_mnim(vvn) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[592]++; if(dbg){print "R592"}; continue};
 if ( vvb(-2) &&
       w(vvn,"вот") &&
        w(-1,"и") && s(-1,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[593]++; if(dbg){print "R593"}; continue};

 # поиск вперёд ----------------------------------------------------------
 if ( qf(7,"gl_edsr") &&
       (prl_kred_sr(qfn+1)||suw_edtv(qfn+1)) && s(0,qfn) )
 { sub(/[Ее]/, "ё", l[i]); r[594]++; if(dbg){print "R594"}; continue};
 if ( qf(7,"gl_nemn") &&
       prq_krmn(qfn+1) && s(0,qfn) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[595]++; if(dbg){print "R595"}; continue};
 if ( qf(5,"gl_edsr") && s(0,qfn-1) )
 { sub(/[Ее]/, "ё", l[i]); r[596]++; if(dbg){print "R596"}; continue};
 if ( mest_it(1) &&
       mest_da(2) &&
        qf(7,"prl_kred_sr") && s(0,qfn-1) && p(qfn) )
 { sub(/[Ее]/, "ё", l[i]); r[597]++; if(dbg){print "R597"}; continue};
 if ( mest_mn(1) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[600]++; if(dbg){print "R600"}; continue};
 if ( qb(-7,"mest_im") &&
       phs(-1,"как и") && s(-2,-1) )
 ...
 if (i<=5 && prevyo == b-1 )
 { sub(/[Ее]/, "ё", l[i]); r[610]++; if(dbg){print "R610"}; continue};

 # короткие предложения в зависимости от предыдущей строки
 if (i<=5 && prevje == b-1 )
 { sub(/([Ее])/, "<_&_>", l[i]); r[611]++; if(dbg){print "R611"}; continue};
...
#dbgstat = 1;
 ...
 if (dbgstat==1) {system(cmd); for (i=1; i<=611; i++) { printf ("%s%s %s %s\n", "R", i, "=", r[i]) >> "_stat.txt"};
