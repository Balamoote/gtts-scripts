...
function vv(n,    k, rett)                        # выдать границы вводного предложения: , и —, n= первая запятая
                {vvn="";rett=0; if(sep[i+n] ~ "[,—]"){for(k=n+1;k<=n+7;k++){if(sep[i+k] !~ "[….:;!?]"){if(sep[i+k] ~ ","){rett=1;vvn=k;break};};};}; return rett}
...
BEGIN {
    ...
    cmd = "zcat basedic.gz glquv.gz glgov.gz gldvi.gz geo.gz";
   while ((cmd|getline) > 0) {
...
#print (length(gl_dvimn))
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); if(dbg){r[15]++; print "R15"}; continue;};
 if ( phf(1,"и так") &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[28]++; print "R28"}; continue;};
 if ( phf(1,"за и против") && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[29]++; print "R29"}; continue;};
 if ( phf(1,"только и") &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[41]++; print "R41"}; continue;};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[72]++; print "R72"}; continue;};
 if ( q(-1,mest_it) &&
       q(1,mest_ed) &&
        q(2,gl_ed) && s(-1,1) && p(2) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[104]++; print "R104"}; continue;};
 if ( q(-2,gl_in) &&
        w(-1,"как") && s(-2,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[105]++; print "R105"}; continue;};
 if ( w(1,"как") &&
       w(2,"будто") &&
        q(3,gl_edsr) && s(0,2) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[119]++; print "R119"}; continue;};
 ...
 if ( w(1,"за") &&
       q(2,mest_vi) &&
        w(3,"горой") && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[124]++; print "R124"}; continue;};
 if ( w(-1,"со ко") && s(-1,-1) )
 ...
 if ( w(1,"до") &&
       w(2,"единого") && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[127]++; print "R127"}; continue;};
 if ( q(-3,pre_pr) &&
 ...
 if ( sc(0,",") &&
       q(1,pre_vi) &&
        w(2,"кого") && s(1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[131]++; print "R131"}; continue;};
 if ( q(-1,pre_vi) &&
       q(1,gl_vzmn) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[145]++; print "R145"}; continue;};
 if ( q(-2,gl_gov) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[163]++; print "R163"}; continue;};
 if ( q(-1,gl_gov) &&
 ...
 if ( q(1,pre_pr) &&
      (q(2,mest_pr)||q(2,suw_edpr)||q(2,suw_mnpr)) &&
        q(3,gl_govmn) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[168]++; print "R168"}; continue;};
 if ( q(-1,gl_gov) &&
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); if(dbg){r[208]++; print "R208"}; continue;};
 if ( cap(-2) &&
       q(-1,gl_quvmn) && s(-2,-1) )
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[223]++; print "R223"}; continue;};
 ...
 if ( q(1,prq_mniv) &&
       q(2,pre_ro) && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); if(dbg){r[227]++; print "R227"}; continue;};
 if ( w(1,"не") &&
       q(2,prq_mniv) &&
        q(3,pre_ro) && s(0,2) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[229]++; print "R229"}; continue;};
 if ( q(1,prl_srav) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[238]++; print "R238"}; continue;};
 if ( q(1,mest_tv) &&
       q(2,prl_krmn) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[239]++; print "R239"}; continue;};
 if ( q(1,prl_krmn) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[240]++; print "R240"}; continue;};
 if ( (q(1,prl_mniv)||q(1,prq_mniv)||q(1,prl_mnvr)||q(1,prq_mnvr)||q(1,prl_krmn)) &&
       (q(2,suw_odmnim)||q(2,suw_nomniv)) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[241]++; print "R241"}; continue;};
 ...
 if ( (q(1,nar_opka)||q(1,nar_opst)) &&
        q(2,prl_kred_sr) &&
         q(3,gl_quvmn) && sc(3,",") &&
          w(4,"что кто") && s(0,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); if(dbg){r[245]++; print "R245"}; continue;};
 if ( w(1,"ли") &&
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[259]++; print "R259"}; continue;};
 if ( (q(1,nar_obme)||q(1,nar_obvr)) &&
       (q(2,prl_edsrim)||q(2,prl_edsrvi)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[260]++; print "R260"}; continue;};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[264]++; print "R264"}; continue;};
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[272]++; print "R272"}; continue;};
 if ( q(1,pre_pr) &&
      (q(2,mest_pr)||q(2,suw_edpr)||q(2,suw_mnpr)) &&
        q(3,prl_kred_sr) && s(0,2) && p(3) )
 ...
 if ( (q(1,mest_ed)||q(1,mest_mn)) &&
       (q(2,suw_odmnim)||q(2,suw_nomniv)) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[283]++; print "R283"}; continue;};
 if ( q(1,suw_edim) && se(1,"-") &&
      (q(2,suw_odmnim)||q(2,suw_nomniv)) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[284]++; print "R284"}; continue;};
 ...
 if ( (q(-1,suw_odmnim)||q(-1,suw_nomniv)) &&
        q(1,prl_krmn) && s(-1,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[288]++; print "R288"}; continue;};
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[303]++; print "R303"}; continue;};
 ...
 if ( q(1,mest_mn) &&
       q(2,pre_pr) &&
       (q(3,suw_edpr)||q(3,suw_mnpr)) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[330]++; print "R330"}; continue;};
 if ( q(1,mest_mn) &&
       phf(2,"друг друга") && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[331]++; print "R331"}; continue;};
 if ( (q(1,mest_ed)||q(1,mest_mn)) &&
        q(2,qisl) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[351]++; print "R351"}; continue;};
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[352]++; print "R352"}; continue;};
 # все + против + всех
 if ( q(-1,gl_in) &&
       q(1,pre_ro) &&
 ...
 if ( q(-1,deep) &&
       q(1,prl_srav) && s(-1,0) )
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[363]++; print "R363"}; continue;};
 if ( q(-1,deep) &&
       q(1,gl_nepm) && s(-1,0) )
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[380]++; print "R380"}; continue;};
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[383]++; print "R383"}; continue;};
 # гл.ед + всё
 if ( (q(-1,gl_ed)||q(-1,gl_in)) &&
 ...
 if ( q(1,qast) &&
       ...
       (q(3,nar_obvr)||q(3,nar_obme)||q(3,nar_opsp)||q(3,nar_srav)||q(3,nar_opka)||q(3,suw_edvi)||q(3,mest_ed)) &&
        (q(4,gl_ed)||q(4,gl_in)) && s(0,3) )
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[392]++; print "R392"}; continue;};
 if ( q(1,qast) &&
       q(2,qast) &&
       (q(3,nar_obvr)||q(3,nar_obme)||q(3,nar_opsp)||q(3,nar_srav)||q(3,nar_opka)||q(3,suw_edvi)||q(3,mest_ed)) &&
         q(4,qast) &&
 ...
 if ( q(1,qast) &&
      (q(2,nar_obvr)||q(2,nar_obme)||q(2,nar_opsp)||q(2,nar_srav)||q(2,nar_opka)||q(2,suw_edvi)||q(2,mest_ed)) &&
       (q(3,gl_ed)||q(3,gl_in)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[394]++; print "R394"}; continue;};
 if ( q(1,qast) &&
      (q(2,nar_obvr)||q(2,nar_obme)||q(2,nar_opsp)||q(2,nar_srav)||q(2,nar_opka)||q(2,suw_edvi)||q(2,mest_ed)) &&
        q(3,qast) &&
        (q(4,gl_ed)||q(4,gl_in)) && s(0,3) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[396]++; print "R396"}; continue;};
 ...
 if ( q(1,nar_obme) &&
       q(2,mest_da) &&
        q(3,gl_ed) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[400]++; print "R400"}; continue;};
 if ( q(1,nar_obme) &&
       q(2,mest_da) &&
        q(3,qast) &&
         q(4,gl_ed) && s(0,3) )
 ...
 if ( q(1,nar_obme) &&
       q(2,gl_pnmn) &&
        q(3,gl_in) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[402]++; print "R402"}; continue;};
 if ( q(1,nar_obme) &&
       q(2,gl_pnmn) &&
        q(3,qast) &&
         q(4,gl_in) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[403]++; print "R403"}; continue;};
 if ( (q(1,gl_pnmn)||q(1,gl_pemn)) &&
       q(2,gl_in) && s(0,1) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[409]++; print "R409"}; continue;};
 if ( q(-2,gl_ed) &&
       q(-1,mest_mnvi) &&
       (q(1,gl_ed)||q(1,gl_in)) && s(-2,0) )
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[412]++; print "R412"}; continue;};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[414]++; print "R414"}; continue;};
 if ( (q(1,gl_pemn)||q(1,gl_pnmn)) &&
        w(2,"о об") &&
        (q(3,mest_pr)||q(3,suw_edtv)||q(3,suw_mntv)) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[415]++; print "R415"}; continue;};
 if ( q(1,mest_vi) &&
      (q(2,gl_pemn)||q(2,gl_pnmn)) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[417]++; print "R417"}; continue;};
 if ( l[i+1]~/..ы$/ &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[420]++; print "R420"}; continue;};
 if (q(1,qast) &&
      q(2,gl_pemn) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[421]++; print "R421"}; continue;};
 if (q(1,mest_mnim) &&
     (q(2,gl_pemn)||q(2,gl_pnmn)) &&
      (q(3,prl_ediv)||q(3,prl_edvr)||q(3,prl_mniv)||q(3,prq_mniv)||q(3,prl_mnvr)||q(3,prq_mnvr)) &&
       (q(4,suw_edvi)||q(4,suw_odmnvr)||q(4,suw_nomniv)) && s(0,3) )
 ...
 if (q(1,gl_pnmn) &&
      q(2,pre_vi) &&
       q(3,suw_edvi) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[425]++; print "R425"}; continue;};
 if ( (q(1,gl_nemn)||q(1,gl_pnmn)||q(1,gl_pemn)) &&
        q(2,nar_srav) && s(0,1) && p(2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[426]++; print "R426"}; continue;};
 if ( (q(-1,suw_odmnim)||q(-1,suw_nomniv)) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[428]++; print "R428"}; continue;};
 if (q(1,qast) &&
      q(2,gl_pnmn) &&
       q(3,pre_vi) &&
        q(4,suw_edvi) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[429]++; print "R429"}; continue;};
 if (q(1,gl_pnmn) &&
      q(2,pre_vi) &&
       q(3,mest_vi) &&
        q(4,suw_edvi) && s(0,3) )
 ...
 if (q(1,pre_vi) &&
      q(2,mest_vi) &&
       q(3,gl_pnmn) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[433]++; print "R433"}; continue;};
 if (q(1,pre_vi) &&
      q(2,mest_vi) &&
       q(3,qast) &&
        q(4,gl_pnmn) && s(0,3) )
 ...
 if (q(1,pre_tv) &&
      q(2,mest_tv) &&
       q(3,nar_mest) &&
        q(4,gl_vzmn) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[435]++; print "R435"}; continue;};
 if (q(1,pre_pr) &&
     (q(2,prl_edpr)||q(2,prl_mnvr)) &&
      (q(3,suw_edpr)||q(3,suw_mnpr)) &&
       (q(4,gl_vzmn)||q(4,gl_nemn)) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[436]++; print "R436"}; continue;};
 if ( (q(1,gl_pemn)||q(1,gl_pnmn)) &&
        q(2,mest_vi) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[439]++; print "R439"}; continue;};
 if (q(-1,mest_da) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[450]++; print "R450"}; continue;};
 if ( (q(1,gl_pemn)) && sc(1,",") &&
        w(2,"что") && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[451]++; print "R451"}; continue;};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[454]++; print "R454"}; continue;};
 ...
 if ( vv(1) &&
       q(vvn+1,gl_edsr) )
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[462]++; print "R462"}; continue;};
 ...
 { sub(/[Ее]/, "ё", l[i]); if(dbg){r[469]++; print "R469"}; continue;};
 if ( qb(-7,mest_im) &&
       phs(-1,"как и") && s(-2,-1) )
 ...
 if ( (q(1,suw_odmnim)||q(1,suw_nomniv)) && (q(1,prl_mniv)||q(1,prl_mnvr)) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); if(dbg){r[474]++; print "R474"}; continue;};
 ...
 #dbg = 1
 #dbgstat = 1
 if (dbgstat==1) {for (i=1; i<=475; i++) { printf ("%s%s %s %s\n", "R", i, "=", r[i]) }; };
