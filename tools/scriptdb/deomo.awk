...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
#if ( sw_mn_i_f() )
#{ l[i]=omo2; R[76]++; if(dbg){print "R76", "sw_mn_i_f"}; continue };
##
#if ( sw_mn_v_f() )
#{ l[i]=omo2; R[77]++; if(dbg){print "R77", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( sw_es_i_f() )
 { l[i]=omo2; R[601]++; if(dbg){print "R601", "sw_es_i_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[602]++; if(dbg){print "R602", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[603]++; if(dbg){print "R603", "sw_ez_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[604]++; if(dbg){print "R604", "sw_es_p_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[605]++; if(dbg){print "R605", "sw_es_v_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[606]++; if(dbg){print "R606", "gl_poed_f"}; continue };
 #
 if ( sw_ez_l_f() )
 { l[i]=omo1; R[607]++; if(dbg){print "R607", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[616]++; if(dbg){print "R616", "gl_poed_f"}; continue };
 #
 if ( sw_ez_l_f() )
 { l[i]=omo1; R[617]++; if(dbg){print "R617", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[618]++; if(dbg){print "R618", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[619]++; if(dbg){print "R619", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[620]++; if(dbg){print "R620", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[621]++; if(dbg){print "R621", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[622]++; if(dbg){print "R622", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[623]++; if(dbg){print "R623", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[626]++; if(dbg){print "R626", "gl_poed_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[627]++; if(dbg){print "R627", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[636]++; if(dbg){print "R636", "sw_ez_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[637]++; if(dbg){print "R637", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[638]++; if(dbg){print "R638", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[639]++; if(dbg){print "R639", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[641]++; if(dbg){print "R641", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[646]++; if(dbg){print "R646", "gl_poed_f"}; continue };
 #
 if ( sw_mn_i_f() )
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[649]++; if(dbg){print "R649", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[650]++; if(dbg){print "R650", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[651]++; if(dbg){print "R651", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[652]++; if(dbg){print "R652", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[658]++; if(dbg){print "R658", "pl_krmn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[659]++; if(dbg){print "R659", "gl_poed_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[660]++; if(dbg){print "R660", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[661]++; if(dbg){print "R661", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[662]++; if(dbg){print "R662", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[663]++; if(dbg){print "R663", "pl_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[664]++; if(dbg){print "R664", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[665]++; if(dbg){print "R665", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[666]++; if(dbg){print "R666", "sw_em_i_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[667]++; if(dbg){print "R667", "sw_ez_t_f"}; continue };
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[668]++; if(dbg){print "R668", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[669]++; if(dbg){print "R669", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[670]++; if(dbg){print "R670", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[671]++; if(dbg){print "R671", "pl_ez_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars_nohyphback();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( s1(0,"-") && w(1,cst) )
 { l[i]=gensub(/(.)$/,"\\1\xcc\x81",1,l[i]); sep[i]=gensub(/-/,"-\xcc\xa0",1,sep[i]); R[676]++; if(dbg){print "R676"}; continue };
 if ( s1(-1,"-") && w(-1,"кое") )
 { l[i]=gensub(/(.)$/,"\\1\xcc\x81",1,l[i]); R[677]++; if(dbg){print "R677"}; continue };
 if ( sc(0,"?") )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo2; R[682]++; if(dbg){print "R682", "sw_mn_p_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[683]++; if(dbg){print "R683", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[686]++; if(dbg){print "R686", "sw_em_d_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[687]++; if(dbg){print "R687", "sw_em_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[688]++; if(dbg){print "R688", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[689]++; if(dbg){print "R689", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[690]++; if(dbg){print "R690", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[691]++; if(dbg){print "R691", "pl_ez_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[697]++; if(dbg){print "R697", "sw_em_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[704]++; if(dbg){print "R704", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[708]++; if(dbg){print "R708", "sw_ez_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[709]++; if(dbg){print "R709", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[711]++; if(dbg){print "R711", "sw_mn_r_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[713]++; if(dbg){print "R713", "sw_em_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[715]++; if(dbg){print "R715", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[716]++; if(dbg){print "R716", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[717]++; if(dbg){print "R717", "sw_em_v_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[722]++; if(dbg){print "R722", "sw_es_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars_nohyphback();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[726]++; if(dbg){print "R726", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[727]++; if(dbg){print "R727", "pl_es_v_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[728]++; if(dbg){print "R728", "pl_srav_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[729]++; if(dbg){print "R729", "sw_ez_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[730]++; if(dbg){print "R730", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[731]++; if(dbg){print "R731", "sw_em_v_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[741]++; if(dbg){print "R741", "sw_mn_r_f"}; continue };
 #
 if ( pl_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[746]++; if(dbg){print "R746", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[751]++; if(dbg){print "R751", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[752]++; if(dbg){print "R752", "sw_ez_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
for(wrd in omap["x2143"]){omakevars(x2143,"x2143");for(y=1;y<=wln;y++)         # header1
 #
 if ( pl_ez_v_f() )
 { l[i]=omo1; R[753]++; if(dbg){print "R753", "pl_ez_v_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[754]++; if(dbg){print "R754", "sw_es_d_f"}; continue };
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[755]++; if(dbg){print "R755", "pl_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[756]++; if(dbg){print "R756", "sw_em_i_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[757]++; if(dbg){print "R757", "pl_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[758]++; if(dbg){print "R758", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[759]++; if(dbg){print "R759", "sw_em_v_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[764]++; if(dbg){print "R764", "sw_em_t_f"}; continue };
 #
 if ( pl_kr_em_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[767]++; if(dbg){print "R767", "pl_kr_em_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[772]++; if(dbg){print "R772", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[775]++; if(dbg){print "R775", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[776]++; if(dbg){print "R776", "sw_es_v_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[777]++; if(dbg){print "R777", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[778]++; if(dbg){print "R778", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[781]++; if(dbg){print "R781", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[783]++; if(dbg){print "R783", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[788]++; if(dbg){print "R788", "sw_ez_i_f"}; continue };
 #
 if ( pl_kr_ez_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[791]++; if(dbg){print "R791", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[792]++; if(dbg){print "R792", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[793]++; if(dbg){print "R793", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[805]++; if(dbg){print "R805", "sw_em_p_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[810]++; if(dbg){print "R810", "sw_em_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[811]++; if(dbg){print "R811", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[812]++; if(dbg){print "R812", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[813]++; if(dbg){print "R813", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[814]++; if(dbg){print "R814", "sw_mn_r_f"}; continue };
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[815]++; if(dbg){print "R815", "pq_kr_em_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[816]++; if(dbg){print "R816", "pq_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[817]++; if(dbg){print "R817", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[818]++; if(dbg){print "R818", "sw_em_v_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[820]++; if(dbg){print "R820", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[821]++; if(dbg){print "R821", "pl_kr_ez_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[822]++; if(dbg){print "R822", "sw_em_r_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[823]++; if(dbg){print "R823", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[824]++; if(dbg){print "R824", "sw_ez_i_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[825]++; if(dbg){print "R825", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[826]++; if(dbg){print "R826", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[827]++; if(dbg){print "R827", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[828]++; if(dbg){print "R828", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[829]++; if(dbg){print "R829", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[831]++; if(dbg){print "R831", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[832]++; if(dbg){print "R832", "sw_mn_d_f"}; continue };
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[833]++; if(dbg){print "R833", "sw_mn_d_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[834]++; if(dbg){print "R834", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[835]++; if(dbg){print "R835", "sw_ez_p_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[842]++; if(dbg){print "R842", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[843]++; if(dbg){print "R843", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[844]++; if(dbg){print "R844", "sw_es_p_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[849]++; if(dbg){print "R849", "sw_ez_t_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[853]++; if(dbg){print "R853", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[854]++; if(dbg){print "R854", "sw_ez_v_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[855]++; if(dbg){print "R855", "sw_em_l_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[860]++; if(dbg){print "R860", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( w(-1,"с") && s(-1) )
 { l[i]=omo2; R[863]++; if(dbg){print "R863", "sw_em_z_f"}; continue };
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[864]++; if(dbg){print "R864", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[865]++; if(dbg){print "R865", "sw_em_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[866]++; if(dbg){print "R866", "sw_em_l_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[868]++; if(dbg){print "R868", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[869]++; if(dbg){print "R869", "sw_es_v_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[870]++; if(dbg){print "R870", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[871]++; if(dbg){print "R871", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[872]++; if(dbg){print "R872", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[873]++; if(dbg){print "R873", "sw_ez_p_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[876]++; if(dbg){print "R876", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[877]++; if(dbg){print "R877", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[878]++; if(dbg){print "R878", "sw_ez_p_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[882]++; if(dbg){print "R882", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[883]++; if(dbg){print "R883", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[884]++; if(dbg){print "R884", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[885]++; if(dbg){print "R885", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[889]++; if(dbg){print "R889", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[890]++; if(dbg){print "R890", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[891]++; if(dbg){print "R891", "sw_ez_v_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[904]++; if(dbg){print "R904", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[905]++; if(dbg){print "R905", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[906]++; if(dbg){print "R906", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[910]++; if(dbg){print "R910", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[913]++; if(dbg){print "R913", "sw_es_z_f()||sw_es_i_f()||sw_es_v_f()||sw_es_r_f()||sw_es_d_f()||sw_es_t_f()||sw_es_p_f()||sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[916]++; if(dbg){print "R916", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[917]++; if(dbg){print "R917", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[918]++; if(dbg){print "R918", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[919]++; if(dbg){print "R919", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[920]++; if(dbg){print "R920", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[921]++; if(dbg){print "R921", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[922]++; if(dbg){print "R922", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[923]++; if(dbg){print "R923", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[924]++; if(dbg){print "R924", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[934]++; if(dbg){print "R934", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[935]++; if(dbg){print "R935", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[938]++; if(dbg){print "R938", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[939]++; if(dbg){print "R939", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[940]++; if(dbg){print "R940", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[941]++; if(dbg){print "R941", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[943]++; if(dbg){print "R943", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[944]++; if(dbg){print "R944", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[945]++; if(dbg){print "R945", "sw_ez_r_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[946]++; if(dbg){print "R946", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[949]++; if(dbg){print "R949", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[950]++; if(dbg){print "R950", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[951]++; if(dbg){print "R951", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[952]++; if(dbg){print "R952", "pl_kr_em_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[953]++; if(dbg){print "R953", "sw_mn_d_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[954]++; if(dbg){print "R954", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[955]++; if(dbg){print "R955", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[956]++; if(dbg){print "R956", "sw_ez_v_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[957]++; if(dbg){print "R957", "sw_em_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[958]++; if(dbg){print "R958", "sw_em_l_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[962]++; if(dbg){print "R962", "sw_em_p_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[967]++; if(dbg){print "R967", "sw_em_r_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[972]++; if(dbg){print "R972", "sw_em_p_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[974]++; if(dbg){print "R974", "sw_em_v_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[977]++; if(dbg){print "R977", "sw_ez_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[979]++; if(dbg){print "R979", "sw_ez_v_f"}; continue };
 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[980]++; if(dbg){print "R980", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[981]++; if(dbg){print "R981", "sw_em_d_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[982]++; if(dbg){print "R982", "sw_em_v_f"}; continue };
 #
 if ( sw_em_l_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
    ...
    cst="вделать вмонтировать вставить вставлять выставить выставлять выстрелить демонтировать захватить захватывать ключ монтировать нащупать нащупывать отмычка переплести переплетать постукивать постучать разжать разжимать сжать сжаться сжимать сжиматься складывать сложить смотреть смыкаться сомкнуть сомкнуться сплести сплестись сплетать стискивать стиснуть стрелять сцепить сцепливать сцеплять ткнуть тыкать";
    if ( base(-2,cst) &&
           w(-1,"в") && s(-2,-1) )
    ...
    if ( base(-3,cst) &&
          q(-2,"suw_edvi suw_mnvi mest_vi mest_3e prl_kred_sr") &&
           w(-1,"в") && s(-3,-1) )
    { l[i]=omo2; R[1588]++; if(dbg){print "R1588"}; continue };
    if ( w(-1,"в") &&
          bf(1,3,cst) && s(-1,bfn-1) )
    { l[i]=omo2; R[1589]++; if(dbg){print "R1589"}; continue };
    ...
    if ( base(-2,cst) &&
          w(-1,"на") && s(-2,-1) )
    { l[i]=omo2; R[1590]++; if(dbg){print "R1590"}; continue };
    if ( base(-3,cst) &&
          q(-2,"suw_edvi suw_mnvi") &&
           w(-1,"на") && s(-3,-1) )
    { l[i]=omo2; R[1591]++; if(dbg){print "R1591"}; continue };
    if ( base(-3,cst) &&
          w(-2,"на") &&
           q(-1,"prl_edvi prl_mnvi mest_vi mest_3e") && s(-3,-1) )
    { l[i]=omo2; R[1592]++; if(dbg){print "R1592"}; continue };
    if ( w(-1,"на") &&
          bf(1,3,cst) && s(-1,bfn-1) )
    { l[i]=omo2; R[1593]++; if(dbg){print "R1593"}; continue };
    ...
    if ( base(-3,cst) &&
          w(-2,"под") &&
           q(-1,"prl_edvi prl_mnvi mest_vi mest_3e") && s(-3,-1) )
    { l[i]=omo2; R[1603]++; if(dbg){print "R1603"}; continue };
    if ( w(-1,"под") &&
          bf(1,3,cst) && s(-1,bfn-1) )
    { l[i]=omo2; R[1604]++; if(dbg){print "R1604"}; continue };
    ...
    if ( base(-2,cst) &&
           w(-1,"в") && s(-2,-1) )
    { l[i]=omo1; R[1612]++; if(dbg){print "R1612"}; continue };
    if ( base(-3,cst) &&
          w(-2,"в") &&
           q(-1,"prl_edvi prl_mnvi mest_vi mest_3e") && s(-3,-1) )
    { l[i]=omo1; R[1613]++; if(dbg){print "R1613"}; continue };
    if ( base(-4,cst) &&
          q(-3,"prl_edvi prl_mnvi mest_vi mest_3e") &&
           q(-2,"suw_edvi suw_mnvi") &&
            w(-1,"в") && s(-3,-1) )
    { l[i]=omo1; R[1614]++; if(dbg){print "R1614"}; continue };
    if ( base(-3,cst) &&
          q(-2,"suw_edvi suw_mnvi mest_vi mest_3e gl_in prl_kred_sr nar_vrem qast") &&
           w(-1,"в") && s(-3,-1) )
    { l[i]=omo1; R[1615]++; if(dbg){print "R1615"}; continue };
    if ( w(-1,"в") &&
          bf(1,3,cst) && s(-1,bfn-1) )
    ...
    if ( base(-2,cst) &&
          w(-1,"в") && s(-2,-1) )
    { l[i]=omo1; R[1621]++; if(dbg){print "R1621"}; continue };
    if ( base(-3,cst) &&
    ...
    { l[i]=omo2; R[1626]++; if(dbg){print "R1626"}; continue };
    ...
    if ( w(-3,"в") &&
          q(-2,"suw_edvi suw_mnvi") &&
           w(-1,"под") && s(-3,-1) )
    { l[i]=omo2; R[1628]++; if(dbg){print "R1628"}; continue };
    if ( w(-1,"под") &&
          w(1,"в") &&
           q(2,"suw_edvi suw_mnvi") && s(-1,1) )
    { l[i]=omo2; R[1629]++; if(dbg){print "R1629"}; continue };
 ...
 if ( base(-2,cst) &&
       Q(-1,"suw_any") && s(-2,-1)  )
 { l[i]=omo1; R[1633]++; if(dbg){print "R1633"}; continue };
 if ( base(1,cst) && s(0) )
 { l[i]=omo1; R[1634]++; if(dbg){print "R1634"}; continue };
 if ( base(1,"быть стать являться") &&
       bf(2,5,cst) && s(0,bfn-1) )
 { l[i]=omo1; R[1635]++; if(dbg){print "R1635"}; continue };
 ...
 { l[i]=omo1; R[1640]++; if(dbg){print "R1640"}; continue };
 ...
 cst="защёлка молния";
 if ( sc(-1,"-") && base(-1,cst) )
 { l[i]=omo2; R[1648]++; if(dbg){print "R1648"}; continue };
 if ( sc(0,"-") && base(1,cst) )
 ...
 if ( w(1,"в") &&
       wf(2,5,cst) && s(0,wfn-1) && Qf(2,wfn-1,"souz_iili pre_any") )
 { l[i]=omo2; R[1651]++; if(dbg){print "R1651"}; continue };
...
cst="берегу вершине востоке горе горизонте гравюре границе западе земле краю море небе озере острове песке пригорке реке севере скале туче холме холмике юге";
 ...
 { l[i]=omo1; R[1652]++; if(dbg){print "R1652"}; continue };
 if ( wb(-6,-1,"на") &&
       wb(wbn+1,-1,cst) && s(wbn,-1) && !(bf(1,5,"повесить") && s(0,bfn-1)) )
 { l[i]=omo1; R[1653]++; if(dbg){print "R1653"}; continue };
 ...
 if ( w(1,"у возле") &&
       wf(2,4,cst) && s(0,wfn-1) )
 { l[i]=omo1; R[1654]++; if(dbg){print "R1654"}; continue };
 if ( wb(-6,-1,"у возле") &&
       wb(wbn+1,-1,cst) && s(wbn,-1) && !(bf(1,5,"повесить") && s(0,bfn-1)) )
 { l[i]=omo1; R[1655]++; if(dbg){print "R1655"}; continue };

 cst="ангар блок ворота гараж дверца дверь защёлка калитка камера кандалы комната контейнер люк наручники рот роток рундук сундук тумбочка холодильник цепочка чемодан шкаф шкафчик ящик";
 if ( w(1,"на") &&
       bf(2,5,cst) && s(0,bfn-1) && Qf(2,bfn-1,"souz_iili pre_any") )
 { l[i]=omo2; R[1656]++; if(dbg){print "R1656"}; continue };
 ...
 if ( w(1,"к") &&
       w(2,cst) && s(0,1) )
 { l[i]=omo1; R[1657]++; if(dbg){print "R1657"}; continue };
 if ( wb(-6,-1,"к") &&
       wb(wbn+1,-1,cst) && s(wbn,-1) )
 { l[i]=omo1; R[1658]++; if(dbg){print "R1658"}; continue };

 if ( w(1,"веками вдали издали вдалеке") && s(0) )
 { l[i]=omo1; R[1659]++; if(dbg){print "R1659"}; continue };


 cst="башенка башня окно привидение слава стена";
 if ( w(1,"с со") &&
       bf(2,5,cst) && s(0,bfn-1) && Qf(2,bfn-1,"souz_iili pre_any") )
 { l[i]=omo1; R[1660]++; if(dbg){print "R1660"}; continue };

 cst="известняка иллюзий камней камня коробков мрамора палочек песка";
 if ( w(1,"из") &&
       wf(2,5,cst) && s(0,wfn-1) && Qf(2,wfn-1,"souz_iili pre_any") )
 { l[i]=omo1; R[1661]++; if(dbg){print "R1661"}; continue };

 cst="ключ код колёсико механизм набор пистон секрет скважина фиксатор шифр";
 if ( w(1,"с со") &&
       bf(2,5,cst) && s(0,bfn-1) && Qf(2,bfn-1,"souz_iili pre_any") )
 { l[i]=omo2; R[1662]++; if(dbg){print "R1662"}; continue };

 if ( sc(0,"[XIV]+") &&
       w(1,"века веков") && s(0) )
 { l[i]=omo1; R[1663]++; if(dbg){print "R1663"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
#if ( base(-1,"главный") && s(-1) )
#{ l[i]=omo2; R[1686]++; if(dbg){print "R1686"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 l[i]=omo1; R[1687]++; if(dbg){print "R1687"}; continue;
