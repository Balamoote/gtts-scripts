...
#_#_#txtmpprb
#       if( ci == "замок" && num!=o001[$i]) {omap [almo[$i]][$i] = omap [almo[$i]][$i] num " "; o001[$i] = num}; # скан одиночного омографа
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 cst="бандитов барона боса брата владетеля волщебникаш герцога графа епископа заклинателей зла князя колдуна колдуньи королевы короля лорда людоеда магистра магната матери надежд надежды некроманта отца отчаяния принца принцев родственников семейства семьи скэгов тролля ужасов феодала хана хранителей царицы царя чародея штурмом эрцгерцога милорда";
 ...
 ### lock_
 cst="автоматический амбарный вакуумный висячий врезной входной дверной инфракрасный кандальный капризный капсюльный кодовый колесцовый кремнёвый лазерный лёгонький магнитный механический навесный незатейливый неподатливый никелированный одноразовый орудийный особый открытый папиллярный потайной противоугонный пудовый пушечный ржавый сверхнадёжный сейфовый сенсорный сундучный тяжёлый фитильный хилый хитрый хлипкий центральный цифровой электрический электромагнитный электронный логический накидной битумный глиняный пудовый";
 if ( bb(-3,-1,cst) && s(bbn,-1) )
 { l[i]=omo2; r[1599]++; if(dbg){print "R1599"}; continue};
 if ( base(1,cst) && s(0) )
 { l[i]=omo2; r[1600]++; if(dbg){print "R1600"}; continue};

 cst="активировать вешать взламывать взломать включать включить врезать вскрывать вскрыть вспарывать вспороть вставить выбивать выбить вываливаться вывалиться выключать выключить вылетать вылететь вырвать вырезать вырывать вышибить деактивировать заблокировать загреметь заедать заклинить закодировать закрывать закрываться закрыть заменить заменять замкнуть замыкать запереть запирать запрограммировать заржаветь заржавить заскрежетать заскрипеть застегнуть застёгивать захлопнуть захлопнуться захлопывать защёлкивался защёлкнуть защёлкнуться звякнуть изготовить испортить клацать клацнуть ключ кодировать лязгать лязгнуть маукать менять мяукнуть навесить навешивать настроить нащупать нащупывать откидывать откинуть открываеться открывать открыть открыться отлететь отмыкать отмычка отомкнуть отпереть отпирать отстрелить отщёлкиваться ощупать ощупывать перекосить повесить подаваться податься поддаваться поддаться поменять принести приносить провернуть провернуться проворачивать проворачиваться программировать проржаветь разблокировать размыкать разомкнуть разработать разрезать раскодировать раскрываться расстегнуть расстёгивать резать сбивать сбить скрежетать скрипеть скрипнуть сломать сломаться смазать смазывать сорвать сработать срезать установить хрустнуть щёлкать щёлкнуть выломать выламывать сменить воздвигнуть воздвигать зажечь привесить привешивать";
 ...
 #
    ...
    cst="вешать закрывать закрываться закрыть закрыться замкнуть запереть запереться запирать запираться застегнуть застёгивать захлопнуть захлопнуться захлопывать захлопываться защёлкнуть защёлкнуться ключ навесить нащупать нащупывать отмычка посадить садить";
    if ( bb(-7,-2,cst) &&
