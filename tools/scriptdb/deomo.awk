...
### все !_#_!
for(wrd in vsez){wln=split(vsez[wrd],omlin," "); for(y=1;y<=wln;y++){b=strtonum(omlin[y]);nf=splitline(book[b]);             # header1
hyphback(book[b]); getwpos(wrd); for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;if(tolower(l[i])!=wrd)continue; # header2
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); sub(/[Ее]/, "ё", l[i+1]); r[17]++; if(dbg){print "R17"}; continue};
 ...
 if ( w(1,"и") &&
       w(2,"вся") && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[19]++; if(dbg){print "R19"}; continue};
 if ( w(1,"и") &&
       w(2,"всяческие") && s(0,1) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[22]++; if(dbg){print "R22"}; continue};
 if ( phs(-1,"и так") && !(mest_mn(hsn)) &&
      (gl_nemn(1)||gl_pemn(1)||gl_pnmn(1)) && !(glc_mn(1,"syg")) && s(hsn+1,0) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[23]++; if(dbg){print "R23"}; continue};
 if ( phf(1,"и так") &&
 ...
 if ((phf(1,"на одно лицо")||
      ...
      phf(1,"за и против") ) &&
       s(0,hfn-2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[30]++; if(dbg){print "R30"}; continue};
 ...
 if ( mest_mnim(1) &&
      ...
      (phf(3,"на одно лицо")||
       phf(3,"под богом ходим") ) &&
        s(0,hfn-2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[31]++; if(dbg){print "R31"}; continue};

 if ( mest_mnim(1) &&
      (phf(2,"на одно лицо")||
       phf(2,"под богом ходим") ) &&
        s(0,hfn-2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[32]++; if(dbg){print "R32"}; continue};
 ...
 if ( phf(1,"только и") &&
       (gl_pnmn(3)||gl_pemn(3)||gl_nemn(3)) &&
         w(4,"что") && s(0,2) && sc(3,",") )
 { sub(/([Ее])/, "<_&_>", l[i]); r[39]++; if(dbg){print "R39"}; continue};
 if ( w(1,"как") &&
       w(2,"один одна") && ( s(0,1)||( sc(0,",") && s(1,1)) ) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[40]++; if(dbg){print "R40"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[43]++; if(dbg){print "R43"}; continue};
 if ( phf(1,"больше по") &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[47]++; if(dbg){print "R47"}; continue};

 if ( w(-1,"и") &&
       w(1,"лишь только") &&
       (w(2,"потому оттого")||pre_vi(2)||pre_ro(2)) && s(-1,1) )
 { sub(/[Ее]/, "ё", l[i]); r[48]++; if(dbg){print "R48"}; continue};
 if ( w(-1,"и") && s(-1,-1) && p(0,",") )
 ...
 if ((phs(-1,"ещё далеко не")||
      ...
      phs(-1,"далеко не") ) &&
      mest_it(hsn) && s(hsn,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[52]++; if(dbg){print "R52"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[79]++; if(dbg){print "R79"}; continue};
 if ( mest_it(1) &&
       mest_mnim(2) &&
       (gl_pnmn(3)||gl_nemn(3)) &&
         pre_any(4) && s(0,4) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[85]++; if(dbg){print "R85"}; continue};
 if ( mest_it(-2) && 
      w(-1,"не") && s(-2,-1) && p(0) )
 ...
 if ( phs(-1,"как и") && s(-2,0) &&
       mest_mn(1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[89]++; if(dbg){print "R89"}; continue};
 if ( phs(-2,"как и") && s(-3,-1) &&
       mest_mn(-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[90]++; if(dbg){print "R90"}; continue};
 if ( phs(-1,"как и") &&
       (mest_im(1)||prl_mnim(1)) && s(-2,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[91]++; if(dbg){print "R91"}; continue};
 if ( phs(-1,"как и") &&
       pre_ro(1) &&
        mest_ro(2) && s(-2,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[92]++; if(dbg){print "R92"}; continue};

 # как все
 if ( (gl_in(-2)||prl_edim(-2)||prl_mnim(-2)||prl_edtv(-2)||prl_mntv(-2)) &&
        w(-1,"как") && s(-1,-1) && sc(-2,",") && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[93]++; if(dbg){print "R93"}; continue};
 if ( gl_in(-2) &&
        w(-1,"как") && s(-2,-1) && p(0) )
 ...
 if ( w(1,"как") &&
       w(2,"будто") &&
        gl_edsr(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[96]++; if(dbg){print "R96"}; continue};
 if ( w(1,"как") &&
       mod_bz(2) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[97]++; if(dbg){print "R97"}; continue};

 # все как
 if ( w(1,"как") &&
       w(2,"надо нужно есть было") && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[98]++; if(dbg){print "R98"}; continue};
 if ( w(1,"как") &&
      (nar_mest(2)||nar_kaq(2)||nar_vrem(2)) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[99]++; if(dbg){print "R99"}; continue};
 if ( gl_pemn(1) &&
       w(2,"как") &&
        w(3,"надо нужно есть было дома") && s(0,2) && p(3) )
 { sub(/[Ее]/, "ё", l[i]); r[100]++; if(dbg){print "R100"}; continue};
 if ( w(1,"как") && sc(0,",") &&
 ...
 if ( phs(-2,"вот и") &&
       ...
       (mest_it(1)||muk_ed(1)||muk_mn(1)) &&
         w(2,"же ж") && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[103]++; if(dbg){print "R103"}; continue};
 if ( prl_kred_sr(1) &&
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); r[107]++; if(dbg){print "R107"}; continue};
 ...
 if ( pre_da(-1) && s(0,0) )
 { sub(/[Ее]/, "ё", l[i]); r[109]++; if(dbg){print "R109"}; continue};
 ...
 if ( (pre_ro(1)||pre_vi(1)) && sc(0,",") &&
       w(2,"кого" ) && s(1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[115]++; if(dbg){print "R115"}; continue};
 if ( pre_vi(1) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[121]++; if(dbg){print "R121"}; continue};
 if ( (gl_poed(-1)||gl_pomn(-1)||gl_povzmn(-1)) &&
       pre_ro(1) &&
       (prl_edro(2)||prl_mnro(2)||mest_ro(2)) &&
        (suw_edro(3)||suw_mnro(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[122]++; if(dbg){print "R122"}; continue};
 if ( (gl_poed(-1)||gl_pomn(-1)||gl_povzmn(-1)) &&
       pre_ro(1) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[125]++; if(dbg){print "R125"}; continue};
 ...
 if ( w(1,"до") &&
       w(2,"единого") && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[130]++; if(dbg){print "R130"}; continue};
 if ( pre_pr(-3) &&
      (prl_edpr(-2)||mest_pr(-2)) &&
       (suw_edpr(-1)||suw_mnpr(-1)) && s(-3,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[131]++; if(dbg){print "R131"}; continue};
 ...
 if ( w(1,"что") &&
       gl_ed(2) )
 { sub(/[Ее]/, "ё", l[i]); r[134]++; if(dbg){print "R134"}; continue};
 ...
 if ( sc(0,",") &&
       pre_da(1) &&
        w(2,"кому") && s(1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[139]++; if(dbg){print "R139"}; continue};
 if ( sc(0,",") &&
       pre_pr(1) &&
        w(2,"чём чем") && s(1,1) )
 ...
 if ( sc(0,",") &&
       pre_pr(1) &&
        w(2,"ком") && s(1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[141]++; if(dbg){print "R141"}; continue};
 if ( pre_pr(1) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[145]++; if(dbg){print "R145"}; continue};

 # предикат
 if ( predik(1) && sc(0,",") && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[146]++; if(dbg){print "R146"}; continue};
 ...
 if ( cap(1) && sc(0,",") && sc(1,",") &&
       nar_step(2) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[149]++; if(dbg){print "R149"}; continue};
 ...
 { sub(/([Ее])/, "ё", l[i]); r[152]++; if(dbg){print "R152"}; continue};
 if ( prl_kred_sr(1) &&
       glc_mn(2,"y") && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[153]++; if(dbg){print "R153"}; continue};
 if ( pre_pr(-4) &&
      (prl_edpr(-3)||prl_mnpr(-3)||mest_pr(-3)||wc(-3,"ой$ их$")) &&
       (suw_edpr(-2)||suw_mnpr(-2)) &&
         glc_mn(-1,"ogj") && s(-4,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[154]++; if(dbg){print "R154"}; continue};
 if ( pre_pr(-3) &&
      (suw_edpr(-2)||suw_mnpr(-2)||mest_pr(-2)) &&
        glc_mn(-1,"ogj") && s(-3,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[155]++; if(dbg){print "R155"}; continue};
 if ( pre_pr(-2) &&
      (suw_edpr(-1)||suw_mnpr(-1)) &&
        glc_mn(1,"ogj") && s(-2,0) && p(1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[156]++; if(dbg){print "R156"}; continue};
 if ( pre_pr(1) &&
 ...
 if ( mod_mn(1) &&
       glc_in(2,"py") &&
        pre_any(3) && s(0,3) )
 { sub(/([Ее])/, "ё", l[i]); r[159]++; if(dbg){print "R159"}; continue};
 if ( glc_in(-1,"qy") && s(-1,-1) &&
      (w(1,"чтобы будто")||mest_im(1)||nar_vopr(1)) && sc(0,",") )
 { sub(/([Ее])/, "ё", l[i]); r[160]++; if(dbg){print "R160"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[162]++; if(dbg){print "R162"}; continue};
 if ( glc_mn(1,"qj") && s(0,0) &&
       pre_any(2) &&
       (w(3,"чтобы будто")||mest_im(3)||nar_vopr(3)) && sc(1,",") )
 { sub(/([Ее])/, "<_&_>", l[i]); r[163]++; if(dbg){print "R163"}; continue};
 if ( mest_mnim(-4) &&
       w(-3,"же ведь") &&
        phs(-1,"и так") &&
         glc_mn(1,"syg") && s(hsn-1,0) )
 { sub(/([Ее])/, "ё", l[i]); r[164]++; if(dbg){print "R164"}; continue};
 if ( glc_mn(1,"qj") && s(0,0) &&
 ...
 { sub(/([Ее])/, "ё", l[i]); r[175]++; if(dbg){print "R175"}; continue};
 if ( mest_mnim(-2) &&
       prl_kred_sr(-1) &&
        glc_mn(1,"syg") && s(-2,0) && p(1) )
 { sub(/([Ее])/, "ё", l[i]); r[176]++; if(dbg){print "R176"}; continue};
 if ( mest_mnim(-2) &&
        glc_mn(-1,"sgy") && s(-2,-1) && p(0) )
 { sub(/([Ее])/, "ё", l[i]); r[177]++; if(dbg){print "R177"}; continue};
 ...
 if ( mest_mnim(-2) &&
       glc_mn(-1,"syg") &&
        (suw_edro(1)||suw_mnro(1)) &&
          pre_vi(2) && s(-2,2) )
 { sub(/([Ее])/, "ё", l[i]); r[180]++; if(dbg){print "R180"}; continue};
 if ( mest_mn(-1) &&
        glc_mn(1,"syg") && s(-1,0) && p(1) )
 { sub(/([Ее])/, "ё", l[i]); r[181]++; if(dbg){print "R181"}; continue};
 if ( mest_it(-1) &&
 ...
 if ( glc_mn(1,"myg") && s(0,0) &&
       zvat(2) && sc(1,",") )
 { sub(/([Ее])/, "ё", l[i]); r[185]++; if(dbg){print "R185"}; continue};
 if ( pre_pr(1) &&
      (suw_edpr(2)||suw_mnpr(2)||suw_edme(2)) &&
        glc_mn(3,"pj") &&
         pre_any(4) && s(0,4) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[186]++; if(dbg){print "R186"}; continue};
 if ( glc_po(1,"j") &&
       (mest_vi(2)||suw_edvi(2)||suw_mnvi(2)) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[187]++; if(dbg){print "R187"}; continue};
 if ( glc_mn(1,"pj") &&
       pre_any(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[188]++; if(dbg){print "R188"}; continue};
 if ( glc_mn(-2,"j") &&
       mest_da(-1) && s(-2,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[189]++; if(dbg){print "R189"}; continue};
 if ( vvod(-2) &&
       glc_mn(-1,"ogj") && sc(-2,",") && s(-1,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[190]++; if(dbg){print "R190"}; continue};
 if ( glc_mn(1,"j") && s(0,0) &&
      !(w(2,"и") && qq(1,3)) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[191]++; if(dbg){print "R191"}; continue};
 if ( glc_mn(-1,"j") && s(-1,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[192]++; if(dbg){print "R192"}; continue};
 if ( w(1,"уже ведь") &&
       glc_mn(2,"y") && s(0,1) )
 ...
 if ( mod_ed(1) &&
       gl_in(2) && s(0,1) )
 { sub(/([Ее])/, "ё", l[i]); r[202]++; if(dbg){print "R202"}; continue};
 if ( mod_mn(1) &&
       prl_kred_sr(2) &&
        gl_in(3) && s(0,2) )
 ...
 if ( mest_mn(-2) &&
       mod_mn(-1) &&
        gl_in(1) && s(-2,0) )
 { sub(/([Ее])/, "ё", l[i]); r[204]++; if(dbg){print "R204"}; continue};
 if ( gl_in(-2) &&
       mod_mn(-1) && s(-2,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[205]++; if(dbg){print "R205"}; continue};
 if ( mod_ed(-2) &&
       pre_vi(-1) && s(-2,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[206]++; if(dbg){print "R206"}; continue};
 if ( mod_bz(-2) &&
       glc_in(-1,"y") && s(-2,-1))
 ...
 if ( mod_mn(1) &&
       nar_napr(2) && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[213]++; if(dbg){print "R213"}; continue};
 if ( phf(1,"никак не") &&
 ...
 if ( (suw_edim(-3)||suw_mnim(-3)) &&
        mod_mn(-2) &&
         gl_in(-1) && s(-2,-1) && p(0) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[215]++; if(dbg){print "R215"}; continue};
 if ( w(1,"не") &&
       mod_mn(2) &&
        gl_in(3) && s(0,2) )
 ...
 if ( mod_mn(1) &&
       mest_edim(2) &&
       gl_in(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[217]++; if(dbg){print "R217"}; continue};
 if ( mod_mn(1) &&
       gl_in(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[218]++; if(dbg){print "R218"}; continue};
 if ( mod_mn(1) &&
       glc_in(2,"j") && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[219]++; if(dbg){print "R219"}; continue};
 if ( mod_mn(1) &&
      (mest_ed(2)||mest_mn(2)) && s(0,1) && p(2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[220]++; if(dbg){print "R220"}; continue};
 if ( mod_mn(1) && s(0,0) && p(1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[221]++; if(dbg){print "R221"}; continue};
 ...
 if ( gl_ed(-2) &&
       mest_it(-1) && s(-2,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[222]++; if(dbg){print "R222"}; continue};
 if ( mest_it(-1) &&
 ...
 if ( mest_it(1) && s(0,0) && sc(1,",") &&
       vvod(2) && sc(2,",") &&
       (gl_ed(3)||gl_in(3)) )
 { sub(/[Ее]/, "ё", l[i]); r[231]++; if(dbg){print "R231"}; continue};
 if ( gl_ed(-1) &&
 ...
 if ( mest_it(1) && s(0,0) && sc(1,",") &&
       vvod(2) && sc(2,",") &&
       (gl_nemn(3)||gl_pnmn(3)) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[233]++; if(dbg){print "R233"}; continue};
 if ( gl_ed(-1) &&
 ...
 if ( suw_mnim(-2) &&
       gl_ed(-1) &&
        pre_any(1) && s(-2,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[237]++; if(dbg){print "R237"}; continue};
 if ( (cap(0)||p(-1,",")||sc(-1,"<p>")) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[241]++; if(dbg){print "R241"}; continue};
 if ( w(-1,"за") &&
 ...
 if ( gl_in(-2) &&
       mest_it(-1) && s(-2,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[245]++; if(dbg){print "R245"}; continue};
 if ( mest_it(-1) &&
       mest_im(1) &&
        suw_edim(2) && s(-1,1) )
 ...
 if ( prq_kred_sr(-4) &&
       w(-3,"еще ещё") &&
        prl_kred_sr(-2) &&
         w(-1,"не") && s(-4,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[260]++; if(dbg){print "R260"}; continue};
 if ( prq_kred_sr(-3) &&
       prl_kred_sr(-2) &&
        w(-1,"не") && s(-3,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[261]++; if(dbg){print "R261"}; continue};
 if ( w(1,"уже") &&
      (nar_mest(2)||nar_step(2)) &&
        prq_kred_sr(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[262]++; if(dbg){print "R262"}; continue};
 if ( mest_mnim(1) &&
       pre_ro(2) &&
       (suw_edro(3)||suw_mnro(3)) &&
         prq_krmn(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[263]++; if(dbg){print "R263"}; continue};
 if ( (mest_tv(1)||prl_edtv(1)||prl_mntv(1)) &&
       (suw_edtv(2)||suw_mntv(2)) &&
         prq_krmn(3) && s(0,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[264]++; if(dbg){print "R264"}; continue};
 if ( suw_edim(1) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[270]++; if(dbg){print "R270"}; continue};
 if ( prq_kred_sr(-1) && s(-1,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[271]++; if(dbg){print "R271"}; continue};
 if ( (prq_edim(1)||prq_kred(1)) && s(0,0) )
 { sub(/[Ее]/, "ё", l[i]); r[272]++; if(dbg){print "R272"}; continue};
 if ( mest_ed(1) &&
 ...
 if ( pre_tv(-1) &&
       (prq_edtv(1)||prq_mntv(1)) &&
        (suw_edtv(2)||suw_mntv(2)) && s(-1,1) )
 { sub(/[Ее]/, "ё", l[i]); r[274]++; if(dbg){print "R274"}; continue};
 if ( (prq_edtv(-1)||prq_mntv(-1)||prl_edtv(-1)||prl_mntv(-1)) && sc(-1,",") &&
       (prq_edtv(1)||prq_mntv(1)) &&
        (suw_edtv(2)||suw_mntv(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[275]++; if(dbg){print "R275"}; continue};
 if ((nar_vrem(1)||qast(1)) &&
       nar_kaq(2) &&
       (prq_edim(3)||prq_kred(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[276]++; if(dbg){print "R276"}; continue};
 if ( (prq_mnim(1) && w(1,"щие$")) && !(suw_mnim(1)) && s(0,0) && p(1,",") )
 { sub(/[Ее]/, "ё", l[i]); r[277]++; if(dbg){print "R277"}; continue};
 if ( (prq_edro(-1)||prq_mnro(-1)) &&
        pre_pr(1) && s(-1,0) )
 { sub(/[Ее]/, "ё", l[i]); r[278]++; if(dbg){print "R278"}; continue};
 if ( prq_mnim(1) &&
       pre_ro(2) && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[279]++; if(dbg){print "R279"}; continue};
 if ( w(1,"не") &&
       prq_mnim(2) &&
        pre_ro(3) && s(0,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[280]++; if(dbg){print "R280"}; continue};
 if ( w(1,"даже") && sc(0,",") &&
       w(2,"не") &&
        prq_mnim(3) &&
         suw_edda(4) && s(1,3) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[281]++; if(dbg){print "R281"}; continue};
 if ( w(1,"не") && sc(0,",") &&
       prq_mnim(2) &&
        suw_edda(3) && s(1,2) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[285]++; if(dbg){print "R285"}; continue};
 if ( prq_edsrim(1) && sc(0,",") )
 { sub(/[Ее]/, "ё", l[i]); r[286]++; if(dbg){print "R286"}; continue};
 ...
 if ( (prl_mnim(1)||prq_mnim(1)||prl_mnro(1)||prq_mnro(1)||prl_krmn(1)) &&
        ...
        (prl_mnim(3)||prq_mnim(3)||prl_mnro(3)||prq_mnro(3)||prl_krmn(3)) &&
          suw_mnim(4) &&
           gl_nemn(5) && s(0,4)  )
 { sub(/([Ее])/, "<_&_>", l[i]); r[290]++; if(dbg){print "R290"}; continue};
 if ( (prl_mnim(1)||prq_mnim(1)||prl_mnro(1)||prq_mnro(1)||prl_krmn(1)) &&
        w(2,"и или") &&
        (prl_mnim(3)||prq_mnim(3)||prl_mnro(3)||prq_mnro(3)||prl_krmn(3)) &&
          suw_mnim(4) && s(0,3)  )
 { sub(/([Ее])/, "<_&_>", l[i]); r[291]++; if(dbg){print "R291"}; continue};
 ...
 if ( (mest_da(-1)||suw_edda(-1)||suw_mnda(-1)) &&
        prl_kred_sr(1) && s(-1,0) )
 { sub(/[Ее]/, "ё", l[i]); r[305]++; if(dbg){print "R305"}; continue};
 if ( prl_kred_sr(1) &&
       pre_pr(2) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[306]++; if(dbg){print "R306"}; continue};
 if ( w(1,"так") &&
        prl_krmn(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[307]++; if(dbg){print "R307"}; continue};
 if ((phf(1,"как будто")||
      phf(1,"вроде бы") ) &&
      prl_krmn(hfn) && s(0,hfn-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[308]++; if(dbg){print "R308"}; continue};
 if ( (mest_ed(1)||mest_mn(1)) &&
       (nar_kaq(2)||nar_step(2)||nar_spos(2)) &&
         prl_krmn(3) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[309]++; if(dbg){print "R309"}; continue};
 if ( (nar_kaq(1)||nar_step(1)||nar_spos(1)) &&
        prl_krmn(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[310]++; if(dbg){print "R310"}; continue};
 if ( pre_tv(-2) &&
      (suw_edtv(-1)||suw_mntv(-1)) &&
        prl_kred_sr(1) && s(-2,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[311]++; if(dbg){print "R311"}; continue};
 if ( w(1,"вроде как") &&
       w(2,"бы как") &&
        prl_kred_sr(3) && s(0,2) && p(3) )
 ...
 if ( pre_pr(1) &&
      (mest_pr(2)||prl_edpr(2)||prl_mnpr(2)) &&
       (suw_edpr(3)||suw_mnpr(3)) &&
         prl_kred_sr(4) && s(0,3) )
 { sub(/[Ее]/, "ё", l[i]); r[317]++; if(dbg){print "R317"}; continue};
 if ( pre_tv(1) &&
       (mest_tv(2)||suw_edtv(2)||suw_mntv(2)) &&
         prl_edsrim(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[318]++; if(dbg){print "R318"}; continue};
 if ( nar_mest(1) &&
       pre_vi(2) &&
       (suw_edvi(3)||suw_mnvi(3)) &&
         prl_kred_sr(4) && s(0,3) )
 { sub(/[Ее]/, "ё", l[i]); r[319]++; if(dbg){print "R319"}; continue};
 if ( pre_vi(1) &&
       (mest_vi(2)||suw_edvi(2)||suw_mnvi(2)) &&
         prl_edsrim(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[320]++; if(dbg){print "R320"}; continue};
 if ( (mest_ed(1)||nar_step(1)) &&
        nar_step(2) &&
        (prl_kred_sr(3)||prl_edsrim(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[321]++; if(dbg){print "R321"}; continue};
 if ( mest_ed(1) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[324]++; if(dbg){print "R324"}; continue};
 if ( pre_vi(-1) &&
      (prl_kred_sr(1)||prl_edsrim(1)) && s(-1,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[325]++; if(dbg){print "R325"}; continue};
 if ( vvod(-1) &&
      (prl_kred_sr(1)||prl_edsrim(1)) && sc(-1,",") && s(0,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[326]++; if(dbg){print "R326"}; continue};
 ...
 if ( (prl_kred_sr(1)||prl_edsrim(1)) &&
        pre_ro(2) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[329]++; if(dbg){print "R329"}; continue};
 if ( (prl_kred_sr(1)||prl_edsrim(1)) && s(0,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[330]++; if(dbg){print "R330"}; continue};
 if ( gl_vzmn(-2) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[332]++; if(dbg){print "R332"}; continue};
 if (  w(1,"кто кого кому кем") && sc(0,",") )
 { sub(/([Ее])/, "<_&_>", l[i]); r[333]++; if(dbg){print "R333"}; continue};
 if ( (prl_kred_sr(-1)||nar_kaq(-1)) &&
        pre_ro(1) &&
        (suw_edro(2)||suw_mnro(2)) && s(-1,1) && p(2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[334]++; if(dbg){print "R334"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[338]++; if(dbg){print "R338"}; continue};
 ...
 if ( prl_srav(1) &&
       prl_edro(2) &&
        suw_edro(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[342]++; if(dbg){print "R342"}; continue};
 if ( prl_srav(1) &&
      (suw_mnro(2)||prl_edro(2)||prl_mnro(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[343]++; if(dbg){print "R343"}; continue};
 if ( prl_srav(1) &&
      (suw_edim(2)||suw_mnim(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[344]++; if(dbg){print "R344"}; continue};
 if ( nar_spos(1) &&
       prl_mnim(2) && s(0,1) && p(2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[345]++; if(dbg){print "R345"}; continue};
 if ( w(1,"ли же ведь") &&
       prl_mnim(2) && s(0,1) && (p(2)||(w(3,"и")||pre_any(3))) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[346]++; if(dbg){print "R346"}; continue};
 ...
 if ( souz(1) && sc(0,",") &&
       w(2,"не") &&
        prq_mnim(3) &&
         suw_edda(4) &&
          suw_mnvi(5) && s(1,4) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[348]++; if(dbg){print "R348"}; continue};
 if ( souz(1) && sc(0,",") &&
       prq_mnim(2) &&
        suw_edda(3) &&
         suw_mnvi(4) && s(1,3) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[349]++; if(dbg){print "R349"}; continue};
 if (  prq_mnim(1) &&
        suw_edda(2) &&
         suw_mnvi(3) && s(1,2) )
 ...
 if ( w(1,"не") &&
       prq_mnim(2) &&
        suw_edda(3) &&
         suw_mnvi(4) && s(1,3) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[351]++; if(dbg){print "R351"}; continue};
 if ( w(1,"нет") &&
      (suw_edro(2)||suw_mnro(2)) && s(0,1) )
 ...
 if ( (mest_ed(1)||mest_mn(1)) &&
        suw_mnim(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[354]++; if(dbg){print "R354"}; continue};
 if ( suw_edim(1) && se(1,"-") &&
       suw_mnim(2) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[355]++; if(dbg){print "R355"}; continue};
 if ( (prl_mnim(1)||prq_mnim(1)) &&
        mest_da(2) &&
         suw_mnim(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[356]++; if(dbg){print "R356"}; continue};
 if ( (mest_ed(1)||mest_mn(1)||prl_kred_sr(1)) &&
       (prl_mnim(2)||prq_mnim(2)) &&
         suw_mnim(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[357]++; if(dbg){print "R357"}; continue};
 if ( mest_tv(1) &&
       w(2,"же") &&
       (prl_mnim(3)||prq_mnim(3)) &&
         suw_mnim(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[358]++; if(dbg){print "R358"}; continue};
 if ( suw_mnim(1) &&
       (gl_nemn(2)||gl_pemn(2)||gl_pnmn(2)) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[359]++; if(dbg){print "R359"}; continue};
 if ( suw_mnim(-1) &&
       prl_krmn(1) && s(-1,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[360]++; if(dbg){print "R360"}; continue};
 if ( suw_mnim(1) && !(prl_mnim(1)||prl_mnvi(1)) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[361]++; if(dbg){print "R361"}; continue};
 ...
 if ( (mest_ed(1)||mest_mn(1)) &&
        suw_edim(2) &&
         qik_edim(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[366]++; if(dbg){print "R366"}; continue};
 if ( mest_ed(1) &&
       qast(2) &&
        suw_edim(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[367]++; if(dbg){print "R367"}; continue};
 if ( (suw_edsrim(1)||suw_edsrvi(1)) && s(0,0)  )
 { sub(/[Ее]/, "ё", l[i]); r[368]++; if(dbg){print "R368"}; continue};
 if ( (prl_mnim(1)||wc(1,"ские$")) && W(1,"новые") &&
       (suw_edro(2)||suw_mnro(2)) && s(0,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[369]++; if(dbg){print "R369"}; continue};
 if ( w(1,"ли же") &&
      (prl_mnim(2)||wc(2,"ские$")) &&
        suw_mnim(3) && s(0,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[370]++; if(dbg){print "R370"}; continue};
 if ( suw_edim(1) &&
       (suw_edro(2)||suw_mnro(2)) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[371]++; if(dbg){print "R371"}; continue};
 if ( suw_edim(1) && s(0,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[372]++; if(dbg){print "R372"}; continue};
 if ( mest_mn(-1) && s(-1,-1) &&
       prl_edim(1) &&
 ...
 if ( (mest_im(1)||mest_vi(1)) && s(1,1) &&
        suw_edim(2) && se(0," — ") )
 { sub(/[Ее]/, "ё", l[i]); r[375]++; if(dbg){print "R375"}; continue};
 if ( suw_edim(1) && se(0," — ") && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[376]++; if(dbg){print "R376"}; continue};
 if ( suw_edim(1) &&
      (suw_edro(2)||suw_mnro(2)) && s(0,1) )
 ...
 if ( w(-3,"каждый каждую каждое") &&
       ...
       (gl_pemn(-1)||gl_pnmn(-1)||gl_nemn(-1)) && 
        w(1,"новые") && s(-3,0) )
 { sub(/[Ее]/, "ё", l[i]); r[379]++; if(dbg){print "R379"}; continue};
 ...
 if ( suw_edsrim(-1) && sc(-1,",") &&
       ...
       (prl_edpr(2)||prl_mnpr(2)) &&
        (suw_edpr(3)||suw_mnpr(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[381]++; if(dbg){print "R381"}; continue};
 if ( suw_edsrim(-1) && sc(-1,",") &&
       pre_pr(1) &&
       (suw_edpr(2)||suw_mnpr(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[382]++; if(dbg){print "R382"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[384]++; if(dbg){print "R384"}; continue};
 if ( (nar_napr(1)) &&
        w(2,"и или") &&
        (nar_napr(3)) && s(0,2)  )
 { sub(/[Ее]/, "ё", l[i]); r[385]++; if(dbg){print "R385"}; continue};
 if ( nar_step(1) &&
       nar_srav(2) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[386]++; if(dbg){print "R386"}; continue};
 if ( (w(1,"куда")||prl_kred_sr(1)) &&
        nar_srav(2) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[387]++; if(dbg){print "R387"}; continue};
 if ( nar_srav(1) &&
       (gl_ed(2)||gl_nemn(2)||gl_pnmn(2)||gl_pemn(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[388]++; if(dbg){print "R388"}; continue};
 if ( nar_srav(1) && s(0,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[389]++; if(dbg){print "R389"}; continue};
 if ( (nar_kaq(1)||nar_vrem(1)||mest_ed(1)) && s(0,0) && p(1) && cap(0) )
 { sub(/[Ее]/, "ё", l[i]); r[390]++; if(dbg){print "R390"}; continue};
 if ( (gl_vzmn(-1)||gl_nemn(-1)) &&
        prl_srav(1) &&
        (prl_edim(2)||prl_mnim(2)||prl_edro(2)||prl_mnro(2)||prl_edtv(2)||prl_mntv(2)) && s(-1,1) )
 { sub(/[Ее]/, "ё", l[i]); r[391]++; if(dbg){print "R391"}; continue};
 if ( nar_step(1) &&
      (prl_mntv(2)||prl_edtv(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[392]++; if(dbg){print "R392"}; continue};
 if ( (gl_vzmn(-1)||gl_nemn(-1)) &&
       (nar_spos(1)||nar_napr(1)||nar_step(1)) &&
         prl_kred_sr(2) && s(-1,1) && p(2) )
 { sub(/([Ее])/, "ё", l[i]); r[393]++; if(dbg){print "R393"}; continue};
 if ( (gl_vzmn(-1)||gl_nemn(-1)) &&
 ...
 if ( (nar_kaq(1)||nar_spos(1)||nar_step(1)||prl_kred_sr(1)) &&
        prl_kred_sr(2) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[396]++; if(dbg){print "R396"}; continue};
 if ( nar_step(1) &&
      (prl_mnvi(2)||prl_edvi(2)) &&
        suw_mnvi(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[397]++; if(dbg){print "R397"}; continue};
 if ( (qast(1)||nar_step(1)) &&
        nar_kaq(2) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[398]++; if(dbg){print "R398"}; continue};
 if ( nar_mest(1) &&
       w(2,"не") &&
        gl_ed(3) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[399]++; if(dbg){print "R399"}; continue};
 if ( mest_da(-1) &&
       nar_mest(1) && s(-1,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[400]++; if(dbg){print "R400"}; continue};
 if ( (nar_kaq(1)||nar_step(1)) &&
        prl_kred_sr(2) &&
         !(gl_pemn(3)||gl_nemn(3)||gl_pnmn(3)) && s(-1,1) )
 { sub(/[Ее]/, "ё", l[i]); r[401]++; if(dbg){print "R401"}; continue};
 if ( (gl_ed(-1)||gl_nemn(-1)||gl_pemn(-1)||gl_pnmn(-1)) &&
        nar_mest(1) &&
         suw_mnim(2) && s(-1,1) )
 { sub(/[Ее]/, "ё", l[i]); r[402]++; if(dbg){print "R402"}; continue};
 if ( nar_mest(1) &&
       suw_mnim(2) && s(0,1) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[404]++; if(dbg){print "R404"}; continue};
 if ( w(1,"не") &&
       w(2,"так") && se(2,"-") &&
        w(3,"то") &&
        (nar_vrem(4)||nar_mest(4)||nar_spos(4)||nar_srav(4)||nar_kaq(4)||suw_edvi(4)||mest_ed(4)) && s(0,2) && s(3,3) && p(4) )
 { sub(/[Ее]/, "ё", l[i]); r[405]++; if(dbg){print "R405"}; continue};
 if ( nar_mest(1) &&
       w(2,"же") && s(0,1) && p(2) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[409]++; if(dbg){print "R409"}; continue};

 # все + местоимения =============================================
 # все + мест.мн
 if ( w(-1,"чем даже") &&
       mest_mnim(1) && s(-1,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[410]++; if(dbg){print "R410"}; continue};
 if ( mest_mn(-3) && sc(-3,",") &&
       w(-2,"а но") &&
        w(-1,"не") && s(-2,-1) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[412]++; if(dbg){print "R412"}; continue};
 if ( mest_mnim(1) &&
       prl_kred_sr(2) &&
        w(3,"и") &&
        (gl_pnmn(4)||gl_nemn(4)||gl_pemn(4)) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[413]++; if(dbg){print "R413"}; continue};
 if ( mest_mnim(-3) && sc(-3,",") &&
       suw_mnim(-2) && sc(-2,",") &&
        (gl_pnmn(-1)||gl_pemn(-1)||gl_nemn(-1)) && s(-1,-1) && (p(0)||pre_any(1)) )
 { sub(/[Ее]/, "ё", l[i]); r[414]++; if(dbg){print "R414"}; continue};
 if ( mest_im(-2) &&
       mest_mnim(-1) &&
        mest_mnim(1) && s(-2,0) )
 ...
 if ( mest_mnim(1) &&
       pre_pr(2) && s(0,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[418]++; if(dbg){print "R418"}; continue};
 if ( mest_mnim(1) &&
       mest_vi(2) &&
        gl_pnmn(3) && s(0,2) && p(3) )
 ...
 if ( mest_da(1) &&
        gl_ed(2) && s(0,1) && p(2) )
 { sub(/[Ее]/, "ё", l[i]); r[420]++; if(dbg){print "R420"}; continue};
 if ( mest_mnim(1) &&
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); r[427]++; if(dbg){print "R427"}; continue};
 if ( mest_mn(-1) &&
 ...
 if ( mest_mn(-1) &&
       gl_povzmn(1) && s(-1,0) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[429]++; if(dbg){print "R429"}; continue};
 if ( mest_mn(-1) &&
       pre_tv(1) &&
        mest_tv(2) &&
         prl_krmn(3) && s(-1,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[430]++; if(dbg){print "R430"}; continue};
 if ( mest_mn(1) &&
       nar_mest(2) &&
         prl_krmn(3) && s(0,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[431]++; if(dbg){print "R431"}; continue};
 if ( mest_mn(1) &&
       pre_tv(2) &&
       (mest_tv(3)||suw_edtv(3)||suw_mntv(3)) && s(-1,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[432]++; if(dbg){print "R432"}; continue};
 if ( mest_mn(-1) &&
       pre_ro(1) &&
        cap(2) && s(-1,1) )
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); r[434]++; if(dbg){print "R434"}; continue};
 if ( mest_mn(-1) &&
       nar_step(1) && sc(1,",") &&
        nar_step(2) &&
         gl_pemn(3) && s(-1,0) && s(2,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[435]++; if(dbg){print "R435"}; continue};
 if ( mest_mnim(-1) &&
       gl_nemn(1) &&
        pre_tv(2) &&
        (mest_tv(3)||suw_edtv(3)||suw_mntv(3)) s(-1,2) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[436]++; if(dbg){print "R436"}; continue};
 if ( mest_mn(-1) &&
       nar_step(1) &&
       (mest_ro(2)||suw_edro(2)||suw_mnro(2)) &&
         gl_pnmn(3) && s(-1,2) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[440]++; if(dbg){print "R440"}; continue};
 if ( mest_mn(1) &&
       nar_vrem(2) &&
        mod_mn(3) &&
         gl_in(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[441]++; if(dbg){print "R441"}; continue};
 if ( mest_mn(1) &&
       prl_mnim(2) &&
        prl_mnim(3) &&
         suw_mnim(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[442]++; if(dbg){print "R442"}; continue};
 if ( mest_mn(-2) &&
       w(-1,"ведь же ж") && s(-2,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[443]++; if(dbg){print "R443"}; continue};
 if ( mest_mnim(-2) &&
       w(-1,"же ведь") &&
        pre_pr(1) &&
        (suw_edpr(2)||suw_mnpr(2)) && s(-2,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[444]++; if(dbg){print "R444"}; continue};
 if ( mest_mnim(-1) &&
       pre_pr(1) &&
       (suw_edpr(2)||suw_mnpr(2)) && s(-1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[445]++; if(dbg){print "R445"}; continue};
 if ( mest_mn(1) &&
       pre_pr(2) &&
       (suw_edpr(3)||suw_mnpr(3)) && s(0,2) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[447]++; if(dbg){print "R447"}; continue};
 if ( (gl_nemn(1)||gl_pnmn(1)) &&
        phf(2,"друг с другом") && s(0,hfn-2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[448]++; if(dbg){print "R448"}; continue};
 if ( (mest_ed(1)||mest_mn(1)) &&
        qip_mnro(2) &&
         suw_mnro(3) && s(0,2) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[451]++; if(dbg){print "R451"}; continue};
 if ( mest_ed(1) &&
       pre_tv(2) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[456]++; if(dbg){print "R456"}; continue};
 if ( mest_edsrim(-1) && prevje != b-1 && s(-1,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[457]++; if(dbg){print "R457"}; continue};

 # Местоимения + все
 # мест.да
 if ( mest_da(-1) &&
       nar_mest(1) && s(-1,0) )
 { sub(/[Ее]/, "ё", l[i]); r[458]++; if(dbg){print "R458"}; continue};
 ...
 if ( mest_mn(-2) &&
       gl_nemn(-1) &&
        gl_in(1) && s(-2,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[462]++; if(dbg){print "R462"}; continue};
 if ( (gl_in(-1)||gl_ed(-1)) &&
 ...
 if ( mest_mn(-1) &&
      (nar_mest(1)||nar_kaq(1)||nar_vrem(1)||nar_spos(1)) &&
        gl_nemn(2) && s(-1,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[465]++; if(dbg){print "R465"}; continue};
 if ( mest_mn(-1) &&
       mest_da(1) &&
        gl_nemn(2) && s(-1,1) && p(2))
 ...
 if ( (suw_edvi(-3)||suw_mnvi(-3)||mest_vi(-3)) &&
       (gl_pnmn(-2)||gl_pemn(-2)||gl_nemn(-2)) &&
         mest_mnim(-1) && s(-3,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[468]++; if(dbg){print "R468"}; continue};
 if ( mest_mn(-1) &&
      (gl_pnmn(1)||gl_pemn(1)) &&
        suw_mnvi(2) && s(-1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[469]++; if(dbg){print "R469"}; continue};
 if ( mest_mn(-1) &&
 ...
 if ( mest_mn(1) &&
       nar_mest(2) &&
        gl_vzmn(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[471]++; if(dbg){print "R471"}; continue};
 if ( mest_mn(1) &&
      (gl_pnmn(2)||gl_pemn(2)) &&
        suw_mnvi(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[472]++; if(dbg){print "R472"}; continue};
 if ( mest_ed(1) &&
       gl_ed(2) && s(0,1) && p(2) )
 ...
 { sub(/[Ее]/, "<_&_>", l[i]); r[479]++; if(dbg){print "R479"}; continue};
 if ( gl_ed(-1) &&
       pre_ro(1) &&
       (mest_ro(2)||suw_edro(2)||suw_mnro(2)||prl_edro(2)||prl_mnro(2)||prq_edro(2)||prq_mnro(2)) && s(-1,1) && p(2) )
 ...
 if ( w(1,"кроме") && sc(0,",") &&
       cap(2) && s(1,1) )
 { sub(/[Ее]/, "<_&_>", l[i]); r[483]++; if(dbg){print "R483"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[485]++; if(dbg){print "R485"}; continue};
 if ( deep(-2) &&
      (suw_edtv(-1)||suw_mntv(-1)) &&
        nar_mest(1) && s(-2,0) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[491]++; if(dbg){print "R491"}; continue};
 if ( deep(-1) &&
       prl_srav(1) && s(-1,0) )
 { sub(/[Ее]/, "ё", l[i]); r[492]++; if(dbg){print "R492"}; continue};
 if ( deep(-1) &&
       gl_nemn(1) && s(-1,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[493]++; if(dbg){print "R493"}; continue};
 if ( w(1,"включая") && sc(0,",") &&
      (suw_edvi(2)||suw_mnvi(2)) && s(1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[494]++; if(dbg){print "R494"}; continue};
 if ( deep(-1) &&
       nar_mest(1) && s(-1,0) )
 { sub(/([Ее])/, "ё", l[i]); r[495]++; if(dbg){print "R495"}; continue};
 if ( deep(-1) && s(-1,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[496]++; if(dbg){print "R496"}; continue};
 if ( gl_nemn(-1) &&
      (prl_mnim(1)||prq_mnim(1)||prl_krmn(1)) &&
        deep(2) && s(-1,0) && sc(1,",") )
 { sub(/[Ее]/, "ё", l[i]); r[497]++; if(dbg){print "R497"}; continue};
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[500]++; if(dbg){print "R500"}; continue};
 if ( nar_vrem(1) &&
       nar_vrem(2) &&
       (gl_vzmn(3)||gl_nemn(3)) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[501]++; if(dbg){print "R501"}; continue};
 if ( (gl_vzed(-1)||gl_vzmn(-1)||gl_nemn(-1)) &&
        prl_srav(1) && s(-1,0) )
 { sub(/[Ее]/, "ё", l[i]); r[502]++; if(dbg){print "R502"}; continue};
 if ( nar_srav(1) &&
      (gl_vzmn(2)||gl_nemn(2)||gl_pemn(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[503]++; if(dbg){print "R503"}; continue};
 if ( suw_mnim(-1) && cap(-1) &&
 ...
 if ( (suw_edim(-3)||suw_mnim(-3)) &&
        ...
        (suw_edpr(-1)||suw_mnpr(-1)) &&
         (gl_vzmn(1)||gl_nemn(1)) && s(0,0) && p(1) )
 { sub(/([Ее])/, "ё", l[i]); r[506]++; if(dbg){print "R506"}; continue};
 if ( gl_vzmn(-3) &&
       pre_tv(-2) &&
       (suw_edtv(-1)||suw_mntv(-1)||mest_tv(-1)) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[507]++; if(dbg){print "R507"}; continue};


 # Всё + ... + глагол.мн + дополнение ============================
  if ( gl_pemn(-2) &&
        w(-1,"себя") && s(-2,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[508]++; if(dbg){print "R508"}; continue};
if ( gl_nemn(1) &&
      nar_kaq(2) &&
       prq_krmn(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[509]++; if(dbg){print "R509"}; continue};
 if ( gl_nemn(1) &&
       prl_krmn(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[510]++; if(dbg){print "R510"}; continue};
 ...
 if ( mest_mnim(-2) && w(-1,"то") && se(-2,"-") &&
      (gl_pemn(1)||gl_nemn(1)||gl_pnmn(1)||gl_vzmn(1)) &&
        w(2,"и") &&
        (gl_pemn(3)||gl_nemn(3)||gl_pnmn(3)||gl_vzmn(3)) && s(0,2) )
 { sub(/([Ее])/, "ё", l[i]); r[514]++; if(dbg){print "R514"}; continue};
 if ( mest_mnim(-1) &&
      (gl_pemn(1)||gl_nemn(1)||gl_pnmn(1)||gl_vzmn(1)) &&
        w(2,"и") &&
        (gl_pemn(3)||gl_nemn(3)||gl_pnmn(3)||gl_vzmn(3)) && s(0,2) )
 { sub(/([Ее])/, "ё", l[i]); r[515]++; if(dbg){print "R515"}; continue};
 if ( w(1,"и") &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[518]++; if(dbg){print "R518"}; continue};
 # гл.ед + всё
 if ( (gl_ed(-2)||gl_in(-2)) &&
        mest_da(-1) &&
         pre_pr(1) &&
         (prl_edpr(2)||prl_mnro(2)||suw_edpr(2)||suw_mnpr(2)) && s(-2,1) )
 { sub(/[Ее]/, "ё", l[i]); r[519]++; if(dbg){print "R519"}; continue};
 # гл.ед + всё
 if ( (gl_ed(-1)||gl_in(-1)) &&
 ...
 if ( w(1,"то") && sc(1,",") &&
       mest_edsr(2) )
 { sub(/[Ее]/, "ё", l[i]); r[521]++; if(dbg){print "R521"}; continue};
 # всё, что
 if ( sc(0,",") &&
       mest_edsr(1) && W(2,"есть") )
 { sub(/[Ее]/, "ё", l[i]); r[522]++; if(dbg){print "R522"}; continue};
 # все те, кто
 if ( w(1,"те") && sc(1,",") &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[526]++; if(dbg){print "R526"}; continue};
 if ( sc(0,",") &&
 ...
 # Ну всё,
 if ( w(-1,"ну") && s(-1,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[528]++; if(dbg){print "R528"}; continue};
 if ( phs(-1,"ну всё") && sc(-1,",") && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[529]++; if(dbg){print "R529"}; continue};
 ...
 if ( (nar_vrem(1)||nar_mest(1)||nar_spos(1)||nar_srav(1)||nar_kaq(1)||nar_step(3)) &&
        gl_edsr(2) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[530]++; if(dbg){print "R530"}; continue};
 if ( gl_edsr(-3) &&
       w(-2,"ли же ведь") &&
        mest_it(-1) && s(-3,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[531]++; if(dbg){print "R531"}; continue};
 if ( gl_edsr(-1) && s(-1,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[532]++; if(dbg){print "R532"}; continue};
 if ( gl_vzed(1) && Q(1,"gl_vzmn") && s(0,0) )
 { sub(/[Ее]/, "ё", l[i]); r[533]++; if(dbg){print "R533"}; continue};
 if ( prl_kred_sr(1) &&
       gl_in(2) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[534]++; if(dbg){print "R534"}; continue};
 if ( gl_vzed(-1) &&
 ...
 if ( w(-2,"так") &&
      (mest_edim(-1)||mest_mnim(-1)) &&
        w(1,"себе") &&
         w(2,"и") && s(-2,1) )
 { sub(/([Ее])/, "ё", l[i]); r[536]++; if(dbg){print "R536"}; continue};
 if ( (gl_ed(-1)) &&
        w(1,"так") && sc(1,",") &&
         w(2,"что чтобы") && s(-1,-1) && s(0,0) )
 { sub(/([Ее])/, "ё", l[i]); r[537]++; if(dbg){print "R537"}; continue};
 if ( sc(0,",") &&
       gl_vzed(-1) && s(-1,-1) )
 { sub(/[Ее]/, "ё", l[i]); r[538]++; if(dbg){print "R538"}; continue};
 if ( qast(1) &&
       qast(2) &&
 ...
 { sub(/[Ее]/, "ё", l[i]); r[540]++; if(dbg){print "R540"}; continue};
 if ( qast(1) &&
      (nar_vrem(2)||nar_mest(2)||nar_spos(2)||nar_srav(2)||nar_kaq(2)||suw_edvi(2)||mest_ed(2)) &&
       (gl_ed(3)||gl_in(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[541]++; if(dbg){print "R541"}; continue};
 if ( qast(1) &&
      (nar_vrem(2)||nar_mest(2)||nar_spos(2)||nar_srav(2)||nar_kaq(2)||suw_edvi(2)||mest_ed(2)) &&
        qast(3) &&
        (gl_ed(4)||gl_in(4)) && s(0,3) )
 { sub(/[Ее]/, "ё", l[i]); r[542]++; if(dbg){print "R542"}; continue};
 if ( mest_mnim(-2) &&
       gl_pnmn(-1) &&
 ...
 if ( (nar_vrem(1)||nar_mest(1)||nar_spos(1)||nar_srav(1)||nar_kaq(1)||suw_edvi(1)||mest_ed(1)) &&
        qast(2) &&
        (gl_ed(3)||gl_in(3)) && s(0,2) )
 { sub(/[Ее]/, "ё", l[i]); r[544]++; if(dbg){print "R544"}; continue};
 if ( gl_nemn(-1) &&
       gl_in(1) && s(-1,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[545]++; if(dbg){print "R545"}; continue};
 if ( nar_mest(1) &&
       mest_da(2) &&
        gl_ed(3) && s(0,2) )
 ...
 if ( nar_mest(1) &&
       mest_da(2) &&
        qast(3) &&
         gl_ed(4) && s(0,3) )
 { sub(/[Ее]/, "ё", l[i]); r[547]++; if(dbg){print "R547"}; continue};
 if ( nar_mest(1) &&
       gl_pnmn(2) &&
        gl_in(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[548]++; if(dbg){print "R548"}; continue};
 if ( nar_mest(1) &&
       gl_pnmn(2) &&
        qast(3) &&
         gl_in(4) && s(0,3) )
 ...
 if ( (gl_pnmn(1)||gl_pemn(1)) &&
       gl_in(2) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[550]++; if(dbg){print "R550"}; continue};
 if ( (gl_pnmn(1)||gl_pemn(1)) &&
       qast(2) &&
        gl_in(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[551]++; if(dbg){print "R551"}; continue};
 if ( (gl_ed(1)||gl_in(1)) && s(0,0) && cap(0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[552]++; if(dbg){print "R552"}; continue};
 if ( pre_ro(-2) &&
       mest_ro(-1) &&
       (gl_ed(1)||gl_in(1)) && s(-2,0) )
 { sub(/[Ее]/, "ё", l[i]); r[553]++; if(dbg){print "R553"}; continue};
 if ( w(1,"и не ли так как же") &&
      (gl_ed(2)||gl_in(2)) && s(0,1) )
 { sub(/[Ее]/, "ё", l[i]); r[554]++; if(dbg){print "R554"}; continue};
 if ( gl_ed(-3) &&
       w(-2,"бы") &&
        mest_mnvi(-1) &&
        (gl_ed(1)||gl_in(1)) && s(-3,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[555]++; if(dbg){print "R555"}; continue};
 if ( gl_ed(-3) &&
       pre_pr(-2) &&
       (suw_edpr(-1)||suw_mnpr(-1)||prl_edpr(-1)||prl_mnpr(-1)||wc(-1,"ах$")) && s(-3,-1) )
 { sub(/([Ее])/, "ё", l[i]); r[556]++; if(dbg){print "R556"}; continue};
 if ( gl_ed(-1) &&
       pre_pr(1) &&
       (suw_edpr(2)||suw_mnpr(2)||prl_edpr(2)||prl_mnpr(2)||wc(2,"ах$")) && s(-1,1) )
 { sub(/([Ее])/, "ё", l[i]); r[557]++; if(dbg){print "R557"}; continue};
 if ( gl_ed(-2) &&
       mest_mnvi(-1) &&
       (gl_ed(1)||gl_in(1)) && s(-2,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[558]++; if(dbg){print "R558"}; continue};
 if ( mest_mnvi(-1) &&
      (gl_ed(1)||gl_in(1)) && s(-1,0) )
 { sub(/[Ее]/, "ё", l[i]); r[559]++; if(dbg){print "R559"}; continue};
 if ( (gl_ed(1)||gl_in(1)) && s(0,0) )
 { sub(/[Ее]/, "ё", l[i]); r[560]++; if(dbg){print "R560"}; continue};
 if ( mest_da(1) &&
      (gl_ed(2)||gl_in(2)) && s(0,1) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[569]++; if(dbg){print "R569"}; continue};
 if (gl_pemn(1) &&
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[573]++; if(dbg){print "R573"}; continue};
 if (mest_mnim(1) &&
      qast(2) &&
      (gl_pemn(3)||gl_pnmn(3)) &&
       (prl_edvi(4)||prl_mnvi(4)||prq_mnvi(4)) &&
        (suw_edvi(5)||suw_mnvi(5)) && s(0,4) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[574]++; if(dbg){print "R574"}; continue};
 if (gl_pnmn(1) &&
      pre_vi(2) &&
       suw_edvi(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[575]++; if(dbg){print "R575"}; continue};
 if ( (gl_nemn(1)||gl_pnmn(1)||gl_pemn(1)) &&
        nar_srav(2) && s(0,1) && p(2) )
 ...
 { sub(/[Ее]/, "ё", l[i]); r[577]++; if(dbg){print "R577"}; continue};
 if ( (gl_nemn(1)||gl_pnmn(1)||gl_pemn(1)) &&
        pre_pr(2) &&
 ...
 if (qast(1) &&
      gl_pnmn(2) &&
       pre_vi(3) &&
        suw_edvi(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[579]++; if(dbg){print "R579"}; continue};
 if (gl_pnmn(1) &&
      pre_vi(2) &&
       mest_vi(3) &&
        suw_edvi(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[580]++; if(dbg){print "R580"}; continue};
 if (qast(1) &&
      gl_pnmn(2) &&
       pre_vi(3) &&
        mest_vi(4) &&
         suw_edvi(5) && s(0,4) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[581]++; if(dbg){print "R581"}; continue};
 if (gl_pnmn(1) &&
      pre_vi(2) &&
       mest_vi(3) && s(0,2) && p(3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[582]++; if(dbg){print "R582"}; continue};
 if (prl_kred_sr(1) &&
      gl_pnmn(2) &&
       pre_vi(3) &&
        mest_vi(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[583]++; if(dbg){print "R583"}; continue};
 if (pre_vi(1) &&
      mest_vi(2) &&
       gl_pnmn(3) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[584]++; if(dbg){print "R584"}; continue};
 if (pre_vi(1) &&
      mest_vi(2) &&
       qast(3) &&
        gl_pnmn(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[585]++; if(dbg){print "R585"}; continue};
 if (pre_tv(1) &&
      mest_tv(2) &&
       nar_mest(3) &&
        gl_vzmn(4) && s(0,3) )
 ...
 if (pre_pr(1) &&
     (prl_edpr(2)||prl_mnpr(2)) &&
      (suw_edpr(3)||suw_mnpr(3)) &&
        gl_ed(4) && s(0,3) )
 { sub(/([Ее])/, "ё", l[i]); r[587]++; if(dbg){print "R587"}; continue};
 if (pre_pr(1) &&
     (prl_edpr(2)||prl_mnpr(2)) &&
      (suw_edpr(3)||suw_mnpr(3)) &&
       (gl_vzmn(4)||gl_nemn(4)) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[588]++; if(dbg){print "R588"}; continue};
 if ( (gl_pemn(1)||gl_pnmn(1)) &&
        mest_vi(2) &&
        (prl_edvi(3)||prl_mnvi(3)||prq_mnvi(3)||suw_edvi(3)||suw_mnvi(3)) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[589]++; if(dbg){print "R589"}; continue};
 if (qast(1) &&
     (gl_pemn(2)||gl_pnmn(2)) &&
       mest_vi(3) &&
       (prl_edvi(4)||prl_mnvi(4)||prq_mnvi(4)||suw_edvi(4)||suw_mnvi(4)) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[590]++; if(dbg){print "R590"}; continue};
 if ( (gl_pemn(1)||gl_pnmn(1)) && cap(0) &&
       (suw_edvi(2)||suw_mnvi(2)||mest_vi(2)) &&
         gl_in(3) && s(0,2) )
 { sub(/([Ее])/, "ё", l[i]); r[591]++; if(dbg){print "R591"}; continue};
 if ( (gl_pemn(1)||gl_pnmn(1)) &&
       (suw_edvi(2)||suw_mnvi(2)||mest_vi(2)) && s(0,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[592]++; if(dbg){print "R592"}; continue};
 if (mest_da(-1) &&
     (suw_edvi(1)||suw_mnvi(1)) &&
      (gl_pemn(2)||gl_pnmn(2)) && s(-1,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[593]++; if(dbg){print "R593"}; continue};
 if ((qast(1)||mest_da(1)) &&
      (gl_pemn(2)||gl_pnmn(2)) &&
       (suw_edvi(3)||suw_mnvi(3)||mest_vi(3)) && s(0,2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[594]++; if(dbg){print "R594"}; continue};
 ...
 { sub(/([Ее])/, "ё", l[i]); r[595]++; if(dbg){print "R595"}; continue};

 # гл.мн. + дополнение с прдл. в пр. п.
 if ( (suw_mnim(-2)||suw_mnne(-2)) &&
         gl_nemn(-1) &&
          pre_pr(1) && s(-2,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[596]++; if(dbg){print "R596"}; continue};
 if ( pre_pr(1) &&
        suw_edpr(2) &&
        (gl_nemn(3)||gl_pnmn(3)) &&
          pre_pr(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[597]++; if(dbg){print "R597"}; continue};
 if ( mest_mnim(1) &&
       pre_tv(2) &&
       (suw_edtv(3)||suw_mntv(3)) &&
        (gl_nemn(4)||gl_pnmn(4)) &&
          pre_pr(5) && s(0,4) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[598]++; if(dbg){print "R598"}; continue};
 if ( pre_tv(1) &&
      (suw_edtv(2)||suw_mntv(2)) &&
       (gl_nemn(3)||gl_pnmn(3)) &&
         pre_pr(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[599]++; if(dbg){print "R599"}; continue};

 # гл.мн. + дополнение с прдл. в тв. п.
 if ( (suw_mnim(-2)||suw_mnne(-2)) &&
         gl_nemn(-1) &&
          pre_tv(1) && s(-2,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[600]++; if(dbg){print "R600"}; continue};
 if ( pre_pr(1) &&
        suw_edpr(2) &&
        (gl_nemn(3)||gl_pnmn(3)) &&
          pre_tv(4) && s(0,3) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[601]++; if(dbg){print "R601"}; continue};
 if ( mest_mnim(1) &&
       pre_tv(2) &&
       (suw_edtv(3)||suw_mntv(3)) &&
        (gl_nemn(4)||gl_pnmn(4)) &&
          pre_tv(5) && s(0,4) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[602]++; if(dbg){print "R602"}; continue};
 if ( pre_tv(1) &&
      (suw_edtv(2)||suw_mntv(2)) &&
       (gl_nemn(3)||gl_pnmn(3)) &&
         pre_tv(4) && s(0,3) )
 ...
 { sub(/([Ее])/, "<_&_>", l[i]); r[604]++; if(dbg){print "R604"}; continue};
 if ( (gl_pemn(1)) && sc(1,",") &&
        w(2,"что") && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[605]++; if(dbg){print "R605"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[607]++; if(dbg){print "R607"}; continue};

 if ( (gl_vzmn(-1)||gl_nemn(-1)) && s(-1,-1) && p(0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[608]++; if(dbg){print "R608"}; continue};

 if ( (gl_ed(-1)||gl_in(-1)) && s(-1,-1) && (p(0)||pre_any(1)) )
 { sub(/[Ее]/, "ё", l[i]); r[609]++; if(dbg){print "R609"}; continue};

 if ( w(1,"были") && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[610]++; if(dbg){print "R610"}; continue};


 # звательное ---------------------------
 if ( zvat(1) && sc(0,",") && p(1) )
 { sub(/([Ее])/, "ё", l[i]); r[611]++; if(dbg){print "R611"}; continue};
 ...
 if ( mest_mnim(1) &&
       nar_mest(2) &&
        vv(2) &&
         suw_mnim(vvn+1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[612]++; if(dbg){print "R612"}; continue};
 if ( vv(0) &&
       suw_mnim(vvn+1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[613]++; if(dbg){print "R613"}; continue};
 if ( mest_mnim(1) && vv(1) &&
      (nar_spos(vvn+1)||prl_kred_sr(vvn+1)) &&
        prl_krmn(vvn+2) && s(0,0) && s(vvn+1,vvn+1) && p(vvn+2) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[614]++; if(dbg){print "R614"}; continue};
 if ( mest_mnim(1) && vv(1) &&
       gl_povzmn(vvn+1) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[615]++; if(dbg){print "R615"}; continue};
 if ( mest_mnim(1) && vv(1) &&
       nar_mest(vvn+1) &&
        nar_mest(vvn+2) && s(0,0) && s(vvn+1,vvn+1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[616]++; if(dbg){print "R616"}; continue};
 if ( vv(1) &&
       gl_edsr(vvn+1) )
 { sub(/[Ее]/, "ё", l[i]); r[617]++; if(dbg){print "R617"}; continue};
 if ( vv(0) && (gl_vzmn(vvn+1)||gl_nemn(vvn+1)) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[618]++; if(dbg){print "R618"}; continue};
 if ( vvb(-1) && suw_mnim(vvn) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[619]++; if(dbg){print "R619"}; continue};
 if ( vvb(-2) &&
       w(vvn,"вот") &&
        w(-1,"и") && s(-1,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[620]++; if(dbg){print "R620"}; continue};

 # поиск вперёд ----------------------------------------------------------
 if ( qf(7,"gl_edsr") &&
       (prl_kred_sr(qfn+1)||suw_edtv(qfn+1)) && s(0,qfn) )
 { sub(/[Ее]/, "ё", l[i]); r[621]++; if(dbg){print "R621"}; continue};
 if ( qf(7,"gl_nemn") &&
       prq_krmn(qfn+1) && s(0,qfn) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[622]++; if(dbg){print "R622"}; continue};
 if ( qf(5,"gl_edsr") && s(0,qfn-1) )
 { sub(/[Ее]/, "ё", l[i]); r[623]++; if(dbg){print "R623"}; continue};
 if ( mest_it(1) &&
       mest_da(2) &&
        qf(7,"prl_kred_sr") && s(0,qfn-1) && p(qfn) )
 { sub(/[Ее]/, "ё", l[i]); r[624]++; if(dbg){print "R624"}; continue};
 if ( mest_mn(1) &&
       qf(6,"gl_vzmn") && s(0,qfn-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[625]++; if(dbg){print "R625"}; continue};
 if ( qf(5,"gl_vzmn") && s(0,qfn-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[626]++; if(dbg){print "R626"}; continue};
 ...
 { sub(/[Ее]/, "ё", l[i]); r[627]++; if(dbg){print "R627"}; continue};
 if ( qb(-7,"mest_im") &&
       phs(-1,"как и") && s(-2,-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[628]++; if(dbg){print "R628"}; continue};
 if ( qb(-5,"suw_mnim") &&
        pre_pr(1) &&
        (mest_pr(2)||suw_edtv(2)||suw_mntv(2)) && s(qbn,1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[629]++; if(dbg){print "R629"}; continue};
 if ( (qb(-5,"prl_krmn")||qb(-5,"mest_mnim")) && sv(qbn,0,".") &&
       (prl_kred_sr(1)||prl_edsrim(1)) && s(0,0) && p(1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[630]++; if(dbg){print "R630"}; continue};

 if ( wb(-7,"вс<_е_>") && sv(wbn,-2,"[!.?]") && p(-1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[631]++; if(dbg){print "R631"}; continue};
 if ( wb(-7,"всё") && sv(wbn,-2,"[!.?]") && p(-1) )
 { sub(/([Ее])/, "ё", l[i]); r[632]++; if(dbg){print "R632"}; continue};


 # Конечное подбирание хвостов ----------------------------------------------
 if ( (nar_spos(1)||nar_napr(1)||nar_step(1)) && s(0,0) && p(1) )
 { sub(/[Ее]/, "ё", l[i]); r[633]++; if(dbg){print "R633"}; continue};
 if ( suw_mnim(1) && (prl_mnim(1)||prl_mnvi(1)) && W(1,"новые") && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[634]++; if(dbg){print "R634"}; continue};
 if ( (prq_mnim(1)||prq_krmn(1)) && s(0,0) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[635]++; if(dbg){print "R635"}; continue};
 if ( (gl_vzmn(1)||gl_nemn(1)) && s(0,0) && p(1) )
 { sub(/([Ее])/, "<_&_>", l[i]); r[636]++; if(dbg){print "R636"}; continue};
 if ( prl_srav(1) && s(0,0) )
 { sub(/[Ее]/, "ё", l[i]); r[637]++; if(dbg){print "R637"}; continue};
 if ( gl_poed(-1) && s(-1,-1) && p(0) )
 { sub(/[Ее]/, "ё", l[i]); r[638]++; if(dbg){print "R638"}; continue};
 if ( deep(1) && s(0,0) )
 { sub(/[Ее]/, "ё", l[i]); r[639]++; if(dbg){print "R639"}; continue};

 # короткие предложения в зависимости от предыдущей строки
 if (i<=5 && prevyo == b-1 )
 { sub(/[Ее]/, "ё", l[i]); r[640]++; if(dbg){print "R640"}; continue};

 # короткие предложения в зависимости от предыдущей строки
 if (i<=5 && prevje == b-1 )
 { sub(/([Ее])/, "<_&_>", l[i]); r[641]++; if(dbg){print "R641"}; continue};
...
### ogl_pomn !_#_!
for(wrd in oglTpomn){wln=split(oglTpomn[wrd],omlin," ");subomo=ogl_pomn[wrd];for(y=1;y<=wln;y++){b=strtonum(omlin[y]); # header1
nf=splitline(book[b]);hyphback(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;      # header2
 #
 if ( (gl_poed(-4)||gl_pomn(-4)||gl_povzmn(-4)) &&
        w(-3,"что") &&
        (gl_ed(-2)||gl_nemn(-2)||gl_pemn(-2)||gl_pnmn(-2)) &&
          w(-1,"и") && s(-4,-1) )
 { if ( l[i] ~ capword ) { lcf=tolower(l[i]); l[i]=toupper(subomo) } else { l[i]=subomo }; r[642]++; if(dbg){print "R642"}; continue};
 #
 if ( w(-2,"так") &&
       w(-1,"что вот") && s(-2,-1) )
 { if ( l[i] ~ capword ) { lcf=tolower(l[i]); l[i]=toupper(subomo) } else { l[i]=subomo }; r[643]++; if(dbg){print "R643"}; continue};

 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                                                         ##_ogl_pomn

### ogl_mn1e !_#_!
for(wrd in oglTmn1e){wln=split(oglTmn1e[wrd],omlin," ");subomo=ogl_mn1e[wrd];for(y=1;y<=wln;y++){b=strtonum(omlin[y]); # header1
nf=splitline(book[b]);hyphback(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;      # header2
 #
 if ( w(-1,"мы все сами") && s(-1,-1) )
 { if ( l[i] ~ capword ) { l[i]=toupper(subomo) } else { l[i]=subomo }; r[644]++; if(dbg){print "R644"}; continue};
 #
 if ( (p(-1)||sc(-1,"[pv]")) &&
        (p(0)||sc(0,"[pv]")) )
 { if ( l[i] ~ capword ) { l[i]=toupper(subomo) } else { l[i]=subomo }; r[644]++; if(dbg){print "R644"}; continue};
...
### ogl_mn2e !_#_!
for(wrd in oglTmn2e){wln=split(oglTmn2e[wrd],omlin," ");subomo=ogl_mn2e[wrd];for(y=1;y<=wln;y++){b=strtonum(omlin[y]); # header1
nf=splitline(book[b]);hyphback(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;      # header2
 #
 ...
 { if ( l[i] ~ capword ) { l[i]=toupper(subomo) } else { l[i]=subomo }; r[645]++; if(dbg){print "R645"}; continue};
 #
 if ( wb(-5,"как") &&
       w(wbn-1,"бы долго же") && s(wbn,-1) )
 { if ( l[i] ~ capword ) { l[i]=toupper(subomo) } else { l[i]=subomo }; r[646]++; if(dbg){print "R646"}; continue};
 #
 if ( sc(0,"?") )
 { if ( l[i] ~ capword ) { l[i]=toupper(subomo) } else { l[i]=subomo }; r[647]++; if(dbg){print "R647"}; continue};

 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                                                        ##_ogl_mn2e

### ogl_mn3e !_#_!
for(wrd in oglTmn3e){wln=split(oglTmn3e[wrd],omlin," ");subomo=ogl_mn3e[wrd];for(y=1;y<=wln;y++){b=strtonum(omlin[y]); # header1
nf=splitline(book[b]);hyphback(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;      # header2
 #
 if ( (mest_mnim(-1)||suw_mnim(-1)) && s(-1,-1) )
 { if ( l[i] ~ capword ) { l[i]=toupper(subomo) } else { l[i]=subomo }; r[648]++; if(dbg){print "R648"}; continue};

 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                                                              ##_ogl_mn3e

### opl_kredmu !_#_!
for(wrd in oplTkredmu){wln=split(oplTkredmu[wrd],omlin," ");subomo=opl_kredmu[wrd];for(y=1;y<=wln;y++){b=strtonum(omlin[y]); # header1
nf=splitline(book[b]);hyphback(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;            # header2
 #
 if ( (w(-1,"я ты он аз")||mod_ed(-1,"mu")||suw_odedim(-1)) && s(-1,-1) )
 { if ( l[i] ~ capword ) { l[i]=toupper(subomo) } else { l[i]=subomo }; r[649]++; if(dbg){print "R649"}; continue};

 }; delete wpos; book[b]=joinpat(l,sep,nf) };};                                                                              ##_opl_kredmu

### opq_kredmu !_#_!
for(wrd in opqTkredmu){wln=split(opqTkredmu[wrd],omlin," ");subomo=opq_kredmu[wrd];for(y=1;y<=wln;y++){b=strtonum(omlin[y]); # header1
nf=splitline(book[b]);hyphback(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;            # header2
 #
 if ( (w(-1,"я ты он аз")||mod_ed(-1,"mu")||suw_odedim(-1)) && s(-1,-1) )
...
### osw_edmu_ro !_#_!
for(wrd in oswTedmu_ro){wln=split(oswTedmu_ro[wrd],omlin," ");subomo=osw_edmu_ro[wrd];for(y=1;y<=wln;y++){b=strtonum(omlin[y]); # header1
nf=splitline(book[b]);hyphback(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=wrd)continue;               # header2
 #
