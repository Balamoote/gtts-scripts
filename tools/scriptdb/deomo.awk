...
{b=strtonum(omlin[y]);nf=splitline(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( esca() )
 { R[1]++; if(dbg){print "R1", "-- is a phrase!"}; continue };

 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer

###   x0301 !_#_! ==> CAPS marked stress
xgrp="x0301";for(wrd in omap[xgrp]){iwrd=tolower(wrd);wln=split(omap[xgrp][wrd],omlin," ");for(y=1;y<=wln;y++)         # header1
{b=strtonum(omlin[y]);nf=splitline(book[b]);regwpos(wrd);for(i in wpos){i=strtonum(i);if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( ecap() )
 { R[2]++; if(dbg){print "R2", "-- caps-marked!"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 { l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[4]++; if(dbg){print "R4", "klitika"}; continue };

 l[i]=omo2; R[5]++; if(dbg){print "R5", "def"}; continue
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_pomn_f() )
 { l[i]=omo1; R[6]++; if(dbg){print "R6", "gl_pomn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="избегаем") {
   if ( q(1,"suw_ro") && s(0) )
   { l[i]=omo1; R[7]++; if(dbg){print "R7"}; continue };
 };

 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[8]++; if(dbg){print "R8", "pq_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[10]++; if(dbg){print "R10", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[11]++; if(dbg){print "R11", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[14]++; if(dbg){print "R14", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[15]++; if(dbg){print "R15", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[16]++; if(dbg){print "R16", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[17]++; if(dbg){print "R17", "sw_em_d_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[18]++; if(dbg){print "R18", "sw_em_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[19]++; if(dbg){print "R19", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[21]++; if(dbg){print "R21", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[22]++; if(dbg){print "R22", "sw_es_v_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[23]++; if(dbg){print "R23", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_t_f() )
 { l[i]=omo1; R[24]++; if(dbg){print "R24", "sw_es_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[25]++; if(dbg){print "R25", "sw_ez_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[26]++; if(dbg){print "R26", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[27]++; if(dbg){print "R27", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[28]++; if(dbg){print "R28", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[29]++; if(dbg){print "R29", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[30]++; if(dbg){print "R30", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[31]++; if(dbg){print "R31", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[32]++; if(dbg){print "R32", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[33]++; if(dbg){print "R33", "sw_mn_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[34]++; if(dbg){print "R34", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 l[i]=omo2; R[42]++; if(dbg){print "R42"}; continue;
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 { l[i]=omo1; l[i+1]=gensub(/^(.+)$/,"\xcc\xa0\\1\xcc\xa0",1,l[i+1]); R[43]++; if(dbg){print "R43"}; continue };
 if ( sL(0,"-") && ismark(1,"YHYF") )
 { l[i]=omo1; R[44]++; if(dbg){print "R44"}; continue };
 #
 cst="весть знает";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo1; R[45]++; if(dbg){print "R45", "sw_ez_t_f"}; continue };
 if ( q(-1,"gl_po") && s(-1) )
 { l[i]=omo1; R[46]++; if(dbg){print "R46", "sw_ez_t_f"}; continue };
 #
 if ( pl_em_i_f()||pl_em_v_f()||pl_ez_d_f()||pl_ez_p_f()||pl_ez_r_f()||pl_ez_t_f() )
 { l[i]=omo1; R[47]++; if(dbg){print "R47", "pl_eX_X_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[48]++; if(dbg){print "R48", "sw_ez_t_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[55]++; if(dbg){print "R55", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo1; R[56]++; if(dbg){print "R56", "sw_ez_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[57]++; if(dbg){print "R57", "pq_kr_em_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 if ( pre_ro(1) &&
           q(2,"suw_ro") && s(0,1) )
 { l[i]=omo2; R[76]++; if(dbg){print "R76"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if ( qxs(-1,"на","все") )
 { l[i]=omo2; R[80]++; if(dbg){print "R80", "sw_ez_r_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( bw(-1,"меткий") && s(-1) )
 { l[i]=omo2; R[86]++; if(dbg){print "R86"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[87]++; if(dbg){print "R87", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( name_im_sy(1) && s(0) )
 { l[i]=omo1; R[88]++; if(dbg){print "R88"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[89]++; if(dbg){print "R89", "sw_em_i_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[90]++; if(dbg){print "R90", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[91]++; if(dbg){print "R91", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[92]++; if(dbg){print "R92", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[93]++; if(dbg){print "R93", "sw_em_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[94]++; if(dbg){print "R94", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[95]++; if(dbg){print "R95", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[96]++; if(dbg){print "R96", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[97]++; if(dbg){print "R97", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[98]++; if(dbg){print "R98", "sw_ez_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 l[i]=omo2; R[103]++; if(dbg){print "R103", "table_"}; continue;
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( w(-1,"полным") && sc(-1,"-") )
 { l[i]=omo2; R[104]++; if(dbg){print "R104", "sw_em_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[119]++; if(dbg){print "R119"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 cst="белая каменный качественный косный низносортный овсяный пшеничный ржаной серая солёный сырой";
 if ( bw(-1,cst) && s(-1) )
 { l[i]=omo1; R[120]++; if(dbg){print "R120"}; continue };
 ...
 if ( bw(-1,cst) && s(-1) )
 { l[i]=omo2; R[121]++; if(dbg){print "R121"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo1; R[122]++; if(dbg){print "R122", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[123]++; if(dbg){print "R123", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[124]++; if(dbg){print "R124", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[125]++; if(dbg){print "R125", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo2; R[146]++; if(dbg){print "R146"}; continue };

 if ( sw_ez_r_f() )
 { l[i]=omo1; R[147]++; if(dbg){print "R147", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if ( bw(1,"душа") && s(0) )
 { l[i]=omo1; R[155]++; if(dbg){print "R155"}; continue };
...
#{ l[i]=omo1; R[173]++; if(dbg){print "R173"}; continue };
 ...
 if ( sw_em_v_f() )
 { l[i]=omo1; R[174]++; if(dbg){print "R174", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 if ( sL(0,"-") && w(1,"то") )
 { l[i]=omo2; l[i+1]=gensub(/^(.+)$/,"\xcc\xa0\\1\xcc\xa0",1,l[i+1]); R[200]++; if(dbg){print "R200"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[222]++; if(dbg){print "R222", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[229]++; if(dbg){print "R229", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[233]++; if(dbg){print "R233", "sw_es_r_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[236]++; if(dbg){print "R236", "sw_ez_i_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[239]++; if(dbg){print "R239", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[240]++; if(dbg){print "R240", "sw_em_v_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[243]++; if(dbg){print "R243", "sw_em_r_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[246]++; if(dbg){print "R246", "sw_ez_i_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[249]++; if(dbg){print "R249", "sw_mn_r_f"}; continue };
 #
 if ( p(-1) && q(1,"mest_vi prl_vi prq_vi") &&
      q(2,"suw_vi") && s(0,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[252]++; if(dbg){print "R252", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( pre_vi(-1) &&
    ...
    suw_edvi(2) && s(-1,1) )
 { l[i]=omo2; R[254]++; if(dbg){print "R254"}; continue };
 if ( pre_vi(-1) &&
    suw_edvi(1) && s(-1,0) )
 { l[i]=omo2; R[255]++; if(dbg){print "R255"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[258]++; if(dbg){print "R258", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[262]++; if(dbg){print "R262", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[263]++; if(dbg){print "R263", "sw_em_v_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[264]++; if(dbg){print "R264", "sw_ez_v_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( gl_in(1) && s(0) )
 { l[i]=omo1; R[267]++; if(dbg){print "R267"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="толку") {
   ...
   { l[i]=omo2; R[271]++; if(dbg){print "R271"}; continue };
 };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[272]++; if(dbg){print "R272", "sw_em_d_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[273]++; if(dbg){print "R273", "sw_em_r_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[275]++; if(dbg){print "R275", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[276]++; if(dbg){print "R276", "sw_em_v_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[278]++; if(dbg){print "R278", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[281]++; if(dbg){print "R281", "sw_em_t_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[284]++; if(dbg){print "R284", "sw_es_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[286]++; if(dbg){print "R286", "sw_ez_t_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[287]++; if(dbg){print "R287", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="веду") {
   if ( w(-1,"себя") && s(-1) )
   { l[i]=omo1; R[288]++; if(dbg){print "R288"}; continue };
   if ( w(1,"себя") && s(0) )
   { l[i]=omo1; R[289]++; if(dbg){print "R289"}; continue };
   if ( qxs(1,"я","вот","к")||
        qxs(1,"я","к") )
   { l[i]=omo1; R[290]++; if(dbg){print "R290"}; continue };
 };
 if(iwrd=="уйму") {
   if ( q(1,"suw_ro") && s(0) )
   { l[i]=omo2; R[291]++; if(dbg){print "R291"}; continue };
 };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[292]++; if(dbg){print "R292", "sw_ez_v_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[293]++; if(dbg){print "R293", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[294]++; if(dbg){print "R294", "sw_mn_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
#if ( gl_ed3e_f() )
#{ l[i]=omo1; R[296]++; if(dbg){print "R296"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo2; R[297]++; if(dbg){print "R297", "pl_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[300]++; if(dbg){print "R300", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_ed3e_f() )
 { l[i]=omo1; R[301]++; if(dbg){print "R301", "gl_ed3e_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[302]++; if(dbg){print "R302", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="вести") {
   if ( w(-1,"себя") && s(-1) )
   { l[i]=omo1; R[303]++; if(dbg){print "R303"}; continue };
   if ( w(1,"себя") && s(0) )
   { l[i]=omo1; R[304]++; if(dbg){print "R304"}; continue };
   if ( w(1,"о об") && s(0) )
   { l[i]=omo2; R[305]++; if(dbg){print "R305"}; continue };
 };
 #
 if ( gl_inf_f() )
 { l[i]=omo1; R[306]++; if(dbg){print "R306", "gl_inf_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[307]++; if(dbg){print "R307", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[308]++; if(dbg){print "R308", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[309]++; if(dbg){print "R309", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[310]++; if(dbg){print "R310", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[311]++; if(dbg){print "R311", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_inf_f() )
 { l[i]=omo1; R[313]++; if(dbg){print "R313", "sw_ez_i_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[314]++; if(dbg){print "R314", "sw_ez_i_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[315]++; if(dbg){print "R315", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[318]++; if(dbg){print "R318", "pl_em_p_f()||pl_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo2; R[320]++; if(dbg){print "R320", "pl_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pq_kr_em_f() )
 { l[i]=omo2; R[323]++; if(dbg){print "R323", "pq_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[325]++; if(dbg){print "R325", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[326]++; if(dbg){print "R326", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[328]++; if(dbg){print "R328", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn1e_f() )
 { l[i]=omo1; R[329]++; if(dbg){print "R329", "gl_mn1e_f"}; continue };
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[330]++; if(dbg){print "R330", "sw_es_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[332]++; if(dbg){print "R332", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pomn_f() )
 { l[i]=omo2; R[334]++; if(dbg){print "R334", "gl_pomn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pomn_f() )
 { l[i]=omo2; R[336]++; if(dbg){print "R336", "gl_pomn_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[337]++; if(dbg){print "R337", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[339]++; if(dbg){print "R339", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[340]++; if(dbg){print "R340", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[341]++; if(dbg){print "R341", "sw_ez_p_f"}; continue };
 #
 if ( gl_mn2e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pq_kr_em_f() )
 { l[i]=omo2; R[343]++; if(dbg){print "R343", "pq_kr_em_f"}; continue };
 #
 if ( gl_mn3e_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[347]++; if(dbg){print "R347", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[348]++; if(dbg){print "R348", "sw_mn_r_f"}; continue };
 #
 if ( gl_mn3e_f() )
 { l[i]=omo1; R[349]++; if(dbg){print "R349", "gl_mn1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( pl_kr_em_f() )
 { l[i]=omo2; R[352]++; if(dbg){print "R352", "pl_kr_em_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[353]++; if(dbg){print "R353"}; continue };
 #
 if ( pl_kr_em_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[359]++; if(dbg){print "R359", "sw_mn_r_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[360]++; if(dbg){print "R360", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[361]++; if(dbg){print "R361", "sw_em_v_f"}; continue };
...
#{ print l[i+1] >> "_sw.txt"; R[365]++; if(dbg){print "R365"}; }; continue
 #
 cst0="берег варю вести весь водила гвозди государя дел дела дело день для дождя души душу еду запас коли коля минут мой мою начала начало осени переднюю покой почту \
       при разлив рубило рыло свей сей тай тони умело царя шлем";
 ...
 {  l[i]=omo2; R[370]++; if(dbg){print "R370"}; continue };
 #
 cst="замер запах обмер перемер погреб";
 if( weq(iwrd,cst) ) {
   if ( q(1,"suw_ro") && s(0) )
 ...
 if( weq(iwrd,cst) ) {
    cst="близко недалеко рядом";
   if ( w(1,cst) && s(0) )
   { l[i]=omo2; R[372]++; if(dbg){print "R372"}; continue };
   if ( wfa(1,4,"_coast_suw-ro") && s(0,wfn-1) &&
        qir(1,wfn-1,"prl_ro mest_ro prq_ro") )
   { l[i]=omo2; R[373]++; if(dbg){print "R373"}; continue };
 };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[374]++; if(dbg){print "R374", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[375]++; if(dbg){print "R375", "sw_em_v_f"}; continue };
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[376]++; if(dbg){print "R376", "gl_paedmu_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[377]++; if(dbg){print "R377", "sw_mn_r_f"}; continue };
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[378]++; if(dbg){print "R378", "gl_paedmu_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[379]++; if(dbg){print "R379", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[380]++; if(dbg){print "R380", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[381]++; if(dbg){print "R381", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="начало") {
   if ( gl_in(1) && s(0) )
   { l[i]=omo1; R[382]++; if(dbg){print "R382"}; continue };
   if ( q(1,"prl_kred_sr prq_kred_sr") && s(0) && Q_w(2,"gl_in") )
   { l[i]=omo2; R[383]++; if(dbg){print "R383"}; continue };
   if ( q(1,"suw_ro") && s(0) )
   { l[i]=omo2; R[384]++; if(dbg){print "R384"}; continue };
 };
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[385]++; if(dbg){print "R385", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[386]++; if(dbg){print "R386", "sw_es_v_f"}; continue };
 #
 if ( gl_paedsr_f() )
 { l[i]=omo1; R[387]++; if(dbg){print "R387", "gl_paedsr_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[390]++; if(dbg){print "R390", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[397]++; if(dbg){print "R397", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[398]++; if(dbg){print "R398", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[399]++; if(dbg){print "R399", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[400]++; if(dbg){print "R400", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[401]++; if(dbg){print "R401", "sw_em_i_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[402]++; if(dbg){print "R402", "gl_paedze_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[403]++; if(dbg){print "R403", "sw_em_r_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[404]++; if(dbg){print "R404", "gl_paedze_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="попали") {
   ...
   { l[i]=omo1; R[405]++; if(dbg){print "R405"}; continue };
   if ( q(1,"pre_vi") && s(0) )
   { l[i]=omo1; R[406]++; if(dbg){print "R406", "gl_pamn_f"}; continue };
 };
 if(iwrd=="дели") {
   if ( wb(-5,-1,"куда никуда они вы мы") && s(wbn,-1) )
   { l[i]=omo1; R[407]++; if(dbg){print "R407"}; continue };
 };
 if(iwrd=="пили") {
   cst="вино виски водки воду какао кофе минералку пиво самогон сок чай";
   if ( w(1,cst) && s(0) )
   { l[i]=omo1; R[408]++; if(dbg){print "R408"}; continue };
 };
 #
 if ( w(1,"под") && s(0) )
 { l[i]=omo1; R[409]++; if(dbg){print "R409", "gl_pamn_f"}; continue };
 if ( q(-1,"mest_da suw_da") && s(-1) )
 { l[i]=omo1; R[410]++; if(dbg){print "R410", "gl_pamn_f"}; continue };

 if ( wb(-5,-1,"пока если когда") && s(wbn,-1) )
 { l[i]=omo1; R[411]++; if(dbg){print "R411"}; continue };
 #
 if ( gl_pamn_f() )
 { l[i]=omo1; R[412]++; if(dbg){print "R412", "gl_pamn_f"}; continue };
 #
 if ( gl_poed_f() )
 { l[i]=omo2; R[413]++; if(dbg){print "R413", "gl_poed_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[416]++; if(dbg){print "R416", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[417]++; if(dbg){print "R417", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[418]++; if(dbg){print "R418", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[419]++; if(dbg){print "R419", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[420]++; if(dbg){print "R420", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_pamn_f() )
 { l[i]=omo1; R[421]++; if(dbg){print "R421", "gl_pamn_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[422]++; if(dbg){print "R422", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[423]++; if(dbg){print "R423", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[424]++; if(dbg){print "R424", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if ( q(-1,"pre_any") && s(-1) )
 { l[i]=omo2; R[427]++; if(dbg){print "R427"}; continue };
 #
 if ( gl_poed_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( p(-1) && sc(0,"!") && w(0,cst) )
 { l[i]=omo1; R[446]++; if(dbg){print "R446"}; continue };
 if ( q(-1,"pre_any") && s(-1) )
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[449]++; if(dbg){print "R449", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[450]++; if(dbg){print "R450", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[451]++; if(dbg){print "R451", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[461]++; if(dbg){print "R461", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[462]++; if(dbg){print "R462", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[466]++; if(dbg){print "R466", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[467]++; if(dbg){print "R467", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[468]++; if(dbg){print "R468", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pamn_f() )
 { l[i]=omo2; R[472]++; if(dbg){print "R472", "gl_pamn_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[473]++; if(dbg){print "R473", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[474]++; if(dbg){print "R474", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[477]++; if(dbg){print "R477", "sw_em_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[480]++; if(dbg){print "R480", "sw_es_d_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[481]++; if(dbg){print "R481", "sw_es_p_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[482]++; if(dbg){print "R482", "sw_es_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[487]++; if(dbg){print "R487", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[488]++; if(dbg){print "R488", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[493]++; if(dbg){print "R493", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[496]++; if(dbg){print "R496", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[499]++; if(dbg){print "R499", "sw_mn_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[501]++; if(dbg){print "R501", "gl_poed_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[502]++; if(dbg){print "R502", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[503]++; if(dbg){print "R503", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_pomn_f() )
 { l[i]=omo1; R[508]++; if(dbg){print "R508", "gl_pomn_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[509]++; if(dbg){print "R509", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn1e_f() )
 { l[i]=omo1; R[510]++; if(dbg){print "R510", "gl_mn1e_f"}; continue };
 #
 if ( pq_kr_em_f() )
 { l[i]=omo1; R[511]++; if(dbg){print "R511", "pq_kr_em_f"}; continue };
 #
 if ( sw_em_t_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn1e_f() )
 { l[i]=omo1; R[513]++; if(dbg){print "R513", "gl_mn1e_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[514]++; if(dbg){print "R514", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[515]++; if(dbg){print "R515", "gl_poed_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[516]++; if(dbg){print "R516", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(-2,"suw_im") &&
     bw(-1,"идти") && s(-2,-1) )
 { l[i]=omo2; R[517]++; if(dbg){print "R517", "sw_em_t_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[518]++; if(dbg){print "R518", "sw_em_t_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(-1,"gl_in") && s(-1) )
 { l[i]=omo1; R[523]++; if(dbg){print "R523"}; continue };
 cst="а и но ну однако по уж";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo1; R[524]++; if(dbg){print "R524"}; continue };
 if ( q(1,"qik_ro") &&
      q(2,"qik_ro suw_mnro") && s(0,1) )
 { l[i]=omo1; R[525]++; if(dbg){print "R525"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[526]++; if(dbg){print "R526", "sw_em_p_f"}; continue };
 #
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( sc(-1,"-") )
 { l[i]=omo2; R[528]++; if(dbg){print "R528"}; continue };
 if ( sc(0,"-") )
 { l[i]=omo2; R[529]++; if(dbg){print "R529"}; continue };
 #
 if ( gl_poed_f() )
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[532]++; if(dbg){print "R532", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[533]++; if(dbg){print "R533", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[534]++; if(dbg){print "R534", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[535]++; if(dbg){print "R535", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[536]++; if(dbg){print "R536", "gl_poed_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[537]++; if(dbg){print "R537", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[538]++; if(dbg){print "R538", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[541]++; if(dbg){print "R541", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[542]++; if(dbg){print "R542", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[543]++; if(dbg){print "R543", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[544]++; if(dbg){print "R544", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[545]++; if(dbg){print "R545", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[548]++; if(dbg){print "R548", "gl_poed_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[549]++; if(dbg){print "R549", "sw_em_d_f"}; continue };
 #
 if ( pl_ez_d_f() )
 { l[i]=omo2; R[550]++; if(dbg){print "R550", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo2; R[551]++; if(dbg){print "R551", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo2; R[552]++; if(dbg){print "R552", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo2; R[553]++; if(dbg){print "R553", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[555]++; if(dbg){print "R555", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[556]++; if(dbg){print "R556", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[557]++; if(dbg){print "R557", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo2; R[559]++; if(dbg){print "R559", "sw_em_z_f"}; continue };
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[560]++; if(dbg){print "R560", "gl_poed_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[561]++; if(dbg){print "R561", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[562]++; if(dbg){print "R562", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[563]++; if(dbg){print "R563", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[564]++; if(dbg){print "R564", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[565]++; if(dbg){print "R565", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[566]++; if(dbg){print "R566"}; continue };
 if ( w(-3,"на") &&
      q(-2,"qin_im qik_im") &&
      q(-1,"suw_ro") &&
      q(1,"suw_ro") && s(-3,0) )
 { l[i]=omo2; R[567]++; if(dbg){print "R567"}; continue };
 #
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[585]++; if(dbg){print "R585", "sw_em_p_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[586]++; if(dbg){print "R586", "pl_srav_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[588]++; if(dbg){print "R588", "sw_es_t_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[589]++; if(dbg){print "R589", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[590]++; if(dbg){print "R590", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo2; R[591]++; if(dbg){print "R591", "pl_kr_ez_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[592]++; if(dbg){print "R592", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[593]++; if(dbg){print "R593", "sw_em_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[594]++; if(dbg){print "R594", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[595]++; if(dbg){print "R595", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[596]++; if(dbg){print "R596", "pl_em_p_f()||pl_es_p_f"}; continue };
 #
 if ( sw_es_t_f() )
 { l[i]=omo2; R[597]++; if(dbg){print "R597", "sw_es_t_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[598]++; if(dbg){print "R598", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { R[599]++; if(dbg){print "R599", "stopper"}; continue };
 if ( w(-1,"на") && s(-1) && p(-2) && bfa(1,3,"_gl_dvizh") && s(0,bfn-1) )
 { R[600]++; if(dbg){print "R600", "stopper"}; continue };
 ...
 { l[i]=omo1; R[603]++; if(dbg){print "R603"}; continue };
 if ( z(0) &&
      q(1,"otsz_edsrvi") )
 ...
 if ( z(0) && s(1) && s(1) &&
      ...
      q(2,"otsz_edzero") )
 { l[i]=omo1; R[605]++; if(dbg){print "R605"}; continue };
 if ( z(0) && s(1) && s(1) &&
      q(1,"pre_vi") &&
      q(2,"otsz_edzevi") )
 { l[i]=omo1; R[606]++; if(dbg){print "R606"}; continue };
 if ( z(0) && s(1) &&
      q(1,"pre_vi pre_ro") &&
      q(2,"otsz_edsrvi") )
 { l[i]=omo2; R[607]++; if(dbg){print "R607"}; continue };

 if ( sw_es_i_f() )
 { l[i]=omo2; R[608]++; if(dbg){print "R608", "sw_es_i_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[609]++; if(dbg){print "R609", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[610]++; if(dbg){print "R610", "sw_ez_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[611]++; if(dbg){print "R611", "sw_es_p_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[612]++; if(dbg){print "R612", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[613]++; if(dbg){print "R613", "gl_poed_f"}; continue };
 #
 if ( sw_ez_l_f() )
 { l[i]=omo1; R[614]++; if(dbg){print "R614", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[615]++; if(dbg){print "R615", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[616]++; if(dbg){print "R616", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[617]++; if(dbg){print "R617", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[618]++; if(dbg){print "R618", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[619]++; if(dbg){print "R619", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[623]++; if(dbg){print "R623", "gl_poed_f"}; continue };
 #
 if ( sw_ez_l_f() )
 { l[i]=omo1; R[624]++; if(dbg){print "R624", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[625]++; if(dbg){print "R625", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[626]++; if(dbg){print "R626", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[627]++; if(dbg){print "R627", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[628]++; if(dbg){print "R628", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 if(iwrd=="души") {
   ...
   { l[i]=omo1; R[631]++; if(dbg){print "R631"}; continue };
   if ( w(1,"в") && q(2,"mest_pr suw_pr name_pr_sy") && w(3,"не") && bw(4,"чаять") && s(0,3) )
   { l[i]=omo1; R[632]++; if(dbg){print "R632"}; continue };
 };
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[633]++; if(dbg){print "R633", "gl_poed_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[634]++; if(dbg){print "R634", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[635]++; if(dbg){print "R635", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[636]++; if(dbg){print "R636", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[644]++; if(dbg){print "R644", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[645]++; if(dbg){print "R645", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[646]++; if(dbg){print "R646", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[647]++; if(dbg){print "R647", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[648]++; if(dbg){print "R648", "sw_es_r_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[649]++; if(dbg){print "R649", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[650]++; if(dbg){print "R650"}; continue };
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[657]++; if(dbg){print "R657", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[658]++; if(dbg){print "R658", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[660]++; if(dbg){print "R660", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[661]++; if(dbg){print "R661", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[662]++; if(dbg){print "R662", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[663]++; if(dbg){print "R663", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[664]++; if(dbg){print "R664", "sw_mn_v_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[665]++; if(dbg){print "R665", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[666]++; if(dbg){print "R666", "pl_krmn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[667]++; if(dbg){print "R667", "gl_poed_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[668]++; if(dbg){print "R668", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[669]++; if(dbg){print "R669", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[671]++; if(dbg){print "R671", "pl_kr_em_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[672]++; if(dbg){print "R672", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[673]++; if(dbg){print "R673", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[674]++; if(dbg){print "R674", "sw_em_i_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[675]++; if(dbg){print "R675", "sw_ez_t_f"}; continue };
 #
 if ( pl_ez_d_f() )
 { l[i]=omo1; R[676]++; if(dbg){print "R676", "pl_ez_d_f"}; continue };
 #
 if ( pl_ez_p_f() )
 { l[i]=omo1; R[677]++; if(dbg){print "R677", "pl_ez_p_f"}; continue };
 #
 if ( pl_ez_r_f() )
 { l[i]=omo1; R[678]++; if(dbg){print "R678", "pl_ez_r_f"}; continue };
 #
 if ( pl_ez_t_f() )
 { l[i]=omo1; R[679]++; if(dbg){print "R679", "pl_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo2; R[873]++; if(dbg){print "R873", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[911]++; if(dbg){print "R911", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[912]++; if(dbg){print "R912", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[913]++; if(dbg){print "R913", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[914]++; if(dbg){print "R914", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[915]++; if(dbg){print "R915", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[916]++; if(dbg){print "R916", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[917]++; if(dbg){print "R917", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[918]++; if(dbg){print "R918", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[919]++; if(dbg){print "R919", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[920]++; if(dbg){print "R920", "sw_es_z_f()||sw_es_i_f()||sw_es_v_f()||sw_es_r_f()||sw_es_d_f()||sw_es_t_f()||sw_es_p_f()||sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[921]++; if(dbg){print "R921", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[922]++; if(dbg){print "R922", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[923]++; if(dbg){print "R923", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[924]++; if(dbg){print "R924", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[925]++; if(dbg){print "R925", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[926]++; if(dbg){print "R926", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[927]++; if(dbg){print "R927", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[928]++; if(dbg){print "R928", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[929]++; if(dbg){print "R929", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[938]++; if(dbg){print "R938", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[939]++; if(dbg){print "R939", "sw_ez_l_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[941]++; if(dbg){print "R941", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[942]++; if(dbg){print "R942", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[943]++; if(dbg){print "R943", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[944]++; if(dbg){print "R944", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[945]++; if(dbg){print "R945", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[946]++; if(dbg){print "R946", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[947]++; if(dbg){print "R947", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[948]++; if(dbg){print "R948", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_l_f() )
 { l[i]=omo2; R[950]++; if(dbg){print "R950", "sw_ez_l_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[951]++; if(dbg){print "R951", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[952]++; if(dbg){print "R952", "sw_ez_r_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo1; R[953]++; if(dbg){print "R953", "sw_ez_p_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[954]++; if(dbg){print "R954", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[955]++; if(dbg){print "R955", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[956]++; if(dbg){print "R956", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[957]++; if(dbg){print "R957", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo1; R[958]++; if(dbg){print "R958", "sw_mn_r_f"}; continue };
 #
 if ( pl_kr_em_f() )
 { l[i]=omo1; R[959]++; if(dbg){print "R959", "pl_kr_em_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_d_f() )
 { l[i]=omo2; R[960]++; if(dbg){print "R960", "sw_mn_d_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[961]++; if(dbg){print "R961", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[962]++; if(dbg){print "R962", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[963]++; if(dbg){print "R963", "sw_ez_v_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[964]++; if(dbg){print "R964", "sw_em_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[965]++; if(dbg){print "R965", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( ismark(-1,"Ykl") && notsym(-1,unxy) && s(-1) )
 { l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[966]++; if(dbg){print "R966"}; continue };
 #
 if ( sw_em_l_f() )
 ...
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[969]++; if(dbg){print "R969", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[971]++; if(dbg){print "R971", "sw_em_z_f"}; continue };
 #
 if ( sw_em_l_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( ismark(-1,"Ykl") && notsym(-1,unxy) && s(-1) )
 { l[i-1]=gensub(/([АЕЁИОУЫЭЮЯаеёиоуыэюя])/,"\\1\xcc\x81",1,l[i-1]); l[i]=gensub(/^(.)/,"\xcc\xa0\\1\xcc\xad",1,l[i]); R[976]++; if(dbg){print "R976"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[977]++; if(dbg){print "R977", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[979]++; if(dbg){print "R979", "sw_em_p_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[981]++; if(dbg){print "R981", "sw_em_v_f"}; continue };
 #
 if ( sw_em_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[984]++; if(dbg){print "R984", "sw_ez_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[986]++; if(dbg){print "R986", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[987]++; if(dbg){print "R987", "sw_em_i_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[988]++; if(dbg){print "R988", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[989]++; if(dbg){print "R989", "sw_em_d_f"}; continue };
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[990]++; if(dbg){print "R990", "sw_em_z_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[991]++; if(dbg){print "R991", "sw_em_z_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[992]++; if(dbg){print "R992", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[993]++; if(dbg){print "R993", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[995]++; if(dbg){print "R995", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[996]++; if(dbg){print "R996", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[997]++; if(dbg){print "R997", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[998]++; if(dbg){print "R998", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1001]++; if(dbg){print "R1001", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1004]++; if(dbg){print "R1004", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1005]++; if(dbg){print "R1005", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1006]++; if(dbg){print "R1006", "sw_em_t_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1007]++; if(dbg){print "R1007", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1008]++; if(dbg){print "R1008", "sw_em_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_p_f() )
 { l[i]=omo2; R[1011]++; if(dbg){print "R1011", "sw_mn_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1013]++; if(dbg){print "R1013", "sw_mn_r_f"}; continue };
 #
 if ( sw_em_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1018]++; if(dbg){print "R1018", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1019]++; if(dbg){print "R1019", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1020]++; if(dbg){print "R1020", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1021]++; if(dbg){print "R1021", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1022]++; if(dbg){print "R1022", "sw_em_d_f"}; continue };
 #
 if ( sw_es_d_f() )
 { l[i]=omo2; R[1023]++; if(dbg){print "R1023", "sw_es_d_f"}; continue };
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1024]++; if(dbg){print "R1024", "sw_em_l_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1025]++; if(dbg){print "R1025", "sw_em_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1034]++; if(dbg){print "R1034", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1035]++; if(dbg){print "R1035", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1036]++; if(dbg){print "R1036", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1037]++; if(dbg){print "R1037", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1039]++; if(dbg){print "R1039", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1040]++; if(dbg){print "R1040", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1041]++; if(dbg){print "R1041", "sw_es_v_f"}; continue };
 #
 if ( sw_em_p_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
#if ( sw_es_p_f() )
#{ l[i]=omo2; R[1045]++; if(dbg){print "R1045"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1048]++; if(dbg){print "R1048", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1049]++; if(dbg){print "R1049", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_q_f() )
 { l[i]=omo1; R[1050]++; if(dbg){print "R1050", "sw_em_q_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1051]++; if(dbg){print "R1051", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1052]++; if(dbg){print "R1052", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1053]++; if(dbg){print "R1053", "sw_es_v_f"}; continue };
 #
 if ( sw_em_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1055]++; if(dbg){print "R1055", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1056]++; if(dbg){print "R1056", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1057]++; if(dbg){print "R1057", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1058]++; if(dbg){print "R1058", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[1067]++; if(dbg){print "R1067"}; continue };
 if ( q(-1,"pre_im pre_vi") && Q(-1,"pre_ro") && s(-1) )
 { l[i]=omo2; R[1068]++; if(dbg){print "R1068"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1069]++; if(dbg){print "R1069", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1070]++; if(dbg){print "R1070", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1071]++; if(dbg){print "R1071", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1072]++; if(dbg){print "R1072", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1073]++; if(dbg){print "R1073", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1076]++; if(dbg){print "R1076", "sw_em_r_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1077]++; if(dbg){print "R1077", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1078]++; if(dbg){print "R1078", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1079]++; if(dbg){print "R1079", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1080]++; if(dbg){print "R1080", "sw_em_p_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1081]++; if(dbg){print "R1081", "sw_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1082]++; if(dbg){print "R1082", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1084]++; if(dbg){print "R1084", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( nar_spos_f() )
 { l[i]=omo1; R[1087]++; if(dbg){print "R1087", "nar_spos_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo1; R[1088]++; if(dbg){print "R1088", "sw_em_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1089]++; if(dbg){print "R1089", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1093]++; if(dbg){print "R1093", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1094]++; if(dbg){print "R1094", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1095]++; if(dbg){print "R1095", "sw_em_r_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1101]++; if(dbg){print "R1101", "sw_em_r_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1102]++; if(dbg){print "R1102", "sw_em_v_f"}; continue };
 #
 if ( sw_mn_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_v_f() )
 { l[i]=omo1; R[1104]++; if(dbg){print "R1104", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1105]++; if(dbg){print "R1105", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1106]++; if(dbg){print "R1106", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1107]++; if(dbg){print "R1107", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1119]++; if(dbg){print "R1119", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1120]++; if(dbg){print "R1120", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[1121]++; if(dbg){print "R1121", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1122]++; if(dbg){print "R1122", "sw_ez_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_d_f() )
 { l[i]=omo1; R[1123]++; if(dbg){print "R1123", "sw_es_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1124]++; if(dbg){print "R1124", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1126]++; if(dbg){print "R1126", "sw_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_i_f() )
 { l[i]=omo1; R[1128]++; if(dbg){print "R1128", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo1; R[1129]++; if(dbg){print "R1129", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo2; R[1130]++; if(dbg){print "R1130", "sw_es_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1133]++; if(dbg){print "R1133", "sw_ez_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1134]++; if(dbg){print "R1134", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_p_f() )
 { l[i]=omo1; R[1135]++; if(dbg){print "R1135", "sw_es_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1138]++; if(dbg){print "R1138", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1139]++; if(dbg){print "R1139", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1140]++; if(dbg){print "R1140", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1142]++; if(dbg){print "R1142", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1143]++; if(dbg){print "R1143", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1144]++; if(dbg){print "R1144", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(-1,"pre_im pre_vi") && Q(-1,"pre_ro") && s(-1) )
 { l[i]=omo2; R[1152]++; if(dbg){print "R1152"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1153]++; if(dbg){print "R1153", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1154]++; if(dbg){print "R1154", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1155]++; if(dbg){print "R1155", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1156]++; if(dbg){print "R1156", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1161]++; if(dbg){print "R1161", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1166]++; if(dbg){print "R1166", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1167]++; if(dbg){print "R1167", "sw_ez_t_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1168]++; if(dbg){print "R1168", "sw_ez_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1169]++; if(dbg){print "R1169", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo1; R[1171]++; if(dbg){print "R1171", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[1174]++; if(dbg){print "R1174", "sw_mn_p_f"}; continue };
 #
 if ( sw_mn_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_p_f() )
 { l[i]=omo1; R[1176]++; if(dbg){print "R1176", "sw_mn_p_f"}; continue };
 #
 if ( sw_mn_v_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1192]++; if(dbg){print "R1192", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1198]++; if(dbg){print "R1198", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1208]++; if(dbg){print "R1208", "sw_em_d_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1216]++; if(dbg){print "R1216", "sw_es_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1217]++; if(dbg){print "R1217", "pl_kr_ez_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1218]++; if(dbg){print "R1218", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1219]++; if(dbg){print "R1219", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( qxs(-1,"того этого","же")||
      ww_(-1,"того этого") )
 { l[i]=omo1; R[1223]++; if(dbg){print "R1223"}; continue };
 #
 cst="меня себя тебя";
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1297]++; if(dbg){print "R1297", "sw_es_z_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[1298]++; if(dbg){print "R1298", "sw_ez_i_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1299]++; if(dbg){print "R1299", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1300]++; if(dbg){print "R1300", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1301]++; if(dbg){print "R1301", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_i_f() )
 { l[i]=omo1; R[1307]++; if(dbg){print "R1307", "sw_ez_i_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1308]++; if(dbg){print "R1308", "sw_em_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1310]++; if(dbg){print "R1310", "sw_ez_i_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1311]++; if(dbg){print "R1311", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1332]++; if(dbg){print "R1332", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1333]++; if(dbg){print "R1333", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1334]++; if(dbg){print "R1334", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_ez_v_f() )
 { l[i]=omo2; R[1337]++; if(dbg){print "R1337", "pl_ez_v_f"}; continue };
 #
 if ( suw_mnvi(1) && s(0) )
 { l[i]=omo1; R[1338]++; if(dbg){print "R1338"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1339]++; if(dbg){print "R1339", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo2; R[1352]++; if(dbg){print "R1352"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1367]++; if(dbg){print "R1367", "sw_ez_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1370]++; if(dbg){print "R1370", "gl_poed_f"}; continue };
 #
#if ( gl_in_f() )
#{ l[i]=omo1; R[1371]++; if(dbg){print "R1371"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1372]++; if(dbg){print "R1372", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1373]++; if(dbg){print "R1373", "sw_ez_p_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1374]++; if(dbg){print "R1374", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1375]++; if(dbg){print "R1375", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1376]++; if(dbg){print "R1376", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pre_ro(-1) && Q(-1,"pre_im pre_vi") && s(-1) )
 { l[i]=omo1; R[1377]++; if(dbg){print "R1377"}; continue };
 if ( q(-1,"pre_im pre_vi") && Q(-1,"pre_ro") && s(-1) )
 { l[i]=omo2; R[1378]++; if(dbg){print "R1378"}; continue };
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1379]++; if(dbg){print "R1379", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1380]++; if(dbg){print "R1380", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1381]++; if(dbg){print "R1381", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1382]++; if(dbg){print "R1382", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_z_f() )
 { l[i]=omo1; R[1383]++; if(dbg){print "R1383", "sw_es_z_f"}; continue };
 #
 if ( sw_es_r_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( bw(-1,"мочка") && s(-1) )
 { l[i]=omo1; R[1387]++; if(dbg){print "R1387", "sw_es_r_f"}; continue };
 #
 if ( sw_es_r_f() )
 { l[i]=omo1; R[1388]++; if(dbg){print "R1388", "sw_es_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1389]++; if(dbg){print "R1389", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_z_f() )
 { l[i]=omo1; R[1392]++; if(dbg){print "R1392", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1393]++; if(dbg){print "R1393", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1394]++; if(dbg){print "R1394", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1395]++; if(dbg){print "R1395", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_i_f() )
 { l[i]=omo1; R[1399]++; if(dbg){print "R1399", "sw_em_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1408]++; if(dbg){print "R1408", "gl_paedmu_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1409]++; if(dbg){print "R1409", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_z_f() )
 { l[i]=omo1; R[1410]++; if(dbg){print "R1410", "sw_em_z_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1411]++; if(dbg){print "R1411", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1412]++; if(dbg){print "R1412", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(-2,"pre_any preph_any") &&
      q(-1,"suw_any") && s(-2,-1) )
 { l[i]=omo2; R[1414]++; if(dbg){print "R1414"}; continue };
 #
 if ( gl_poed_f() )
 { l[i]=omo1; R[1415]++; if(dbg){print "R1415", "gl_poed_f"}; continue };
 #
 if ( sw_ez_z_f() )
 { l[i]=omo2; R[1416]++; if(dbg){print "R1416", "sw_ez_z_f"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo2; R[1417]++; if(dbg){print "R1417", "sw_ez_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1418]++; if(dbg){print "R1418", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo2; R[1419]++; if(dbg){print "R1419", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( bw(-1,cst) && s(-1) )
 { l[i]=omo2; R[1420]++; if(dbg){print "R1420", "gl_paedsr_f"}; continue };
 cst="достаточнош немного слишком черезчур";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo2; R[1421]++; if(dbg){print "R1421", "gl_paedsr_f"}; continue };
 if ( q(-2,"prl_kred_sr") &&
sz_iili(-1) && s(-2,-1) )
 { l[i]=omo2; R[1422]++; if(dbg){print "R1422", "gl_paedsr_f"}; continue };
 ...
 if ( gl_paedsr_f() )
 { l[i]=omo1; R[1426]++; if(dbg){print "R1426", "gl_paedsr_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( w(-1,"на") && s(-1) )
 { l[i]=omo2; R[1427]++; if(dbg){print "R1427", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1428]++; if(dbg){print "R1428", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1429]++; if(dbg){print "R1429", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1430]++; if(dbg){print "R1430", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if(iwrd=="полке") {
   if ( w(-1,"на") && s(-1) )
   { l[i]=omo2; R[1432]++; if(dbg){print "R1432"}; continue };
 };
 if(iwrd=="жаре") {
   if ( w(-1,"на по") && s(-1) )
   { l[i]=omo2; R[1433]++; if(dbg){print "R1433"}; continue };
 };
 if(iwrd=="носке") {
   if ( w(-1,"в на") && s(-1) )
   { l[i]=omo1; R[1434]++; if(dbg){print "R1434"}; continue };
 };
 if(iwrd=="спине") {
   prex=0
   if ( sw_em_p_f() )
   { l[i]=omo2; R[1435]++; if(dbg){print "R1435", "sw_em_p_f"}; continue };
   prex=1
 };
 #
 if ( sw_em_p_f() )
 { l[i]=omo1; R[1436]++; if(dbg){print "R1436", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo2; R[1437]++; if(dbg){print "R1437", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1438]++; if(dbg){print "R1438", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1439]++; if(dbg){print "R1439", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1440]++; if(dbg){print "R1440", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_v_f() )
 { l[i]=omo2; R[1442]++; if(dbg){print "R1442", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1443]++; if(dbg){print "R1443", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1444]++; if(dbg){print "R1444", "sw_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( bw(-1,cst) && s(-1) )
 { l[i]=omo2; R[1445]++; if(dbg){print "R1445"}; continue };
 if ( bw(-2,cst) &&
       q(-1,"mest_3e") && s(-1) )
 { l[i]=omo2; R[1446]++; if(dbg){print "R1446"}; continue };
 ...
 if ( q(-2,"suw_tv") &&
sz_iili(-1) && s(-2,-1) )
 { l[i]=omo2; R[1448]++; if(dbg){print "R1448", "sw_em_t_f"}; continue };
 #
 if ( sw_em_p_f()||sw_es_p_f()||pl_em_p_f()||pl_es_p_f() )
 { l[i]=omo1; R[1449]++; if(dbg){print "R1449", "sw_em_p_f||sw_es_p_f||pl_em_p_f||pl_es_p_f"}; continue };
 #
 if ( sw_em_t_f() )
 { l[i]=omo2; R[1450]++; if(dbg){print "R1450", "sw_em_t_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1451]++; if(dbg){print "R1451", "pl_srav_f"}; continue };
 #
 cst="значительно куда лишь много намного немного несколько";
 if ( w(-1,cst) && s(-1) )
 { l[i]=omo1; R[1452]++; if(dbg){print "R1452"}; continue };
 if ( nar_vrem_f() )
 { l[i]=omo1; R[1453]++; if(dbg){print "R1453", "nar_vrem_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo2; R[1454]++; if(dbg){print "R1454", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo2; R[1455]++; if(dbg){print "R1455", "pl_es_v_f"}; continue };
 #
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo2; R[1456]++; if(dbg){print "R1456", "sw_em_l_f"}; continue };
 #
 if ( sw_em_d_f() )
 { l[i]=omo1; R[1457]++; if(dbg){print "R1457", "sw_em_d_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1458]++; if(dbg){print "R1458", "gl_ed1e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_ez_d_f() )
 { l[i]=omo1; R[1459]++; if(dbg){print "R1459", "sw_ez_d_f"}; continue };
 #
 if ( sw_em_p_f() )           ##_footer
 { l[i]=omo1; R[1460]++; if(dbg){print "R1460", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo2; R[1461]++; if(dbg){print "R1461", "sw_ez_p_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( pl_em_p_f() )
 { l[i]=omo2; R[1463]++; if(dbg){print "R1463", "sw_ez_d_f"}; continue };
 #
 if ( pl_es_p_f() )
 { l[i]=omo2; R[1464]++; if(dbg){print "R1464", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[1465]++; if(dbg){print "R1465", "sw_ez_d_f"}; continue };
 #
 if ( pl_srav_f() )
 { l[i]=omo2; R[1466]++; if(dbg){print "R1466", "sw_em_p_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_r_f() )
 { l[i]=omo2; R[1469]++; if(dbg){print "R1469", "sw_mn_r_f"}; continue };
 #
 if ( gl_paedmu_f() )
 { l[i]=omo1; R[1470]++; if(dbg){print "R1470", "gl_paedmu_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( sL(0,"-") && ismark(1,"YHYF") && w(1,"то") )
 { l[i]=omo1; l[i+1]=gensub(/^(.+)$/,"\xcc\xa0\\1\xcc\xa0",1,l[i+1]); R[1472]++; if(dbg){print "R1472"}; continue };
 if ( sL(0,"-") && ismark(1,"YHYF") )
 { l[i]=omo1; R[1473]++; if(dbg){print "R1473"}; continue };
 #
 if ( pl_ez_i_f() )
 { l[i]=omo1; R[1474]++; if(dbg){print "R1474", "pl_ez_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 ...
 cst="быть стать являться";
 if ( bw(-1,cst) && s(-1) )
 { l[i]=omo1; R[1475]++; if(dbg){print "R1475"}; continue };
 if ( q(-1,"nar_step") && s(-1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1477]++; if(dbg){print "R1477", "sw_em_r_f"}; continue };
 #
 if ( pl_kr_ez_f() )
 { l[i]=omo1; R[1478]++; if(dbg){print "R1478", "pl_kr_ez_f"}; continue };
 #
 if ( sw_ez_i_f() )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( w(-1,"из-под") && s(-1) )
 { l[i]=omo2; R[1480]++; if(dbg){print "R1480"}; continue };
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1481]++; if(dbg){print "R1481", "sw_ez_r_f"}; continue };
 #
 if ( pl_krmn_f() )
 { l[i]=omo1; R[1482]++; if(dbg){print "R1482", "pl_krmn_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo2; R[1483]++; if(dbg){print "R1483", "sw_mn_i_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1485]++; if(dbg){print "R1485", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1486]++; if(dbg){print "R1486", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1487]++; if(dbg){print "R1487", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1488]++; if(dbg){print "R1488", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1489]++; if(dbg){print "R1489", "sw_mn_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1490]++; if(dbg){print "R1490", "sw_mn_v_f"}; continue };
 #
 if ( gl_paedze_f() )
 { l[i]=omo1; R[1491]++; if(dbg){print "R1491", "gl_paedze_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1492]++; if(dbg){print "R1492", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1493]++; if(dbg){print "R1493", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1494]++; if(dbg){print "R1494", "sw_mn_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1495]++; if(dbg){print "R1495", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1496]++; if(dbg){print "R1496", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo3; R[1497]++; if(dbg){print "R1497", "sw_ez_i_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_d_f() )
 { l[i]=omo2; R[1498]++; if(dbg){print "R1498", "sw_em_d_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1499]++; if(dbg){print "R1499", "sw_ez_v_f"}; continue };
 #
 if ( gl_ed1e_f() )
 { l[i]=omo1; R[1500]++; if(dbg){print "R1500", "gl_ed1e_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_i_f() )
 { l[i]=omo2; R[1501]++; if(dbg){print "R1501", "sw_es_i_f"}; continue };
 #
 if ( sw_es_v_f() )
 { l[i]=omo2; R[1502]++; if(dbg){print "R1502", "sw_es_v_f"}; continue };
 #
 if ( sw_es_p_f() )
 { l[i]=omo3; R[1503]++; if(dbg){print "R1503", "sw_es_p_f"}; continue };
 #
 if ( pl_es_i_f() )
 { l[i]=omo1; R[1504]++; if(dbg){print "R1504", "pl_es_i_f"}; continue };
 #
 if ( pl_es_v_f() )
 { l[i]=omo1; R[1505]++; if(dbg){print "R1505", "pl_es_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 #
 if ( sw_em_r_f() )
 { l[i]=omo1; R[1507]++; if(dbg){print "R1507", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_i_f() )
 { l[i]=omo2; R[1508]++; if(dbg){print "R1508", "sw_ez_i_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1509]++; if(dbg){print "R1509", "sw_mn_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_l_f() )
 { l[i]=omo1; R[1510]++; if(dbg){print "R1510", "sw_em_l_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1511]++; if(dbg){print "R1511", "sw_em_r_f"}; continue };
 #
 if ( sw_ez_v_f() )
 { l[i]=omo3; R[1512]++; if(dbg){print "R1512", "sw_ez_v_f"}; continue };
 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_ed3e_f() )
 { l[i]=omo1; R[1513]++; if(dbg){print "R1513", "gl_ed3e_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1514]++; if(dbg){print "R1514", "sw_mn_r_f"}; continue };
 #
 if ( sw_em_i_f() )
 { l[i]=omo2; R[1515]++; if(dbg){print "R1515", "sw_em_i_f"}; continue };
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1516]++; if(dbg){print "R1516", "sw_em_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_em_p_f() )
 { l[i]=omo2; R[1517]++; if(dbg){print "R1517", "sw_em_p_f"}; continue };
 #
 if ( sw_ez_d_f() )
 { l[i]=omo3; R[1518]++; if(dbg){print "R1518", "sw_ez_d_f"}; continue };
 #
 if ( sw_ez_p_f() )
 { l[i]=omo3; R[1519]++; if(dbg){print "R1519", "sw_ez_p_f"}; continue };
 #
 if ( gl_mn2e_f() )
 { l[i]=omo1; R[1520]++; if(dbg){print "R1520", "gl_mn2e_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( gl_mn2e_f() )
 { l[i]=omo3; R[1521]++; if(dbg){print "R1521", "gl_mn2e_f"}; continue };
 #
 if ( gl_pomn_f() )
 { l[i]=omo2; R[1522]++; if(dbg){print "R1522", "gl_pomn_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_es_r_f() )
 { l[i]=omo2; R[1523]++; if(dbg){print "R1523", "sw_es_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo1; R[1524]++; if(dbg){print "R1524", "sw_mn_i_f"}; continue };
 if ( sw_mn_v_f() )
 { l[i]=omo1; R[1525]++; if(dbg){print "R1525", "sw_mn_v_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( sw_ez_r_f() )
 { l[i]=omo1; R[1526]++; if(dbg){print "R1526", "sw_ez_r_f"}; continue };
...
###   x3017 !_#_! ==> deep_na_  sw_em_vr_  sw_mn_i_  слеса́ря  слесаря́  сле́саря
xgrp="x3017";for(wrd in omap[xgrp]){omakevars(xgrp);for(y=1;y<=wln;y++)        # header1
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( sw_em_v_f() )
 { l[i]=omo2; R[1528]++; if(dbg){print "R1528", "sw_em_v_f"}; continue };
 #
 if ( sw_em_r_f() )
 { l[i]=omo2; R[1529]++; if(dbg){print "R1529", "sw_em_r_f"}; continue };
 #
 if ( sw_mn_i_f() )
 { l[i]=omo3; R[1530]++; if(dbg){print "R1530", "sw_mn_i_f"}; continue };

 }; book[b]=joinpat(l,sep,nf) };};                                ##_footer

###   x3018 !_#_! ==> pl_srav_  sw_ez_t_  sw_mn_vr_  сепара'тней  сепаратнёй  сепаратне'й
xgrp="x3018";for(wrd in omap[xgrp]){omakevars(xgrp);for(y=1;y<=wln;y++)        # header1
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2 _nohyphback
 #
 if ( pl_srav_f() )
 { l[i]=omo1; R[1531]++; if(dbg){print "R1531", "pl_srav_f"}; continue };
 #
 if ( sw_ez_t_f() )
 { l[i]=omo2; R[1532]++; if(dbg){print "R1532", "sw_ez_t_f"}; continue };
 #
 if ( sw_mn_v_f() )
 { l[i]=omo3; R[1533]++; if(dbg){print "R1533", "sw_mn_v_f"}; continue };
 #
 if ( sw_mn_r_f() )
 { l[i]=omo3; R[1534]++; if(dbg){print "R1534", "sw_mn_r_f"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( pre_pr(1) &&
           q(2,"suw_pr prl_pr prq_pr mest_pr") && s(0,1) )
 { l[i]=omo2; R[1566]++; if(dbg){print "R1566"}; continue };
 if ( pre_pr(-2) &&
           q(-1,"suw_pr") &&
           q(1,"suw_im") && s(-2,0) )
 { l[i]=omo2; R[1567]++; if(dbg){print "R1567"}; continue };
 if ( pre_pr(-2) &&
           q(-1,"suw_pr") &&
           q(1,"prl_im prq_im mest_im") &&
           q(2,"suw_im") && s(-2,1) )
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 if ( q(1,"suw_ro") && s(0) )
 { l[i]=omo2; R[1580]++; if(dbg){print "R1580"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo2; R[1581]++; if(dbg){print "R1581"}; continue };
 #
 if(iwrd=="временной") {
   if ( q(1,"suw_edmuim suw_edmuvi") && s(0) )
   { l[i]=omo2; R[1582]++; if(dbg){print "R1582"}; continue };
 };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 ...
 { l[i]=omo1; R[1585]++; if(dbg){print "R1585"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
 if ( bw(-1,"главный") && s(-1) )
 { l[i]=omo2; R[1595]++; if(dbg){print "R1595"}; continue };
...
{makebookvars();for(i in wpos){makewposvars();if(tolower(l[i])!=iwrd)continue; # header2
 #
#if ( bw(-1,"главный") && s(-1) )
#{ l[i]=omo2; R[1596]++; if(dbg){print "R1596"}; continue };
...
if ( catch_file && length(wCAT) > 0 ) { for (i in wCAT) { print i >> catch_file } }
