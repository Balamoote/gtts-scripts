...
function gl_peedge(n,     wd,rett) { wd = lc(n);
...
function gl_peedmu(n,     wd,rett) { wd = lc(n);
...
function gl_peedze(n,     wd,rett) { wd = lc(n);
...
function gl_peedsr(n,     wd,rett) { wd = lc(n);
...
function wordmark(n,   el, stopp, rett) { el=lc(n); while (stopp == 0) {
   if(el in dpn_ne_na         ) { rett = rett "#" dpn_ne_na         [el]; stopp=1; };
   if(el in dpn_ne_pa         ) { rett = rett "#" dpn_ne_pa         [el]; stopp=1; };
   if(el in dpn_pe_na         ) { rett = rett "#" dpn_pe_na         [el]; stopp=1; };
   if(el in dpn_pe_pa         ) { rett = rett "#" dpn_pe_pa         [el]; stopp=1; };
   if(el in dpn_pn_na         ) { rett = rett "#" dpn_pn_na         [el]; stopp=1; };
   if(el in dpn_pn_pa         ) { rett = rett "#" dpn_pn_pa         [el]; stopp=1; };
   if(el in dpn_vz_ne_na      ) { rett = rett "#" dpn_vz_ne_na      [el]; stopp=1; };
   if(el in dps_ne_pa         ) { rett = rett "#" dps_ne_pa         [el]; stopp=1; };
   if(el in dps_pe_pa         ) { rett = rett "#" dps_pe_pa         [el]; stopp=1; };
   if(el in dps_pn_pa         ) { rett = rett "#" dps_pn_pa         [el]; stopp=1; };
   if(el in dps_vz_ne_pa      ) { rett = rett "#" dps_vz_ne_pa      [el]; stopp=1; };
   if(el in g2_nebu_e1        ) { rett = rett "#" g2_nebu_e1        [el]; stopp=1; };
   if(el in g2_nebu_e2        ) { rett = rett "#" g2_nebu_e2        [el]; stopp=1; };
   if(el in g2_nebu_e3        ) { rett = rett "#" g2_nebu_e3        [el]; stopp=1; };
   if(el in g2_nebu_m1        ) { rett = rett "#" g2_nebu_m1        [el]; stopp=1; };
   if(el in g2_nebu_m2        ) { rett = rett "#" g2_nebu_m2        [el]; stopp=1; };
   if(el in g2_nebu_m3        ) { rett = rett "#" g2_nebu_m3        [el]; stopp=1; };
   if(el in g2_nein           ) { rett = rett "#" g2_nein           [el]; stopp=1; };
   if(el in g2_nena_e1        ) { rett = rett "#" g2_nena_e1        [el]; stopp=1; };
   if(el in g2_nena_e2        ) { rett = rett "#" g2_nena_e2        [el]; stopp=1; };
   if(el in g2_nena_e3        ) { rett = rett "#" g2_nena_e3        [el]; stopp=1; };
   if(el in g2_nena_m1        ) { rett = rett "#" g2_nena_m1        [el]; stopp=1; };
   if(el in g2_nena_m2        ) { rett = rett "#" g2_nena_m2        [el]; stopp=1; };
   if(el in g2_nena_m3        ) { rett = rett "#" g2_nena_m3        [el]; stopp=1; };
   if(el in g2_nepa_edmu      ) { rett = rett "#" g2_nepa_edmu      [el]; stopp=1; };
   if(el in g2_nepa_edsr      ) { rett = rett "#" g2_nepa_edsr      [el]; stopp=1; };
   if(el in g2_nepa_edze      ) { rett = rett "#" g2_nepa_edze      [el]; stopp=1; };
   if(el in g2_nepa_mn        ) { rett = rett "#" g2_nepa_mn        [el]; stopp=1; };
   if(el in g2_nepo_ed        ) { rett = rett "#" g2_nepo_ed        [el]; stopp=1; };
   if(el in g2_nepo_mn        ) { rett = rett "#" g2_nepo_mn        [el]; stopp=1; };
   if(el in g2_pebu_e1        ) { rett = rett "#" g2_pebu_e1        [el]; stopp=1; };
   if(el in g2_pebu_e2        ) { rett = rett "#" g2_pebu_e2        [el]; stopp=1; };
   if(el in g2_pebu_e3        ) { rett = rett "#" g2_pebu_e3        [el]; stopp=1; };
   if(el in g2_pebu_m1        ) { rett = rett "#" g2_pebu_m1        [el]; stopp=1; };
   if(el in g2_pebu_m2        ) { rett = rett "#" g2_pebu_m2        [el]; stopp=1; };
   if(el in g2_pebu_m3        ) { rett = rett "#" g2_pebu_m3        [el]; stopp=1; };
   if(el in g2_pein           ) { rett = rett "#" g2_pein           [el]; stopp=1; };
   if(el in g2_pena_e1        ) { rett = rett "#" g2_pena_e1        [el]; stopp=1; };
   if(el in g2_pena_e2        ) { rett = rett "#" g2_pena_e2        [el]; stopp=1; };
   if(el in g2_pena_e3        ) { rett = rett "#" g2_pena_e3        [el]; stopp=1; };
   if(el in g2_pena_m1        ) { rett = rett "#" g2_pena_m1        [el]; stopp=1; };
   if(el in g2_pena_m2        ) { rett = rett "#" g2_pena_m2        [el]; stopp=1; };
   if(el in g2_pena_m3        ) { rett = rett "#" g2_pena_m3        [el]; stopp=1; };
   if(el in g2_pepa_edmu      ) { rett = rett "#" g2_pepa_edmu      [el]; stopp=1; };
   if(el in g2_pepa_edsr      ) { rett = rett "#" g2_pepa_edsr      [el]; stopp=1; };
   if(el in g2_pepa_edze      ) { rett = rett "#" g2_pepa_edze      [el]; stopp=1; };
   if(el in g2_pepa_mn        ) { rett = rett "#" g2_pepa_mn        [el]; stopp=1; };
   if(el in g2_pepo_ed        ) { rett = rett "#" g2_pepo_ed        [el]; stopp=1; };
   if(el in g2_pepo_mn        ) { rett = rett "#" g2_pepo_mn        [el]; stopp=1; };
   if(el in g2_pnbu_e1        ) { rett = rett "#" g2_pnbu_e1        [el]; stopp=1; };
   if(el in g2_pnbu_e2        ) { rett = rett "#" g2_pnbu_e2        [el]; stopp=1; };
   if(el in g2_pnbu_e3        ) { rett = rett "#" g2_pnbu_e3        [el]; stopp=1; };
   if(el in g2_pnbu_m1        ) { rett = rett "#" g2_pnbu_m1        [el]; stopp=1; };
   if(el in g2_pnbu_m2        ) { rett = rett "#" g2_pnbu_m2        [el]; stopp=1; };
   if(el in g2_pnbu_m3        ) { rett = rett "#" g2_pnbu_m3        [el]; stopp=1; };
   if(el in g2_pnin           ) { rett = rett "#" g2_pnin           [el]; stopp=1; };
   if(el in g2_pnna_e1        ) { rett = rett "#" g2_pnna_e1        [el]; stopp=1; };
   if(el in g2_pnna_e2        ) { rett = rett "#" g2_pnna_e2        [el]; stopp=1; };
   if(el in g2_pnna_e3        ) { rett = rett "#" g2_pnna_e3        [el]; stopp=1; };
   if(el in g2_pnna_m1        ) { rett = rett "#" g2_pnna_m1        [el]; stopp=1; };
   if(el in g2_pnna_m2        ) { rett = rett "#" g2_pnna_m2        [el]; stopp=1; };
   if(el in g2_pnna_m3        ) { rett = rett "#" g2_pnna_m3        [el]; stopp=1; };
   if(el in g2_pnpa_edmu      ) { rett = rett "#" g2_pnpa_edmu      [el]; stopp=1; };
   if(el in g2_pnpa_edsr      ) { rett = rett "#" g2_pnpa_edsr      [el]; stopp=1; };
   if(el in g2_pnpa_edze      ) { rett = rett "#" g2_pnpa_edze      [el]; stopp=1; };
   if(el in g2_pnpa_mn        ) { rett = rett "#" g2_pnpa_mn        [el]; stopp=1; };
   if(el in g2_pnpo_ed        ) { rett = rett "#" g2_pnpo_ed        [el]; stopp=1; };
   if(el in g2_pnpo_mn        ) { rett = rett "#" g2_pnpo_mn        [el]; stopp=1; };
   if(el in g2_vz_nebu_e1     ) { rett = rett "#" g2_vz_nebu_e1     [el]; stopp=1; };
   if(el in g2_vz_nebu_e2     ) { rett = rett "#" g2_vz_nebu_e2     [el]; stopp=1; };
   if(el in g2_vz_nebu_e3     ) { rett = rett "#" g2_vz_nebu_e3     [el]; stopp=1; };
   if(el in g2_vz_nebu_m1     ) { rett = rett "#" g2_vz_nebu_m1     [el]; stopp=1; };
   if(el in g2_vz_nebu_m2     ) { rett = rett "#" g2_vz_nebu_m2     [el]; stopp=1; };
   if(el in g2_vz_nebu_m3     ) { rett = rett "#" g2_vz_nebu_m3     [el]; stopp=1; };
   if(el in g2_vz_nein        ) { rett = rett "#" g2_vz_nein        [el]; stopp=1; };
   if(el in g2_vz_nena_e1     ) { rett = rett "#" g2_vz_nena_e1     [el]; stopp=1; };
   if(el in g2_vz_nena_e2     ) { rett = rett "#" g2_vz_nena_e2     [el]; stopp=1; };
   if(el in g2_vz_nena_e3     ) { rett = rett "#" g2_vz_nena_e3     [el]; stopp=1; };
   if(el in g2_vz_nena_m1     ) { rett = rett "#" g2_vz_nena_m1     [el]; stopp=1; };
   if(el in g2_vz_nena_m2     ) { rett = rett "#" g2_vz_nena_m2     [el]; stopp=1; };
   if(el in g2_vz_nena_m3     ) { rett = rett "#" g2_vz_nena_m3     [el]; stopp=1; };
   if(el in g2_vz_nepa_edmu   ) { rett = rett "#" g2_vz_nepa_edmu   [el]; stopp=1; };
   if(el in g2_vz_nepa_edsr   ) { rett = rett "#" g2_vz_nepa_edsr   [el]; stopp=1; };
   if(el in g2_vz_nepa_edze   ) { rett = rett "#" g2_vz_nepa_edze   [el]; stopp=1; };
   if(el in g2_vz_nepa_mn     ) { rett = rett "#" g2_vz_nepa_mn     [el]; stopp=1; };
   if(el in g2_vz_nepo_ed     ) { rett = rett "#" g2_vz_nepo_ed     [el]; stopp=1; };
   if(el in g2_vz_nepo_mn     ) { rett = rett "#" g2_vz_nepo_mn     [el]; stopp=1; };
   if(el in gn_nein           ) { rett = rett "#" gn_nein           [el]; stopp=1; };
   if(el in gn_nein_bz        ) { rett = rett "#" gn_nein_bz        [el]; stopp=1; };
   if(el in gn_nena_e1        ) { rett = rett "#" gn_nena_e1        [el]; stopp=1; };
   if(el in gn_nena_e2        ) { rett = rett "#" gn_nena_e2        [el]; stopp=1; };
   if(el in gn_nena_e3        ) { rett = rett "#" gn_nena_e3        [el]; stopp=1; };
   if(el in gn_nena_m1        ) { rett = rett "#" gn_nena_m1        [el]; stopp=1; };
   if(el in gn_nena_m2        ) { rett = rett "#" gn_nena_m2        [el]; stopp=1; };
   if(el in gn_nena_m3        ) { rett = rett "#" gn_nena_m3        [el]; stopp=1; };
   if(el in gn_nepa_edmu      ) { rett = rett "#" gn_nepa_edmu      [el]; stopp=1; };
   if(el in gn_nepa_edsr      ) { rett = rett "#" gn_nepa_edsr      [el]; stopp=1; };
   if(el in gn_nepa_edze      ) { rett = rett "#" gn_nepa_edze      [el]; stopp=1; };
   if(el in gn_nepa_mn        ) { rett = rett "#" gn_nepa_mn        [el]; stopp=1; };
   if(el in gn_nepo_ed        ) { rett = rett "#" gn_nepo_ed        [el]; stopp=1; };
   if(el in gn_nepo_mn        ) { rett = rett "#" gn_nepo_mn        [el]; stopp=1; };
   if(el in gn_pein           ) { rett = rett "#" gn_pein           [el]; stopp=1; };
   if(el in gn_pein_bz        ) { rett = rett "#" gn_pein_bz        [el]; stopp=1; };
   if(el in gn_pena_e1        ) { rett = rett "#" gn_pena_e1        [el]; stopp=1; };
   if(el in gn_pena_e2        ) { rett = rett "#" gn_pena_e2        [el]; stopp=1; };
   if(el in gn_pena_e3        ) { rett = rett "#" gn_pena_e3        [el]; stopp=1; };
   if(el in gn_pena_m1        ) { rett = rett "#" gn_pena_m1        [el]; stopp=1; };
   if(el in gn_pena_m2        ) { rett = rett "#" gn_pena_m2        [el]; stopp=1; };
   if(el in gn_pena_m3        ) { rett = rett "#" gn_pena_m3        [el]; stopp=1; };
   if(el in gn_pepa_edmu      ) { rett = rett "#" gn_pepa_edmu      [el]; stopp=1; };
   if(el in gn_pepa_edsr      ) { rett = rett "#" gn_pepa_edsr      [el]; stopp=1; };
   if(el in gn_pepa_edze      ) { rett = rett "#" gn_pepa_edze      [el]; stopp=1; };
   if(el in gn_pepa_mn        ) { rett = rett "#" gn_pepa_mn        [el]; stopp=1; };
   if(el in gn_pepo_ed        ) { rett = rett "#" gn_pepo_ed        [el]; stopp=1; };
   if(el in gn_pepo_mn        ) { rett = rett "#" gn_pepo_mn        [el]; stopp=1; };
   if(el in gn_pnin           ) { rett = rett "#" gn_pnin           [el]; stopp=1; };
   if(el in gn_pnna_e1        ) { rett = rett "#" gn_pnna_e1        [el]; stopp=1; };
   if(el in gn_pnna_e2        ) { rett = rett "#" gn_pnna_e2        [el]; stopp=1; };
   if(el in gn_pnna_e3        ) { rett = rett "#" gn_pnna_e3        [el]; stopp=1; };
   if(el in gn_pnna_m1        ) { rett = rett "#" gn_pnna_m1        [el]; stopp=1; };
   if(el in gn_pnna_m2        ) { rett = rett "#" gn_pnna_m2        [el]; stopp=1; };
   if(el in gn_pnna_m3        ) { rett = rett "#" gn_pnna_m3        [el]; stopp=1; };
   if(el in gn_pnpa_edmu      ) { rett = rett "#" gn_pnpa_edmu      [el]; stopp=1; };
   if(el in gn_pnpa_edsr      ) { rett = rett "#" gn_pnpa_edsr      [el]; stopp=1; };
   if(el in gn_pnpa_edze      ) { rett = rett "#" gn_pnpa_edze      [el]; stopp=1; };
   if(el in gn_pnpa_mn        ) { rett = rett "#" gn_pnpa_mn        [el]; stopp=1; };
   if(el in gn_pnpo_ed        ) { rett = rett "#" gn_pnpo_ed        [el]; stopp=1; };
   if(el in gn_pnpo_mn        ) { rett = rett "#" gn_pnpo_mn        [el]; stopp=1; };
   if(el in gn_vz_ne_in       ) { rett = rett "#" gn_vz_ne_in       [el]; stopp=1; };
   if(el in gn_vz_nein_bz     ) { rett = rett "#" gn_vz_nein_bz     [el]; stopp=1; };
   if(el in gn_vz_nena_e1     ) { rett = rett "#" gn_vz_nena_e1     [el]; stopp=1; };
   if(el in gn_vz_nena_e2     ) { rett = rett "#" gn_vz_nena_e2     [el]; stopp=1; };
   if(el in gn_vz_nena_e3     ) { rett = rett "#" gn_vz_nena_e3     [el]; stopp=1; };
   if(el in gn_vz_nena_m1     ) { rett = rett "#" gn_vz_nena_m1     [el]; stopp=1; };
   if(el in gn_vz_nena_m2     ) { rett = rett "#" gn_vz_nena_m2     [el]; stopp=1; };
   if(el in gn_vz_nena_m3     ) { rett = rett "#" gn_vz_nena_m3     [el]; stopp=1; };
   if(el in gn_vz_nepa_edmu   ) { rett = rett "#" gn_vz_nepa_edmu   [el]; stopp=1; };
   if(el in gn_vz_nepa_edsr   ) { rett = rett "#" gn_vz_nepa_edsr   [el]; stopp=1; };
   if(el in gn_vz_nepa_edze   ) { rett = rett "#" gn_vz_nepa_edze   [el]; stopp=1; };
   if(el in gn_vz_nepa_mn     ) { rett = rett "#" gn_vz_nepa_mn     [el]; stopp=1; };
   if(el in gn_vz_nepo_ed     ) { rett = rett "#" gn_vz_nepo_ed     [el]; stopp=1; };
   if(el in gn_vz_nepo_mn     ) { rett = rett "#" gn_vz_nepo_mn     [el]; stopp=1; };
   if(el in gs_nebu_e1        ) { rett = rett "#" gs_nebu_e1        [el]; stopp=1; };
   if(el in gs_nebu_e2        ) { rett = rett "#" gs_nebu_e2        [el]; stopp=1; };
   if(el in gs_nebu_e3        ) { rett = rett "#" gs_nebu_e3        [el]; stopp=1; };
   if(el in gs_nebu_m1        ) { rett = rett "#" gs_nebu_m1        [el]; stopp=1; };
   if(el in gs_nebu_m2        ) { rett = rett "#" gs_nebu_m2        [el]; stopp=1; };
   if(el in gs_nebu_m3        ) { rett = rett "#" gs_nebu_m3        [el]; stopp=1; };
   if(el in gs_nein           ) { rett = rett "#" gs_nein           [el]; stopp=1; };
   if(el in gs_nein_bz        ) { rett = rett "#" gs_nein_bz        [el]; stopp=1; };
   if(el in gs_nepa_edmu      ) { rett = rett "#" gs_nepa_edmu      [el]; stopp=1; };
   if(el in gs_nepa_edsr      ) { rett = rett "#" gs_nepa_edsr      [el]; stopp=1; };
   if(el in gs_nepa_edze      ) { rett = rett "#" gs_nepa_edze      [el]; stopp=1; };
   if(el in gs_nepa_mn        ) { rett = rett "#" gs_nepa_mn        [el]; stopp=1; };
   if(el in gs_nepo_ed        ) { rett = rett "#" gs_nepo_ed        [el]; stopp=1; };
   if(el in gs_nepo_mn        ) { rett = rett "#" gs_nepo_mn        [el]; stopp=1; };
   if(el in gs_pebu_e1        ) { rett = rett "#" gs_pebu_e1        [el]; stopp=1; };
   if(el in gs_pebu_e2        ) { rett = rett "#" gs_pebu_e2        [el]; stopp=1; };
   if(el in gs_pebu_e3        ) { rett = rett "#" gs_pebu_e3        [el]; stopp=1; };
   if(el in gs_pebu_m1        ) { rett = rett "#" gs_pebu_m1        [el]; stopp=1; };
   if(el in gs_pebu_m2        ) { rett = rett "#" gs_pebu_m2        [el]; stopp=1; };
   if(el in gs_pebu_m3        ) { rett = rett "#" gs_pebu_m3        [el]; stopp=1; };
   if(el in gs_pein           ) { rett = rett "#" gs_pein           [el]; stopp=1; };
   if(el in gs_pein_bz        ) { rett = rett "#" gs_pein_bz        [el]; stopp=1; };
   if(el in gs_pepa_edmu      ) { rett = rett "#" gs_pepa_edmu      [el]; stopp=1; };
   if(el in gs_pepa_edsr      ) { rett = rett "#" gs_pepa_edsr      [el]; stopp=1; };
   if(el in gs_pepa_edze      ) { rett = rett "#" gs_pepa_edze      [el]; stopp=1; };
   if(el in gs_pepa_mn        ) { rett = rett "#" gs_pepa_mn        [el]; stopp=1; };
   if(el in gs_pepo_ed        ) { rett = rett "#" gs_pepo_ed        [el]; stopp=1; };
   if(el in gs_pepo_mn        ) { rett = rett "#" gs_pepo_mn        [el]; stopp=1; };
   if(el in gs_pnbu_e1        ) { rett = rett "#" gs_pnbu_e1        [el]; stopp=1; };
   if(el in gs_pnbu_e2        ) { rett = rett "#" gs_pnbu_e2        [el]; stopp=1; };
   if(el in gs_pnbu_e3        ) { rett = rett "#" gs_pnbu_e3        [el]; stopp=1; };
   if(el in gs_pnbu_m1        ) { rett = rett "#" gs_pnbu_m1        [el]; stopp=1; };
   if(el in gs_pnbu_m2        ) { rett = rett "#" gs_pnbu_m2        [el]; stopp=1; };
   if(el in gs_pnbu_m3        ) { rett = rett "#" gs_pnbu_m3        [el]; stopp=1; };
   if(el in gs_pnin           ) { rett = rett "#" gs_pnin           [el]; stopp=1; };
   if(el in gs_pnpa_edmu      ) { rett = rett "#" gs_pnpa_edmu      [el]; stopp=1; };
   if(el in gs_pnpa_edsr      ) { rett = rett "#" gs_pnpa_edsr      [el]; stopp=1; };
   if(el in gs_pnpa_edze      ) { rett = rett "#" gs_pnpa_edze      [el]; stopp=1; };
   if(el in gs_pnpa_mn        ) { rett = rett "#" gs_pnpa_mn        [el]; stopp=1; };
   if(el in gs_pnpo_ed        ) { rett = rett "#" gs_pnpo_ed        [el]; stopp=1; };
   if(el in gs_pnpo_mn        ) { rett = rett "#" gs_pnpo_mn        [el]; stopp=1; };
   if(el in gs_vz_nebu_e1     ) { rett = rett "#" gs_vz_nebu_e1     [el]; stopp=1; };
   if(el in gs_vz_nebu_e2     ) { rett = rett "#" gs_vz_nebu_e2     [el]; stopp=1; };
   if(el in gs_vz_nebu_e3     ) { rett = rett "#" gs_vz_nebu_e3     [el]; stopp=1; };
   if(el in gs_vz_nebu_m1     ) { rett = rett "#" gs_vz_nebu_m1     [el]; stopp=1; };
   if(el in gs_vz_nebu_m2     ) { rett = rett "#" gs_vz_nebu_m2     [el]; stopp=1; };
   if(el in gs_vz_nebu_m3     ) { rett = rett "#" gs_vz_nebu_m3     [el]; stopp=1; };
   if(el in gs_vz_nein        ) { rett = rett "#" gs_vz_nein        [el]; stopp=1; };
   if(el in gs_vz_nein_bz     ) { rett = rett "#" gs_vz_nein_bz     [el]; stopp=1; };
   if(el in gs_vz_nepa_edmu   ) { rett = rett "#" gs_vz_nepa_edmu   [el]; stopp=1; };
   if(el in gs_vz_nepa_edsr   ) { rett = rett "#" gs_vz_nepa_edsr   [el]; stopp=1; };
   if(el in gs_vz_nepa_edze   ) { rett = rett "#" gs_vz_nepa_edze   [el]; stopp=1; };
   if(el in gs_vz_nepa_mn     ) { rett = rett "#" gs_vz_nepa_mn     [el]; stopp=1; };
   if(el in gs_vz_nepo_ed     ) { rett = rett "#" gs_vz_nepo_ed     [el]; stopp=1; };
   if(el in gs_vz_nepo_mn     ) { rett = rett "#" gs_vz_nepo_mn     [el]; stopp=1; };
   if(el in mst_da            ) { rett = rett "#" mst_da            [el]; stopp=1; };
   if(el in mst_ed_da         ) { rett = rett "#" mst_ed_da         [el]; stopp=1; };
   if(el in mst_ed_im         ) { rett = rett "#" mst_ed_im         [el]; stopp=1; };
   if(el in mst_ed_mu         ) { rett = rett "#" mst_ed_mu         [el]; stopp=1; };
   if(el in mst_ed_mu_da      ) { rett = rett "#" mst_ed_mu_da      [el]; stopp=1; };
   if(el in mst_ed_mu_im      ) { rett = rett "#" mst_ed_mu_im      [el]; stopp=1; };
   if(el in mst_ed_mu_pr      ) { rett = rett "#" mst_ed_mu_pr      [el]; stopp=1; };
   if(el in mst_ed_mu_ro      ) { rett = rett "#" mst_ed_mu_ro      [el]; stopp=1; };
   if(el in mst_ed_mu_tv      ) { rett = rett "#" mst_ed_mu_tv      [el]; stopp=1; };
   if(el in mst_ed_mu_vi      ) { rett = rett "#" mst_ed_mu_vi      [el]; stopp=1; };
   if(el in mst_ed_pr         ) { rett = rett "#" mst_ed_pr         [el]; stopp=1; };
   if(el in mst_ed_ro         ) { rett = rett "#" mst_ed_ro         [el]; stopp=1; };
   if(el in mst_ed_sr         ) { rett = rett "#" mst_ed_sr         [el]; stopp=1; };
   if(el in mst_ed_sr_da      ) { rett = rett "#" mst_ed_sr_da      [el]; stopp=1; };
   if(el in mst_ed_sr_im      ) { rett = rett "#" mst_ed_sr_im      [el]; stopp=1; };
   if(el in mst_ed_sr_pr      ) { rett = rett "#" mst_ed_sr_pr      [el]; stopp=1; };
   if(el in mst_ed_sr_ro      ) { rett = rett "#" mst_ed_sr_ro      [el]; stopp=1; };
   if(el in mst_ed_sr_tv      ) { rett = rett "#" mst_ed_sr_tv      [el]; stopp=1; };
   if(el in mst_ed_sr_vi      ) { rett = rett "#" mst_ed_sr_vi      [el]; stopp=1; };
   if(el in mst_ed_tv         ) { rett = rett "#" mst_ed_tv         [el]; stopp=1; };
   if(el in mst_ed_vi         ) { rett = rett "#" mst_ed_vi         [el]; stopp=1; };
   if(el in mst_ed_ze         ) { rett = rett "#" mst_ed_ze         [el]; stopp=1; };
   if(el in mst_ed_ze_da      ) { rett = rett "#" mst_ed_ze_da      [el]; stopp=1; };
   if(el in mst_ed_ze_im      ) { rett = rett "#" mst_ed_ze_im      [el]; stopp=1; };
   if(el in mst_ed_ze_pr      ) { rett = rett "#" mst_ed_ze_pr      [el]; stopp=1; };
   if(el in mst_ed_ze_ro      ) { rett = rett "#" mst_ed_ze_ro      [el]; stopp=1; };
   if(el in mst_ed_ze_tv      ) { rett = rett "#" mst_ed_ze_tv      [el]; stopp=1; };
   if(el in mst_ed_ze_vi      ) { rett = rett "#" mst_ed_ze_vi      [el]; stopp=1; };
   if(el in mst_im            ) { rett = rett "#" mst_im            [el]; stopp=1; };
   if(el in mst_mn            ) { rett = rett "#" mst_mn            [el]; stopp=1; };
   if(el in mst_mn_da         ) { rett = rett "#" mst_mn_da         [el]; stopp=1; };
   if(el in mst_mn_im         ) { rett = rett "#" mst_mn_im         [el]; stopp=1; };
   if(el in mst_mn_pr         ) { rett = rett "#" mst_mn_pr         [el]; stopp=1; };
   if(el in mst_mn_ro         ) { rett = rett "#" mst_mn_ro         [el]; stopp=1; };
   if(el in mst_mn_tv         ) { rett = rett "#" mst_mn_tv         [el]; stopp=1; };
   if(el in mst_mn_vi         ) { rett = rett "#" mst_mn_vi         [el]; stopp=1; };
   if(el in mst_pr            ) { rett = rett "#" mst_pr            [el]; stopp=1; };
   if(el in mst_ro            ) { rett = rett "#" mst_ro            [el]; stopp=1; };
   if(el in mst_suw           ) { rett = rett "#" mst_suw           [el]; stopp=1; };
   if(el in mst_tv            ) { rett = rett "#" mst_tv            [el]; stopp=1; };
   if(el in mst_vi            ) { rett = rett "#" mst_vi            [el]; stopp=1; };
   if(el in mzd               ) { rett = rett "#" mzd               [el]; stopp=1; };
   if(el in nr_mest           ) { rett = rett "#" nr_mest           [el]; stopp=1; };
   if(el in nr_nar            ) { rett = rett "#" nr_nar            [el]; stopp=1; };
   if(el in nr_obce           ) { rett = rett "#" nr_obce           [el]; stopp=1; };
   if(el in nr_obme           ) { rett = rett "#" nr_obme           [el]; stopp=1; };
   if(el in nr_obna           ) { rett = rett "#" nr_obna           [el]; stopp=1; };
   if(el in nr_obpr           ) { rett = rett "#" nr_obpr           [el]; stopp=1; };
   if(el in nr_obvr           ) { rett = rett "#" nr_obvr           [el]; stopp=1; };
   if(el in nr_opka           ) { rett = rett "#" nr_opka           [el]; stopp=1; };
   if(el in nr_opsp           ) { rett = rett "#" nr_opsp           [el]; stopp=1; };
   if(el in nr_opst           ) { rett = rett "#" nr_opst           [el]; stopp=1; };
   if(el in nr_pv             ) { rett = rett "#" nr_pv             [el]; stopp=1; };
   if(el in nr_srv            ) { rett = rett "#" nr_srv            [el]; stopp=1; };
   if(el in nr_vopr           ) { rett = rett "#" nr_vopr           [el]; stopp=1; };
   if(el in pl_edmu_da        ) { rett = rett "#" pl_edmu_da        [el]; stopp=1; };
   if(el in pl_edmu_im        ) { rett = rett "#" pl_edmu_im        [el]; stopp=1; };
   if(el in pl_edmu_pr        ) { rett = rett "#" pl_edmu_pr        [el]; stopp=1; };
   if(el in pl_edmu_ro        ) { rett = rett "#" pl_edmu_ro        [el]; stopp=1; };
   if(el in pl_edmu_tv        ) { rett = rett "#" pl_edmu_tv        [el]; stopp=1; };
   if(el in pl_edsr_da        ) { rett = rett "#" pl_edsr_da        [el]; stopp=1; };
   if(el in pl_edsr_im        ) { rett = rett "#" pl_edsr_im        [el]; stopp=1; };
   if(el in pl_edsr_pr        ) { rett = rett "#" pl_edsr_pr        [el]; stopp=1; };
   if(el in pl_edsr_ro        ) { rett = rett "#" pl_edsr_ro        [el]; stopp=1; };
   if(el in pl_edsr_tv        ) { rett = rett "#" pl_edsr_tv        [el]; stopp=1; };
   if(el in pl_edze_dr        ) { rett = rett "#" pl_edze_dr        [el]; stopp=1; };
   if(el in pl_edze_im        ) { rett = rett "#" pl_edze_im        [el]; stopp=1; };
   if(el in pl_edze_tv        ) { rett = rett "#" pl_edze_tv        [el]; stopp=1; };
   if(el in pl_edze_vi        ) { rett = rett "#" pl_edze_vi        [el]; stopp=1; };
   if(el in pl_kred_mu        ) { rett = rett "#" pl_kred_mu        [el]; stopp=1; };
   if(el in pl_kred_sr        ) { rett = rett "#" pl_kred_sr        [el]; stopp=1; };
   if(el in pl_kred_ze        ) { rett = rett "#" pl_kred_ze        [el]; stopp=1; };
   if(el in pl_krmn           ) { rett = rett "#" pl_krmn           [el]; stopp=1; };
   if(el in pl_mn_da          ) { rett = rett "#" pl_mn_da          [el]; stopp=1; };
   if(el in pl_mn_im          ) { rett = rett "#" pl_mn_im          [el]; stopp=1; };
   if(el in pl_mn_ro          ) { rett = rett "#" pl_mn_ro          [el]; stopp=1; };
   if(el in pl_mn_tv          ) { rett = rett "#" pl_mn_tv          [el]; stopp=1; };
   if(el in pl_neiz           ) { rett = rett "#" pl_neiz           [el]; stopp=1; };
   if(el in pl_pv_edmu_da     ) { rett = rett "#" pl_pv_edmu_da     [el]; stopp=1; };
   if(el in pl_pv_edmu_im     ) { rett = rett "#" pl_pv_edmu_im     [el]; stopp=1; };
   if(el in pl_pv_edmu_pr     ) { rett = rett "#" pl_pv_edmu_pr     [el]; stopp=1; };
   if(el in pl_pv_edmu_ro     ) { rett = rett "#" pl_pv_edmu_ro     [el]; stopp=1; };
   if(el in pl_pv_edmu_tv     ) { rett = rett "#" pl_pv_edmu_tv     [el]; stopp=1; };
   if(el in pl_pv_edsr_da     ) { rett = rett "#" pl_pv_edsr_da     [el]; stopp=1; };
   if(el in pl_pv_edsr_im     ) { rett = rett "#" pl_pv_edsr_im     [el]; stopp=1; };
   if(el in pl_pv_edsr_pr     ) { rett = rett "#" pl_pv_edsr_pr     [el]; stopp=1; };
   if(el in pl_pv_edsr_ro     ) { rett = rett "#" pl_pv_edsr_ro     [el]; stopp=1; };
   if(el in pl_pv_edsr_tv     ) { rett = rett "#" pl_pv_edsr_tv     [el]; stopp=1; };
   if(el in pl_pv_edze_dr     ) { rett = rett "#" pl_pv_edze_dr     [el]; stopp=1; };
   if(el in pl_pv_edze_im     ) { rett = rett "#" pl_pv_edze_im     [el]; stopp=1; };
   if(el in pl_pv_edze_tv     ) { rett = rett "#" pl_pv_edze_tv     [el]; stopp=1; };
   if(el in pl_pv_edze_vi     ) { rett = rett "#" pl_pv_edze_vi     [el]; stopp=1; };
   if(el in pl_pv_mn_da       ) { rett = rett "#" pl_pv_mn_da       [el]; stopp=1; };
   if(el in pl_pv_mn_im       ) { rett = rett "#" pl_pv_mn_im       [el]; stopp=1; };
   if(el in pl_pv_mn_pr       ) { rett = rett "#" pl_pv_mn_pr       [el]; stopp=1; };
   if(el in pl_pv_mn_ro       ) { rett = rett "#" pl_pv_mn_ro       [el]; stopp=1; };
   if(el in pl_pv_mn_tv       ) { rett = rett "#" pl_pv_mn_tv       [el]; stopp=1; };
   if(el in pl_srv            ) { rett = rett "#" pl_srv            [el]; stopp=1; };
   if(el in pq_edmu_da        ) { rett = rett "#" pq_edmu_da        [el]; stopp=1; };
   if(el in pq_edmu_im        ) { rett = rett "#" pq_edmu_im        [el]; stopp=1; };
   if(el in pq_edmu_pr        ) { rett = rett "#" pq_edmu_pr        [el]; stopp=1; };
   if(el in pq_edmu_ro        ) { rett = rett "#" pq_edmu_ro        [el]; stopp=1; };
   if(el in pq_edmu_tv        ) { rett = rett "#" pq_edmu_tv        [el]; stopp=1; };
   if(el in pq_edsr_da        ) { rett = rett "#" pq_edsr_da        [el]; stopp=1; };
   if(el in pq_edsr_im        ) { rett = rett "#" pq_edsr_im        [el]; stopp=1; };
   if(el in pq_edsr_pr        ) { rett = rett "#" pq_edsr_pr        [el]; stopp=1; };
   if(el in pq_edsr_ro        ) { rett = rett "#" pq_edsr_ro        [el]; stopp=1; };
   if(el in pq_edsr_tv        ) { rett = rett "#" pq_edsr_tv        [el]; stopp=1; };
   if(el in pq_edze_dr        ) { rett = rett "#" pq_edze_dr        [el]; stopp=1; };
   if(el in pq_edze_im        ) { rett = rett "#" pq_edze_im        [el]; stopp=1; };
   if(el in pq_edze_vi        ) { rett = rett "#" pq_edze_vi        [el]; stopp=1; };
   if(el in pq_kred_mu        ) { rett = rett "#" pq_kred_mu        [el]; stopp=1; };
   if(el in pq_kred_sr        ) { rett = rett "#" pq_kred_sr        [el]; stopp=1; };
   if(el in pq_kred_ze        ) { rett = rett "#" pq_kred_ze        [el]; stopp=1; };
   if(el in pq_krmn           ) { rett = rett "#" pq_krmn           [el]; stopp=1; };
   if(el in pq_mn_da          ) { rett = rett "#" pq_mn_da          [el]; stopp=1; };
   if(el in pq_mn_im          ) { rett = rett "#" pq_mn_im          [el]; stopp=1; };
   if(el in pq_mn_ro          ) { rett = rett "#" pq_mn_ro          [el]; stopp=1; };
   if(el in pq_mn_tv          ) { rett = rett "#" pq_mn_tv          [el]; stopp=1; };
   if(el in pred_da           ) { rett = rett "#" pred_da           [el]; stopp=1; };
   if(el in pred_im           ) { rett = rett "#" pred_im           [el]; stopp=1; };
   if(el in pred_pr           ) { rett = rett "#" pred_pr           [el]; stopp=1; };
   if(el in pred_ro           ) { rett = rett "#" pred_ro           [el]; stopp=1; };
   if(el in pred_tv           ) { rett = rett "#" pred_tv           [el]; stopp=1; };
   if(el in pred_vi           ) { rett = rett "#" pred_vi           [el]; stopp=1; };
   if(el in predk             ) { rett = rett "#" predk             [el]; stopp=1; };
   if(el in qall              ) { rett = rett "#" qall              [el]; stopp=1; };
   if(el in qko_da            ) { rett = rett "#" qko_da            [el]; stopp=1; };
   if(el in qko_ed_mu_da      ) { rett = rett "#" qko_ed_mu_da      [el]; stopp=1; };
   if(el in qko_ed_mu_im      ) { rett = rett "#" qko_ed_mu_im      [el]; stopp=1; };
   if(el in qko_ed_mu_pr      ) { rett = rett "#" qko_ed_mu_pr      [el]; stopp=1; };
   if(el in qko_ed_mu_ro      ) { rett = rett "#" qko_ed_mu_ro      [el]; stopp=1; };
   if(el in qko_ed_mu_tv      ) { rett = rett "#" qko_ed_mu_tv      [el]; stopp=1; };
   if(el in qko_ed_mu_vi      ) { rett = rett "#" qko_ed_mu_vi      [el]; stopp=1; };
   if(el in qko_ed_sr_da      ) { rett = rett "#" qko_ed_sr_da      [el]; stopp=1; };
   if(el in qko_ed_sr_im      ) { rett = rett "#" qko_ed_sr_im      [el]; stopp=1; };
   if(el in qko_ed_sr_pr      ) { rett = rett "#" qko_ed_sr_pr      [el]; stopp=1; };
   if(el in qko_ed_sr_ro      ) { rett = rett "#" qko_ed_sr_ro      [el]; stopp=1; };
   if(el in qko_ed_sr_tv      ) { rett = rett "#" qko_ed_sr_tv      [el]; stopp=1; };
   if(el in qko_ed_sr_vi      ) { rett = rett "#" qko_ed_sr_vi      [el]; stopp=1; };
   if(el in qko_ed_ze_da      ) { rett = rett "#" qko_ed_ze_da      [el]; stopp=1; };
   if(el in qko_ed_ze_im      ) { rett = rett "#" qko_ed_ze_im      [el]; stopp=1; };
   if(el in qko_ed_ze_pr      ) { rett = rett "#" qko_ed_ze_pr      [el]; stopp=1; };
   if(el in qko_ed_ze_ro      ) { rett = rett "#" qko_ed_ze_ro      [el]; stopp=1; };
   if(el in qko_ed_ze_tv      ) { rett = rett "#" qko_ed_ze_tv      [el]; stopp=1; };
   if(el in qko_ed_ze_vi      ) { rett = rett "#" qko_ed_ze_vi      [el]; stopp=1; };
   if(el in qko_im            ) { rett = rett "#" qko_im            [el]; stopp=1; };
   if(el in qko_mn_da         ) { rett = rett "#" qko_mn_da         [el]; stopp=1; };
   if(el in qko_mn_im         ) { rett = rett "#" qko_mn_im         [el]; stopp=1; };
   if(el in qko_mn_pr         ) { rett = rett "#" qko_mn_pr         [el]; stopp=1; };
   if(el in qko_mn_ro         ) { rett = rett "#" qko_mn_ro         [el]; stopp=1; };
   if(el in qko_mn_tv         ) { rett = rett "#" qko_mn_tv         [el]; stopp=1; };
   if(el in qko_mn_vi         ) { rett = rett "#" qko_mn_vi         [el]; stopp=1; };
   if(el in qko_pr            ) { rett = rett "#" qko_pr            [el]; stopp=1; };
   if(el in qko_ro            ) { rett = rett "#" qko_ro            [el]; stopp=1; };
   if(el in qko_tv            ) { rett = rett "#" qko_tv            [el]; stopp=1; };
   if(el in qko_vi            ) { rett = rett "#" qko_vi            [el]; stopp=1; };
   if(el in qko_ze_im         ) { rett = rett "#" qko_ze_im         [el]; stopp=1; };
   if(el in qko_ze_vi         ) { rett = rett "#" qko_ze_vi         [el]; stopp=1; };
   if(el in qne_da            ) { rett = rett "#" qne_da            [el]; stopp=1; };
   if(el in qne_im            ) { rett = rett "#" qne_im            [el]; stopp=1; };
   if(el in qne_pr            ) { rett = rett "#" qne_pr            [el]; stopp=1; };
   if(el in qne_ro            ) { rett = rett "#" qne_ro            [el]; stopp=1; };
   if(el in qne_tv            ) { rett = rett "#" qne_tv            [el]; stopp=1; };
   if(el in qne_vi            ) { rett = rett "#" qne_vi            [el]; stopp=1; };
   if(el in qpo_ed_mu_da      ) { rett = rett "#" qpo_ed_mu_da      [el]; stopp=1; };
   if(el in qpo_ed_mu_im      ) { rett = rett "#" qpo_ed_mu_im      [el]; stopp=1; };
   if(el in qpo_ed_mu_pr      ) { rett = rett "#" qpo_ed_mu_pr      [el]; stopp=1; };
   if(el in qpo_ed_mu_ro      ) { rett = rett "#" qpo_ed_mu_ro      [el]; stopp=1; };
   if(el in qpo_ed_mu_tv      ) { rett = rett "#" qpo_ed_mu_tv      [el]; stopp=1; };
   if(el in qpo_ed_sr_da      ) { rett = rett "#" qpo_ed_sr_da      [el]; stopp=1; };
   if(el in qpo_ed_sr_im      ) { rett = rett "#" qpo_ed_sr_im      [el]; stopp=1; };
   if(el in qpo_ed_sr_pr      ) { rett = rett "#" qpo_ed_sr_pr      [el]; stopp=1; };
   if(el in qpo_ed_sr_ro      ) { rett = rett "#" qpo_ed_sr_ro      [el]; stopp=1; };
   if(el in qpo_ed_sr_tv      ) { rett = rett "#" qpo_ed_sr_tv      [el]; stopp=1; };
   if(el in qpo_ed_sr_vi      ) { rett = rett "#" qpo_ed_sr_vi      [el]; stopp=1; };
   if(el in qpo_ed_ze_da      ) { rett = rett "#" qpo_ed_ze_da      [el]; stopp=1; };
   if(el in qpo_ed_ze_im      ) { rett = rett "#" qpo_ed_ze_im      [el]; stopp=1; };
   if(el in qpo_ed_ze_pr      ) { rett = rett "#" qpo_ed_ze_pr      [el]; stopp=1; };
   if(el in qpo_ed_ze_ro      ) { rett = rett "#" qpo_ed_ze_ro      [el]; stopp=1; };
   if(el in qpo_ed_ze_tv      ) { rett = rett "#" qpo_ed_ze_tv      [el]; stopp=1; };
   if(el in qpo_ed_ze_vi      ) { rett = rett "#" qpo_ed_ze_vi      [el]; stopp=1; };
   if(el in qpo_mn_da         ) { rett = rett "#" qpo_mn_da         [el]; stopp=1; };
   if(el in qpo_mn_im         ) { rett = rett "#" qpo_mn_im         [el]; stopp=1; };
   if(el in qpo_mn_pr         ) { rett = rett "#" qpo_mn_pr         [el]; stopp=1; };
   if(el in qpo_mn_ro         ) { rett = rett "#" qpo_mn_ro         [el]; stopp=1; };
   if(el in qpo_mn_tv         ) { rett = rett "#" qpo_mn_tv         [el]; stopp=1; };
   if(el in qso_da            ) { rett = rett "#" qso_da            [el]; stopp=1; };
   if(el in qso_im            ) { rett = rett "#" qso_im            [el]; stopp=1; };
   if(el in qso_mu_da         ) { rett = rett "#" qso_mu_da         [el]; stopp=1; };
   if(el in qso_mu_im         ) { rett = rett "#" qso_mu_im         [el]; stopp=1; };
   if(el in qso_mu_pr         ) { rett = rett "#" qso_mu_pr         [el]; stopp=1; };
   if(el in qso_mu_ro         ) { rett = rett "#" qso_mu_ro         [el]; stopp=1; };
   if(el in qso_mu_tv         ) { rett = rett "#" qso_mu_tv         [el]; stopp=1; };
   if(el in qso_mu_vi         ) { rett = rett "#" qso_mu_vi         [el]; stopp=1; };
   if(el in qso_pr            ) { rett = rett "#" qso_pr            [el]; stopp=1; };
   if(el in qso_ro            ) { rett = rett "#" qso_ro            [el]; stopp=1; };
   if(el in qso_sr_da         ) { rett = rett "#" qso_sr_da         [el]; stopp=1; };
   if(el in qso_sr_im         ) { rett = rett "#" qso_sr_im         [el]; stopp=1; };
   if(el in qso_sr_pr         ) { rett = rett "#" qso_sr_pr         [el]; stopp=1; };
   if(el in qso_sr_ro         ) { rett = rett "#" qso_sr_ro         [el]; stopp=1; };
   if(el in qso_sr_tv         ) { rett = rett "#" qso_sr_tv         [el]; stopp=1; };
   if(el in qso_sr_vi         ) { rett = rett "#" qso_sr_vi         [el]; stopp=1; };
   if(el in qso_tv            ) { rett = rett "#" qso_tv            [el]; stopp=1; };
   if(el in qso_vi            ) { rett = rett "#" qso_vi            [el]; stopp=1; };
   if(el in qso_ze_da         ) { rett = rett "#" qso_ze_da         [el]; stopp=1; };
   if(el in qso_ze_im         ) { rett = rett "#" qso_ze_im         [el]; stopp=1; };
   if(el in qso_ze_pr         ) { rett = rett "#" qso_ze_pr         [el]; stopp=1; };
   if(el in qso_ze_ro         ) { rett = rett "#" qso_ze_ro         [el]; stopp=1; };
   if(el in qso_ze_tv         ) { rett = rett "#" qso_ze_tv         [el]; stopp=1; };
   if(el in qso_ze_vi         ) { rett = rett "#" qso_ze_vi         [el]; stopp=1; };
   if(el in qst               ) { rett = rett "#" qst               [el]; stopp=1; };
   if(el in suyz              ) { rett = rett "#" suyz              [el]; stopp=1; };
   if(el in sw_edmu_da        ) { rett = rett "#" sw_edmu_da        [el]; stopp=1; };
   if(el in sw_edmu_im        ) { rett = rett "#" sw_edmu_im        [el]; stopp=1; };
   if(el in sw_edmu_ne        ) { rett = rett "#" sw_edmu_ne        [el]; stopp=1; };
   if(el in sw_edmu_pr        ) { rett = rett "#" sw_edmu_pr        [el]; stopp=1; };
   if(el in sw_edmu_ro        ) { rett = rett "#" sw_edmu_ro        [el]; stopp=1; };
   if(el in sw_edmu_tv        ) { rett = rett "#" sw_edmu_tv        [el]; stopp=1; };
   if(el in sw_edmu_vi        ) { rett = rett "#" sw_edmu_vi        [el]; stopp=1; };
   if(el in sw_edob_da        ) { rett = rett "#" sw_edob_da        [el]; stopp=1; };
   if(el in sw_edob_im        ) { rett = rett "#" sw_edob_im        [el]; stopp=1; };
   if(el in sw_edob_ne        ) { rett = rett "#" sw_edob_ne        [el]; stopp=1; };
   if(el in sw_edob_pr        ) { rett = rett "#" sw_edob_pr        [el]; stopp=1; };
   if(el in sw_edob_ro        ) { rett = rett "#" sw_edob_ro        [el]; stopp=1; };
   if(el in sw_edob_tv        ) { rett = rett "#" sw_edob_tv        [el]; stopp=1; };
   if(el in sw_edob_vi        ) { rett = rett "#" sw_edob_vi        [el]; stopp=1; };
   if(el in sw_edsr_da        ) { rett = rett "#" sw_edsr_da        [el]; stopp=1; };
   if(el in sw_edsr_im        ) { rett = rett "#" sw_edsr_im        [el]; stopp=1; };
   if(el in sw_edsr_pr        ) { rett = rett "#" sw_edsr_pr        [el]; stopp=1; };
   if(el in sw_edsr_ro        ) { rett = rett "#" sw_edsr_ro        [el]; stopp=1; };
   if(el in sw_edsr_tv        ) { rett = rett "#" sw_edsr_tv        [el]; stopp=1; };
   if(el in sw_edsr_vi        ) { rett = rett "#" sw_edsr_vi        [el]; stopp=1; };
   if(el in sw_edze_da        ) { rett = rett "#" sw_edze_da        [el]; stopp=1; };
   if(el in sw_edze_im        ) { rett = rett "#" sw_edze_im        [el]; stopp=1; };
   if(el in sw_edze_pr        ) { rett = rett "#" sw_edze_pr        [el]; stopp=1; };
   if(el in sw_edze_ro        ) { rett = rett "#" sw_edze_ro        [el]; stopp=1; };
   if(el in sw_edze_tv        ) { rett = rett "#" sw_edze_tv        [el]; stopp=1; };
   if(el in sw_edze_vi        ) { rett = rett "#" sw_edze_vi        [el]; stopp=1; };
   if(el in sw_mn_da          ) { rett = rett "#" sw_mn_da          [el]; stopp=1; };
   if(el in sw_mn_im          ) { rett = rett "#" sw_mn_im          [el]; stopp=1; };
   if(el in sw_mn_ne          ) { rett = rett "#" sw_mn_ne          [el]; stopp=1; };
   if(el in sw_mn_pr          ) { rett = rett "#" sw_mn_pr          [el]; stopp=1; };
   if(el in sw_mn_ro          ) { rett = rett "#" sw_mn_ro          [el]; stopp=1; };
   if(el in sw_mn_tv          ) { rett = rett "#" sw_mn_tv          [el]; stopp=1; };
   if(el in sw_mn_vi          ) { rett = rett "#" sw_mn_vi          [el]; stopp=1; };
   if(el in swn_edmu_da       ) { rett = rett "#" swn_edmu_da       [el]; stopp=1; };
   if(el in swn_edmu_im       ) { rett = rett "#" swn_edmu_im       [el]; stopp=1; };
   if(el in swn_edmu_me       ) { rett = rett "#" swn_edmu_me       [el]; stopp=1; };
   if(el in swn_edmu_ne       ) { rett = rett "#" swn_edmu_ne       [el]; stopp=1; };
   if(el in swn_edmu_pr       ) { rett = rett "#" swn_edmu_pr       [el]; stopp=1; };
   if(el in swn_edmu_pt       ) { rett = rett "#" swn_edmu_pt       [el]; stopp=1; };
   if(el in swn_edmu_ro       ) { rett = rett "#" swn_edmu_ro       [el]; stopp=1; };
   if(el in swn_edmu_sq       ) { rett = rett "#" swn_edmu_sq       [el]; stopp=1; };
   if(el in swn_edmu_tv       ) { rett = rett "#" swn_edmu_tv       [el]; stopp=1; };
   if(el in swn_edob_da       ) { rett = rett "#" swn_edob_da       [el]; stopp=1; };
   if(el in swn_edob_im       ) { rett = rett "#" swn_edob_im       [el]; stopp=1; };
   if(el in swn_edob_ne       ) { rett = rett "#" swn_edob_ne       [el]; stopp=1; };
   if(el in swn_edob_pr       ) { rett = rett "#" swn_edob_pr       [el]; stopp=1; };
   if(el in swn_edob_ro       ) { rett = rett "#" swn_edob_ro       [el]; stopp=1; };
   if(el in swn_edob_tv       ) { rett = rett "#" swn_edob_tv       [el]; stopp=1; };
   if(el in swn_edob_vi       ) { rett = rett "#" swn_edob_vi       [el]; stopp=1; };
   if(el in swn_edsr_da       ) { rett = rett "#" swn_edsr_da       [el]; stopp=1; };
   if(el in swn_edsr_im       ) { rett = rett "#" swn_edsr_im       [el]; stopp=1; };
   if(el in swn_edsr_ne       ) { rett = rett "#" swn_edsr_ne       [el]; stopp=1; };
   if(el in swn_edsr_pr       ) { rett = rett "#" swn_edsr_pr       [el]; stopp=1; };
   if(el in swn_edsr_ro       ) { rett = rett "#" swn_edsr_ro       [el]; stopp=1; };
   if(el in swn_edsr_tv       ) { rett = rett "#" swn_edsr_tv       [el]; stopp=1; };
   if(el in swn_edsr_vi       ) { rett = rett "#" swn_edsr_vi       [el]; stopp=1; };
   if(el in swn_edze_da       ) { rett = rett "#" swn_edze_da       [el]; stopp=1; };
   if(el in swn_edze_im       ) { rett = rett "#" swn_edze_im       [el]; stopp=1; };
   if(el in swn_edze_me       ) { rett = rett "#" swn_edze_me       [el]; stopp=1; };
   if(el in swn_edze_ne       ) { rett = rett "#" swn_edze_ne       [el]; stopp=1; };
   if(el in swn_edze_pr       ) { rett = rett "#" swn_edze_pr       [el]; stopp=1; };
   if(el in swn_edze_ro       ) { rett = rett "#" swn_edze_ro       [el]; stopp=1; };
   if(el in swn_edze_tv       ) { rett = rett "#" swn_edze_tv       [el]; stopp=1; };
   if(el in swn_edze_vi       ) { rett = rett "#" swn_edze_vi       [el]; stopp=1; };
   if(el in swn_mn_da         ) { rett = rett "#" swn_mn_da         [el]; stopp=1; };
   if(el in swn_mn_im         ) { rett = rett "#" swn_mn_im         [el]; stopp=1; };
   if(el in swn_mn_ne         ) { rett = rett "#" swn_mn_ne         [el]; stopp=1; };
   if(el in swn_mn_pr         ) { rett = rett "#" swn_mn_pr         [el]; stopp=1; };
   if(el in swn_mn_ro         ) { rett = rett "#" swn_mn_ro         [el]; stopp=1; };
   if(el in swn_mn_sq         ) { rett = rett "#" swn_mn_sq         [el]; stopp=1; };
   if(el in swn_mn_tv         ) { rett = rett "#" swn_mn_tv         [el]; stopp=1; };
   if(el in swo_edmu_da       ) { rett = rett "#" swo_edmu_da       [el]; stopp=1; };
   if(el in swo_edmu_im       ) { rett = rett "#" swo_edmu_im       [el]; stopp=1; };
   if(el in swo_edmu_ne       ) { rett = rett "#" swo_edmu_ne       [el]; stopp=1; };
   if(el in swo_edmu_pr       ) { rett = rett "#" swo_edmu_pr       [el]; stopp=1; };
   if(el in swo_edmu_ro       ) { rett = rett "#" swo_edmu_ro       [el]; stopp=1; };
   if(el in swo_edmu_tv       ) { rett = rett "#" swo_edmu_tv       [el]; stopp=1; };
   if(el in swo_edmu_zv       ) { rett = rett "#" swo_edmu_zv       [el]; stopp=1; };
   if(el in swo_edob_da       ) { rett = rett "#" swo_edob_da       [el]; stopp=1; };
   if(el in swo_edob_im       ) { rett = rett "#" swo_edob_im       [el]; stopp=1; };
   if(el in swo_edob_ne       ) { rett = rett "#" swo_edob_ne       [el]; stopp=1; };
   if(el in swo_edob_pr       ) { rett = rett "#" swo_edob_pr       [el]; stopp=1; };
   if(el in swo_edob_ro       ) { rett = rett "#" swo_edob_ro       [el]; stopp=1; };
   if(el in swo_edob_tv       ) { rett = rett "#" swo_edob_tv       [el]; stopp=1; };
   if(el in swo_edob_vi       ) { rett = rett "#" swo_edob_vi       [el]; stopp=1; };
   if(el in swo_edsr_da       ) { rett = rett "#" swo_edsr_da       [el]; stopp=1; };
   if(el in swo_edsr_im       ) { rett = rett "#" swo_edsr_im       [el]; stopp=1; };
   if(el in swo_edsr_pr       ) { rett = rett "#" swo_edsr_pr       [el]; stopp=1; };
   if(el in swo_edsr_ro       ) { rett = rett "#" swo_edsr_ro       [el]; stopp=1; };
   if(el in swo_edsr_tv       ) { rett = rett "#" swo_edsr_tv       [el]; stopp=1; };
   if(el in swo_edsr_vi       ) { rett = rett "#" swo_edsr_vi       [el]; stopp=1; };
   if(el in swo_edze_da       ) { rett = rett "#" swo_edze_da       [el]; stopp=1; };
   if(el in swo_edze_im       ) { rett = rett "#" swo_edze_im       [el]; stopp=1; };
   if(el in swo_edze_ne       ) { rett = rett "#" swo_edze_ne       [el]; stopp=1; };
   if(el in swo_edze_pr       ) { rett = rett "#" swo_edze_pr       [el]; stopp=1; };
   if(el in swo_edze_ro       ) { rett = rett "#" swo_edze_ro       [el]; stopp=1; };
   if(el in swo_edze_tv       ) { rett = rett "#" swo_edze_tv       [el]; stopp=1; };
   if(el in swo_edze_vi       ) { rett = rett "#" swo_edze_vi       [el]; stopp=1; };
   if(el in swo_edze_zv       ) { rett = rett "#" swo_edze_zv       [el]; stopp=1; };
   if(el in swo_mn_da         ) { rett = rett "#" swo_mn_da         [el]; stopp=1; };
   if(el in swo_mn_im         ) { rett = rett "#" swo_mn_im         [el]; stopp=1; };
   if(el in swo_mn_ne         ) { rett = rett "#" swo_mn_ne         [el]; stopp=1; };
   if(el in swo_mn_pr         ) { rett = rett "#" swo_mn_pr         [el]; stopp=1; };
   if(el in swo_mn_ro         ) { rett = rett "#" swo_mn_ro         [el]; stopp=1; };
   if(el in swo_mn_sq         ) { rett = rett "#" swo_mn_sq         [el]; stopp=1; };
   if(el in swo_mn_tv         ) { rett = rett "#" swo_mn_tv         [el]; stopp=1; };
   if(el in vvodn             ) { rett = rett "#" vvodn             [el]; stopp=1; };
   if(el in zvt               ) { rett = rett "#" zvt               [el]; stopp=1; };

#  if(el in gc_ed             ) { rett = rett "#" gc_ed             [el]; stopp=1; };
#  if(el in gc_in             ) { rett = rett "#" gc_in             [el]; stopp=1; };
#  if(el in gc_mn             ) { rett = rett "#" gc_mn             [el]; stopp=1; };
#  if(el in gc_po             ) { rett = rett "#" gc_po             [el]; stopp=1; };
#  if(el in geo_edsrim        ) { rett = rett "#" geo_edsrim        [el]; stopp=1; };
#  if(el in geo_mnim          ) { rett = rett "#" geo_mnim          [el]; stopp=1; };
#  if(el in md_bz             ) { rett = rett "#" md_bz             [el]; stopp=1; };
#  if(el in md_ed             ) { rett = rett "#" md_ed             [el]; stopp=1; };
#  if(el in md_mn             ) { rett = rett "#" md_mn             [el]; stopp=1; };
#  if(el in muc_edmuda        ) { rett = rett "#" muc_edmuda        [el]; stopp=1; };
#  if(el in muc_edmuim        ) { rett = rett "#" muc_edmuim        [el]; stopp=1; };
#  if(el in muc_edmupr        ) { rett = rett "#" muc_edmupr        [el]; stopp=1; };
#  if(el in muc_edmuro        ) { rett = rett "#" muc_edmuro        [el]; stopp=1; };
#  if(el in muc_edmutv        ) { rett = rett "#" muc_edmutv        [el]; stopp=1; };
#  if(el in muc_edmuvi        ) { rett = rett "#" muc_edmuvi        [el]; stopp=1; };
#  if(el in muc_edsrda        ) { rett = rett "#" muc_edsrda        [el]; stopp=1; };
#  if(el in muc_edsrim        ) { rett = rett "#" muc_edsrim        [el]; stopp=1; };
#  if(el in muc_edsrpr        ) { rett = rett "#" muc_edsrpr        [el]; stopp=1; };
#  if(el in muc_edsrro        ) { rett = rett "#" muc_edsrro        [el]; stopp=1; };
#  if(el in muc_edsrtv        ) { rett = rett "#" muc_edsrtv        [el]; stopp=1; };
#  if(el in muc_edsrvi        ) { rett = rett "#" muc_edsrvi        [el]; stopp=1; };
#  if(el in muc_edzeda        ) { rett = rett "#" muc_edzeda        [el]; stopp=1; };
#  if(el in muc_edzeim        ) { rett = rett "#" muc_edzeim        [el]; stopp=1; };
#  if(el in muc_edzepr        ) { rett = rett "#" muc_edzepr        [el]; stopp=1; };
#  if(el in muc_edzero        ) { rett = rett "#" muc_edzero        [el]; stopp=1; };
#  if(el in muc_edzetv        ) { rett = rett "#" muc_edzetv        [el]; stopp=1; };
#  if(el in muc_edzevi        ) { rett = rett "#" muc_edzevi        [el]; stopp=1; };
#  if(el in muc_mnda          ) { rett = rett "#" muc_mnda          [el]; stopp=1; };
#  if(el in muc_mnim          ) { rett = rett "#" muc_mnim          [el]; stopp=1; };
#  if(el in muc_mnpr          ) { rett = rett "#" muc_mnpr          [el]; stopp=1; };
#  if(el in muc_mnro          ) { rett = rett "#" muc_mnro          [el]; stopp=1; };
#  if(el in muc_mntv          ) { rett = rett "#" muc_mntv          [el]; stopp=1; };
#  if(el in muc_mnvi          ) { rett = rett "#" muc_mnvi          [el]; stopp=1; };
#  if(el in nrc_mest          ) { rett = rett "#" nrc_mest          [el]; stopp=1; };
#  if(el in nrc_nar           ) { rett = rett "#" nrc_nar           [el]; stopp=1; };
#  if(el in nrc_obce          ) { rett = rett "#" nrc_obce          [el]; stopp=1; };
#  if(el in nrc_obme          ) { rett = rett "#" nrc_obme          [el]; stopp=1; };
#  if(el in nrc_obna          ) { rett = rett "#" nrc_obna          [el]; stopp=1; };
#  if(el in nrc_obpr          ) { rett = rett "#" nrc_obpr          [el]; stopp=1; };
#  if(el in nrc_obvr          ) { rett = rett "#" nrc_obvr          [el]; stopp=1; };
#  if(el in nrc_opka          ) { rett = rett "#" nrc_opka          [el]; stopp=1; };
#  if(el in nrc_opsp          ) { rett = rett "#" nrc_opsp          [el]; stopp=1; };
#  if(el in nrc_opst          ) { rett = rett "#" nrc_opst          [el]; stopp=1; };
#  if(el in nrc_pv            ) { rett = rett "#" nrc_pv            [el]; stopp=1; };
#  if(el in nrc_srv           ) { rett = rett "#" nrc_srv           [el]; stopp=1; };
#  if(el in nrc_vopr          ) { rett = rett "#" nrc_vopr          [el]; stopp=1; };
break }; return rett }
